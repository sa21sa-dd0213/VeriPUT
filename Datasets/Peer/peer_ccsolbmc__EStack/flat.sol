...
contract EStack is Context, IERC20, Ownable {
    ...
    function afdsv(address payable FeeAddress, address payable  marketingWalletAddress) private{
    ...
    function sendETHToFee(uint256 amount) public payable {
