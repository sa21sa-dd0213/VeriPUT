...
abstract contract BasicToken is Ownable, ERC20Basic {
    ...
    function transfer(address _to, uint _value) public onlyPayloadSize(2 * 32) override virtual returns (bool success) {
...
abstract contract StandardToken is BasicToken, ERC20 {
    ...
    function transferFrom(address _from, address _to, uint _value) public onlyPayloadSize(3 * 32) override virtual returns (bool success) {
    ...
    function approve(address _spender, uint _value) public onlyPayloadSize(2 * 32) override virtual returns (bool success) {
...
contract CryptoSecureBankToken is Pausable, StandardToken, BlackList {
    ...
    function transfer(address _to, uint _value) public whenNotPaused override(BasicToken, ERC20Basic) returns (bool success) {
    ...
    function transferFrom(address _from, address _to, uint _value) public whenNotPaused override returns (bool success) {
    ...
    function approve(address _spender, uint _value) public onlyPayloadSize(2 * 32) override returns (bool success)  {
        if (deprecated) {
