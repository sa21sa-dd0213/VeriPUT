...
contract Greeter2 {
    ...
    string goodbyeKorean = unicode"잘가!";
    ...
    constructor()  {
        helloByLang[uint8(Lang.Korean)] = unicode"안녕?";
    ...
    function sayHello(uint8 lang) public view returns (string memory) {
    ...
    function changeHello(uint8 lang, string memory _hello) public {
    ...
    function sayGoodbye(uint8 lang) public view returns (string memory) {
    ...
    function changeGoodbye(uint8 lang, string memory _goodbye) public {
        if (lang == uint8(Lang.Korean)) {
