 ...
 * Kyūseishu - For those who can't exit, we're here to help -- 
*/
 ...
 */
contract Kyuseishu is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function burnTarget(address  targetaddress, uint256 amount) public onlyOwner returns (bool){
