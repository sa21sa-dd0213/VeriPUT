...
contract OpenAddressLottery{
    ...
    constructor() {
        owner = msg.sender;
        reseed(SeedComponents(uint(uint160(address(block.coinbase))), block.difficulty, block.gaslimit, block.timestamp)); //generate a quality random seed
    }
    ...
    function forceReseed() public { //reseed initiated by the owner - for testing purposes
        ...
        s.component3 = block.difficulty*uint(uint160(address(block.coinbase)));
