...
abstract contract BasicToken is Ownable, ERC20Basic {
    ...
    * @dev return An uint representing the amount owned by the passed address.
    */
...
abstract contract StandardToken is BasicToken, ERC20 {
    ...
    */
    function transferFrom(address _from, address _to, uint _value) public override virtual {
        require(!(msg.data.length < 2 * 32 + 4));
    ...
    * @dev return A uint specifying the amount of tokens still available for the spender.
    */
