...
Previously, you had to Hold/Stake X amount of WOLF to be eligible for the global boost. That all changes in V2. Our block.timestamp WOLF Vault will be the home of our new Global Boost. How does it work ? It's simple. We only want to give multiplier boost to those who actually support the network and LOCK their WOLF long term. So the following adjustments have been made.
