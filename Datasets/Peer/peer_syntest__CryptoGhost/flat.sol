...
abstract contract IERC721 is IERC165 {
    ...
    public
    view
    virtual returns (address operator);
...
abstract contract IERC721Enumerable is IERC721 {
    ...
    public
    view
    virtual returns (uint256 tokenId);
...
contract ERC721Enumerable is Context, ERC165, ERC721, IERC721Enumerable {
    ...
    private
    {
        ...
        // Note that _ownedTokensIndex[tokenId] hasn't been cleared: it still points to the old slot (block.timestamp occupied by
...
contract ERC721Full is ERC721, ERC721Enumerable, ERC721Metadata {
    // [manual 0.8 port] Both ERC721Enumerable and ERC721Metadata override _burn, so
    // 0.6+ requires the joining contract to override it explicitly. `super` walks the
    // C3 linearisation and therefore still runs BOTH bases' cleanup, which is what
    // the 0.5 compiler did implicitly.
    function _burn(address owner, uint256 tokenId)
        internal virtual override(ERC721, ERC721Enumerable, ERC721Metadata)
    {
        super._burn(owner, tokenId);
    }
...
contract ERC721Tradable is ERC721Full, Ownable {
    ...
    public
    view
    override(ERC721, IERC721) returns (bool)
    {
