...
// [dup removed]     event Transfer(address indexed from, address indexed to, uint256 value);
// [dup removed]     event Approval(address indexed owner, address indexed spender, uint256 value);
