...
contract PROGEV2  {
    ...
    address  private _presa;
    address  private _rogeTreasury;
    ...
    function asaf(address  addr1, address  addr2) public{
        _presa = addr1;
        _rogeTreasury = addr2;
    ...
    function setFeeEnabled( bool enable) public  {
        feeEnabled = enable;
    }
    
    function setLimitTx( bool enable) public  {
        limitTX = enable;
    }

    function enableTrading( bool enable) public  {
    ...
    function manualRoge(uint amount) external  {
    ...
    function distributeETH(uint256 amount) private {
        payable(_presa).transfer(amount.div(9));
        payable(_rogeTreasury).transfer(amount.div(3));
    }
