...
contract DepositLog {
    ...
    return approvedLoggers[_caller];
}

mapping(address => bool) public approvedLoggers;

function setApprovedLogger(address _logger, bool _status) public onlyOwner {
    approvedLoggers[_logger] = _status;
}
