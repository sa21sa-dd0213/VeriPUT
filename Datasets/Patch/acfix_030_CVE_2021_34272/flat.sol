...
contract RobotBTC is Owned, TokenERC20 {
    ...
    constructor(
        uint256 initialSupply, string memory tokenName, string memory tokenSymbol) TokenERC20(initialSupply, tokenName, tokenSymbol) public {
    ...
    function setExchange(bool istrue)  public onlyOwner {
        isOpened = istrue;
    }
}
