...
contract RoundFactory is IRoundFactory, OwnableUpgradeable {
  ...
  function create(
    ...
    address ownedBy
  ) external onlyProgramOperator returns (address) {
...
mapping(address => bool) public programOperators;

modifier onlyProgramOperator() {
    require(programOperators[msg.sender], "Caller is not a program operator");
    _;
}
}
