...
contract ProtocolFeeControllerMigration is ReentrancyGuardTransient, SingletonAuthentication {
    ...
    function _migrateGlobalPercentages() internal {
        ...
        bytes32 swapFeeRole = IAuthentication_1(address(newFeeController)).getActionId(
            IProtocolFeeController.setGlobalProtocolSwapFeePercentage.selector
        );

        bytes32 yieldFeeRole = IAuthentication_1(address(newFeeController)).getActionId(
    ...
    function _migrateFeeController() internal {
        bytes32 setFeeControllerRole = IAuthentication_1(address(vault)).getActionId(
    ...
    VaultGuard
{
    ...
    uint256 public constant MAX_PROTOCOL_SWAP_FEE_PERCENTAGE = 50e16; 

    
    uint256 public constant MAX_PROTOCOL_YIELD_FEE_PERCENTAGE = 50e16; 

    
    uint256 public constant MAX_CREATOR_FEE_PERCENTAGE = 99.999e16; 
    ...
    function _computeAggregateFeePercentage(
        ...
        aggregateFeePercentage = (aggregateFeePercentage / FEE_SCALING_FACTOR_1) * FEE_SCALING_FACTOR_1;
    }
    ...
    function _ensureValidPrecision(uint256 feePercentage) private pure {
        ...
        if ((feePercentage / FEE_SCALING_FACTOR_1) * FEE_SCALING_FACTOR_1 != feePercentage) {
