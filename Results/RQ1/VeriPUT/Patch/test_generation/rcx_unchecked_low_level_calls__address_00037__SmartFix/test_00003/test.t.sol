...
contract MultiplicatorX4CovTest_1_MultiplicatorX4_withdraw_put2p1 is Test {
  MultiplicatorX4 c0;
  function setUp() public {
  ...
  function test_put_MultiplicatorX4_withdraw_path2p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { MultiplicatorX4CovTest_1_MultiplicatorX4_withdraw_concrete2p1__basis_root__W _veriput_w = new MultiplicatorX4CovTest_1_MultiplicatorX4_withdraw_concrete2p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract MultiplicatorX4CovTest_1_MultiplicatorX4_withdraw_concrete2p1__basis_root__W is Test {
  MultiplicatorX4 c0;
  function setUp() public {
    vm.startPrank(address(uint160(4294967295)), address(uint160(4294967295)));
    c0 = new MultiplicatorX4();
