...
contract MultiplicatorX3CovTest_MultiplicatorX3_receive_put1p1 is Test {
  MultiplicatorX3 c0;
  ...
  function test_put_MultiplicatorX3_receive_path1p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { MultiplicatorX3CovTest_MultiplicatorX3_receive_concrete1p1__basis_root__W _veriput_w = new MultiplicatorX3CovTest_MultiplicatorX3_receive_concrete1p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract MultiplicatorX3CovTest_MultiplicatorX3_receive_concrete1p1__basis_root__W is Test {
  MultiplicatorX3 c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new MultiplicatorX3();
