...
contract MultiplicatorX3CovTest_1_MultiplicatorX3_Command_put2p1 is Test {
  MultiplicatorX3 c0;
  function setUp() public {
  ...
  function test_put_MultiplicatorX3_Command_path2p1(address p_msg_sender, address adr, bytes memory data) public {
    _veriput_parameterized(p_msg_sender, adr, data);
    
    { MultiplicatorX3CovTest_1_MultiplicatorX3_Command_concrete2p1__basis_root__W _veriput_w = new MultiplicatorX3CovTest_1_MultiplicatorX3_Command_concrete2p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract MultiplicatorX3CovTest_1_MultiplicatorX3_Command_concrete2p1__basis_root__W is Test {
  MultiplicatorX3 c0;
  function setUp() public {
    vm.startPrank(address(uint160(4294967295)), address(uint160(4294967295)));
    c0 = new MultiplicatorX3();
