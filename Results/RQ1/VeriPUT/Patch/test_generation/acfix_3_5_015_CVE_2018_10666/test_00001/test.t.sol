...
contract OwnedCovTest_Owned_setOwner_put2p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address _owner) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("setOwner(address)", _owner));
  ...
  function test_put_Owned_setOwner_path2p1(address p_msg_sender, uint256 p_msg_value, address _owner) public {
