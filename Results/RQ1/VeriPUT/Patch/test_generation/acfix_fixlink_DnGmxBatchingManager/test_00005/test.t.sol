...
contract DnGmxBatchingManagerCovTest_DnGmxBatchingManager_owner_put3p1 is Test {
  ...
  // claim: sol:@C@DnGmxBatchingManager@F@owner#823:path:3
  // witness-fingerprint-sha256: 1f86ca80257e15005c3d5c8bff481bb87dd9a3fe2a193e0391c918677a9ff43f
  // claim: sol:@C@DnGmxBatchingManager@F@owner#823:path:2
  // witness-fingerprint-sha256: 84dbed1801682a9b5c85ed7d8aad642cb21b913caef1eb56ca8a0dacecb20839

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@DnGmxBatchingManager@F@owner#823:path:3   depth=1
  ...
  //   state._owner$782 in [0, 1461501637330902918203684832716283019655932542975]
  //   PIN block.basefee == 0
  ...
  //   rung DROPPED: return: return == state._owner$782 (rung shape not renderable for its declared type)
