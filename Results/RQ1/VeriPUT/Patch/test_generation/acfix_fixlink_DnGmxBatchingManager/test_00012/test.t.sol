...
contract DnGmxBatchingManagerCovTest_DnGmxBatchingManager_unclaimedShares_put7p1 is Test {
  ...
  // claim: sol:@C@DnGmxBatchingManager@F@unclaimedShares#1706:path:7
  // witness-fingerprint-sha256: 5c17e195fb5f684137978c0d8aada59ffbb61de947e4db53b768bc4c7e67682e
  // claim: sol:@C@DnGmxBatchingManager@F@unclaimedShares#1706:path:2
  // witness-fingerprint-sha256: b9b7b1801a06cb41d221924e8d24f70ede709e9bc6ab026c1347482faa4f3b00

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@DnGmxBatchingManager@F@unclaimedShares#1706:path:7   depth=2
  ...
  //   rung IMPLIED (not lost, not asserted twice): vaultBatchingState.roundUsdcBalance: post <= pre (entailed by a stronger rung that also HOLDS on vaultBatchingState.roundUsdcBalance, so asserting it detects nothing the stronger one misses)
  //   path guard DROPPED: 'userDeposit.round < vaultBatchingState.currentRound && userDeposit.usdcBalance > 0' (`userDeposit.round` is not nameable in this PUT)
