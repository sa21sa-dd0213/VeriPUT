...
contract DnGmxBatchingManagerCovTest_DnGmxBatchingManager_unclaimedShares_put7p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, address account) internal {
    ...
    uint256 _put_ret = c0.unclaimedShares(account);
  ...
  function test_put_DnGmxBatchingManager_unclaimedShares_path7p1(address p_msg_sender, address account) public {
    _veriput_parameterized(p_msg_sender, account);
    
    { DnGmxBatchingManagerCovTest_DnGmxBatchingManager_unclaimedShares_concrete7p1__basis_root__W _veriput_w = new DnGmxBatchingManagerCovTest_DnGmxBatchingManager_unclaimedShares_concrete7p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract DnGmxBatchingManagerCovTest_DnGmxBatchingManager_unclaimedShares_concrete7p1__basis_root__W is Test {
  DnGmxBatchingManager c0;
  function setUp() public {
    c0 = new DnGmxBatchingManager();
  }
  ...
  function _w_test_cov_0() public {
    ...
    uint256 _veriput_concrete_return = c0.unclaimedShares(address(uint160(0)));
