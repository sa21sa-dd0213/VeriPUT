...
contract DnGmxBatchingManagerCovTest_DnGmxBatchingManager_usdcBalance_put3p1_p1_part_part0_r is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, address account) internal {
    ...
    if (p_msg_sender == address(uint160(0)) && account == address(uint160(1))) {
  ...
  function test_put_DnGmxBatchingManager_usdcBalance_path3p1_part_part0_r(address p_msg_sender, address account) public {
    _veriput_parameterized(p_msg_sender, account);
    
    { DnGmxBatchingManagerCovTest_DnGmxBatchingManager_usdcBalance_concrete3p1__basis_part0_r__W _veriput_w = new DnGmxBatchingManagerCovTest_DnGmxBatchingManager_usdcBalance_concrete3p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract DnGmxBatchingManagerCovTest_DnGmxBatchingManager_usdcBalance_concrete3p1__basis_part0_r__W is Test {
  DnGmxBatchingManager c0;
  function setUp() public {
    c0 = new DnGmxBatchingManager();
  }
  ...
  function _w_test_cov_0() public {
    ...
    uint256 _veriput_concrete_return = c0.usdcBalance(address(uint160(1)));
