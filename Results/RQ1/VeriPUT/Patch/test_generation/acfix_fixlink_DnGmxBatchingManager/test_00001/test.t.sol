...
contract DnGmxBatchingManagerCovTest_DnGmxBatchingManager_currentRound_put2p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("currentRound()"));
  ...
  function test_put_DnGmxBatchingManager_currentRound_path2p1(address p_msg_sender, uint256 p_msg_value) public {
