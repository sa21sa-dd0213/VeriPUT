...
contract DCFCovTest_DCF_transferOwnership_put2p1 is Test {
  ...
  // claim: sol:@C@DCF@F@transferOwnership#1728:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@DCF@F@transferOwnership#1728:path:2   depth=1
  ...
  //   level0 = True
  //   level0_perturb = True
  //   level0_points = {'12': 'newOwner==0', '13': '(none)', '14': 'newOwner==0, state._owner$1650==4294967295', '15': 'state._owner$1650==4294967295'}
  //   max_holes = 3
  //   max_region_pieces = 4
  //   max_tx = 1
  //   probe_ladder = True
