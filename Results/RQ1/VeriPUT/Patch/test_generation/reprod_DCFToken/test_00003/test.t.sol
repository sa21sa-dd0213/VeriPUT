...
contract DCFCovTest_DCF_balanceOf_put3p1_p1_part_part0_r is Test {
  DCF c0;
  LiquidityHelper c1;
  ...
  function _veriput_parameterized(address p_msg_sender, address account) internal {
    ...
    if (p_msg_sender == address(uint160(0)) && account == address(uint160(4294967295))) {
      assertEq(_put_ret, uint256(2000000000000000000000000), "fixed witness return");
      ...
      assertEq(uint256(vm.load(address(c0), keccak256(abi.encode(address(uint160(4294967295)), uint256(0))))), uint256(2000000000000000000000000), "fixed witness state");
      assertEq((uint256(vm.load(address(c0), bytes32(uint256(5)))) & 1461501637330902918203684832716283019655932542975), uint256(4294967295), "fixed witness state");
      assertEq(uint256(vm.load(address(c0), bytes32(uint256(2)))), uint256(2000000000000000000000000), "fixed witness state");
      ...
      assertEq((uint256(vm.load(address(c0), keccak256(abi.encode(address(uint160(4294967295)), uint256(20))))) & 255), uint256(1), "fixed witness state");
    }
  ...
  function test_put_DCF_balanceOf_path3p1_part_part0_r(address p_msg_sender, address account) public {
    _veriput_parameterized(p_msg_sender, account);
    
    { DCFCovTest_DCF_balanceOf_concrete3p1__basis_part0_r__W _veriput_w = new DCFCovTest_DCF_balanceOf_concrete3p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract DCFCovTest_DCF_balanceOf_concrete3p1__basis_part0_r__W is Test {
  DCF c0;
  LiquidityHelper c1;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
  ...
  function _w_test_cov_0() public {
    ...
    assertEq((uint256(vm.load(address(c0), bytes32(uint256(11)))) & 1461501637330902918203684832716283019655932542975), uint256(489982930986835137684486657990555633941558688085), "entry pin state.USDT$2547 did NOT land: vm.store wrote a word the contract does not read back at this slot, so the test is not inside the certified region and every rung below is about a different state");
    {
      ...
      _w = (_w & ~uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)) | ((uint256(2000000000000000000000000) & 115792089237316195423570985008687907853269984665640564039457584007913129639935) << 0);
      vm.store(address(c0), keccak256(abi.encode(uint256(4294967295), uint256(0))), bytes32(_w));
    }
    assertEq(uint256(vm.load(address(c0), keccak256(abi.encode(uint256(4294967295), uint256(0))))), uint256(2000000000000000000000000), "entry pin state._balances$1758[4294967295] did NOT land: vm.store wrote a word the contract does not read back at this slot, so the test is not inside the certified region and every rung below is about a different state");
    {
    ...
    assertEq((uint256(vm.load(address(c0), bytes32(uint256(5)))) & 1461501637330902918203684832716283019655932542975), uint256(4294967295), "entry pin state._owner$1650 did NOT land: vm.store wrote a word the contract does not read back at this slot, so the test is not inside the certified region and every rung below is about a different state");
    {
      uint256 _w = uint256(vm.load(address(c0), bytes32(uint256(2))));
      _w = (_w & ~uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)) | ((uint256(2000000000000000000000000) & 115792089237316195423570985008687907853269984665640564039457584007913129639935) << 0);
      vm.store(address(c0), bytes32(uint256(2)), bytes32(_w));
    }
    assertEq(uint256(vm.load(address(c0), bytes32(uint256(2)))), uint256(2000000000000000000000000), "entry pin state._totalSupply$1766 did NOT land: vm.store wrote a word the contract does not read back at this slot, so the test is not inside the certified region and every rung below is about a different state");
    {
    ...
    {
      uint256 _w = uint256(vm.load(address(c0), keccak256(abi.encode(uint256(4294967295), uint256(20)))));
      _w = (_w & ~uint256(255)) | ((uint256(1) & 255) << 0);
      vm.store(address(c0), keccak256(abi.encode(uint256(4294967295), uint256(20))), bytes32(_w));
    }
    assertEq((uint256(vm.load(address(c0), keccak256(abi.encode(uint256(4294967295), uint256(20))))) & 255), uint256(1), "entry pin state.whiteAddress[4294967295] did NOT land: vm.store wrote a word the contract does not read back at this slot, so the test is not inside the certified region and every rung below is about a different state");
    ...
    assertEq(_veriput_concrete_return, uint256(2000000000000000000000000), "fixed witness return must match");
    uint256 _veriput_fixed_state_USDT_2547_2 = (uint256(vm.load(address(c0), bytes32(uint256(11)))) & 1461501637330902918203684832716283019655932542975);
    assertEq(_veriput_fixed_state_USDT_2547_2, uint256(489982930986835137684486657990555633941558688085), "fixed witness state");
    uint256 _veriput_fixed_state_balances_1758_4294967295_3 = uint256(vm.load(address(c0), keccak256(abi.encode(address(uint160(4294967295)), uint256(0)))));
    assertEq(_veriput_fixed_state_balances_1758_4294967295_3, uint256(2000000000000000000000000), "fixed witness state");
    uint256 _veriput_fixed_state_owner_1650_4 = (uint256(vm.load(address(c0), bytes32(uint256(5)))) & 1461501637330902918203684832716283019655932542975);
    assertEq(_veriput_fixed_state_owner_1650_4, uint256(4294967295), "fixed witness state");
    uint256 _veriput_fixed_state_totalSupply_1766_5 = uint256(vm.load(address(c0), bytes32(uint256(2))));
    assertEq(_veriput_fixed_state_totalSupply_1766_5, uint256(2000000000000000000000000), "fixed witness state");
    uint256 _veriput_fixed_state_cfo_6 = (uint256(vm.load(address(c0), bytes32(uint256(16)))) & 1461501637330902918203684832716283019655932542975);
    assertEq(_veriput_fixed_state_cfo_6, uint256(0), "fixed witness state");
    uint256 _veriput_fixed_state_deadCfg_7 = uint256(vm.load(address(c0), bytes32(uint256(12))));
    assertEq(_veriput_fixed_state_deadCfg_7, uint256(2), "fixed witness state");
    uint256 _veriput_fixed_state_distributeAddress_8 = (uint256(vm.load(address(c0), bytes32(uint256(17)))) & 1461501637330902918203684832716283019655932542975);
    assertEq(_veriput_fixed_state_distributeAddress_8, uint256(0), "fixed witness state");
    uint256 _veriput_fixed_state_distributeAmount_9 = uint256(vm.load(address(c0), bytes32(uint256(15))));
    assertEq(_veriput_fixed_state_distributeAmount_9, uint256(2000000000000000000000), "fixed witness state");
    uint256 _veriput_fixed_state_helperAddress_10 = (uint256(vm.load(address(c0), bytes32(uint256(9)))) & 1461501637330902918203684832716283019655932542975);
    assertEq(_veriput_fixed_state_helperAddress_10, uint256(3), "fixed witness state");
    uint256 _veriput_fixed_state_initTime_11 = uint256(vm.load(address(c0), bytes32(uint256(14))));
    assertEq(_veriput_fixed_state_initTime_11, uint256(0), "fixed witness state");
    uint256 _veriput_fixed_state_liquidityReceiveAddress_2567_13 = (uint256(vm.load(address(c0), bytes32(uint256(19)))) & 1461501637330902918203684832716283019655932542975);
    assertEq(_veriput_fixed_state_liquidityReceiveAddress_2567_13, uint256(0), "fixed witness state");
    uint256 _veriput_fixed_state_pairAddress_14 = (uint256(vm.load(address(c0), bytes32(uint256(8)))) & 1461501637330902918203684832716283019655932542975);
    assertEq(_veriput_fixed_state_pairAddress_14, uint256(0), "fixed witness state");
    uint256 _veriput_fixed_state_rewardAddress_15 = (uint256(vm.load(address(c0), bytes32(uint256(18)))) & 1461501637330902918203684832716283019655932542975);
    assertEq(_veriput_fixed_state_rewardAddress_15, uint256(0), "fixed witness state");
    uint256 _veriput_fixed_state_router_2544_17 = (uint256(vm.load(address(c0), bytes32(uint256(10)))) & 1461501637330902918203684832716283019655932542975);
    assertEq(_veriput_fixed_state_router_2544_17, uint256(96635033217071433185869069577301221175488545358), "fixed witness state");
    uint256 _veriput_fixed_state_swapping_18 = (uint256(vm.load(address(c0), bytes32(uint256(13)))) & 255);
    assertEq(_veriput_fixed_state_swapping_18, uint256(0), "fixed witness state");
    uint256 _veriput_fixed_state_whiteAddress_0_21 = (uint256(vm.load(address(c0), keccak256(abi.encode(address(uint160(0)), uint256(20))))) & 255);
    assertEq(_veriput_fixed_state_whiteAddress_0_21, uint256(1), "fixed witness state");
    uint256 _veriput_fixed_state_whiteAddress_4294967295_22 = (uint256(vm.load(address(c0), keccak256(abi.encode(address(uint160(4294967295)), uint256(20))))) & 255);
    assertEq(_veriput_fixed_state_whiteAddress_4294967295_22, uint256(1), "fixed witness state");
  }
