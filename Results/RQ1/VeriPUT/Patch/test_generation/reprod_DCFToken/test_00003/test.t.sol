...
contract DCFCovTest_DCF_balanceOf_concrete3p1__basis_part0_r__W is Test {
  ...
  function _w_test_cov_0() public {
    ...
    // VERIPUT_FIXED_REPLAY_STATE_PROJECTION {"state.DCT":{"certificate":"fixed-replay-state-constant-or-immutable/v1","kind":"fixed-replay-state-constant-or-immutable","value":496423980066692787666240234175246447705334195271},"state.USDT$2323":{"certificate":"fixed-replay-state-constant-or-immutable/v1","kind":"fixed-replay-state-constant-or-immutable","value":489982930986835137684486657990555633941558688085},"state.liquidityReceiveAddress$2328":{"certificate":"fixed-replay-state-constant-or-immutable/v1","kind":"fixed-replay-state-constant-or-immutable","value":0},"state.router$2326":{"certificate":"fixed-replay-state-constant-or-immutable/v1","kind":"fixed-replay-state-constant-or-immutable","value":96635033217071433185869069577301221175488545358},"state.token":{"certificate":"fixed-replay-state-constant-or-immutable/v1","kind":"fixed-replay-state-constant-or-immutable","value":1}}
    // [asserted] path exits normally; a revert fails the test
    vm.warp(115792089237316195423570985008687907853269984665640564039457584007913129639934);
    vm.roll(115792089237316195423570985008687907853269984665640564039457584007913129639934);
    vm.chainId(0);
