...
contract DCFCovTest_DCF_totalSupply_put3p1 is Test {
  ...
  // claim: sol:@C@DCF@F@totalSupply#1822:path:3
  // witness-fingerprint-sha256: 6c40fc5ec64598104d0d634c6acae81a0388a09f8f214e7f0d2628479db00b49
  // claim: sol:@C@DCF@F@totalSupply#1822:path:2
  // witness-fingerprint-sha256: 8982d17b31374d25abff6801f331e38a1ae1798fad0d58f3b1ef72a92006ae41

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@DCF@F@totalSupply#1822:path:3   depth=1
  ...
  //   state._totalSupply$1766 in [0, 115792089237316195423570985008687907853269984665640564039457584007913129639935]
  //   PIN block.basefee == 0
