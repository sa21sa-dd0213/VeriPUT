...
contract DCFCovTest_DCF_totalSupply_put3p1 is Test {
  DCF c0;
  LiquidityHelper c1;
  ...
  function test_put_DCF_totalSupply_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { DCFCovTest_DCF_totalSupply_concrete3p1__basis_root__W _veriput_w = new DCFCovTest_DCF_totalSupply_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract DCFCovTest_DCF_totalSupply_concrete3p1__basis_root__W is Test {
  DCF c0;
  LiquidityHelper c1;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
