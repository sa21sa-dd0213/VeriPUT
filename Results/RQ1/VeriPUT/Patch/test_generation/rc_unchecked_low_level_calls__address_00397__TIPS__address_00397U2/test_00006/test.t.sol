...
contract PoCGameCovTest_1_PoCGame_AdjustDifficulty_put6p1 is Test {
  PoCGame c0;
  function setUp() public {
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 amount) internal {
    ...
    bool _put_ok = true;
    try c0.AdjustDifficulty(amount) {} catch { _put_ok = false; }
  ...
  function test_put_PoCGame_AdjustDifficulty_path6p1(address p_msg_sender, uint256 amount) public {
    _veriput_parameterized(p_msg_sender, amount);
    
    { PoCGameCovTest_1_PoCGame_AdjustDifficulty_concrete6p1__basis_root__W _veriput_w = new PoCGameCovTest_1_PoCGame_AdjustDifficulty_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract PoCGameCovTest_1_PoCGame_AdjustDifficulty_concrete6p1__basis_root__W is Test {
  PoCGame c0;
  function setUp() public {
    vm.startPrank(address(uint160(4294967295)), address(uint160(4294967295)));
    c0 = new PoCGame(address(uint160(0)), 0);
  ...
  function _w_test_cov_2() public {
    ...
    try c0.AdjustDifficulty(uint256(0)) {
