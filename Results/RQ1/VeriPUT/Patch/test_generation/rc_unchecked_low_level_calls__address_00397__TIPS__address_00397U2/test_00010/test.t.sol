...
contract PoCGameCovTest_0_PoCGame_AdjustDifficulty_put7p1_p1_part_part0_w_w is Test {
  PoCGame c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 amount) internal {
    ...
    if (p_msg_sender == address(uint160(0)) && amount == uint256(0)) {
      ...
      assertEq(_veriputFixedLogs[0].topics[0], keccak256("DifficultyChanged(uint256)"));
  ...
  function test_put_PoCGame_AdjustDifficulty_path7p1_part_part0_w_w(address p_msg_sender, uint256 amount) public {
