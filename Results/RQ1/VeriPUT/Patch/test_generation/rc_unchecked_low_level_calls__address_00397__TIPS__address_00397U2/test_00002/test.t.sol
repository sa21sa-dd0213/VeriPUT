...
contract PoCGameCovTest_0_PoCGame_AdjustBetAmounts_put7p1_p1_part_part0_r_r is Test {
  PoCGame c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 amount) internal {
    ...
    amount = bound(amount, 115792089237316195423570985008687907853269984665640564039457584007913129639935, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
    ...
    if (p_msg_sender == address(uint160(0)) && amount == uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)) {
  ...
  function test_put_PoCGame_AdjustBetAmounts_path7p1_part_part0_r_r(address p_msg_sender, uint256 amount) public {
    _veriput_parameterized(p_msg_sender, amount);
    
    { PoCGameCovTest_0_PoCGame_AdjustBetAmounts_concrete7p1__basis_part0_r_r__W _veriput_w = new PoCGameCovTest_0_PoCGame_AdjustBetAmounts_concrete7p1__basis_part0_r_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PoCGameCovTest_0_PoCGame_AdjustBetAmounts_concrete7p1__basis_part0_r_r__W is Test {
  PoCGame c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new PoCGame(address(uint160(0)), 0);
  ...
  function _w_test_cov_0() public {
    ...
    c0.AdjustBetAmounts(uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935));
    uint256 _veriput_fixed_state_betLimit_0 = uint256(vm.load(address(c0), bytes32(uint256(1))));
    assertEq(_veriput_fixed_state_betLimit_0, uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935), "fixed witness state");
