...
contract PoCGameCovTest_PoCGame_currentBetLimit_put3p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    assertEq(_post_betLimit, _pre_betLimit, "betLimit: post == state.betLimit");
    assertGe(_post_betLimit, 0, "betLimit: post in [0, pre]");
    assertLe(_post_betLimit, _pre_betLimit, "betLimit: post in [0, pre]");
    assertGe(_post_betLimit, 0, "betLimit: post in [0, state.betLimit]");
    assertLe(_post_betLimit, _pre_betLimit, "betLimit: post in [0, state.betLimit]");
    assertGe(_post_betLimit, 0, "betLimit: post in [0, (msg.value + 115792089237316195423570985008687907853269984665640564039457584007913129639935)]");
