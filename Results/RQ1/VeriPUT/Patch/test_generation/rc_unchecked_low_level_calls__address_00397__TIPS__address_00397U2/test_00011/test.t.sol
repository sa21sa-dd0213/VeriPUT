...
contract PoCGameCovTest_0_PoCGame_OpenToThePublic_put7p1_p1_part_part0_w is Test {
  PoCGame c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    if (p_msg_sender == address(uint160(0))) {
      ...
      assertEq((uint256(vm.load(address(c0), bytes32(uint256(7)))) & 255), uint256(1), "fixed witness state");
    ...
    assertEq(_post_openToPublic, 1, "openToPublic: post == true");
    ...
    assertGe(_post_owner, 0, "owner: post in [0, (pre * pre)]");
    unchecked { assertLe(_post_owner, (uint256(_pre_owner) * uint256(_pre_owner)), "owner: post in [0, (pre * pre)]"); }
    assertGe(_post_owner, 0, "owner: post in [0, (pre + state.openToPublic)]");
    unchecked { assertLe(_post_owner, (uint256(_pre_owner) + uint256(_pre_openToPublic)), "owner: post in [0, (pre + state.openToPublic)]"); }
    ...
    assertGe(_post_owner, 0, "owner: post in [0, (1461501637330902918203684832716283019655932542975 - state.openToPublic)]");
    unchecked { assertLe(_post_owner, (uint256(1461501637330902918203684832716283019655932542975) - uint256(_pre_openToPublic)), "owner: post in [0, (1461501637330902918203684832716283019655932542975 - state.openToPublic)]"); }
    
  }


  
  function test_put_PoCGame_OpenToThePublic_path7p1_part_part0_w(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { PoCGameCovTest_0_PoCGame_OpenToThePublic_concrete7p1__basis_part0_w__W _veriput_w = new PoCGameCovTest_0_PoCGame_OpenToThePublic_concrete7p1__basis_part0_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PoCGameCovTest_0_PoCGame_OpenToThePublic_concrete7p1__basis_part0_w__W is Test {
  PoCGame c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new PoCGame(address(uint160(0)), 0);
  ...
  function _w_test_cov_0() public {
    ...
    assertEq(_veriput_fixed_state_openToPublic_2, uint256(1), "fixed witness state");
