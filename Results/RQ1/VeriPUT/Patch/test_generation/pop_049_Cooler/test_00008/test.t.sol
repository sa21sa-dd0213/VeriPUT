...
contract CoolerCovTest_Cooler_isActive_put2p1 is Test {
  Cooler c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, uint256 reqID_) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("isActive(uint256)", reqID_));
  ...
  function test_put_Cooler_isActive_path2p1(address p_msg_sender, uint256 p_msg_value, uint256 reqID_) public {
