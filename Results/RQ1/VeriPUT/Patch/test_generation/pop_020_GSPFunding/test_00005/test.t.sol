...
contract GSPFundingCovTest_GSPFunding_balanceOf_put3p1_p1_part_part0_w_w is Test {
  ...
  // claim: sol:@C@GSPFunding@F@balanceOf#3818:path:3
  // witness-fingerprint-sha256: 58e7fc0ebb2b33a28e36dc26e868c97a3ec015baa3510ff504cd6fc092b0a6ce
  // claim: sol:@C@GSPFunding@F@balanceOf#3818:path:2
  // witness-fingerprint-sha256: 804e07c3e1eb4b1c732b08ab5386c843bbe3d0de8821a06725883309c5ff5500

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@GSPFunding@F@balanceOf#3818:path:3   depth=1
  ...
  //   owner in [0, 365375409332725729550921208179070754913983135743]
  //   PIN block.basefee == 0
  ...
  //   rung IMPLIED (not lost, not asserted twice): _SHARES_[owner]: post >= pre (entailed by a stronger rung that also HOLDS on _SHARES_[owner], so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): _SHARES_[owner]: post <= pre (entailed by a stronger rung that also HOLDS on _SHARES_[owner], so asserting it detects nothing the stronger one misses)
