...
contract GSPFundingCovTest_GSPFunding_balanceOf_put3p1_p1_part_part0_w_w is Test {
  GSPFunding c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address owner) internal {
    ...
    owner = address(uint160(bound(uint256(uint160(owner)), 0, 365375409332725729550921208179070754913983135743)));
  ...
  function test_put_GSPFunding_balanceOf_path3p1_part_part0_w_w(address p_msg_sender, address owner) public {
    _veriput_parameterized(p_msg_sender, owner);
    
    { GSPFundingCovTest_GSPFunding_balanceOf_concrete3p1__basis_part0_w_w__W _veriput_w = new GSPFundingCovTest_GSPFunding_balanceOf_concrete3p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract GSPFundingCovTest_GSPFunding_balanceOf_concrete3p1__basis_part0_w_w__W is Test {
  GSPFunding c0;
  function setUp() public {
    c0 = new GSPFunding();
  }
