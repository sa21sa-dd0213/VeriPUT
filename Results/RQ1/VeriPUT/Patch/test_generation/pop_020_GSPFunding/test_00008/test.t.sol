...
contract GSPFundingCovTest_GSPFunding_getQuoteInput_put2p1 is Test {
  GSPFunding c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("getQuoteInput()"));
  ...
  function test_put_GSPFunding_getQuoteInput_path2p1(address p_msg_sender, uint256 p_msg_value) public {
