...
contract GSPFundingCovTest_GSPFunding_balanceOf_put3p1_p1_part_part0_r is Test {
  ...
  //   owner in [730750818665451459101842416358141509827966271488, 1461501637330902918203684832716283019655932542975]
  //   PIN block.basefee == 0
...
contract GSPFundingCovTest_GSPFunding_balanceOf_concrete3p1__basis_part0_r__W is Test {
  ...
  function _w_test_cov_0() public {
    ...
    // VERIPUT_FIXED_REPLAY_STATE_PROJECTION {"state.PERMIT_TYPEHASH$3056":{"certificate":"fixed-replay-state-constant-or-immutable/v1","kind":"fixed-replay-state-constant-or-immutable","value":49955707469362902507454157297736832118868343942642399513960811609542965143241},"state._ENTERED$1314":{"certificate":"fixed-replay-state-constant-or-immutable/v1","kind":"fixed-replay-state-constant-or-immutable","value":2},"state._NOT_ENTERED$1311":{"certificate":"fixed-replay-state-constant-or-immutable/v1","kind":"fixed-replay-state-constant-or-immutable","value":1}}
    // [asserted] path exits normally; a revert fails the test
    vm.warp(115792089237316195423570985008687907853269984665640564039457584007913129639934);
    vm.roll(115792089237316195423570985008687907853269984665640564039457584007913129639934);
    vm.chainId(0);
