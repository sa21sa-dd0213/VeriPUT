...
contract SimpleSuicideCovTest_1_SimpleSuicide_sudicideAnyone_put6p1_p1_part_part0_w is Test {
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    assertGe(_post_owner, _pre_owner, "__owner: post >= pre");
    assertLe(_post_owner, _pre_owner, "__owner: post <= pre");
...
contract SimpleSuicideCovTest_1_SimpleSuicide_sudicideAnyone_concrete6p1__basis_part0_w__W is Test {
  ...
  function _w_test_cov_2() public {
    ...
    assertEq(_veriput_fixed_state_owner_15_0, uint256(2147483647), "fixed witness state");
  }
}
