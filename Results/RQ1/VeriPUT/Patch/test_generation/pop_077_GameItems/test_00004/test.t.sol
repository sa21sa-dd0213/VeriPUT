...
contract GameItemsCovTest_GameItems_balanceOfBatch_put2p1 is Test {
  ...
  // claim: sol:@C@GameItems@F@balanceOfBatch#1874:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@GameItems@F@balanceOfBatch#1874:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, accounts, ids
