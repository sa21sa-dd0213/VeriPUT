...
contract GameItemsCovTest_GameItems_isApprovedForAll_put3p1 is Test {
  ...
  // claim: sol:@C@GameItems@F@isApprovedForAll#1907:path:3
  // witness-fingerprint-sha256: b5a7d0b79efff8a5a5e668cd0147bc7e7eadba60ac6fa91a44c1e006efe9b204
  // claim: sol:@C@GameItems@F@isApprovedForAll#1907:path:2
  // witness-fingerprint-sha256: a639265b3d118ed5726ea0195fbe16649522305cfda445c0c67007c0390a1c3c

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@GameItems@F@isApprovedForAll#1907:path:3   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, account, operator
