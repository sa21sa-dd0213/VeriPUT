...
contract GameItemsCovTest_GameItems_setAllowedBurningAddresses_put2p1 is Test {
  ...
  // claim: sol:@C@GameItems@F@setAllowedBurningAddresses#3685:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@GameItems@F@setAllowedBurningAddresses#3685:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, newBurningAddress
