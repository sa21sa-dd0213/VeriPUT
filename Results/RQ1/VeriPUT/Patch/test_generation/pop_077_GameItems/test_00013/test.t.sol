...
contract GameItemsCovTest_0_GameItems_transferOwnership_put7p1_p1_part_part0_w_w is Test {
  ...
  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@GameItems@F@transferOwnership#3437:path:7   depth=2
  ...
  //   path guard ESTABLISHED: `!(msg.sender == _ownerAddress$3365)` -> `vm.assume(uint256(uint160(p_msg_sender)) == _pre_ownerAddress_3365);`
  ...
  function _veriput_parameterized(address p_msg_sender, address newOwnerAddress) internal {
    ...
    //   state._ownerAddress$3365 := msg.sender
    {
