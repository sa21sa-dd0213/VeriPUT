...
contract PENNY_BY_PENNYCovTest_PENNY_BY_PENNY_SetMinSum_put7p1_p1_part_part0_r is Test {
  PENNY_BY_PENNY c0;
  ...
  function test_put_PENNY_BY_PENNY_SetMinSum_path7p1_part_part0_r(address p_msg_sender, uint256 _val) public {
    _veriput_parameterized(p_msg_sender, _val);
    
    { PENNY_BY_PENNYCovTest_PENNY_BY_PENNY_SetMinSum_concrete7p1__basis_part0_r__W _veriput_w = new PENNY_BY_PENNYCovTest_PENNY_BY_PENNY_SetMinSum_concrete7p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PENNY_BY_PENNYCovTest_PENNY_BY_PENNY_SetMinSum_concrete7p1__basis_part0_r__W is Test {
  PENNY_BY_PENNY c0;
  function setUp() public {
    c0 = new PENNY_BY_PENNY();
  }
