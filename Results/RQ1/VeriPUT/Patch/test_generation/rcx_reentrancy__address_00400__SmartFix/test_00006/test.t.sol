...
contract PENNY_BY_PENNYCovTest_PENNY_BY_PENNY_SetLogFile_put7p1 is Test {
  PENNY_BY_PENNY c0;
  ...
  function test_put_PENNY_BY_PENNY_SetLogFile_path7p1(address p_msg_sender, address _log) public {
    _veriput_parameterized(p_msg_sender, _log);
    
    { PENNY_BY_PENNYCovTest_PENNY_BY_PENNY_SetLogFile_concrete7p1__basis_root__W _veriput_w = new PENNY_BY_PENNYCovTest_PENNY_BY_PENNY_SetLogFile_concrete7p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PENNY_BY_PENNYCovTest_PENNY_BY_PENNY_SetLogFile_concrete7p1__basis_root__W is Test {
  PENNY_BY_PENNY c0;
  function setUp() public {
    c0 = new PENNY_BY_PENNY();
  }
