...
contract ANCHTokenCovTest_0 is Test {
  ...
  // claim: sol:@C@ANCHToken@F@setMinTxnAmount#1855:path:7
  // witness-fingerprint-sha256: 4a6cde3192ee954c59637d98b9ee6692e3f6ec848443c963f8b857195bf7c80d
  // claim: sol:@C@ANCHToken@F@setMinTxnAmount#1855:path:2
  // witness-fingerprint-sha256: 174bef7850394ca148e2a494d9293b8f5ed379429f787e311c87bd2bd35056b4
}
...
contract ANCHTokenCovTest_1_ANCHToken_setMinTxnAmount_put6p1 is Test {
  ...
  // claim: sol:@C@ANCHToken@F@setMinTxnAmount#1855:path:6
  // witness-fingerprint-sha256: 10dbf6b4d76db301b76a803f6832a8e15e2bcd6a110f859f0b070223e1c06cb0

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@ANCHToken@F@setMinTxnAmount#1855:path:6   depth=2
  ...
  //   _minTxnAmount in [0, 115792089237316195423570985008687907853269984665640564039457584007913129639935]
  //   msg.sender in [0, 1461501637330902918203684832716283019655932542975]  \ {2147483647}
  //   state._owner$70 in [2147483647, 2147483647]
  //   state.minTxnAmount in [0, 115792089237316195423570985008687907853269984665640564039457584007913129639935]
  //   PIN block.basefee == 0
  ...
  // FUZZ COORDINATES: msg.sender, _minTxnAmount
