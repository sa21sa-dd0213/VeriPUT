...
contract ANCHTokenCovTest_ANCHToken_setRewardRate_put2p1 is Test {
  ANCHToken c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, uint256 _rewardRate) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("setRewardRate(uint256)", _rewardRate));
  ...
  function test_put_ANCHToken_setRewardRate_path2p1(address p_msg_sender, uint256 p_msg_value, uint256 _rewardRate) public {
    _veriput_parameterized(p_msg_sender, p_msg_value, _rewardRate);
  }
}
