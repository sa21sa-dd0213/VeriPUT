...
contract ANCHTokenCovTest_ANCHToken_owner_put2p1 is Test {
  ANCHToken c0;
  function setUp() public {
    ...
    vm.mockCall(_esbmc_ctor_state_mock_0_0, abi.encodeWithSignature("factory()"), abi.encode(address(0)));
    vm.etch(_esbmc_ctor_arg_mock_0_0_ret_0, hex"60006000f3");
    vm.etch(_esbmc_ctor_arg_mock_0_8_ret_0, hex"60006000f3");
  }
  ...
  function test_put_ANCHToken_owner_path2p1(address p_msg_sender, uint256 p_msg_value) public {
