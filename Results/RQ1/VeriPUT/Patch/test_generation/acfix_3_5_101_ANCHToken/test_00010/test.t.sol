...
contract ANCHTokenCovTest_ANCHToken_totalFees_put2p1 is Test {
  ANCHToken c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value) internal {
    ...
    uint256 _pre_tFeeTotal = uint256(vm.load(address(c0), bytes32(uint256(6))));
    ...
    uint256 _post_tFeeTotal = uint256(vm.load(address(c0), bytes32(uint256(6))));
  ...
  function test_put_ANCHToken_totalFees_path2p1(address p_msg_sender, uint256 p_msg_value) public {
