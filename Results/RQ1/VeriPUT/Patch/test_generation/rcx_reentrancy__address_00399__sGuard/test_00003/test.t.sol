...
contract X_WALLETCovTest_X_WALLET_fallback_put14p1_p1_part_part0_w_r is Test {
  X_WALLET c0;
  ...
  function test_put_X_WALLET_fallback_path14p1_part_part0_w_r(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { X_WALLETCovTest_X_WALLET_fallback_concrete14p1__basis_part0_w_r__W _veriput_w = new X_WALLETCovTest_X_WALLET_fallback_concrete14p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract X_WALLETCovTest_X_WALLET_fallback_concrete14p1__basis_part0_w_r__W is Test {
  X_WALLET c0;
  function setUp() public {
    c0 = new X_WALLET(address(uint160(0)));
