...
contract StaxLPStakingCovTest_StaxLPStaking_stake_put2p1 is Test {
  ...
  // claim: sol:@C@StaxLPStaking@F@stake#1812:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@StaxLPStaking@F@stake#1812:path:2   depth=1
  ...
  // ORACLE: rollback exit plus 93 restored post-state frame assertion(s).
