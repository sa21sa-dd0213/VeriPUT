...
contract StaxLPStakingCovTest_StaxLPStaking_addReward_put2p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address _rewardToken) internal {
    ...
    uint256 _pre_rewardData__rewardToken__lastUpdateTime = (uint256(vm.load(address(c0), bytes32(uint256(keccak256(abi.encode(_rewardToken, uint256(6)))) + 1))) & 1099511627775);
    uint256 _pre_rewardData__rewardToken__periodFinish = (uint256(vm.load(address(c0), keccak256(abi.encode(_rewardToken, uint256(6))))) & 1099511627775);
    ...
    uint256 _pre_rewardData__rewardToken__rewardPerTokenStored = ((uint256(vm.load(address(c0), bytes32(uint256(keccak256(abi.encode(_rewardToken, uint256(6)))) + 1))) >> 40) & 105312291668557186697918027683670432318895095400549111254310977535);
    ...
    uint256 _pre_rewardData__rewardToken__rewardRate = ((uint256(vm.load(address(c0), keccak256(abi.encode(_rewardToken, uint256(6))))) >> 40) & 105312291668557186697918027683670432318895095400549111254310977535);
    ...
    uint256 _post_rewardData__rewardToken__lastUpdateTime = (uint256(vm.load(address(c0), bytes32(uint256(keccak256(abi.encode(_rewardToken, uint256(6)))) + 1))) & 1099511627775);
    uint256 _post_rewardData__rewardToken__periodFinish = (uint256(vm.load(address(c0), keccak256(abi.encode(_rewardToken, uint256(6))))) & 1099511627775);
    ...
    uint256 _post_rewardData__rewardToken__rewardPerTokenStored = ((uint256(vm.load(address(c0), bytes32(uint256(keccak256(abi.encode(_rewardToken, uint256(6)))) + 1))) >> 40) & 105312291668557186697918027683670432318895095400549111254310977535);
    ...
    uint256 _post_rewardData__rewardToken__rewardRate = ((uint256(vm.load(address(c0), keccak256(abi.encode(_rewardToken, uint256(6))))) >> 40) & 105312291668557186697918027683670432318895095400549111254310977535);
