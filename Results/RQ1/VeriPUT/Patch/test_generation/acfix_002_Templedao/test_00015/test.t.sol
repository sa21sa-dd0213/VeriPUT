...
contract StaxLPStakingCovTest_StaxLPStaking_totalSupply_put3p1 is Test {
  StaxLPStaking c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    uint256 _pre_totalSupply_1501 = uint256(vm.load(address(c0), bytes32(uint256(3))));
    ...
    unchecked { assertEq(_post_totalSupply, (uint256(_pre_totalSupply) - uint256(_pre_totalSupply_1501)), "_totalSupply: post == (pre - state._totalSupply$1501)"); }
  ...
  function test_put_StaxLPStaking_totalSupply_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { StaxLPStakingCovTest_StaxLPStaking_totalSupply_concrete3p1__basis_root__W _veriput_w = new StaxLPStakingCovTest_StaxLPStaking_totalSupply_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract StaxLPStakingCovTest_StaxLPStaking_totalSupply_concrete3p1__basis_root__W is Test {
  StaxLPStaking c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new StaxLPStaking(address(uint160(0)), address(uint160(0)));
