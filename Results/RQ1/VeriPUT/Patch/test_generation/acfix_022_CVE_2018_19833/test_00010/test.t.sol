...
contract ERCDDATokenCovTest_1_ERCDDAToken_owned_put6p1_p1_part_part0_w is Test {
  ERCDDAToken c0;
  function setUp() public {
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    bool _put_ok = true;
    try c0.owned() {} catch { _put_ok = false; }
  ...
  function test_put_ERCDDAToken_owned_path6p1_part_part0_w(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { ERCDDATokenCovTest_1_ERCDDAToken_owned_concrete6p1__basis_part0_w__W _veriput_w = new ERCDDATokenCovTest_1_ERCDDAToken_owned_concrete6p1__basis_part0_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract ERCDDATokenCovTest_1_ERCDDAToken_owned_concrete6p1__basis_part0_w__W is Test {
  ERCDDAToken c0;
  function setUp() public {
    vm.startPrank(address(uint160(2147483647)), address(uint160(2147483647)));
    c0 = new ERCDDAToken(0, "", "");
