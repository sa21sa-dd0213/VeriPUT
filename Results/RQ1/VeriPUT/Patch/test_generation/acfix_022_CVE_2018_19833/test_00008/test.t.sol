...
contract ERCDDATokenCovTest_1_ERCDDAToken_mintToken_put6p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, address target, uint256 mintedAmount) internal {
    ...
    uint256 _pre_balanceOf_36_msg_sender = uint256(vm.load(address(c0), keccak256(abi.encode(p_msg_sender, uint256(5)))));
    uint256 _pre_balanceOf_msg_sender = uint256(vm.load(address(c0), keccak256(abi.encode(p_msg_sender, uint256(5)))));
    uint256 _pre_balanceOf_2147483647 = uint256(vm.load(address(c0), keccak256(abi.encode(uint256(2147483647), uint256(5)))));
    ...
    uint256 _post_balanceOf_36_msg_sender = uint256(vm.load(address(c0), keccak256(abi.encode(p_msg_sender, uint256(5)))));
    uint256 _post_balanceOf_msg_sender = uint256(vm.load(address(c0), keccak256(abi.encode(p_msg_sender, uint256(5)))));
    uint256 _post_balanceOf_2147483647 = uint256(vm.load(address(c0), keccak256(abi.encode(uint256(2147483647), uint256(5)))));
