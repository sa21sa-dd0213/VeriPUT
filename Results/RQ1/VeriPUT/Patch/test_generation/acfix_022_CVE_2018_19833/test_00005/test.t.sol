...
contract ERCDDATokenCovTest_1_ERCDDAToken_freezeAccount_put6p1_p1_part_part0_w is Test {
  ERCDDAToken c0;
  function setUp() public {
  ...
  function _veriput_parameterized(address p_msg_sender, address target, bool freeze) internal {
    ...
    if (p_msg_sender == address(uint160(4294967295)) && target == address(uint160(0)) && freeze == false) {
  ...
  function test_put_ERCDDAToken_freezeAccount_path6p1_part_part0_w(address p_msg_sender, address target, bool freeze) public {
    _veriput_parameterized(p_msg_sender, target, freeze);
    
    { ERCDDATokenCovTest_1_ERCDDAToken_freezeAccount_concrete6p1__basis_part0_w__W _veriput_w = new ERCDDATokenCovTest_1_ERCDDAToken_freezeAccount_concrete6p1__basis_part0_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract ERCDDATokenCovTest_1_ERCDDAToken_freezeAccount_concrete6p1__basis_part0_w__W is Test {
  ERCDDAToken c0;
  function setUp() public {
    vm.startPrank(address(uint160(2147483647)), address(uint160(2147483647)));
    c0 = new ERCDDAToken(0, "", "");
