...
contract LRTDepositPoolCovTest_LRTDepositPool_pause_put2p1 is Test {
  LRTDepositPool c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("pause()"));
  ...
  function test_put_LRTDepositPool_pause_path2p1(address p_msg_sender, uint256 p_msg_value) public {
