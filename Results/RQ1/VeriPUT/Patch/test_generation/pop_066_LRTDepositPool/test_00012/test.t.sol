...
contract LRTDepositPoolCovTest_LRTDepositPool_updateLRTConfig_put2p1 is Test {
  LRTDepositPool c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address lrtConfigAddr) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("updateLRTConfig(address)", lrtConfigAddr));
  ...
  function test_put_LRTDepositPool_updateLRTConfig_path2p1(address p_msg_sender, uint256 p_msg_value, address lrtConfigAddr) public {
