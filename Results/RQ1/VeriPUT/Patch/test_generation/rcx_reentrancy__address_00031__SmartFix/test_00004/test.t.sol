...
contract PrivateBankCovTest_PrivateBank_receive_put1p1 is Test {
  PrivateBank c0;
  ...
  function test_put_PrivateBank_receive_path1p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { PrivateBankCovTest_PrivateBank_receive_concrete1p1__basis_root__W _veriput_w = new PrivateBankCovTest_PrivateBank_receive_concrete1p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PrivateBankCovTest_PrivateBank_receive_concrete1p1__basis_root__W is Test {
  PrivateBank c0;
  function setUp() public {
    c0 = new PrivateBank(address(uint160(0)));
