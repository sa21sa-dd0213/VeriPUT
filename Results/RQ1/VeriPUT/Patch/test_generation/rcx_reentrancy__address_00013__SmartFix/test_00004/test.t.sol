...
contract W_WALLETCovTest_W_WALLET_fallback_put14p1 is Test {
  ...
  // claim: sol:@C@W_WALLET@F@fallback#138:path:14
  // witness-fingerprint-sha256: ae3599a835d6cd16209ed7ecdf50b06ec902a27d063effa64bb7e513ab8480a3

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@W_WALLET@F@fallback#138:path:14   depth=3
