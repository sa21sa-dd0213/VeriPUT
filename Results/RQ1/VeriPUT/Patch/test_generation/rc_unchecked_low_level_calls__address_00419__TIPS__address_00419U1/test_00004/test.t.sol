...
contract airDropCovTest_airDrop_transfer_put6p1_p1_part_part0_w_w is Test {
  airDrop c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_block_timestamp, uint256 p_block_number, address from, address caddress, address[] memory _tos, uint256 v, uint256 _decimals) internal {
    ...
    p_block_number = bound(p_block_number, 0, 115792089237316195423570985008687907853269984665640564039457584007913129639932);
  ...
  function test_put_airDrop_transfer_path6p1_part_part0_w_w(address p_msg_sender, uint256 p_block_timestamp, uint256 p_block_number, address from, address caddress, address[] memory _tos, uint256 v, uint256 _decimals) public {
    _veriput_parameterized(p_msg_sender, p_block_timestamp, p_block_number, from, caddress, _tos, v, _decimals);
    
    { airDropCovTest_airDrop_transfer_concrete6p1__basis_part0_w_w__W _veriput_w = new airDropCovTest_airDrop_transfer_concrete6p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract airDropCovTest_airDrop_transfer_concrete6p1__basis_part0_w_w__W is Test {
  airDrop c0;
  function setUp() public {
    c0 = new airDrop();
  }
