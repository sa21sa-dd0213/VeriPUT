...
contract RoundFactoryCovTest_RoundFactory_owner_put3p1 is Test {
  ...
  // claim: sol:@C@RoundFactory@F@owner#629:path:3
  // witness-fingerprint-sha256: 03f4f66d94e237f29f20cfd09aecd67f75b89d1f7239dc43ad0a337f42454fb9
  // claim: sol:@C@RoundFactory@F@owner#629:path:2
  // witness-fingerprint-sha256: 0acaad8e10be590bebc6191c22e80d0ce85db7045e170d7b5267a68167659342

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@RoundFactory@F@owner#629:path:3   depth=1
  ...
  //   state._owner$588 in [0, 1461501637330902918203684832716283019655932542975]
  //   PIN block.basefee == 0
  ...
  //   rung DROPPED: return: return == state._owner$588 (rung shape not renderable for its declared type)
