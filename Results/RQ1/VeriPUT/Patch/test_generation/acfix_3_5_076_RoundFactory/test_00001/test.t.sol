...
contract RoundFactoryCovTest_RoundFactory_create_put2p1 is Test {
  ...
  // claim: sol:@C@RoundFactory@F@create#876:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@RoundFactory@F@create#876:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, encodedParameters, ownedBy
