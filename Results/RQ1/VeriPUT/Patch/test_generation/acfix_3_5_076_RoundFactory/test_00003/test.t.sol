...
contract RoundFactoryCovTest_RoundFactory_initialize_put52p1_p1_part_part0_r is Test {
  RoundFactory c0;
  ...
  function test_put_RoundFactory_initialize_path52p1_part_part0_r(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { RoundFactoryCovTest_RoundFactory_initialize_concrete52p1__basis_part0_r__W _veriput_w = new RoundFactoryCovTest_RoundFactory_initialize_concrete52p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract RoundFactoryCovTest_RoundFactory_initialize_concrete52p1__basis_part0_r__W is Test {
  RoundFactory c0;
  function setUp() public {
    c0 = new RoundFactory();
  }
  ...
  function _w_test_cov_0() public {
    ...
    assertEq(_veriput_fixed_state_owner_588_2, uint256(4294967295), "fixed witness state");
