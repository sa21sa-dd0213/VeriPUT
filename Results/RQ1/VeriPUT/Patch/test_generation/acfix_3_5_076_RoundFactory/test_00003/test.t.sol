...
contract RoundFactoryCovTest_RoundFactory_initialize_put52p1_p1_part_part0_r is Test {
  ...
  // claim: sol:@C@RoundFactory@F@initialize#773:path:52
  // witness-fingerprint-sha256: a424f327aa101e6e09b5ad373b8722eb5ea77e50fe153eb6cc46fd9e4e6a46b2
  // claim: sol:@C@RoundFactory@F@initialize#773:path:2
  // witness-fingerprint-sha256: 9d793163718b78b82261a52ccde3ba0bb2e448f8ead4434f3ef167d021963403

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@RoundFactory@F@initialize#773:path:52   depth=5
  ...
  //   level0 = True
  //   level0_perturb = True
  //   level0_points = {'52': 'state._initialized$391==0, state._initializing$393==0'}
  //   max_holes = 3
  //   max_region_pieces = 4
  //   max_tx = 1
  //   probe_ladder = True
  ...
  //   rung IMPLIED (not lost, not asserted twice): _initialized: post >= pre (entailed by a stronger rung that also HOLDS on _initialized, so asserting it detects nothing the stronger one misses)
  //   path guard ESTABLISHED: `!(isTopLevelCall && _initialized$391 < 1)` -> `vm.assume(_pre_initialized_391 < 1);`
  //   path guard DROPPED: '!(isTopLevelCall && _initialized$391 < 1)' (`isTopLevelCall` is not nameable in this PUT)
