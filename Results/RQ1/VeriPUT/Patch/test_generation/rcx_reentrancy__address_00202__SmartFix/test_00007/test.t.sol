...
contract BANK_SAFECovTest_BANK_SAFE_SetMinSum_put7p1_p1_part_part0_w_r is Test {
  BANK_SAFE c0;
  ...
  function test_put_BANK_SAFE_SetMinSum_path7p1_part_part0_w_r(address p_msg_sender, uint256 _val) public {
    _veriput_parameterized(p_msg_sender, _val);
    
    { BANK_SAFECovTest_BANK_SAFE_SetMinSum_concrete7p1__basis_part0_w_r__W _veriput_w = new BANK_SAFECovTest_BANK_SAFE_SetMinSum_concrete7p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract BANK_SAFECovTest_BANK_SAFE_SetMinSum_concrete7p1__basis_part0_w_r__W is Test {
  BANK_SAFE c0;
  function setUp() public {
    c0 = new BANK_SAFE();
  }
