...
contract WalletCovTest_Wallet_migrateTo_put2p1 is Test {
  Wallet c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address to) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("migrateTo(address)", to));
  ...
  function test_put_Wallet_migrateTo_path2p1(address p_msg_sender, uint256 p_msg_value, address to) public {
