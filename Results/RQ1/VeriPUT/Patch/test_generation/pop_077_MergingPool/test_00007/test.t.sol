...
contract MergingPoolCovTest_MergingPool_getFighterPoints_put2p1 is Test {
  ...
  // claim: sol:@C@MergingPool@F@getFighterPoints#6066:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@MergingPool@F@getFighterPoints#6066:path:2   depth=1
  ...
  //   level0 = True
  //   level0_perturb = True
  //   level0_points = {'13': 'maxId==1', '25': 'maxId==2', '49': 'maxId==3', '7': 'maxId==0'}
  //   max_holes = 3
  //   max_region_pieces = 4
  //   max_tx = 1
  //   probe_ladder = True
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, maxId
