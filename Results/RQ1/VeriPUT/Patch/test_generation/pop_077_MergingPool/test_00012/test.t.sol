...
contract MergingPoolCovTest_MergingPool_updateWinnersPerPeriod_put2p1 is Test {
  ...
  // claim: sol:@C@MergingPool@F@updateWinnersPerPeriod#5715:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@MergingPool@F@updateWinnersPerPeriod#5715:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, newWinnersPerPeriodAmount
