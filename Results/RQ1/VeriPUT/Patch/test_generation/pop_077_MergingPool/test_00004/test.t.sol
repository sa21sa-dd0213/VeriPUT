...
contract MergingPoolCovTest_1_MergingPool_adjustAdminAccess_put6p1 is Test {
  ...
  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@MergingPool@F@adjustAdminAccess#5698:path:6   depth=2
  ...
  //   state._ownerAddress$5604 in [730750818665451459101842416358141509832261238783, 730750818665451459101842416358141509832261238783]
  //   PIN block.basefee == 0
  ...
  //   path guard ESTABLISHED: `!(!(msg.sender == _ownerAddress$5604))` -> `vm.assume(uint256(uint160(p_msg_sender)) != 730750818665451459101842416358141509832261238783);`
