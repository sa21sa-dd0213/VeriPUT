...
contract MY_BANKCovTest_MY_BANK_fallback_put14p1_p1_part_part0_r is Test {
  MY_BANK c0;
  ...
  function test_put_MY_BANK_fallback_path14p1_part_part0_r(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { MY_BANKCovTest_MY_BANK_fallback_concrete14p1__basis_part0_r__W _veriput_w = new MY_BANKCovTest_MY_BANK_fallback_concrete14p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract MY_BANKCovTest_MY_BANK_fallback_concrete14p1__basis_part0_r__W is Test {
  MY_BANK c0;
  function setUp() public {
    c0 = new MY_BANK(address(uint160(0)));
