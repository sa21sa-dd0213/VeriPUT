...
contract ReentrancyDAOCovTest_ReentrancyDAO_withdrawAll_put15p1_p1_part_part0_r_w is Test {
  ...
  //   environment ESTABLISHED: msg.sender in [3791923280, 4060358719] is ESTABLISHED and FUZZED: the governing vm.prank now takes the bound() fuzz parameter `p_msg_sender`, so this PUT ranges over the certified sender interval rather than over one point of it (replacing `vm.prank(address(uint160(0)));`)
