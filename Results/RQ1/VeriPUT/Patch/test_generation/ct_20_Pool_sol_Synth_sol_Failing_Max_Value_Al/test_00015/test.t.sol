...
contract SynthCovTest_Synth_transfer_put14p1_p1_part_part0_w_w is Test {
  Synth c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address recipient, uint256 amount) internal {
    ...
    amount = bound(amount, 57896044618658097711785492504343953926634992332820282019728792003956564819970, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
    ...
    if (p_msg_sender == address(uint160(1)) && recipient == address(uint160(0)) && amount == uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)) {
  ...
  function test_put_Synth_transfer_path14p1_part_part0_w_w(address p_msg_sender, address recipient, uint256 amount) public {
    _veriput_parameterized(p_msg_sender, recipient, amount);
    
    { SynthCovTest_Synth_transfer_concrete14p1__basis_part0_w_w__W _veriput_w = new SynthCovTest_Synth_transfer_concrete14p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract SynthCovTest_Synth_transfer_concrete14p1__basis_part0_w_w__W is Test {
  Synth c0;
  function setUp() public {
    vm.warp(1);
    vm.startPrank(address(uint160(1)), address(uint160(1)));
