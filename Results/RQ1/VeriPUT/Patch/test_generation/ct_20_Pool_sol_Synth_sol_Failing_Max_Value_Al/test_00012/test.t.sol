...
contract SynthCovTest_Synth_realise_put2p1 is Test {
  Synth c0;
...
vm.mockCall(pool, abi.encodeWithSignature("burn(uint256)"), bytes(""));
    
    uint256 _pre_BASE = (uint256(vm.load(address(c0), bytes32(uint256(0)))) & 1461501637330902918203684832716283019655932542975);
    uint256 _pre_mapSynth_LPBalance_pool = uint256(vm.load(address(c0), keccak256(abi.encode(pool, uint256(10)))));
    uint256 _pre_mapSynth_LPDebt_pool = uint256(vm.load(address(c0), keccak256(abi.encode(pool, uint256(11)))));
    
    
    vm.deal(p_msg_sender, p_msg_value);
    vm.prank(p_msg_sender);
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("realise(address)", pool));
    
    uint256 _post_BASE = (uint256(vm.load(address(c0), bytes32(uint256(0)))) & 1461501637330902918203684832716283019655932542975);
    uint256 _post_mapSynth_LPBalance_pool = uint256(vm.load(address(c0), keccak256(abi.encode(pool, uint256(10)))));
    uint256 _post_mapSynth_LPDebt_pool = uint256(vm.load(address(c0), keccak256(abi.encode(pool, uint256(11)))));
    assertEq(_post_BASE, _pre_BASE, "BASE: post == pre");
    assertEq(_post_mapSynth_LPBalance_pool, _pre_mapSynth_LPBalance_pool, "mapSynth_LPBalance[pool]: post == pre");
    assertEq(_post_mapSynth_LPDebt_pool, _pre_mapSynth_LPDebt_pool, "mapSynth_LPDebt[pool]: post == pre");
    assertGe(_post_BASE, _pre_BASE, "BASE: post >= pre");
    assertLe(_post_BASE, _pre_BASE, "BASE: post <= pre");
    assertGe(_post_mapSynth_LPBalance_pool, _pre_mapSynth_LPBalance_pool, "mapSynth_LPBalance[pool]: post >= pre");
    assertLe(_post_mapSynth_LPBalance_pool, _pre_mapSynth_LPBalance_pool, "mapSynth_LPBalance[pool]: post <= pre");
  ...
  function test_put_Synth_realise_path2p1(address p_msg_sender, uint256 p_msg_value, address pool) public {
