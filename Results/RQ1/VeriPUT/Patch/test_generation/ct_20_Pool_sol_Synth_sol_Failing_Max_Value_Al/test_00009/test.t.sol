...
contract SynthCovTest_Synth_getmapAddress_LPDebt_put3p1 is Test {
  ...
  // claim: sol:@C@Synth@F@getmapAddress_LPDebt#3222:path:3
  // witness-fingerprint-sha256: c10bc7a662544d74579d3ee13fee87ee48a25ed83eef0d3de7c56da971d0e9a0
  // claim: sol:@C@Synth@F@getmapAddress_LPDebt#3222:path:2
  // witness-fingerprint-sha256: e2f93e8493376db0a85831cea2a77bf6d3bfcf78dde94681159d8bbdbf64a81a

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@Synth@F@getmapAddress_LPDebt#3222:path:3   depth=1
  ...
  //   rung IMPLIED (not lost, not asserted twice): mapSynth_LPDebt[pool]: post >= pre (entailed by a stronger rung that also HOLDS on mapSynth_LPDebt[pool], so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): mapSynth_LPDebt[pool]: post <= pre (entailed by a stronger rung that also HOLDS on mapSynth_LPDebt[pool], so asserting it detects nothing the stronger one misses)
