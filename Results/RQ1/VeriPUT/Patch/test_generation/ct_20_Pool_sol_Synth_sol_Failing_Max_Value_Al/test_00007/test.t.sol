...
contract SynthCovTest_Synth_getmapAddress_LPBalance_put3p1 is Test {
  ...
  // claim: sol:@C@Synth@F@getmapAddress_LPBalance#3210:path:3
  // witness-fingerprint-sha256: cc4b2d3a8cf1acfa099cedcc3e7a4482af8bd1591bc568b2448dfb4a5001b8de
  // claim: sol:@C@Synth@F@getmapAddress_LPBalance#3210:path:2
  // witness-fingerprint-sha256: ab06892d61dd1e91ad02c9774df7357b855fb924e086205abb6ad7cabe8761f3

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@Synth@F@getmapAddress_LPBalance#3210:path:3   depth=1
  ...
  //   pool in [0, 1461501637330902918203684832716283019655932542975]
  //   PIN block.basefee == 0
  ...
  // FUZZ COORDINATES: msg.sender, pool
  ...
  //   rung IMPLIED (not lost, not asserted twice): mapSynth_LPBalance[pool]: post >= pre (entailed by a stronger rung that also HOLDS on mapSynth_LPBalance[pool], so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): mapSynth_LPBalance[pool]: post <= pre (entailed by a stronger rung that also HOLDS on mapSynth_LPBalance[pool], so asserting it detects nothing the stronger one misses)
