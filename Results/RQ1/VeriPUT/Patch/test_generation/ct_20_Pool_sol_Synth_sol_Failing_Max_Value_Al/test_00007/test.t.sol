...
contract SynthCovTest_Synth_getmapAddress_LPBalance_put3p1 is Test {
  Synth c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address pool) internal {
    ...
    uint256 _ret_pre_mapSynth_LPBalance_pool = uint256(vm.load(address(c0), keccak256(abi.encode(pool, uint256(10)))));
    ...
    uint256 _put_ret = c0.getmapAddress_LPBalance(pool);
    ...
    assertEq(uint256(_put_ret), _ret_pre_mapSynth_LPBalance_pool, "return: return == state.mapSynth_LPBalance[pool]");
    
  }


  
  function test_put_Synth_getmapAddress_LPBalance_path3p1(address p_msg_sender, address pool) public {
    _veriput_parameterized(p_msg_sender, pool);
    
    { SynthCovTest_Synth_getmapAddress_LPBalance_concrete3p1__basis_root__W _veriput_w = new SynthCovTest_Synth_getmapAddress_LPBalance_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract SynthCovTest_Synth_getmapAddress_LPBalance_concrete3p1__basis_root__W is Test {
  Synth c0;
  function setUp() public {
    vm.warp(1);
    vm.startPrank(address(uint160(1)), address(uint160(1)));
  ...
  function _w_test_cov_0() public {
    ...
    uint256 _veriput_concrete_return = c0.getmapAddress_LPBalance(address(uint160(0)));
