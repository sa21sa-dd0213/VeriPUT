...
contract SynthCovTest_Synth_increaseAllowance_put2p1 is Test {
  Synth c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address spender, uint256 addedValue) internal {
    ...
    uint256 _pre_allowances_msg_sender__spender = uint256(vm.load(address(c0), keccak256(abi.encode(spender, keccak256(abi.encode(p_msg_sender, uint256(9)))))));
    ...
    uint256 _post_allowances_msg_sender__spender = uint256(vm.load(address(c0), keccak256(abi.encode(spender, keccak256(abi.encode(p_msg_sender, uint256(9)))))));
  ...
  function test_put_Synth_increaseAllowance_path2p1(address p_msg_sender, uint256 p_msg_value, address spender, uint256 addedValue) public {
