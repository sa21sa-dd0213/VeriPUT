...
contract DepositLogCovTest_DepositLog_logExitedCourtesyCall_put6p1_p1_part_part0_r is Test {
  DepositLog c0;
  ...
  function test_put_DepositLog_logExitedCourtesyCall_path6p1_part_part0_r(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { DepositLogCovTest_DepositLog_logExitedCourtesyCall_concrete6p1__basis_part0_r__W _veriput_w = new DepositLogCovTest_DepositLog_logExitedCourtesyCall_concrete6p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract DepositLogCovTest_DepositLog_logExitedCourtesyCall_concrete6p1__basis_part0_r__W is Test {
  DepositLog c0;
  function setUp() public {
    c0 = new DepositLog();
  }
