...
contract DepositLogCovTest_DepositLog_logSetupFailed_put6p1_p1_part_part0_w_r is Test {
  DepositLog c0;
  ...
  function test_put_DepositLog_logSetupFailed_path6p1_part_part0_w_r(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { DepositLogCovTest_DepositLog_logSetupFailed_concrete6p1__basis_part0_w_r__W _veriput_w = new DepositLogCovTest_DepositLog_logSetupFailed_concrete6p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract DepositLogCovTest_DepositLog_logSetupFailed_concrete6p1__basis_part0_w_r__W is Test {
  DepositLog c0;
  function setUp() public {
    c0 = new DepositLog();
  }
