...
contract DepositLogCovTest_DepositLog_logLiquidated_put6p1_p1_part_part0_w_w is Test {
  DepositLog c0;
  ...
  function test_put_DepositLog_logLiquidated_path6p1_part_part0_w_w(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { DepositLogCovTest_DepositLog_logLiquidated_concrete6p1__basis_part0_w_w__W _veriput_w = new DepositLogCovTest_DepositLog_logLiquidated_concrete6p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract DepositLogCovTest_DepositLog_logLiquidated_concrete6p1__basis_part0_w_w__W is Test {
  DepositLog c0;
  function setUp() public {
    c0 = new DepositLog();
  }
