...
contract DepositLogCovTest_DepositLog_logRedemptionRequested_put2p1 is Test {
  ...
  // claim: sol:@C@DepositLog@F@logRedemptionRequested#210:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@DepositLog@F@logRedemptionRequested#210:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, _requester, _digest, _utxoSize, _redeemerOutputScript, _requestedFee, _outpoint
