...
contract MY_BANKCovTest_MY_BANK_Put_put14p1 is Test {
  MY_BANK c0;
  ...
  function test_put_MY_BANK_Put_path14p1(address p_msg_sender, uint256 p_block_timestamp, uint256 _unlockTime) public {
    _veriput_parameterized(p_msg_sender, p_block_timestamp, _unlockTime);
    
    { MY_BANKCovTest_MY_BANK_Put_concrete14p1__basis_root__W _veriput_w = new MY_BANKCovTest_MY_BANK_Put_concrete14p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract MY_BANKCovTest_MY_BANK_Put_concrete14p1__basis_root__W is Test {
  MY_BANK c0;
  function setUp() public {
    c0 = new MY_BANK(address(uint160(0)));
