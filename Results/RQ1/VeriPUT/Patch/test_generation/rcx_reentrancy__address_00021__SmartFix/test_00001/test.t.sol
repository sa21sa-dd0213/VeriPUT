...
contract Private_BankCovTest_Private_Bank_Deposit_put3p1 is Test {
  ...
  // claim: sol:@C@Private_Bank@F@Deposit#68:path:3
  // witness-fingerprint-sha256: bff72e31732c78987814b7b5bf36b621c3b9c2c5c7852db060034f73cf8d002c
  // claim: sol:@C@Private_Bank@F@Deposit#68:path:11
  // witness-fingerprint-sha256: 46bec8b6a0780e4c9b7fc530547045536f63b6e551d4fcd46133ec8967302cb6

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@Private_Bank@F@Deposit#68:path:3   depth=1
  ...
  //   msg.value in [0, 1000000000000000000]
  ...
  //   rung IMPLIED (not lost, not asserted twice): MinDeposit: post in [1000000000000000000, 1000000000000000000] (entailed by a stronger rung that also HOLDS on MinDeposit, so asserting it detects nothing the stronger one misses)
  ...
  //   environment ESTABLISHED: msg.value in [0, 1000000000000000000] is ESTABLISHED and FUZZED: the existing value-bearing call now takes the bound() fuzz parameter `p_msg_value`
