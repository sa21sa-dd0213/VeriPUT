...
contract BCovTest_B_go_put1p1_p1_part_part0_w_w is Test {
  B c0;
  ...
  function test_put_B_go_path1p1_part_part0_w_w(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { BCovTest_B_go_concrete1p1__basis_part0_w_w__W _veriput_w = new BCovTest_B_go_concrete1p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract BCovTest_B_go_concrete1p1__basis_part0_w_w__W is Test {
  B c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new B();
