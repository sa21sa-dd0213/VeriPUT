...
contract PoCGameCovTest_PoCGame_currentDifficulty_put3p1 is Test {
  PoCGame c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    uint256 _ret_pre_difficulty = uint256(vm.load(address(c0), bytes32(uint256(2))));
    ...
    uint256 _put_ret = c0.currentDifficulty();
    ...
    assertEq(_post_difficulty, 0, "difficulty: post == msg.value");
    assertEq(_post_difficulty, _pre_difficulty, "difficulty: post == state.difficulty");
    unchecked { assertEq(_post_difficulty, (uint256(_pre_difficulty) + uint256(_pre_difficulty)), "difficulty: post == (pre + pre)"); }
    unchecked { assertEq(_post_difficulty, (uint256(_pre_difficulty) * uint256(_pre_difficulty)), "difficulty: post == (pre * pre)"); }
    unchecked { assertEq(_post_difficulty, (uint256(_pre_difficulty) + uint256(_pre_difficulty)), "difficulty: post == (pre + state.difficulty)"); }
    unchecked { assertEq(_post_difficulty, (uint256(_pre_difficulty) - uint256(_pre_difficulty)), "difficulty: post == (pre - state.difficulty)"); }
    unchecked { assertEq(_post_difficulty, (uint256(_pre_difficulty) * uint256(_pre_difficulty)), "difficulty: post == (pre * state.difficulty)"); }
    unchecked { assertEq(_post_difficulty, (uint256(_pre_difficulty) * uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)), "difficulty: post == (pre * 115792089237316195423570985008687907853269984665640564039457584007913129639935)"); }
    unchecked { assertEq(_post_difficulty, (uint256(0) - uint256(_pre_difficulty)), "difficulty: post == (msg.value - pre)"); }
    unchecked { assertEq(_post_difficulty, (uint256(0) - uint256(_pre_difficulty)), "difficulty: post == (msg.value - state.difficulty)"); }
    unchecked { assertEq(_post_difficulty, (uint256(_pre_difficulty) - uint256(_pre_difficulty)), "difficulty: post == (state.difficulty - pre)"); }
    unchecked { assertEq(_post_difficulty, (uint256(_pre_difficulty) + uint256(_pre_difficulty)), "difficulty: post == (state.difficulty + state.difficulty)"); }
    unchecked { assertEq(_post_difficulty, (uint256(_pre_difficulty) * uint256(_pre_difficulty)), "difficulty: post == (state.difficulty * state.difficulty)"); }
    unchecked { assertEq(_post_difficulty, (uint256(_pre_difficulty) * uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)), "difficulty: post == (state.difficulty * 115792089237316195423570985008687907853269984665640564039457584007913129639935)"); }
    unchecked { assertEq(_post_difficulty, (uint256(_pre_difficulty) / uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)), "difficulty: post == (pre / 115792089237316195423570985008687907853269984665640564039457584007913129639935)"); }
    unchecked { assertEq(_post_difficulty, (uint256(0) / uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)), "difficulty: post == (msg.value / 115792089237316195423570985008687907853269984665640564039457584007913129639935)"); }
    unchecked { assertEq(_post_difficulty, (uint256(_pre_difficulty) / uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)), "difficulty: post == (state.difficulty / 115792089237316195423570985008687907853269984665640564039457584007913129639935)"); }
    assertEq(uint256(_put_ret), 0, "return: return == 0");
    assertEq(uint256(_put_ret), _ret_pre_difficulty, "return: return == state.difficulty");
    
  }


  
  function test_put_PoCGame_currentDifficulty_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { PoCGameCovTest_PoCGame_currentDifficulty_concrete3p1__basis_root__W _veriput_w = new PoCGameCovTest_PoCGame_currentDifficulty_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PoCGameCovTest_PoCGame_currentDifficulty_concrete3p1__basis_root__W is Test {
  PoCGame c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new PoCGame(address(uint160(0)), 0);
  ...
  function _w_test_cov_0() public {
    ...
    uint256 _veriput_concrete_return = c0.currentDifficulty();
