...
contract PoCGameCovTest_PoCGame_AdjustBetAmounts_put2p1 is Test {
  PoCGame c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, uint256 amount) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("AdjustBetAmounts(uint256)", amount));
  ...
  function test_put_PoCGame_AdjustBetAmounts_path2p1(address p_msg_sender, uint256 p_msg_value, uint256 amount) public {
