...
contract PoCGameCovTest_PoCGame_fallback_put1p1 is Test {
  PoCGame c0;
  ...
  function test_put_PoCGame_fallback_path1p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { PoCGameCovTest_PoCGame_fallback_concrete1p1__basis_root__W _veriput_w = new PoCGameCovTest_PoCGame_fallback_concrete1p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PoCGameCovTest_PoCGame_fallback_concrete1p1__basis_root__W is Test {
  PoCGame c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new PoCGame(address(uint160(0)), 0);
