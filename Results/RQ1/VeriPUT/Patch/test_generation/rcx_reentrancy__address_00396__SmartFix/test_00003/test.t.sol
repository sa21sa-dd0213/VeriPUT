...
contract W_WALLETCovTest_W_WALLET_Put_put15p1 is Test {
  W_WALLET c0;
  ...
  function test_put_W_WALLET_Put_path15p1(address p_msg_sender, uint256 _unlockTime) public {
    _veriput_parameterized(p_msg_sender, _unlockTime);
    
    { W_WALLETCovTest_W_WALLET_Put_concrete15p1__basis_root__W _veriput_w = new W_WALLETCovTest_W_WALLET_Put_concrete15p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract W_WALLETCovTest_W_WALLET_Put_concrete15p1__basis_root__W is Test {
  W_WALLET c0;
  function setUp() public {
    c0 = new W_WALLET(address(uint160(0)));
