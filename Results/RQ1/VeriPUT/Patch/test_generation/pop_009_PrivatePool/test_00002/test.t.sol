...
contract PrivatePoolCovTest_PrivatePool_flashFeeToken_put2p1 is Test {
  PrivatePool c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("flashFeeToken()"));
    ...
    assertGe(_post_baseToken, _pre_baseToken, "baseToken: post >= pre");
    assertLe(_post_baseToken, _pre_baseToken, "baseToken: post <= pre");
  ...
  function test_put_PrivatePool_flashFeeToken_path2p1(address p_msg_sender, uint256 p_msg_value) public {
