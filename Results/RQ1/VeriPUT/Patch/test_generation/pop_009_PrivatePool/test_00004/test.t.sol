...
contract PrivatePoolCovTest_PrivatePool_sellQuote_put2p1 is Test {
  ...
  // claim: sol:@C@PrivatePool@F@sellQuote#6622:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@PrivatePool@F@sellQuote#6622:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, inputAmount
