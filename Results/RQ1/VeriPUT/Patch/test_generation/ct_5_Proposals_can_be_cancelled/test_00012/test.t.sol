...
contract DAOCovTest_DAO_newAddressProposal_put2p1 is Test {
  ...
  // claim: sol:@C@DAO@F@newAddressProposal#1054:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@DAO@F@newAddressProposal#1054:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, proposedAddress, typeStr
