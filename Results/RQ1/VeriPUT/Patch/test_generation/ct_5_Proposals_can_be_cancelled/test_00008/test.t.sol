...
contract DAOCovTest_DAO_init_put7p1_p1_part_part0_r_r is Test {
  DAO c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address _vader, address _usdv, address _vault) internal {
    ...
    _usdv = address(uint160(bound(uint256(uint160(_usdv)), 1461501637330902918203684832716283019655932542975, 1461501637330902918203684832716283019655932542975)));
    ...
    if (p_msg_sender == address(uint160(0)) && _vader == address(uint160(1461501637330902918203684832716283019655932542975)) && _usdv == address(uint160(1461501637330902918203684832716283019655932542975)) && _vault == address(uint160(0))) {
    ...
    assertGt(_post_USDV, _pre_USDV, "USDV: post > pre");
    
  }


  
  function test_put_DAO_init_path7p1_part_part0_r_r(address p_msg_sender, address _vader, address _usdv, address _vault) public {
    _veriput_parameterized(p_msg_sender, _vader, _usdv, _vault);
    
    { DAOCovTest_DAO_init_concrete7p1__basis_part0_r_r__W _veriput_w = new DAOCovTest_DAO_init_concrete7p1__basis_part0_r_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract DAOCovTest_DAO_init_concrete7p1__basis_part0_r_r__W is Test {
  DAO c0;
  function setUp() public {
    c0 = new DAO();
  }
  ...
  function _w_test_cov_0() public {
    ...
    c0.init(address(uint160(1461501637330902918203684832716283019655932542975)), address(uint160(1461501637330902918203684832716283019655932542975)), address(uint160(0)));
    ...
    assertEq(_veriput_fixed_state_USDV_0, uint256(1461501637330902918203684832716283019655932542975), "fixed witness state");
    ...
    assertEq(_veriput_fixed_state_VADER_1, uint256(1461501637330902918203684832716283019655932542975), "fixed witness state");
