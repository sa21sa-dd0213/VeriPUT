...
contract DAOCovTest_DAO_hasQuorum_put2p1 is Test {
  DAO c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, uint256 _proposalID) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("hasQuorum(uint256)", _proposalID));
  ...
  function test_put_DAO_hasQuorum_path2p1(address p_msg_sender, uint256 p_msg_value, uint256 _proposalID) public {
