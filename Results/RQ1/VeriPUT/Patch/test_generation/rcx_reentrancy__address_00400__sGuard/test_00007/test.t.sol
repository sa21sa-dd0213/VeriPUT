...
contract PENNY_BY_PENNYCovTest_PENNY_BY_PENNY_SetMinSum_put15p1_p1_part_part0_r is Test {
  PENNY_BY_PENNY c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 _val) internal {
    ...
    _val = bound(_val, 1, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
    ...
    if (p_msg_sender == address(uint160(0)) && _val == uint256(1)) {
  ...
  function test_put_PENNY_BY_PENNY_SetMinSum_path15p1_part_part0_r(address p_msg_sender, uint256 _val) public {
    _veriput_parameterized(p_msg_sender, _val);
    
    { PENNY_BY_PENNYCovTest_PENNY_BY_PENNY_SetMinSum_concrete15p1__basis_part0_r__W _veriput_w = new PENNY_BY_PENNYCovTest_PENNY_BY_PENNY_SetMinSum_concrete15p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PENNY_BY_PENNYCovTest_PENNY_BY_PENNY_SetMinSum_concrete15p1__basis_part0_r__W is Test {
  PENNY_BY_PENNY c0;
  function setUp() public {
    c0 = new PENNY_BY_PENNY();
  }
  ...
  function _w_test_cov_0() public {
    ...
    c0.SetMinSum(uint256(1));
    uint256 _veriput_fixed_state_MinSum_0 = uint256(vm.load(address(c0), bytes32(uint256(2))));
    assertEq(_veriput_fixed_state_MinSum_0, uint256(1), "fixed witness state");
