...
contract demoCovTest_demo_transfer_put29p1 is Test {
  demo c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address from, address caddress, address[] memory _tos, uint256 v) internal {
    ...
    if (p_msg_sender == address(uint160(0)) && from == address(uint160(0)) && caddress == address(uint160(0)) && _tos.length == uint256(1) && v == uint256(0)) {
  ...
  function test_put_demo_transfer_path29p1(address p_msg_sender, address from, address caddress, address[] memory _tos, uint256 v) public {
    _veriput_parameterized(p_msg_sender, from, caddress, _tos, v);
    
    { demoCovTest_demo_transfer_concrete29p1__basis_root__W _veriput_w = new demoCovTest_demo_transfer_concrete29p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract demoCovTest_demo_transfer_concrete29p1__basis_root__W is Test {
  demo c0;
  function setUp() public {
    c0 = new demo();
  }
  ...
  function _w_test_cov_0() public {
    ...
    bool _veriput_concrete_return = c0.transfer(address(uint160(0)), address(uint160(0)), new address[](1), uint256(0));
