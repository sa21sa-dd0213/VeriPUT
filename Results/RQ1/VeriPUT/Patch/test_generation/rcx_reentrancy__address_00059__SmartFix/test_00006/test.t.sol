...
contract ACCURAL_DEPOSITCovTest_ACCURAL_DEPOSIT_SetMinSum_put2p1 is Test {
  ACCURAL_DEPOSIT c0;
  ...
  function test_put_ACCURAL_DEPOSIT_SetMinSum_path2p1(address p_msg_sender, uint256 p_msg_value, uint256 _val) public {
