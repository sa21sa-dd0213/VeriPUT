...
contract ACCURAL_DEPOSITCovTest_ACCURAL_DEPOSIT_Initialized_put3p1 is Test {
  ACCURAL_DEPOSIT c0;
  ...
  function test_put_ACCURAL_DEPOSIT_Initialized_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { ACCURAL_DEPOSITCovTest_ACCURAL_DEPOSIT_Initialized_concrete3p1__basis_root__W _veriput_w = new ACCURAL_DEPOSITCovTest_ACCURAL_DEPOSIT_Initialized_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract ACCURAL_DEPOSITCovTest_ACCURAL_DEPOSIT_Initialized_concrete3p1__basis_root__W is Test {
  ACCURAL_DEPOSIT c0;
  function setUp() public {
    c0 = new ACCURAL_DEPOSIT();
