...
contract CVXStakerCovTest_CVXStaker_owner_put3p1 is Test {
  ...
  // claim: sol:@C@CVXStaker@F@owner#677:path:3

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@CVXStaker@F@owner#677:path:3   depth=1
  ...
  //   rung DROPPED: return: return == state._owner$647 (rung shape not renderable for its declared type)
