...
contract CVXStakerCovTest_CVXStaker_withdrawAndUnwrap_put2p1 is Test {
  ...
  // claim: sol:@C@CVXStaker@F@withdrawAndUnwrap#1401:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@CVXStaker@F@withdrawAndUnwrap#1401:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, amount, claim, to
