...
contract CVXStakerCovTest_CVXStaker_getReward_put2p1 is Test {
  CVXStaker c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, bool claimExtras) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("getReward(bool)", claimExtras));
  ...
  function test_put_CVXStaker_getReward_path2p1(address p_msg_sender, uint256 p_msg_value, bool claimExtras) public {
    _veriput_parameterized(p_msg_sender, p_msg_value, claimExtras);
  }
}
