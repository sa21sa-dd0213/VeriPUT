...
contract CVXStakerCovTest_CVXStaker_withdrawAllAndUnwrap_put2p1 is Test {
  ...
  // claim: sol:@C@CVXStaker@F@withdrawAllAndUnwrap#1439:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@CVXStaker@F@withdrawAllAndUnwrap#1439:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, claim, sendToOperator
