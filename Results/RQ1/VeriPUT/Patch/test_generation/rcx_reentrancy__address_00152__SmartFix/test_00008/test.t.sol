...
contract PRIVATE_ETH_CELLCovTest_PRIVATE_ETH_CELL_SetMinSum_put7p1_p1_part_part0_w_w is Test {
  PRIVATE_ETH_CELL c0;
  ...
  function test_put_PRIVATE_ETH_CELL_SetMinSum_path7p1_part_part0_w_w(address p_msg_sender, uint256 _val) public {
    _veriput_parameterized(p_msg_sender, _val);
    
    { PRIVATE_ETH_CELLCovTest_PRIVATE_ETH_CELL_SetMinSum_concrete7p1__basis_part0_w_w__W _veriput_w = new PRIVATE_ETH_CELLCovTest_PRIVATE_ETH_CELL_SetMinSum_concrete7p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PRIVATE_ETH_CELLCovTest_PRIVATE_ETH_CELL_SetMinSum_concrete7p1__basis_part0_w_w__W is Test {
  PRIVATE_ETH_CELL c0;
  function setUp() public {
    c0 = new PRIVATE_ETH_CELL();
  }
