...
contract PRIVATE_ETH_CELLCovTest_PRIVATE_ETH_CELL_Initialized_put3p1 is Test {
  PRIVATE_ETH_CELL c0;
  ...
  function test_put_PRIVATE_ETH_CELL_Initialized_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { PRIVATE_ETH_CELLCovTest_PRIVATE_ETH_CELL_Initialized_concrete3p1__basis_root__W _veriput_w = new PRIVATE_ETH_CELLCovTest_PRIVATE_ETH_CELL_Initialized_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PRIVATE_ETH_CELLCovTest_PRIVATE_ETH_CELL_Initialized_concrete3p1__basis_root__W is Test {
  PRIVATE_ETH_CELL c0;
  function setUp() public {
    c0 = new PRIVATE_ETH_CELL();
  }
