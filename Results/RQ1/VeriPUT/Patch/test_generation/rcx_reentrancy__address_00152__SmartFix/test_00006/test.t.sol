...
contract PRIVATE_ETH_CELLCovTest_PRIVATE_ETH_CELL_SetMinSum_put7p1_p1_part_part0_r is Test {
  PRIVATE_ETH_CELL c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 _val) internal {
    ...
    _val = bound(_val, 115792089237316195423570985008687907853269984665640564039457584007913129639935, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
    ...
    if (p_msg_sender == address(uint160(0)) && _val == uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)) {
      assertEq(uint256(vm.load(address(c0), bytes32(uint256(1)))), uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935), "fixed witness state");
  ...
  function test_put_PRIVATE_ETH_CELL_SetMinSum_path7p1_part_part0_r(address p_msg_sender, uint256 _val) public {
    _veriput_parameterized(p_msg_sender, _val);
    
    { PRIVATE_ETH_CELLCovTest_PRIVATE_ETH_CELL_SetMinSum_concrete7p1__basis_part0_r__W _veriput_w = new PRIVATE_ETH_CELLCovTest_PRIVATE_ETH_CELL_SetMinSum_concrete7p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PRIVATE_ETH_CELLCovTest_PRIVATE_ETH_CELL_SetMinSum_concrete7p1__basis_part0_r__W is Test {
  PRIVATE_ETH_CELL c0;
  function setUp() public {
    c0 = new PRIVATE_ETH_CELL();
  }
  ...
  function _w_test_cov_0() public {
    ...
    c0.SetMinSum(uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935));
    uint256 _veriput_fixed_state_MinSum_0 = uint256(vm.load(address(c0), bytes32(uint256(1))));
    assertEq(_veriput_fixed_state_MinSum_0, uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935), "fixed witness state");
