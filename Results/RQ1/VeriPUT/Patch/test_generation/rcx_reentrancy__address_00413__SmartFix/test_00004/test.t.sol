...
contract MONEY_BOXCovTest_MONEY_BOX_Initialized_put3p1 is Test {
  MONEY_BOX c0;
  ...
  function test_put_MONEY_BOX_Initialized_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { MONEY_BOXCovTest_MONEY_BOX_Initialized_concrete3p1__basis_root__W _veriput_w = new MONEY_BOXCovTest_MONEY_BOX_Initialized_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract MONEY_BOXCovTest_MONEY_BOX_Initialized_concrete3p1__basis_root__W is Test {
  MONEY_BOX c0;
  function setUp() public {
    c0 = new MONEY_BOX();
  }
