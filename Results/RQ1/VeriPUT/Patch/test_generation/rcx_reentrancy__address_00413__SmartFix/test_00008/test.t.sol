...
contract MONEY_BOXCovTest_MONEY_BOX_SetMinSum_put7p1_p1_part_part0_r is Test {
  MONEY_BOX c0;
  ...
  function test_put_MONEY_BOX_SetMinSum_path7p1_part_part0_r(address p_msg_sender, uint256 _val) public {
    _veriput_parameterized(p_msg_sender, _val);
    
    { MONEY_BOXCovTest_MONEY_BOX_SetMinSum_concrete7p1__basis_part0_r__W _veriput_w = new MONEY_BOXCovTest_MONEY_BOX_SetMinSum_concrete7p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract MONEY_BOXCovTest_MONEY_BOX_SetMinSum_concrete7p1__basis_part0_r__W is Test {
  MONEY_BOX c0;
  function setUp() public {
    c0 = new MONEY_BOX();
  }
