...
contract ReentranceCovTest_Reentrance_withdrawBalance_put15p1_p1_part_part0_w_r is Test {
  Reentrance c0;
  ...
  function test_put_Reentrance_withdrawBalance_path15p1_part_part0_w_r(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { ReentranceCovTest_Reentrance_withdrawBalance_concrete15p1__basis_part0_w_r__W _veriput_w = new ReentranceCovTest_Reentrance_withdrawBalance_concrete15p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract ReentranceCovTest_Reentrance_withdrawBalance_concrete15p1__basis_part0_w_r__W is Test {
  Reentrance c0;
  function setUp() public {
    c0 = new Reentrance();
  ...
  function _w_test_cov_0() public {
    ...
    uint256 _veriput_fixed_state_userBalance_1912875072_1 = uint256(vm.load(address(c0), keccak256(abi.encode(address(uint160(1912875072)), uint256(1)))));
    assertEq(_veriput_fixed_state_userBalance_1912875072_1, uint256(0), "fixed witness state");
  }
