...
contract ProductCovTest_Product_latestVersion_put3_pf10121p1 is Test {
  Product c0;
  ...
  function test_put_Product_latestVersion_path3_pf10121p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { ProductCovTest_Product_latestVersion_concrete3_pf10121p1__basis_root__W _veriput_w = new ProductCovTest_Product_latestVersion_concrete3_pf10121p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}



contract ProductCovTest_Product_latestVersion_concrete3_pf10121p1__basis_root__W is Test {
  Product c0;
  function setUp() public {
    c0 = new Product();
  }
