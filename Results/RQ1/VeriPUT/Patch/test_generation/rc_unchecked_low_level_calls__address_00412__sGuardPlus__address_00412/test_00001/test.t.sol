...
contract keepMyEtherCovTest_keepMyEther_fallback_put1p1 is Test {
  keepMyEther c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    (bool ok1, ) = address(c0).call{value: 115792089237316195423570985008687907853269984665640564039457584007913129639934}(hex"deadbeef");
    
    if (p_msg_sender == address(uint160(0))) {
      assertEq((uint256(vm.load(address(c0), bytes32(uint256(0)))) & 255), uint256(0), "fixed witness state");
      assertEq(uint256(vm.load(address(c0), keccak256(abi.encode(address(uint160(0)), uint256(1))))), uint256(115792089237316195423570985008687907853269984665640564039457584007913129639934), "fixed witness state");
    }
    ...
    unchecked { assertGe(_post_balances_msg_sender - _pre_balances_msg_sender, 115792089237316195423570985008687907853269984665640564039457584007913129639934, "balances[msg.sender]: post - pre in [msg.value, msg.value] with post >= pre"); }
    unchecked { assertLe(_post_balances_msg_sender - _pre_balances_msg_sender, 115792089237316195423570985008687907853269984665640564039457584007913129639934, "balances[msg.sender]: post - pre in [msg.value, msg.value] with post >= pre"); }
  ...
  function test_put_keepMyEther_fallback_path1p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { keepMyEtherCovTest_keepMyEther_fallback_concrete1p1__basis_root__W _veriput_w = new keepMyEtherCovTest_keepMyEther_fallback_concrete1p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract keepMyEtherCovTest_keepMyEther_fallback_concrete1p1__basis_root__W is Test {
  keepMyEther c0;
  function setUp() public {
    c0 = new keepMyEther();
  }
  ...
  function _w_test_cov_0() public {
    ...
    vm.deal(address(uint160(0)), 115792089237316195423570985008687907853269984665640564039457584007913129639934);
    vm.warp(115792089237316195423570985008687907853269984665640564039457584007913129639934);
    vm.roll(115792089237316195423570985008687907853269984665640564039457584007913129639934);
    vm.chainId(0);
    vm.fee(0);
    ...
    assertEq(_veriput_fixed_state_balances_0_1, uint256(115792089237316195423570985008687907853269984665640564039457584007913129639934), "fixed witness state");
  }
}
