...
contract DEP_BANKCovTest_DEP_BANK_SetLogFile_put7p1 is Test {
  DEP_BANK c0;
  ...
  function test_put_DEP_BANK_SetLogFile_path7p1(address p_msg_sender, address _log) public {
    _veriput_parameterized(p_msg_sender, _log);
    
    { DEP_BANKCovTest_DEP_BANK_SetLogFile_concrete7p1__basis_root__W _veriput_w = new DEP_BANKCovTest_DEP_BANK_SetLogFile_concrete7p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract DEP_BANKCovTest_DEP_BANK_SetLogFile_concrete7p1__basis_root__W is Test {
  DEP_BANK c0;
  function setUp() public {
    c0 = new DEP_BANK();
  }
