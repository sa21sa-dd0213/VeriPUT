...
contract MStableYieldSourceCovTest_MStableYieldSource_supplyTokenTo_put2p1 is Test {
  ...
  // claim: sol:@C@MStableYieldSource@F@supplyTokenTo#1309:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@MStableYieldSource@F@supplyTokenTo#1309:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, mAssetAmount, to
