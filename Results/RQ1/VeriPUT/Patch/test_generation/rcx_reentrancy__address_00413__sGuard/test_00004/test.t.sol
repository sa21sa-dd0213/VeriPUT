...
contract MONEY_BOXCovTest_MONEY_BOX_Initialized_put7p1 is Test {
  MONEY_BOX c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    assertLe(((uint256(vm.load(address(c0), bytes32(uint256(3)))) >> 160) & 255), uint256(1), "the entry state is OUTSIDE the certified region: state.intitalized was assumed in [0, 1] when the path was certified, so a value outside it means the assumption was vacuous and the rungs below were proved about no execution this test can reach");
    {
    ...
    if (p_msg_sender == address(uint160(0))) {
      ...
      assertEq(((uint256(vm.load(address(c0), bytes32(uint256(3)))) >> 160) & 255), uint256(1), "fixed witness state");
  ...
  function test_put_MONEY_BOX_Initialized_path7p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { MONEY_BOXCovTest_MONEY_BOX_Initialized_concrete7p1__basis_root__W _veriput_w = new MONEY_BOXCovTest_MONEY_BOX_Initialized_concrete7p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract MONEY_BOXCovTest_MONEY_BOX_Initialized_concrete7p1__basis_root__W is Test {
  MONEY_BOX c0;
  function setUp() public {
    c0 = new MONEY_BOX();
  }
