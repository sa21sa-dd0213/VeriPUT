...
contract MONEY_BOXCovTest_MONEY_BOX_SetMinSum_put15p1_p1_part_part0_w is Test {
  MONEY_BOX c0;
  ...
  function test_put_MONEY_BOX_SetMinSum_path15p1_part_part0_w(address p_msg_sender, uint256 _val) public {
    _veriput_parameterized(p_msg_sender, _val);
    
    { MONEY_BOXCovTest_MONEY_BOX_SetMinSum_concrete15p1__basis_part0_w__W _veriput_w = new MONEY_BOXCovTest_MONEY_BOX_SetMinSum_concrete15p1__basis_part0_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract MONEY_BOXCovTest_MONEY_BOX_SetMinSum_concrete15p1__basis_part0_w__W is Test {
  MONEY_BOX c0;
  function setUp() public {
    c0 = new MONEY_BOX();
  }
