...
contract LiquidityPoolCovTest_LiquidityPool_convertToAssets_put3p1_p1_part_part0_r is Test {
  LiquidityPool c0;
  function setUp() public {
    ...
    vm.mockCall(_esbmc_ctor_state_mock_0_0, abi.encodeWithSignature("convertToAssets(uint256,address)"), abi.encode(uint256(0)));
    vm.stopPrank();
  }
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 shares) internal {
    p_msg_sender = address(uint160(bound(uint256(uint160(p_msg_sender)), 1, 1461501637330902918203684832716283019655932542975)));
    shares = bound(shares, 115792089237316195423570985008687907853269984665640564039457584007913129639935, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
    ...
    uint256 _put_ret = c0.convertToAssets(shares);
    
    if (p_msg_sender == address(uint160(0)) && shares == uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)) {
    ...
    assertGe(uint256(_put_ret), 0, "return: return in [0, (115792089237316195423570985008687907853269984665640564039457584007913129639935 - 0)]");
    assertLe(uint256(_put_ret), (uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935) - uint256(0)), "return: return in [0, (115792089237316195423570985008687907853269984665640564039457584007913129639935 - 0)]");
    assertGe(uint256(_put_ret), 0, "return: return in [0, shares]");
    assertLe(uint256(_put_ret), shares, "return: return in [0, shares]");
    assertGe(uint256(_put_ret), 0, "return: return in [0, (shares + msg.value)]");
    assertLe(uint256(_put_ret), (uint256(shares) + uint256(0)), "return: return in [0, (shares + msg.value)]");
    assertGe(uint256(_put_ret), 0, "return: return in [0, (shares - msg.value)]");
    assertLe(uint256(_put_ret), (uint256(shares) - uint256(0)), "return: return in [0, (shares - msg.value)]");
    assertGe(uint256(_put_ret), 0, "return: return in [0, (shares + 0)]");
    assertLe(uint256(_put_ret), (uint256(shares) + uint256(0)), "return: return in [0, (shares + 0)]");
    assertGe(uint256(_put_ret), 0, "return: return in [0, (shares - 0)]");
    assertLe(uint256(_put_ret), (uint256(shares) - uint256(0)), "return: return in [0, (shares - 0)]");
    assertGe(uint256(_put_ret), 0, "return: return in [0, (msg.value + shares)]");
    assertLe(uint256(_put_ret), (uint256(0) + uint256(shares)), "return: return in [0, (msg.value + shares)]");
    assertGe(uint256(_put_ret), 0, "return: return in [0, (0 + shares)]");
    assertLe(uint256(_put_ret), (uint256(0) + uint256(shares)), "return: return in [0, (0 + shares)]");
    
  }


  
  function test_put_LiquidityPool_convertToAssets_path3p1_part_part0_r(address p_msg_sender, uint256 shares) public {
    _veriput_parameterized(p_msg_sender, shares);
    
    { LiquidityPoolCovTest_LiquidityPool_convertToAssets_concrete3p1__basis_part0_r__W _veriput_w = new LiquidityPoolCovTest_LiquidityPool_convertToAssets_concrete3p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract LiquidityPoolCovTest_LiquidityPool_convertToAssets_concrete3p1__basis_part0_r__W is Test {
  LiquidityPool c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new LiquidityPool(0, bytes16(0x00000000000000000000000000000000), address(uint160(0)), address(uint160(0)), address(uint160(0)));
  ...
  function _w_test_cov_0() public {
    ...
    uint256 _veriput_concrete_return = c0.convertToAssets(uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935));
