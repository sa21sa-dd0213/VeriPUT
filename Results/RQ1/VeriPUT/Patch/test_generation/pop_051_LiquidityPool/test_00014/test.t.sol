...
contract LiquidityPoolCovTest_LiquidityPool_previewMint_put3p1_p1_part_part0_r is Test {
  LiquidityPool c0;
  function setUp() public {
    ...
    vm.mockCall(_esbmc_ctor_state_mock_0_0, abi.encodeWithSignature("previewMint(address,address,uint256)"), abi.encode(uint256(0)));
    vm.stopPrank();
  }
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 shares) internal {
    ...
    uint256 _put_ret = c0.previewMint(shares);
  ...
  function test_put_LiquidityPool_previewMint_path3p1_part_part0_r(address p_msg_sender, uint256 shares) public {
    _veriput_parameterized(p_msg_sender, shares);
    
    { LiquidityPoolCovTest_LiquidityPool_previewMint_concrete3p1__basis_part0_r__W _veriput_w = new LiquidityPoolCovTest_LiquidityPool_previewMint_concrete3p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract LiquidityPoolCovTest_LiquidityPool_previewMint_concrete3p1__basis_part0_r__W is Test {
  LiquidityPool c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new LiquidityPool(0, bytes16(0x00000000000000000000000000000000), address(uint160(0)), address(uint160(0)), address(uint160(0)));
  ...
  function _w_test_cov_0() public {
    ...
    uint256 _veriput_concrete_return = c0.previewMint(uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935));
