...
contract LiquidityPoolCovTest_LiquidityPool_previewMint_put3p1_p1_part_part0_w_w is Test {
  LiquidityPool c0;
  ...
  function test_put_LiquidityPool_previewMint_path3p1_part_part0_w_w(address p_msg_sender, uint256 shares) public {
    _veriput_parameterized(p_msg_sender, shares);
    
    { LiquidityPoolCovTest_LiquidityPool_previewMint_concrete3p1__basis_part0_w_w__W _veriput_w = new LiquidityPoolCovTest_LiquidityPool_previewMint_concrete3p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract LiquidityPoolCovTest_LiquidityPool_previewMint_concrete3p1__basis_part0_w_w__W is Test {
  LiquidityPool c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new LiquidityPool(0, bytes16(0x00000000000000000000000000000000), address(uint160(0)), address(uint160(0)), address(uint160(0)));
  ...
  function _w_test_cov_0() public {
    ...
    uint256 _veriput_concrete_return = c0.previewMint(uint256(0));
