...
contract LiquidityPoolCovTest_LiquidityPool_maxMint_put3p1_p1_part_part0_r is Test {
  LiquidityPool c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address receiver) internal {
    ...
    receiver = address(uint160(bound(uint256(uint160(receiver)), 1461501637330902918203684832716283019655932542975, 1461501637330902918203684832716283019655932542975)));
    ...
    if (p_msg_sender == address(uint160(0)) && receiver == address(uint160(1461501637330902918203684832716283019655932542975))) {
  ...
  function test_put_LiquidityPool_maxMint_path3p1_part_part0_r(address p_msg_sender, address receiver) public {
    _veriput_parameterized(p_msg_sender, receiver);
    
    { LiquidityPoolCovTest_LiquidityPool_maxMint_concrete3p1__basis_part0_r__W _veriput_w = new LiquidityPoolCovTest_LiquidityPool_maxMint_concrete3p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract LiquidityPoolCovTest_LiquidityPool_maxMint_concrete3p1__basis_part0_r__W is Test {
  LiquidityPool c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new LiquidityPool(0, bytes16(0x00000000000000000000000000000000), address(uint160(0)), address(uint160(0)), address(uint160(0)));
  ...
  function _w_test_cov_0() public {
    ...
    uint256 _veriput_concrete_return = c0.maxMint(address(uint160(1461501637330902918203684832716283019655932542975)));
