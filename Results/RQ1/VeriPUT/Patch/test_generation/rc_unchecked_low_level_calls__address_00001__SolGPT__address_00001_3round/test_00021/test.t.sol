...
contract PoCGameCovTest_PoCGame_hasPlayerWagered_put3p1 is Test {
  ...
  // claim: sol:@C@PoCGame@F@hasPlayerWagered#450:path:3
  // witness-fingerprint-sha256: 3e06472fb71e48c0b7dd72b3b88361f20f2e789ffbc8bd98951547cb7f8b41c8
  // claim: sol:@C@PoCGame@F@hasPlayerWagered#450:path:2
  // witness-fingerprint-sha256: c8cea735da26c1c73551156800d5aea2acabf68e61dfb1867d05a269b642f86a

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@PoCGame@F@hasPlayerWagered#450:path:3   depth=1
  ...
  //   player in [0, 1461501637330902918203684832716283019655932542975]
  //   PIN block.basefee == 0
  ...
  // FUZZ COORDINATES: msg.sender, player
  ...
  //   rung IMPLIED (not lost, not asserted twice): wagers[player]: post >= pre (entailed by a stronger rung that also HOLDS on wagers[player], so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): wagers[player]: post <= pre (entailed by a stronger rung that also HOLDS on wagers[player], so asserting it detects nothing the stronger one misses)
