...
contract PoCGameCovTest_0_PoCGame_OpenToThePublic_put7p1_p1_part_part0_w is Test {
  ...
  // claim: sol:@C@PoCGame@F@OpenToThePublic#143:path:7
  // witness-fingerprint-sha256: d2972053f745cbfc109fa911b145c561f4beef29655156163b996b5142375682
  // claim: sol:@C@PoCGame@F@OpenToThePublic#143:path:2
  // witness-fingerprint-sha256: 3d06bbd1a45cf8e3be51b6761e1809ed5036b4f759f9c14b4a36e336d18429da

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@PoCGame@F@OpenToThePublic#143:path:7   depth=2
  ...
  // --path-cov-assert -- 17 over POST-STATE, read through vm.load at
...
contract PoCGameCovTest_1 is Test {
  ...
  // claim: sol:@C@PoCGame@F@OpenToThePublic#143:path:6
  // witness-fingerprint-sha256: cefcf25aec11ca5d51a889bbd0cf1e8cb1572dfcad42e76afafa2f845e8d89ee
}
