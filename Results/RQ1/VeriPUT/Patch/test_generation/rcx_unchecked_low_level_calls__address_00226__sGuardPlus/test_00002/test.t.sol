...
contract SimpleWalletCovTest_0_SimpleWallet_sendMoney_put6p1 is Test {
  ...
  function test_put_SimpleWallet_sendMoney_path6p1(address p_msg_sender, address _target, uint256 _value, bytes memory _data) public {
    ...
    { SimpleWalletCovTest_0_SimpleWallet_sendMoney_concrete6p1__basis_root__W _veriput_w = new SimpleWalletCovTest_0_SimpleWallet_sendMoney_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
