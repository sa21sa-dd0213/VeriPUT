...
contract NewIntelTechMediaCovTest_NewIntelTechMedia_allowance_put3p1 is Test {
  ...
  function test_put_NewIntelTechMedia_allowance_path3p1(address p_msg_sender, address _owner, address _spender) public {
    _veriput_parameterized(p_msg_sender, _owner, _spender);
    
    { NewIntelTechMediaCovTest_NewIntelTechMedia_allowance_concrete3p1__basis_root__W _veriput_w = new NewIntelTechMediaCovTest_NewIntelTechMedia_allowance_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract NewIntelTechMediaCovTest_NewIntelTechMedia_allowance_concrete3p1__basis_root__W is Test {
  NewIntelTechMedia c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new NewIntelTechMedia();
