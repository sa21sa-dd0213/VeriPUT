...
contract NewIntelTechMediaCovTest_0 is Test {
  ...
  // claim: sol:@C@NewIntelTechMedia@F@withdrawForeignTokens#884:path:7
  // witness-fingerprint-sha256: a96a8ab012a0e9d01d0150c24bfd338055e77599876288f894e075a210731e3e
  // claim: sol:@C@NewIntelTechMedia@F@withdrawForeignTokens#884:path:2
  // witness-fingerprint-sha256: c8a73a2b2560505ae2b6273afdf75fa820ed0565b1d083fc64a747c7bbdc6f99
}
...
contract NewIntelTechMediaCovTest_1_NewIntelTechMedia_withdrawForeignTokens_put6p1_p1_part_part0_r_r is Test {
  ...
  // claim: sol:@C@NewIntelTechMedia@F@withdrawForeignTokens#884:path:6
  // witness-fingerprint-sha256: e5dc0845f812b7a0562d2c20a4693a0d1ddaa6044855d637fc2265b05aa1d8c3

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@NewIntelTechMedia@F@withdrawForeignTokens#884:path:6   depth=2
  ...
  //   _tokenContract in [0, 1461501637330902918203684832716283019655932542975]
  ...
  // FUZZ COORDINATES: msg.sender, _tokenContract
