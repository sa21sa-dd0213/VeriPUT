...
contract NewIntelTechMediaCovTest_1_NewIntelTechMedia_transferOwnership_put6p1_p1_part_part0_r_r is Test {
  NewIntelTechMedia c0;
  function setUp() public {
  ...
  function test_put_NewIntelTechMedia_transferOwnership_path6p1_part_part0_r_r(address p_msg_sender, address newOwner) public {
    _veriput_parameterized(p_msg_sender, newOwner);
    
    { NewIntelTechMediaCovTest_1_NewIntelTechMedia_transferOwnership_concrete6p1__basis_part0_r_r__W _veriput_w = new NewIntelTechMediaCovTest_1_NewIntelTechMedia_transferOwnership_concrete6p1__basis_part0_r_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract NewIntelTechMediaCovTest_1_NewIntelTechMedia_transferOwnership_concrete6p1__basis_part0_r_r__W is Test {
  NewIntelTechMedia c0;
  function setUp() public {
    vm.startPrank(address(uint160(2147483647)), address(uint160(2147483647)));
    c0 = new NewIntelTechMedia();
