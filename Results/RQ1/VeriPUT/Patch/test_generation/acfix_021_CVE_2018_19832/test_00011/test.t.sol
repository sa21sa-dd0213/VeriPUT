...
contract NewIntelTechMediaCovTest_NewIntelTechMedia_transfer_put2p1 is Test {
  ...
  // claim: sol:@C@NewIntelTechMedia@F@transfer#590:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@NewIntelTechMedia@F@transfer#590:path:2   depth=1
  ...
  //   level0 = True
  //   level0_perturb = True
  //   level0_points = {'14': '(none)', '30': '_to==0', '62': '(none)', '63': '_amount==0'}
  //   max_holes = 3
  //   max_region_pieces = 4
  //   max_tx = 1
  //   probe_ladder = True
