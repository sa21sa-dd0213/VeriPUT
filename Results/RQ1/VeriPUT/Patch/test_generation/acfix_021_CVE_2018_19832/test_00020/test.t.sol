...
contract NewIntelTechMediaCovTest_1_NewIntelTechMedia_withdrawForeignTokens_put6p1_p1_part_part0_w is Test {
  NewIntelTechMedia c0;
  function setUp() public {
  ...
  function _veriput_parameterized(address p_msg_sender, address _tokenContract) internal {
    ...
    if (p_msg_sender == address(uint160(4294967295)) && _tokenContract == address(uint160(0))) {
  ...
  function test_put_NewIntelTechMedia_withdrawForeignTokens_path6p1_part_part0_w(address p_msg_sender, address _tokenContract) public {
    _veriput_parameterized(p_msg_sender, _tokenContract);
    
    { NewIntelTechMediaCovTest_1_NewIntelTechMedia_withdrawForeignTokens_concrete6p1__basis_part0_w__W _veriput_w = new NewIntelTechMediaCovTest_1_NewIntelTechMedia_withdrawForeignTokens_concrete6p1__basis_part0_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract NewIntelTechMediaCovTest_1_NewIntelTechMedia_withdrawForeignTokens_concrete6p1__basis_part0_w__W is Test {
  NewIntelTechMedia c0;
  function setUp() public {
    vm.startPrank(address(uint160(2147483647)), address(uint160(2147483647)));
    c0 = new NewIntelTechMedia();
