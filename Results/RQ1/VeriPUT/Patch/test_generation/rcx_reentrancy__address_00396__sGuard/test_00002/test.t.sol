...
contract W_WALLETCovTest_W_WALLET_fallback_put14p1_p1_part_part0_r is Test {
  W_WALLET c0;
  ...
  function test_put_W_WALLET_fallback_path14p1_part_part0_r(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { W_WALLETCovTest_W_WALLET_fallback_concrete14p1__basis_part0_r__W _veriput_w = new W_WALLETCovTest_W_WALLET_fallback_concrete14p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract W_WALLETCovTest_W_WALLET_fallback_concrete14p1__basis_part0_r__W is Test {
  W_WALLET c0;
  function setUp() public {
    c0 = new W_WALLET(address(uint160(0)));
