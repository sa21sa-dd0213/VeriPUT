...
contract FlashGovernanceArbiterCovTest_FlashGovernanceArbiter_setDAO_put2p1 is Test {
  ...
  // claim: sol:@C@FlashGovernanceArbiter@F@setDAO#426:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@FlashGovernanceArbiter@F@setDAO#426:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, dao
