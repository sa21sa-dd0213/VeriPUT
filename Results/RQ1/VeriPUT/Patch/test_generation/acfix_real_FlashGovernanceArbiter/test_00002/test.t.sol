...
contract FlashGovernanceArbiterCovTest_FlashGovernanceArbiter_burnFlashGovernanceAsset_put2p1 is Test {
  ...
  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@FlashGovernanceArbiter@F@burnFlashGovernanceAsset#757:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, targetContract, user, asset, amount
