...
contract FlashGovernanceArbiterCovTest_FlashGovernanceArbiter_configureSecurityParameters_put2p1 is Test {
  ...
  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@FlashGovernanceArbiter@F@configureSecurityParameters#721:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, maxGovernanceChangePerEpoch, epochSize, changeTolerance
