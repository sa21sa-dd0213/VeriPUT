...
contract FlashGovernanceArbiterCovTest_FlashGovernanceArbiter_setGoverned_put2p1 is Test {
  ...
  // claim: sol:@C@FlashGovernanceArbiter@F@setGoverned#530:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@FlashGovernanceArbiter@F@setGoverned#530:path:2   depth=1
  ...
  //   level0 = True
  //   level0_perturb = True
  //   level0_points = {'55': 'state.configured$221==0'}
  //   max_holes = 3
  //   max_region_pieces = 4
  //   max_tx = 1
  //   probe_ladder = True
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, governables, isGoverned
