...
contract RyujinCovTest_Ryujin_setCooldownEnabled_put3p1_p1_part_part0_r is Test {
  Ryujin c0;
  ...
  function test_put_Ryujin_setCooldownEnabled_path3p1_part_part0_r(address p_msg_sender, bool onoff) public {
    _veriput_parameterized(p_msg_sender, onoff);
    
    { RyujinCovTest_Ryujin_setCooldownEnabled_concrete3p1__basis_part0_r__W _veriput_w = new RyujinCovTest_Ryujin_setCooldownEnabled_concrete3p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract RyujinCovTest_Ryujin_setCooldownEnabled_concrete3p1__basis_part0_r__W is Test {
  Ryujin c0;
  function setUp() public {
    c0 = new Ryujin();
  }
