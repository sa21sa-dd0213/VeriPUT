...
contract RyujinCovTest_Ryujin_approve_put3p1 is Test {
  Ryujin c0;
  ...
  function test_put_Ryujin_approve_path3p1(address p_msg_sender, address spender, uint256 amount) public {
    _veriput_parameterized(p_msg_sender, spender, amount);
    
    { RyujinCovTest_Ryujin_approve_concrete3p1__basis_root__W _veriput_w = new RyujinCovTest_Ryujin_approve_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract RyujinCovTest_Ryujin_approve_concrete3p1__basis_root__W is Test {
  Ryujin c0;
  function setUp() public {
    c0 = new Ryujin();
  }
