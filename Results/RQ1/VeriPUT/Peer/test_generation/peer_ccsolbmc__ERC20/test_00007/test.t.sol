...
contract ERC20CovTest_ERC20_ascf_put2p1 is Test {
  ERC20 c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value) internal {
    ...
    uint256 _pre_enable_0 = (uint256(vm.load(address(c0), keccak256(abi.encode(uint256(0), uint256(5))))) & 255);
    uint256 _pre_balances_msg_sender = uint256(vm.load(address(c0), keccak256(abi.encode(p_msg_sender, uint256(0)))));
    uint256 _pre_balances_state_uniswapV2Pair = uint256(vm.load(address(c0), keccak256(abi.encode(address(uint160((uint256(vm.load(address(c0), bytes32(uint256(7)))) & 1461501637330902918203684832716283019655932542975))), uint256(0)))));
    
    
    vm.deal(p_msg_sender, p_msg_value);
    vm.prank(p_msg_sender);
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("ascf()"));
    ...
    uint256 _post_enable_0 = (uint256(vm.load(address(c0), keccak256(abi.encode(uint256(0), uint256(5))))) & 255);
    uint256 _post_balances_msg_sender = uint256(vm.load(address(c0), keccak256(abi.encode(p_msg_sender, uint256(0)))));
    uint256 _post_balances_state_uniswapV2Pair = uint256(vm.load(address(c0), keccak256(abi.encode(address(uint160((uint256(vm.load(address(c0), bytes32(uint256(7)))) & 1461501637330902918203684832716283019655932542975))), uint256(0)))));
    ...
    assertEq(_post_enable_0, _pre_enable_0, "_enable[0]: post == pre");
    assertEq(_post_balances_msg_sender, _pre_balances_msg_sender, "_balances[msg.sender]: post == pre");
    assertEq(_post_balances_state_uniswapV2Pair, _pre_balances_state_uniswapV2Pair, "_balances[state.uniswapV2Pair]: post == pre");
    ...
    assertGe(_post_balances_state_uniswapV2Pair, _pre_balances_state_uniswapV2Pair, "_balances[state.uniswapV2Pair]: post >= pre");
    assertLe(_post_balances_state_uniswapV2Pair, _pre_balances_state_uniswapV2Pair, "_balances[state.uniswapV2Pair]: post <= pre");
  ...
  function test_put_ERC20_ascf_path2p1(address p_msg_sender, uint256 p_msg_value) public {
