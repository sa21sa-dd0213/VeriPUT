...
contract ERC20CovTest_ERC20_balanceOf_put3p1 is Test {
  ERC20 c0;
  ...
  function test_put_ERC20_balanceOf_path3p1(address p_msg_sender, address account) public {
    _veriput_parameterized(p_msg_sender, account);
    
    { ERC20CovTest_ERC20_balanceOf_concrete3p1__basis_root__W _veriput_w = new ERC20CovTest_ERC20_balanceOf_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract ERC20CovTest_ERC20_balanceOf_concrete3p1__basis_root__W is Test {
  ERC20 c0;
  function setUp() public {
    c0 = new ERC20();
  }
