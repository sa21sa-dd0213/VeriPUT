...
contract PaymentsCovTest_Payments_withdraw_put2p1 is Test {
  Payments c0;
  ...
  function test_put_Payments_withdraw_path2p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { PaymentsCovTest_Payments_withdraw_concrete2p1__basis_root__W _veriput_w = new PaymentsCovTest_Payments_withdraw_concrete2p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract PaymentsCovTest_Payments_withdraw_concrete2p1__basis_root__W is Test {
  Payments c0;
  function setUp() public {
    c0 = new Payments();
  }
