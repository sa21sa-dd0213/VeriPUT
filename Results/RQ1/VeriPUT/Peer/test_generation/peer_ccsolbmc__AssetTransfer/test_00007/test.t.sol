...
contract AssetTransferCovTest_AssetTransfer_MakeOffer_put2p1 is Test {
  ...
  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@AssetTransfer@F@MakeOffer#173:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, inspector, appraiser, offerPrice
  ...
  // 12 snapshot local(s) HOISTED to storage: 5 fuzz parameter(s) + 12 snapshot local(s) exceed the 12-slot budget (solc stack reach); the reads and every assertion are unchanged
