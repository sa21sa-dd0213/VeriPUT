...
contract AssetTransferCovTest_0_AssetTransfer_initialize_put3p1_p1_part_part0_w is Test {
  AssetTransfer c0;
  ...
  function test_put_AssetTransfer_initialize_path3p1_part_part0_w(address p_msg_sender, uint256 price) public {
    _veriput_parameterized(p_msg_sender, price);
    
    { AssetTransferCovTest_0_AssetTransfer_initialize_concrete3p1__basis_part0_w__W _veriput_w = new AssetTransferCovTest_0_AssetTransfer_initialize_concrete3p1__basis_part0_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract AssetTransferCovTest_0_AssetTransfer_initialize_concrete3p1__basis_part0_w__W is Test {
  AssetTransfer c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new AssetTransfer();
  ...
  function _w_test_cov_0() public {
    ...
    try c0.initialize("", uint256(0)) {} catch {}
