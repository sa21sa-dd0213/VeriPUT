...
contract AssetTransferCovTest_0_AssetTransfer_initialize_put3p1_p1_part_part0_w is Test {
  ...
  //   rung IMPLIED (not lost, not asserted twice): AskingPrice: post in [0, 115792089237316195423570985008687907853269984665640564039457584007913129639935] (entailed by a stronger rung that also HOLDS on AskingPrice, so asserting it detects nothing the stronger one misses)
