...
contract AssetTransferCovTest_AssetTransfer_ModifyOffer_put6p1 is Test {
  ...
  // claim: sol:@C@AssetTransfer@F@ModifyOffer#395:path:6
  // witness-fingerprint-sha256: 79284df07370aa328f93d75e807d4700e900626e10d0399228dcceb472d5c682
  // claim: sol:@C@AssetTransfer@F@ModifyOffer#395:path:2
  // witness-fingerprint-sha256: 47838c99c9e1123adfd56568a73993a5812e2caf2d17ffd8c8599b232b2eaec8

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@AssetTransfer@F@ModifyOffer#395:path:6   depth=2
  ...
  //   offerPrice in [0, 115792089237316195423570985008687907853269984665640564039457584007913129639935]
  //   state.InstanceBuyer in [0, 1461501637330902918203684832716283019655932542975]
  //   state.OfferPrice in [0, 115792089237316195423570985008687907853269984665640564039457584007913129639935]
  ...
  // FUZZ COORDINATES: msg.sender, offerPrice
  ...
  //   path guard ESTABLISHED: `!(State != 1)` -> `vm.assume(_pre_State != 1);`
  ...
  //   entry-state bound DROPPED: state.OfferPrice in [0, 115792089237316195423570985008687907853269984665640564039457584007913129639935] (width > 1, DROPPED: the entry state is not havoc'd, so this bound constrained nothing in the query -- the rungs were proved about the constructor's own value. Establishing a fuzz-chosen value here would test entry states the proof never covered, which is how this PUT came back RED on the unmodified contract. Both endpoints are the type's own limits, so there is not even an in-region check to make: the bound says nothing at all)
