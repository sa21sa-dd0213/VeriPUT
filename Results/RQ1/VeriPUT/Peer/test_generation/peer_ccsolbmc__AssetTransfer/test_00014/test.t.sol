...
contract AssetTransferCovTest_AssetTransfer_Modify_put14p1 is Test {
  ...
  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@AssetTransfer@F@Modify#107:path:14   depth=3
  ...
  // FUZZ COORDINATES: msg.sender, description, price
  ...
  //   path guard ESTABLISHED: `!(InstanceOwner != msg.sender)` -> `vm.assume(0 != uint256(uint160(p_msg_sender)));`
