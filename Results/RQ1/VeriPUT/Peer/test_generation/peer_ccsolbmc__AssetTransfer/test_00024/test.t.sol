...
contract AssetTransferCovTest_AssetTransfer_Reject_put6p1_p1_part_part0_w_w is Test {
  ...
  // claim: sol:@C@AssetTransfer@F@Reject#256:path:6
  // witness-fingerprint-sha256: c934ad63a15c943aafee1ba4fe252a1dcf98acc330145295ea990708dc7fcb89
  // claim: sol:@C@AssetTransfer@F@Reject#256:path:2
  // witness-fingerprint-sha256: 4828be9c3ce0d7ea45a0f71b37cc79f4143f9d4a4262c9c4202ce7468fb93bf3

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@AssetTransfer@F@Reject#256:path:6   depth=2
  ...
  //   path guard DROPPED: '!(State != 1 && State != 2 && State != 3 && State != 4 && State != 5 && State != 6)' (`State` is assigned inside the unit before this source decision may execute, so it is not the calldata coordinate)
  //   path guard DROPPED: '!(State != 1 && State != 2 && State != 3 && State != 4 && State != 5 && State != 6)' (`State` is assigned inside the unit before this source decision may execute, so it is not the calldata coordinate)
  //   path guard DROPPED: '!(State != 1 && State != 2 && State != 3 && State != 4 && State != 5 && State != 6)' (`State` is assigned inside the unit before this source decision may execute, so it is not the calldata coordinate)
  //   path guard DROPPED: '!(State != 1 && State != 2 && State != 3 && State != 4 && State != 5 && State != 6)' (`State` is assigned inside the unit before this source decision may execute, so it is not the calldata coordinate)
  //   path guard DROPPED: '!(State != 1 && State != 2 && State != 3 && State != 4 && State != 5 && State != 6)' (`State` is assigned inside the unit before this source decision may execute, so it is not the calldata coordinate)
