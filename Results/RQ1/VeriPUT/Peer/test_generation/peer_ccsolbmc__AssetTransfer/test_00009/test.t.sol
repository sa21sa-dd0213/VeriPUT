...
contract AssetTransferCovTest_AssetTransfer_MarkAppraised_put31p1 is Test {
  ...
  // claim: sol:@C@AssetTransfer@F@MarkAppraised#494:path:31
  // witness-fingerprint-sha256: 33e5888adad2f26702dd3578142b685a9b7ca1e7580ec331cf4bc841d438ce74
  // claim: sol:@C@AssetTransfer@F@MarkAppraised#494:path:6
  // witness-fingerprint-sha256: 37cb169788efcae9c2b513ef394eebf28dc6ceaa538f94cafe41e6f67b795ede
  // claim: sol:@C@AssetTransfer@F@MarkAppraised#494:path:2
  // witness-fingerprint-sha256: b1f0a83ee3adfb08edb578b83841c307638e74729541e27954a9defcfa3131aa

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@AssetTransfer@F@MarkAppraised#494:path:31   depth=4
  ...
  //   path guard ESTABLISHED: `InstanceAppraiser != msg.sender` -> `vm.assume(_pre_InstanceAppraiser == uint256(uint160(p_msg_sender)));`
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    //   state.InstanceAppraiser := msg.sender
    {
