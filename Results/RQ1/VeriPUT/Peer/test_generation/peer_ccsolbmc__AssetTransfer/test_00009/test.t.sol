...
contract AssetTransferCovTest_AssetTransfer_MarkAppraised_put31p1 is Test {
  AssetTransfer c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    assertEq((uint256(vm.load(address(c0), bytes32(uint256(6)))) & 1461501637330902918203684832716283019655932542975), uint256(uint256(uint160(p_msg_sender))), "entry pin state.InstanceAppraiser did NOT land: vm.store wrote a word the contract does not read back at this slot, so the test is not inside the certified region and every rung below is about a different state");
    
    uint256 _pre_State = (uint256(vm.load(address(c0), bytes32(uint256(3)))) & 255);
    uint256 _pre_InstanceAppraiser = (uint256(vm.load(address(c0), bytes32(uint256(6)))) & 1461501637330902918203684832716283019655932542975);
    
    vm.assume(_pre_InstanceAppraiser == uint256(uint160(p_msg_sender)));
    ...
    bool _put_ok = true;
    try c0.MarkAppraised() {} catch { _put_ok = false; }
    ...
    uint256 _post_InstanceAppraiser = (uint256(vm.load(address(c0), bytes32(uint256(6)))) & 1461501637330902918203684832716283019655932542975);
  ...
  function test_put_AssetTransfer_MarkAppraised_path31p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { AssetTransferCovTest_AssetTransfer_MarkAppraised_concrete31p1__basis_root__W _veriput_w = new AssetTransferCovTest_AssetTransfer_MarkAppraised_concrete31p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract AssetTransferCovTest_AssetTransfer_MarkAppraised_concrete31p1__basis_root__W is Test {
  AssetTransfer c0;
  function setUp() public {
    c0 = new AssetTransfer();
  }
