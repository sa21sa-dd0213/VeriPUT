...
contract AssetTransferCovTest_AssetTransfer_Modify_put15p1_p1_part_part0_r is Test {
  AssetTransfer c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 price) internal {
    ...
    price = bound(price, 115792089237316195423570985008687907853269984665640564039457584007913129639935, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
    ...
    if (p_msg_sender == address(uint160(0)) && price == uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)) {
    ...
    assertGe(_post_AskingPrice, _pre_AskingPrice, "AskingPrice: post >= pre");
    
  }


  
  function test_put_AssetTransfer_Modify_path15p1_part_part0_r(address p_msg_sender, uint256 price) public {
    _veriput_parameterized(p_msg_sender, price);
    
    { AssetTransferCovTest_AssetTransfer_Modify_concrete15p1__basis_part0_r__W _veriput_w = new AssetTransferCovTest_AssetTransfer_Modify_concrete15p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract AssetTransferCovTest_AssetTransfer_Modify_concrete15p1__basis_part0_r__W is Test {
  AssetTransfer c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new AssetTransfer();
  ...
  function _w_test_cov_0() public {
    ...
    try c0.Modify("", uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)) {} catch {}
    uint256 _veriput_fixed_state_AskingPrice_0 = uint256(vm.load(address(c0), bytes32(uint256(2))));
    assertEq(_veriput_fixed_state_AskingPrice_0, uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935), "fixed witness state");
