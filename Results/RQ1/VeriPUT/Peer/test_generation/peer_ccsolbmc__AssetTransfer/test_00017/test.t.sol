...
contract AssetTransferCovTest_AssetTransfer_Modify_put15p1_p1_part_part0_w_w is Test {
  AssetTransfer c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 price) internal {
    ...
    price = bound(price, 0, 57896044618658097711785492504343953926634992332820282019728792003956564819966);
    ...
    if (p_msg_sender == address(uint160(0)) && price == uint256(0)) {
  ...
  function test_put_AssetTransfer_Modify_path15p1_part_part0_w_w(address p_msg_sender, uint256 price) public {
    _veriput_parameterized(p_msg_sender, price);
    
    { AssetTransferCovTest_AssetTransfer_Modify_concrete15p1__basis_part0_w_w__W _veriput_w = new AssetTransferCovTest_AssetTransfer_Modify_concrete15p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract AssetTransferCovTest_AssetTransfer_Modify_concrete15p1__basis_part0_w_w__W is Test {
  AssetTransfer c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new AssetTransfer();
