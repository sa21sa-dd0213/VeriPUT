...
contract AssetTransferCovTest_AssetTransfer_RescindOffer_put6p1_p1_part_part0_w_r is Test {
  AssetTransfer c0;
  ...
  function test_put_AssetTransfer_RescindOffer_path6p1_part_part0_w_r(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { AssetTransferCovTest_AssetTransfer_RescindOffer_concrete6p1__basis_part0_w_r__W _veriput_w = new AssetTransferCovTest_AssetTransfer_RescindOffer_concrete6p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract AssetTransferCovTest_AssetTransfer_RescindOffer_concrete6p1__basis_part0_w_r__W is Test {
  AssetTransfer c0;
  function setUp() public {
    c0 = new AssetTransfer();
  }
