...
contract AssetTransferCovTest_AssetTransfer_MarkAppraised_put6p1 is Test {
  ...
  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@AssetTransfer@F@MarkAppraised#494:path:6   depth=2
  ...
  //   state.InstanceAppraiser in [0, 0]
  //   PIN block.basefee == 0
  ...
  //   path guard ESTABLISHED: `!(InstanceAppraiser != msg.sender)` -> `vm.assume(0 != uint256(uint160(p_msg_sender)));`
