...
contract AssetTransferCovTest_AssetTransfer_MarkAppraised_put6p1 is Test {
  AssetTransfer c0;
  ...
  function test_put_AssetTransfer_MarkAppraised_path6p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { AssetTransferCovTest_AssetTransfer_MarkAppraised_concrete6p1__basis_root__W _veriput_w = new AssetTransferCovTest_AssetTransfer_MarkAppraised_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract AssetTransferCovTest_AssetTransfer_MarkAppraised_concrete6p1__basis_root__W is Test {
  AssetTransfer c0;
  function setUp() public {
    c0 = new AssetTransfer();
  }
