...
contract AssetTransferCovTest_AssetTransfer_RescindOffer_put6p1_p1_part_part0_w_r is Test {
  ...
  // claim: sol:@C@AssetTransfer@F@RescindOffer#455:path:6
  // witness-fingerprint-sha256: 408319215d511bb0abcd8425e345a181ed3775d9c779610869b7f52ddc4460bb
  // claim: sol:@C@AssetTransfer@F@RescindOffer#455:path:2
  // witness-fingerprint-sha256: 5a0af997e7b4618e52952e71f3dfdd22b00903cc996b4a69b877e33d921eeb4f

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@AssetTransfer@F@RescindOffer#455:path:6   depth=2
  ...
  //   path guard DROPPED: '!(State != 1 && State != 2 && State != 3 && State != 4 && State != 5 && State != 7)' (`State` is assigned inside the unit before this source decision may execute, so it is not the calldata coordinate)
  //   path guard DROPPED: '!(State != 1 && State != 2 && State != 3 && State != 4 && State != 5 && State != 7)' (`State` is assigned inside the unit before this source decision may execute, so it is not the calldata coordinate)
  //   path guard DROPPED: '!(State != 1 && State != 2 && State != 3 && State != 4 && State != 5 && State != 7)' (`State` is assigned inside the unit before this source decision may execute, so it is not the calldata coordinate)
  //   path guard DROPPED: '!(State != 1 && State != 2 && State != 3 && State != 4 && State != 5 && State != 7)' (`State` is assigned inside the unit before this source decision may execute, so it is not the calldata coordinate)
  //   path guard DROPPED: '!(State != 1 && State != 2 && State != 3 && State != 4 && State != 5 && State != 7)' (`State` is assigned inside the unit before this source decision may execute, so it is not the calldata coordinate)
  //   path guard DROPPED: '!(State != 1 && State != 2 && State != 3 && State != 4 && State != 5 && State != 7)' (`State` is assigned inside the unit before this source decision may execute, so it is not the calldata coordinate)
  //   environment ESTABLISHED: msg.sender in [4294967292, 4294967293] is ESTABLISHED and FUZZED: the governing vm.prank now takes the bound() fuzz parameter `p_msg_sender`, so this PUT ranges over the certified sender interval rather than over one point of it (no prank was present, so one was inserted)
