...
contract PrimalityCovTest_Primality_setX_put2p1 is Test {
  Primality c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, uint256 _x) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("setX(uint256)", _x));
  ...
  function test_put_Primality_setX_path2p1(address p_msg_sender, uint256 p_msg_value, uint256 _x) public {
