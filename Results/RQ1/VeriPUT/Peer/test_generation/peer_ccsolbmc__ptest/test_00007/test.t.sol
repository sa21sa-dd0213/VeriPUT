...
contract PrimalityCovTest_Primality_setY_put3p1_p1_part_part0_w_r is Test {
  Primality c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 _y) internal {
    ...
    _y = bound(_y, 115792089237316195423570985008687907853269984665640564039457584007913129639934, 115792089237316195423570985008687907853269984665640564039457584007913129639934);
    ...
    if (p_msg_sender == address(uint160(0)) && _y == uint256(115792089237316195423570985008687907853269984665640564039457584007913129639934)) {
  ...
  function test_put_Primality_setY_path3p1_part_part0_w_r(address p_msg_sender, uint256 _y) public {
    _veriput_parameterized(p_msg_sender, _y);
    
    { PrimalityCovTest_Primality_setY_concrete3p1__basis_part0_w_r__W _veriput_w = new PrimalityCovTest_Primality_setY_concrete3p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PrimalityCovTest_Primality_setY_concrete3p1__basis_part0_w_r__W is Test {
  Primality c0;
  function setUp() public {
    c0 = new Primality();
  }
  ...
  function _w_test_cov_0() public {
    ...
    c0.setY(uint256(115792089237316195423570985008687907853269984665640564039457584007913129639934));
    ...
    assertEq(_veriput_fixed_state_y_2, uint256(115792089237316195423570985008687907853269984665640564039457584007913129639934), "fixed witness state");
  }
