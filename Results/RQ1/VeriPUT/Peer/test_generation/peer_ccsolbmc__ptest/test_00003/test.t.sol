...
contract PrimalityCovTest_Primality_setX_put3p1_p1_part_part0_w_r is Test {
  Primality c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 _x) internal {
    ...
    uint256 _pre_x = uint256(vm.load(address(c0), bytes32(uint256(1))));
    ...
    if (p_msg_sender == address(uint160(0)) && _x == uint256(115792089237316195423570985008687907853269984665640564039457584007913129639934)) {
      assertEq(uint256(vm.load(address(c0), bytes32(uint256(0)))), uint256(973013), "fixed witness state");
      assertEq(uint256(vm.load(address(c0), bytes32(uint256(1)))), uint256(115792089237316195423570985008687907853269984665640564039457584007913129639934), "fixed witness state");
  ...
  function test_put_Primality_setX_path3p1_part_part0_w_r(address p_msg_sender, uint256 _x) public {
    _veriput_parameterized(p_msg_sender, _x);
    
    { PrimalityCovTest_Primality_setX_concrete3p1__basis_part0_w_r__W _veriput_w = new PrimalityCovTest_Primality_setX_concrete3p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PrimalityCovTest_Primality_setX_concrete3p1__basis_part0_w_r__W is Test {
  Primality c0;
  function setUp() public {
    c0 = new Primality();
  }
  ...
  function _w_test_cov_0() public {
    ...
    c0.setX(uint256(115792089237316195423570985008687907853269984665640564039457584007913129639934));
    ...
    assertEq(_veriput_fixed_state_x_1, uint256(115792089237316195423570985008687907853269984665640564039457584007913129639934), "fixed witness state");
    uint256 _veriput_fixed_state_y_2 = uint256(vm.load(address(c0), bytes32(uint256(2))));
    assertEq(_veriput_fixed_state_y_2, uint256(0), "fixed witness state");
  }
