...
contract PrimalityCovTest_Primality_verifyPrime_put2p1 is Test {
  Primality c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value) internal {
    ...
    uint256 _pre_largePrime = uint256(vm.load(address(c0), bytes32(uint256(0))));
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("verifyPrime()"));
    
    uint256 _post_largePrime = uint256(vm.load(address(c0), bytes32(uint256(0))));
  ...
  function test_put_Primality_verifyPrime_path2p1(address p_msg_sender, uint256 p_msg_value) public {
