...
contract KizunaInuCovTest_KizunaInu_startTrading_put6p1 is Test {
  ...
  // claim: sol:@C@KizunaInu@F@startTrading#1078:path:63
  // witness-fingerprint-sha256: d6052fcd3e90d8616a21a76087abc481ac416378ad8ad439a683bdd576b11fac
  // claim: sol:@C@KizunaInu@F@startTrading#1078:path:6
  // witness-fingerprint-sha256: a65cfb40ff76dc432b656a17d154f543c72e0167429ad7df68b48c0525efbcf7
  // claim: sol:@C@KizunaInu@F@startTrading#1078:path:2
  // witness-fingerprint-sha256: 8c3ebd4d41412a72bee8673fac8aaa1d0f68608e92226c6cec56c0c5f0c9a067

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@KizunaInu@F@startTrading#1078:path:6   depth=2
  ...
  //   PIN msg.value == 0
  //   PIN state._tTotal == 1000000000000000000   [NOT ESTABLISHED -- see the dropped-bound line]
  //   PIN tx.gasprice == 0
  ...
  //   path guard ESTABLISHED: `!(!(_owner$32 == return_value$__msgSender$1))` -> `vm.assume(0 != uint256(uint160(p_msg_sender)));`
  ...
  function _veriput_parameterized(address p_msg_sender, uint8 s_cooldownEnabled, uint8 s_swapEnabled, uint8 s_tradingOpen) internal {
    ...
    //   state._owner$32 := 0; state.cooldownEnabled := s_cooldownEnabled in [0, 1] (SET and FUZZED: freed at the certification entry); state.swapEnabled := s_swapEnabled in [0, 1] (SET and FUZZED: freed at the certification entry); state.tradingOpen := s_tradingOpen in [0, 1] (SET and FUZZED: freed at the certification entry)
    {
    ...
    // VERIPUT_FIXED_REPLAY_STATE_PROJECTION {"state._tTotal":{"certificate":"fixed-replay-state-constant-or-immutable/v1","kind":"fixed-replay-state-constant-or-immutable","value":1000000000000000000}}
