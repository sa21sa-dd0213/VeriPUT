...
contract KizunaInuCovTest_KizunaInu_unblockBot_put6p1 is Test {
  KizunaInu c0;
  ...
  function test_put_KizunaInu_unblockBot_path6p1(address p_msg_sender, address notbot) public {
    _veriput_parameterized(p_msg_sender, notbot);
    
    { KizunaInuCovTest_KizunaInu_unblockBot_concrete6p1__basis_root__W _veriput_w = new KizunaInuCovTest_KizunaInu_unblockBot_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract KizunaInuCovTest_KizunaInu_unblockBot_concrete6p1__basis_root__W is Test {
  KizunaInu c0;
  function setUp() public {
    c0 = new KizunaInu();
  }
