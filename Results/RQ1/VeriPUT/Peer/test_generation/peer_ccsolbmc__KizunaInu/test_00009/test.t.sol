...
contract KizunaInuCovTest_KizunaInu_owner_put3p1 is Test {
  ...
  // claim: sol:@C@KizunaInu@F@owner#69:path:3
  // witness-fingerprint-sha256: 62793a885a47b6d5e6d7f785b6a0b09bc3e2ef8412c3ca295fd2caeeb8349e08
  // claim: sol:@C@KizunaInu@F@owner#69:path:2
  // witness-fingerprint-sha256: f63378fdd3e9cde9d37bf5bfb33cc6adb1cc97d5f5e5418aabb1105e5e978cff

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@KizunaInu@F@owner#69:path:3   depth=1
  ...
  //   state._owner$32 in [0, 1461501637330902918203684832716283019655932542975]
  //   PIN block.basefee == 0
  ...
  //   rung DROPPED: return: return == state._owner$32 (rung shape not renderable for its declared type)
