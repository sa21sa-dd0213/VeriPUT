...
contract TestDateTimeCovTest_TestDateTime_isWeekDay_put3p1_p1_part_part0_r is Test {
  TestDateTime c0;
  ...
  function test_put_TestDateTime_isWeekDay_path3p1_part_part0_r(address p_msg_sender, uint256 timestamp) public {
    _veriput_parameterized(p_msg_sender, timestamp);
    
    { TestDateTimeCovTest_TestDateTime_isWeekDay_concrete3p1__basis_part0_r__W _veriput_w = new TestDateTimeCovTest_TestDateTime_isWeekDay_concrete3p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract TestDateTimeCovTest_TestDateTime_isWeekDay_concrete3p1__basis_part0_r__W is Test {
  TestDateTime c0;
  function setUp() public {
    c0 = new TestDateTime();
  }
  ...
  function _w_test_cov_0() public {
    ...
    bool _veriput_concrete_return = c0.isWeekDay(uint256(0));
