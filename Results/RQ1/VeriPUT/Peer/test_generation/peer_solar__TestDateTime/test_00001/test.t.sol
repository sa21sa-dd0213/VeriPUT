...
contract TestDateTimeCovTest_TestDateTime__isLeapYear_put12p1_p1_part_part0_r is Test {
  TestDateTime c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_block_timestamp, uint256 year) internal {
    ...
    if (p_msg_sender == address(uint160(0)) && p_block_timestamp == uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935) && year == uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)) {
  ...
  function test_put_TestDateTime__isLeapYear_path12p1_part_part0_r(address p_msg_sender, uint256 p_block_timestamp, uint256 year) public {
