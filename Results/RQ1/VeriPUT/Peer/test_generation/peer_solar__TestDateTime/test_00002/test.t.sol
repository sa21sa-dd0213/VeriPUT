...
contract TestDateTimeCovTest_TestDateTime__isLeapYear_put13p1 is Test {
  ...
  function test_put_TestDateTime__isLeapYear_path13p1(address p_msg_sender, uint256 p_block_timestamp, uint256 p_block_number, uint256 year) public {
    ...
    { TestDateTimeCovTest_TestDateTime__isLeapYear_concrete13p1__basis_root__W _veriput_w = new TestDateTimeCovTest_TestDateTime__isLeapYear_concrete13p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}



contract TestDateTimeCovTest_TestDateTime__isLeapYear_concrete13p1__basis_root__W is Test {
  TestDateTime c0;
  function setUp() public {
    c0 = new TestDateTime();
  }
  ...
  function _w_test_cov_0() public {
    ...
    bool _veriput_concrete_return = c0._isLeapYear(uint256(0));
