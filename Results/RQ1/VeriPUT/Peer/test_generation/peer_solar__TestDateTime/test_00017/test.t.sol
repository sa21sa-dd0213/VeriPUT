...
contract TestDateTimeCovTest_TestDateTime_getSecond_put3p1_p1_part_part0_r_r is Test {
  ...
  function test_put_TestDateTime_getSecond_path3p1_part_part0_r_r(address p_msg_sender, uint256 timestamp) public {
    ...
    { TestDateTimeCovTest_TestDateTime_getSecond_concrete3p1__basis_part0_r_r__W _veriput_w = new TestDateTimeCovTest_TestDateTime_getSecond_concrete3p1__basis_part0_r_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract TestDateTimeCovTest_TestDateTime_getSecond_concrete3p1__basis_part0_r_r__W is Test {
  TestDateTime c0;
  function setUp() public {
    c0 = new TestDateTime();
  }
  ...
  function _w_test_cov_0() public {
    ...
    uint256 _veriput_concrete_return = c0.getSecond(uint256(60));
