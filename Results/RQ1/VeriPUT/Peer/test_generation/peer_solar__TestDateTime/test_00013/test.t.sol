...
contract TestDateTimeCovTest_TestDateTime_getMinute_put3p1_p1_part_part0_r_r is Test {
  ...
  // claim: sol:@C@TestDateTime@F@getMinute#1960:path:3
  // witness-fingerprint-sha256: e1ecb41b9e5661a8f1057a24a9dfa75211d743b39ec6ca03c4762387179119dd
  // claim: sol:@C@TestDateTime@F@getMinute#1960:path:2
  // witness-fingerprint-sha256: 0567e94ec7277eaecdf024969a451e7c914c0e0f75c48548f87b8dca4e3d1844

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@TestDateTime@F@getMinute#1960:path:3   depth=1
  ...
  //   timestamp in [115792089237316195423570985008687907853269984665640564038449944123685627048031, 115792089237316195423570985008687907853269984665640564039457584007913129639935]
  //   PIN block.basefee == 0
  ...
  // ORACLE: 58 assertion(s) from the surviving (HOLDS) rungs of
  // --path-cov-assert -- 0 over POST-STATE, read through vm.load at
  // the slot solc reports, and 58 over the unit's OWN RETURN
