...
contract TestDateTimeCovTest_TestDateTime_isWeekEnd_put3p1_p1_part_part0_w_w is Test {
  TestDateTime c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 timestamp) internal {
    ...
    timestamp = bound(timestamp, 29335062287520263058250598157477873973198849, 83948430946845727467622121301051408180126446586585607864152098945810824565247);
  ...
  function test_put_TestDateTime_isWeekEnd_path3p1_part_part0_w_w(address p_msg_sender, uint256 timestamp) public {
    _veriput_parameterized(p_msg_sender, timestamp);
    
    { TestDateTimeCovTest_TestDateTime_isWeekEnd_concrete3p1__basis_part0_w_w__W _veriput_w = new TestDateTimeCovTest_TestDateTime_isWeekEnd_concrete3p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract TestDateTimeCovTest_TestDateTime_isWeekEnd_concrete3p1__basis_part0_w_w__W is Test {
  TestDateTime c0;
  function setUp() public {
    c0 = new TestDateTime();
  }
  ...
  function _w_test_cov_0() public {
    ...
    bool _veriput_concrete_return = c0.isWeekEnd(uint256(58670124575040526116501196314955747946397697));
