...
contract TestDateTimeCovTest_TestDateTime_isWeekDay_put3p1_p1_part_part0_w_w is Test {
  TestDateTime c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 timestamp) internal {
    ...
    timestamp = bound(timestamp, 2, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
    ...
    bool _veriput_fixed_return_0 = c0.isWeekDay(timestamp);
  ...
  function test_put_TestDateTime_isWeekDay_path3p1_part_part0_w_w(address p_msg_sender, uint256 timestamp) public {
    _veriput_parameterized(p_msg_sender, timestamp);
    
    { TestDateTimeCovTest_TestDateTime_isWeekDay_concrete3p1__basis_part0_w_w__W _veriput_w = new TestDateTimeCovTest_TestDateTime_isWeekDay_concrete3p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract TestDateTimeCovTest_TestDateTime_isWeekDay_concrete3p1__basis_part0_w_w__W is Test {
  TestDateTime c0;
  function setUp() public {
    c0 = new TestDateTime();
  }
  ...
  function _w_test_cov_0() public {
    ...
    bool _veriput_concrete_return = c0.isWeekDay(uint256(58670124575040526116501196314955747946397697));
