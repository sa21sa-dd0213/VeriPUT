...
contract TestDateTimeCovTest_TestDateTime_getHour_put3p1_p1_part_part0_w_r is Test {
  TestDateTime c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 timestamp) internal {
    ...
    timestamp = bound(timestamp, 3599, 3599);
    ...
    if (p_msg_sender == address(uint160(0)) && timestamp == uint256(3599)) {
  ...
  function test_put_TestDateTime_getHour_path3p1_part_part0_w_r(address p_msg_sender, uint256 timestamp) public {
    _veriput_parameterized(p_msg_sender, timestamp);
    
    { TestDateTimeCovTest_TestDateTime_getHour_concrete3p1__basis_part0_w_r__W _veriput_w = new TestDateTimeCovTest_TestDateTime_getHour_concrete3p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract TestDateTimeCovTest_TestDateTime_getHour_concrete3p1__basis_part0_w_r__W is Test {
  TestDateTime c0;
  function setUp() public {
    c0 = new TestDateTime();
  }
  ...
  function _w_test_cov_0() public {
    ...
    uint256 _veriput_concrete_return = c0.getHour(uint256(3599));
