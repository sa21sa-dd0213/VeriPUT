...
contract TestDateTimeCovTest_TestDateTime_isWeekEnd_put3p1_p1_part_part0_r_r is Test {
  TestDateTime c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 timestamp) internal {
    ...
    timestamp = bound(timestamp, 0, 29335015023984634360564457201805879715214080);
    ...
    if (p_msg_sender == address(uint160(0)) && timestamp == uint256(29335015023984634360564457201805879715214080)) {
  ...
  function test_put_TestDateTime_isWeekEnd_path3p1_part_part0_r_r(address p_msg_sender, uint256 timestamp) public {
    _veriput_parameterized(p_msg_sender, timestamp);
    
    { TestDateTimeCovTest_TestDateTime_isWeekEnd_concrete3p1__basis_part0_r_r__W _veriput_w = new TestDateTimeCovTest_TestDateTime_isWeekEnd_concrete3p1__basis_part0_r_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract TestDateTimeCovTest_TestDateTime_isWeekEnd_concrete3p1__basis_part0_r_r__W is Test {
  TestDateTime c0;
  function setUp() public {
    c0 = new TestDateTime();
  }
  ...
  function _w_test_cov_0() public {
    ...
    bool _veriput_concrete_return = c0.isWeekEnd(uint256(29335015023984634360564457201805879715214080));
