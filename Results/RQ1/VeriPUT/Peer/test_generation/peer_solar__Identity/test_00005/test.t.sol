...
contract IdentityCovTest_0_Identity_addPermission_put25p1 is Test {
  ...
  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@Identity@F@addPermission#118:path:25   depth=4
  ...
  //   path guard DROPPED: 'return_value$_hasPermission$2' (`return_value$_hasPermission$2` is not nameable in this PUT)
