...
contract IdentityCovTest_Identity_hasPermission_put2p1 is Test {
  Identity c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address caller) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("hasPermission(address)", caller));
  ...
  function test_put_Identity_hasPermission_path2p1(address p_msg_sender, uint256 p_msg_value, address caller) public {
