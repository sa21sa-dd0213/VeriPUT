...
contract SecureAuctionCovTest_SecureAuction_bid_put2p1_p1_part_part0_w_w is Test {
  SecureAuction c0;
  ...
  function test_put_SecureAuction_bid_path2p1_part_part0_w_w(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { SecureAuctionCovTest_SecureAuction_bid_concrete2p1__basis_part0_w_w__W _veriput_w = new SecureAuctionCovTest_SecureAuction_bid_concrete2p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract SecureAuctionCovTest_SecureAuction_bid_concrete2p1__basis_part0_w_w__W is Test {
  SecureAuction c0;
  function setUp() public {
    c0 = new SecureAuction();
  }
