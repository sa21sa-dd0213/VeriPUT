...
contract SecureAuctionCovTest_SecureAuction_withdraw_put2p1 is Test {
  SecureAuction c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value) internal {
    ...
    assertGe(_post_refunds_msg_sender, _pre_refunds_msg_sender, "refunds[msg.sender]: post >= pre");
    assertLe(_post_refunds_msg_sender, _pre_refunds_msg_sender, "refunds[msg.sender]: post <= pre");
  ...
  function test_put_SecureAuction_withdraw_path2p1(address p_msg_sender, uint256 p_msg_value) public {
