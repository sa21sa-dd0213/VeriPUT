...
contract SecureAuctionCovTest_SecureAuction_bid_put2p1_p1_part_part0_w_r is Test {
  SecureAuction c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    assertFalse(_put_ok, "path enc=2p1_part_part0_w_r exits through a REVERT: the call must fail on the unmodified contract");
  }


  
  function test_put_SecureAuction_bid_path2p1_part_part0_w_r(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { SecureAuctionCovTest_SecureAuction_bid_concrete2p1__basis_part0_w_r__W _veriput_w = new SecureAuctionCovTest_SecureAuction_bid_concrete2p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract SecureAuctionCovTest_SecureAuction_bid_concrete2p1__basis_part0_w_r__W is Test {
  SecureAuction c0;
  function setUp() public {
    c0 = new SecureAuction();
  }
