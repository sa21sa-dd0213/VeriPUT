...
contract ChinaCoinCovTest_ChinaCoin_setCooldownEnabled_put7p1_p1_part_part0_w_w is Test {
  ChinaCoin c0;
  ...
  function test_put_ChinaCoin_setCooldownEnabled_path7p1_part_part0_w_w(address p_msg_sender, bool onoff) public {
    _veriput_parameterized(p_msg_sender, onoff);
    
    { ChinaCoinCovTest_ChinaCoin_setCooldownEnabled_concrete7p1__basis_part0_w_w__W _veriput_w = new ChinaCoinCovTest_ChinaCoin_setCooldownEnabled_concrete7p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract ChinaCoinCovTest_ChinaCoin_setCooldownEnabled_concrete7p1__basis_part0_w_w__W is Test {
  ChinaCoin c0;
  function setUp() public {
    c0 = new ChinaCoin();
  }
