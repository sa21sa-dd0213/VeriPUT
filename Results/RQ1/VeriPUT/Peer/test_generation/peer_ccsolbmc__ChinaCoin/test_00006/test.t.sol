...
contract ChinaCoinCovTest_ChinaCoin_openTrading_put6p1 is Test {
  ...
  // claim: sol:@C@ChinaCoin@F@openTrading#1036:path:63
  // witness-fingerprint-sha256: f9474e94e833a83cd3356859d6095cd96df0d9c581cd63df03e78efc20d0cca2
  // claim: sol:@C@ChinaCoin@F@openTrading#1036:path:6
  // witness-fingerprint-sha256: 26c74682af95e29f4cf540da2d51da68b3ef0ce9a4e30e71bf05fb3c6e84c7fb
  // claim: sol:@C@ChinaCoin@F@openTrading#1036:path:2
  // witness-fingerprint-sha256: d923cb6712d4f29c364986905a08d0a6e4d2618928c59ab894c1d3a6ade5203a

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@ChinaCoin@F@openTrading#1036:path:6   depth=2
  ...
  function _veriput_parameterized(address p_msg_sender, uint8 s_tradingOpen) internal {
    ...
    //   state._owner$173 := 0; state.tradingOpen := s_tradingOpen in [0, 1] (SET and FUZZED: freed at the certification entry)
    {
