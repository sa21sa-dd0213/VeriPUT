...
contract DigitalLockerCovTest_DigitalLocker_BeginReviewProcess_put7p1_p1_part_part0_w_w is Test {
  DigitalLocker c0;
  ...
  function test_put_DigitalLocker_BeginReviewProcess_path7p1_part_part0_w_w(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { DigitalLockerCovTest_DigitalLocker_BeginReviewProcess_concrete7p1__basis_part0_w_w__W _veriput_w = new DigitalLockerCovTest_DigitalLocker_BeginReviewProcess_concrete7p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract DigitalLockerCovTest_DigitalLocker_BeginReviewProcess_concrete7p1__basis_part0_w_w__W is Test {
  DigitalLocker c0;
  function setUp() public {
    c0 = new DigitalLocker();
  }
  ...
  function _w_test_cov_0() public {
    ...
    assertEq(_veriput_fixed_state_BankAgent_0, uint256(1), "fixed witness state");
