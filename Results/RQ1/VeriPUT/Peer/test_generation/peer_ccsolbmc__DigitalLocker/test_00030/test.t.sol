...
contract DigitalLockerCovTest_DigitalLocker_UploadDocuments_put2p1 is Test {
  ...
  // claim: sol:@C@DigitalLocker@F@UploadDocuments#148:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@DigitalLocker@F@UploadDocuments#148:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, lockerIdentifier, image
