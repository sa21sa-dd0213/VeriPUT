...
contract DigitalLockerCovTest_DigitalLocker_RequestLockerAccess_put7p1_p1_part_part0_w_w is Test {
  DigitalLocker c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    p_msg_sender = address(uint160(bound(uint256(uint160(p_msg_sender)), 1, 2147483646)));
    ...
    if (p_msg_sender == address(uint160(1))) {
      ...
      assertEq((uint256(vm.load(address(c0), bytes32(uint256(7)))) & 1461501637330902918203684832716283019655932542975), uint256(1), "fixed witness state");
    }
  ...
  function test_put_DigitalLocker_RequestLockerAccess_path7p1_part_part0_w_w(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { DigitalLockerCovTest_DigitalLocker_RequestLockerAccess_concrete7p1__basis_part0_w_w__W _veriput_w = new DigitalLockerCovTest_DigitalLocker_RequestLockerAccess_concrete7p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract DigitalLockerCovTest_DigitalLocker_RequestLockerAccess_concrete7p1__basis_part0_w_w__W is Test {
  DigitalLocker c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new DigitalLocker();
  ...
  function _w_test_cov_0() public {
    ...
    assertEq(_veriput_fixed_state_ThirdPartyRequestor_4, uint256(1), "fixed witness state");
  }
}
