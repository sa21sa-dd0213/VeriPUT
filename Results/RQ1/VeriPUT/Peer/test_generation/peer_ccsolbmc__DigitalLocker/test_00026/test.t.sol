...
contract DigitalLockerCovTest_DigitalLocker_ShareWithThirdParty_put6p1 is Test {
  ...
  // claim: sol:@C@DigitalLocker@F@ShareWithThirdParty#192:path:7
  // witness-fingerprint-sha256: e2a366a93589744ebd12adf922773ce10a4ad7e182c57dcc7c00a27966d47ad7
  // claim: sol:@C@DigitalLocker@F@ShareWithThirdParty#192:path:2, sol:@C@DigitalLocker@F@ShareWithThirdParty#192:path:6
  // witness-fingerprint-sha256: 6d5845951d5ec608c8434a1f46a0c22c3a793c6b2426424cb4c567492901a8c7

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@DigitalLocker@F@ShareWithThirdParty#192:path:6   depth=2
  ...
  //   thirdPartyRequestor in [0, 1461501637330902918203684832716283019655932542975]
  //   PIN block.basefee == 0
  ...
  // FUZZ COORDINATES: msg.sender, thirdPartyRequestor, expirationDate, intendedPurpose
