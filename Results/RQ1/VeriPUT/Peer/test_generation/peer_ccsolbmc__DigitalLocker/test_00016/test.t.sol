...
contract DigitalLockerCovTest_DigitalLocker_ReleaseLockerAccess_put6p1 is Test {
  DigitalLocker c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    bool _put_ok = true;
    try c0.ReleaseLockerAccess() {} catch { _put_ok = false; }
  ...
  function test_put_DigitalLocker_ReleaseLockerAccess_path6p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { DigitalLockerCovTest_DigitalLocker_ReleaseLockerAccess_concrete6p1__basis_root__W _veriput_w = new DigitalLockerCovTest_DigitalLocker_ReleaseLockerAccess_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract DigitalLockerCovTest_DigitalLocker_ReleaseLockerAccess_concrete6p1__basis_root__W is Test {
  DigitalLocker c0;
  function setUp() public {
    c0 = new DigitalLocker();
  }
