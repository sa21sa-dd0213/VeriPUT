...
contract DigitalLockerCovTest_DigitalLocker_RejectApplication_put7p1_p1_part_part0_w is Test {
  DigitalLocker c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    assertEq((uint256(vm.load(address(c0), bytes32(uint256(1)))) & 1461501637330902918203684832716283019655932542975), uint256(uint256(uint160(p_msg_sender))), "entry pin state.BankAgent did NOT land: vm.store wrote a word the contract does not read back at this slot, so the test is not inside the certified region and every rung below is about a different state");
    ...
    vm.assume(_pre_BankAgent == uint256(uint160(p_msg_sender)));
    ...
    assertGe(_post_BankAgent, 0, "BankAgent: post in [0, pre]");
    assertLe(_post_BankAgent, _pre_BankAgent, "BankAgent: post in [0, pre]");
    assertGe(_post_BankAgent, 0, "BankAgent: post in [0, (pre + pre)]");
    unchecked { assertLe(_post_BankAgent, (uint256(_pre_BankAgent) + uint256(_pre_BankAgent)), "BankAgent: post in [0, (pre + pre)]"); }
    assertGe(_post_BankAgent, 0, "BankAgent: post in [0, (pre * pre)]");
    unchecked { assertLe(_post_BankAgent, (uint256(_pre_BankAgent) * uint256(_pre_BankAgent)), "BankAgent: post in [0, (pre * pre)]"); }
    assertGe(_post_BankAgent, 0, "BankAgent: post in [0, (msg.value + 1461501637330902918203684832716283019655932542975)]");
    unchecked { assertLe(_post_BankAgent, (uint256(0) + uint256(1461501637330902918203684832716283019655932542975)), "BankAgent: post in [0, (msg.value + 1461501637330902918203684832716283019655932542975)]"); }
    
  }


  
  function test_put_DigitalLocker_RejectApplication_path7p1_part_part0_w(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { DigitalLockerCovTest_DigitalLocker_RejectApplication_concrete7p1__basis_part0_w__W _veriput_w = new DigitalLockerCovTest_DigitalLocker_RejectApplication_concrete7p1__basis_part0_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract DigitalLockerCovTest_DigitalLocker_RejectApplication_concrete7p1__basis_part0_w__W is Test {
  DigitalLocker c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new DigitalLocker();
  ...
  function _w_test_cov_0() public {
    ...
    try c0.RejectApplication("") {} catch {}
