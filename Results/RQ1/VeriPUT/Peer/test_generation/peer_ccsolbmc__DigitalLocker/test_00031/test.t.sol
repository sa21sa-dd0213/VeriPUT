...
contract DigitalLockerCovTest_DigitalLocker_UploadDocuments_put6p1 is Test {
  DigitalLocker c0;
  ...
  function _veriput_parameterized(address p_msg_sender, string memory lockerIdentifier, string memory image) internal {
    ...
    bool _put_ok = true;
    try c0.UploadDocuments(lockerIdentifier, image) {} catch { _put_ok = false; }
  ...
  function test_put_DigitalLocker_UploadDocuments_path6p1(address p_msg_sender, string memory lockerIdentifier, string memory image) public {
    _veriput_parameterized(p_msg_sender, lockerIdentifier, image);
    
    { DigitalLockerCovTest_DigitalLocker_UploadDocuments_concrete6p1__basis_root__W _veriput_w = new DigitalLockerCovTest_DigitalLocker_UploadDocuments_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract DigitalLockerCovTest_DigitalLocker_UploadDocuments_concrete6p1__basis_root__W is Test {
  DigitalLocker c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new DigitalLocker();
