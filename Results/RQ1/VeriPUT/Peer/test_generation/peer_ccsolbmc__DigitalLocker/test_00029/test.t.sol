...
contract DigitalLockerCovTest_DigitalLocker_Terminate_put7p1_p1_part_part0_w is Test {
  DigitalLocker c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    if (p_msg_sender == address(uint160(0))) {
      ...
      assertEq((uint256(vm.load(address(c0), bytes32(uint256(11)))) & 255), uint256(5), "fixed witness state");
    ...
    assertEq(_post_State, 5, "State: post == 5");
  ...
  function test_put_DigitalLocker_Terminate_path7p1_part_part0_w(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { DigitalLockerCovTest_DigitalLocker_Terminate_concrete7p1__basis_part0_w__W _veriput_w = new DigitalLockerCovTest_DigitalLocker_Terminate_concrete7p1__basis_part0_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract DigitalLockerCovTest_DigitalLocker_Terminate_concrete7p1__basis_part0_w__W is Test {
  DigitalLocker c0;
  function setUp() public {
    c0 = new DigitalLocker();
  }
  ...
  function _w_test_cov_0() public {
    ...
    assertEq(_veriput_fixed_state_State_3, uint256(5), "fixed witness state");
