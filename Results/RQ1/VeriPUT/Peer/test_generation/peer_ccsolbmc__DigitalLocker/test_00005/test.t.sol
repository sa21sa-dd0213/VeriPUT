...
contract DigitalLockerCovTest_DigitalLocker_BeginReviewProcess_put6p1 is Test {
  ...
  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@DigitalLocker@F@BeginReviewProcess#86:path:6   depth=2
  ...
  //   state.BankAgent in [0, 1461501637330902918203684832716283019655932542975]
  //   PIN block.basefee == 0
