...
contract DigitalLockerCovTest_DigitalLocker_UploadDocuments_put7p1_p1_part_part0_w is Test {
  DigitalLocker c0;
  ...
  function test_put_DigitalLocker_UploadDocuments_path7p1_part_part0_w(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { DigitalLockerCovTest_DigitalLocker_UploadDocuments_concrete7p1__basis_part0_w__W _veriput_w = new DigitalLockerCovTest_DigitalLocker_UploadDocuments_concrete7p1__basis_part0_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract DigitalLockerCovTest_DigitalLocker_UploadDocuments_concrete7p1__basis_part0_w__W is Test {
  DigitalLocker c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new DigitalLocker();
