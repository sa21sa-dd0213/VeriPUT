...
contract DigitalLockerCovTest_DigitalLocker_AcceptSharingRequest_put7p1_p1_part_part0_w is Test {
  DigitalLocker c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    if (p_msg_sender == address(uint160(0))) {
      ...
      assertEq((uint256(vm.load(address(c0), bytes32(uint256(11)))) & 255), uint256(4), "fixed witness state");
    ...
    assertEq(_post_CurrentAuthorizedUser, _pre_ThirdPartyRequestor, "CurrentAuthorizedUser: post == state.ThirdPartyRequestor");
    assertEq(_post_State, 4, "State: post == 4");
    ...
    assertEq(_post_ThirdPartyRequestor, _pre_ThirdPartyRequestor, "ThirdPartyRequestor: post == state.ThirdPartyRequestor");
    assertGe(_post_ThirdPartyRequestor, 0, "ThirdPartyRequestor: post in [0, pre]");
    assertLe(_post_ThirdPartyRequestor, _pre_ThirdPartyRequestor, "ThirdPartyRequestor: post in [0, pre]");
    assertGe(_post_ThirdPartyRequestor, 0, "ThirdPartyRequestor: post in [0, (msg.value + 1461501637330902918203684832716283019655932542975)]");
    unchecked { assertLe(_post_ThirdPartyRequestor, (uint256(0) + uint256(1461501637330902918203684832716283019655932542975)), "ThirdPartyRequestor: post in [0, (msg.value + 1461501637330902918203684832716283019655932542975)]"); }
    
  }


  
  function test_put_DigitalLocker_AcceptSharingRequest_path7p1_part_part0_w(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { DigitalLockerCovTest_DigitalLocker_AcceptSharingRequest_concrete7p1__basis_part0_w__W _veriput_w = new DigitalLockerCovTest_DigitalLocker_AcceptSharingRequest_concrete7p1__basis_part0_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract DigitalLockerCovTest_DigitalLocker_AcceptSharingRequest_concrete7p1__basis_part0_w__W is Test {
  DigitalLocker c0;
  function setUp() public {
    c0 = new DigitalLocker();
  }
  ...
  function _w_test_cov_0() public {
    ...
    assertEq(_veriput_fixed_state_State_3, uint256(4), "fixed witness state");
