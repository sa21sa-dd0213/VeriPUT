...
contract Arcadia_TokenCovTest_Arcadia_Token_allowance_put3p1 is Test {
  ...
  // claim: sol:@C@Arcadia_Token@F@allowance#713:path:3
  // witness-fingerprint-sha256: c8c1afb518bf7ae2abf2f207df4605f802f4853f69c8d1110bbe828186a595dd
  // claim: sol:@C@Arcadia_Token@F@allowance#713:path:2
  // witness-fingerprint-sha256: 1c49a4dfa5dc52f4a667629f46c3e42535dafed5bb2b945d8fc62d35a4c8afe9

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@Arcadia_Token@F@allowance#713:path:3   depth=1
  ...
  //   rung IMPLIED (not lost, not asserted twice): _allowances[owner][spender]: post >= pre (entailed by a stronger rung that also HOLDS on _allowances[owner][spender], so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): _allowances[owner][spender]: post <= pre (entailed by a stronger rung that also HOLDS on _allowances[owner][spender], so asserting it detects nothing the stronger one misses)
