...
contract Arcadia_TokenCovTest_Arcadia_Token_isExcluded_put2p1 is Test {
  Arcadia_Token c0;
  ...
  function test_put_Arcadia_Token_isExcluded_path2p1(address p_msg_sender, uint256 p_msg_value, address account) public {
