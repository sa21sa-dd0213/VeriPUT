...
contract AnimaliaCovTest_Animalia_reflectionFromToken_put14p1 is Test {
  Animalia c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 tAmount, bool deductTransferFee) internal {
    ...
    tAmount = bound(tAmount, 0, 1000000000000000000000000000000000);
    ...
    if (p_msg_sender == address(uint160(0)) && tAmount == uint256(512755775575375820767211489853440) && deductTransferFee == false) {
  ...
  function test_put_Animalia_reflectionFromToken_path14p1(address p_msg_sender, uint256 tAmount, bool deductTransferFee) public {
    _veriput_parameterized(p_msg_sender, tAmount, deductTransferFee);
    
    { AnimaliaCovTest_Animalia_reflectionFromToken_concrete14p1__basis_root__W _veriput_w = new AnimaliaCovTest_Animalia_reflectionFromToken_concrete14p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract AnimaliaCovTest_Animalia_reflectionFromToken_concrete14p1__basis_root__W is Test {
  Animalia c0;
  function setUp() public {
    c0 = new Animalia();
  }
  ...
  function _w_test_cov_1() public {
    ...
    uint256 _veriput_concrete_return = c0.reflectionFromToken(uint256(512755775575375820767211489853440), false);
