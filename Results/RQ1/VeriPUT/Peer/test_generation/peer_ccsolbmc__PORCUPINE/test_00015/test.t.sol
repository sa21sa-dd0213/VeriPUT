...
contract PORCUPINECovTest_PORCUPINE_reflectionFromToken_put15p1 is Test {
  PORCUPINE c0;
  ...
  function test_put_PORCUPINE_reflectionFromToken_path15p1(address p_msg_sender, uint256 tAmount, bool deductTransferFee) public {
    _veriput_parameterized(p_msg_sender, tAmount, deductTransferFee);
    
    { PORCUPINECovTest_PORCUPINE_reflectionFromToken_concrete15p1__basis_root__W _veriput_w = new PORCUPINECovTest_PORCUPINE_reflectionFromToken_concrete15p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract PORCUPINECovTest_PORCUPINE_reflectionFromToken_concrete15p1__basis_root__W is Test {
  PORCUPINE c0;
  function setUp() public {
    c0 = new PORCUPINE();
  }
