...
contract PORCUPINECovTest_PORCUPINE_reflectionFromToken_put6p1_p1_part_part0_r is Test {
  PORCUPINE c0;
  ...
  function test_put_PORCUPINE_reflectionFromToken_path6p1_part_part0_r(address p_msg_sender, uint256 tAmount, bool deductTransferFee) public {
    _veriput_parameterized(p_msg_sender, tAmount, deductTransferFee);
    
    { PORCUPINECovTest_PORCUPINE_reflectionFromToken_concrete6p1__basis_part0_r__W _veriput_w = new PORCUPINECovTest_PORCUPINE_reflectionFromToken_concrete6p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PORCUPINECovTest_PORCUPINE_reflectionFromToken_concrete6p1__basis_part0_r__W is Test {
  PORCUPINE c0;
  function setUp() public {
    c0 = new PORCUPINE();
  }
