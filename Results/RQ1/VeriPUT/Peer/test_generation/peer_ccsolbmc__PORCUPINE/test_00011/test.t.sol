...
contract PORCUPINECovTest_PORCUPINE_isExcluded_put3p1 is Test {
  PORCUPINE c0;
  ...
  function test_put_PORCUPINE_isExcluded_path3p1(address p_msg_sender, address account) public {
    _veriput_parameterized(p_msg_sender, account);
    
    { PORCUPINECovTest_PORCUPINE_isExcluded_concrete3p1__basis_root__W _veriput_w = new PORCUPINECovTest_PORCUPINE_isExcluded_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PORCUPINECovTest_PORCUPINE_isExcluded_concrete3p1__basis_root__W is Test {
  PORCUPINE c0;
  function setUp() public {
    c0 = new PORCUPINE();
  }
