...
contract PORCUPINECovTest_PORCUPINE_includeAccount_put2p1 is Test {
  ...
  // claim: sol:@C@PORCUPINE@F@includeAccount#988:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@PORCUPINE@F@includeAccount#988:path:2   depth=1
  ...
  //   level0 = True
  //   level0_perturb = True
  //   level0_points = {'14': 'state._isExcluded$514[account]==0', '6': '(none)'}
  //   max_holes = 3
  //   max_region_pieces = 4
  //   max_tx = 1
  //   probe_ladder = True
