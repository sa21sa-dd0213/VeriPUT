...
contract PORCUPINECovTest_PORCUPINE_reflectionFromToken_put14p1 is Test {
  PORCUPINE c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 tAmount, bool deductTransferFee) internal {
    ...
    if (p_msg_sender == address(uint160(0)) && tAmount == uint256(501377107476480) && deductTransferFee == false) {
  ...
  function test_put_PORCUPINE_reflectionFromToken_path14p1(address p_msg_sender, uint256 tAmount, bool deductTransferFee) public {
    _veriput_parameterized(p_msg_sender, tAmount, deductTransferFee);
    
    { PORCUPINECovTest_PORCUPINE_reflectionFromToken_concrete14p1__basis_root__W _veriput_w = new PORCUPINECovTest_PORCUPINE_reflectionFromToken_concrete14p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract PORCUPINECovTest_PORCUPINE_reflectionFromToken_concrete14p1__basis_root__W is Test {
  PORCUPINE c0;
  function setUp() public {
    c0 = new PORCUPINE();
  }
  ...
  function _w_test_cov_1() public {
    ...
    uint256 _veriput_concrete_return = c0.reflectionFromToken(uint256(501377107476480), false);
