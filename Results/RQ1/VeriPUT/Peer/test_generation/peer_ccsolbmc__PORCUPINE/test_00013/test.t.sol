...
contract PORCUPINECovTest_PORCUPINE_owner_put3p1 is Test {
  PORCUPINE c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    assertEq(_post_owner, _pre_owner_392, "_owner: post == state._owner$392");
  ...
  function test_put_PORCUPINE_owner_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { PORCUPINECovTest_PORCUPINE_owner_concrete3p1__basis_root__W _veriput_w = new PORCUPINECovTest_PORCUPINE_owner_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PORCUPINECovTest_PORCUPINE_owner_concrete3p1__basis_root__W is Test {
  PORCUPINE c0;
  function setUp() public {
    c0 = new PORCUPINE();
  }
