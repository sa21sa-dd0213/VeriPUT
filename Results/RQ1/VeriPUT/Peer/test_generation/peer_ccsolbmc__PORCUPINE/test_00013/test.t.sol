...
contract PORCUPINECovTest_PORCUPINE_owner_put3p1 is Test {
  ...
  // claim: sol:@C@PORCUPINE@F@owner#425:path:3
  // witness-fingerprint-sha256: 2d6cd0272e5f0178c3b60df10e4dde4685647ecf6e8028c15a152a4765d0a247
  // claim: sol:@C@PORCUPINE@F@owner#425:path:2
  // witness-fingerprint-sha256: 0e6ee337b3e2648b2cbb76a8371986e1c76a6876a041c027a6355fcf7f9b80c0

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@PORCUPINE@F@owner#425:path:3   depth=1
  ...
  //   state._owner$392 in [0, 1461501637330902918203684832716283019655932542975]
  //   PIN block.basefee == 0
  ...
  //   rung DROPPED: return: return == state._owner$392 (rung shape not renderable for its declared type)
