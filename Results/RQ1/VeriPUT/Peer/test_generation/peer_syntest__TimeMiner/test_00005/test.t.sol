...
contract TimeMinerCovTest_TimeMiner_balanceOf_put3p1_p1_part_part0_r_r is Test {
  TimeMiner c0;
  ...
  function test_put_TimeMiner_balanceOf_path3p1_part_part0_r_r(address p_msg_sender, address _user) public {
    _veriput_parameterized(p_msg_sender, _user);
    
    { TimeMinerCovTest_TimeMiner_balanceOf_concrete3p1__basis_part0_r_r__W _veriput_w = new TimeMinerCovTest_TimeMiner_balanceOf_concrete3p1__basis_part0_r_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract TimeMinerCovTest_TimeMiner_balanceOf_concrete3p1__basis_part0_r_r__W is Test {
  TimeMiner c0;
  function setUp() public {
    vm.warp(1);
    vm.startPrank(address(uint160(1)), address(uint160(1)));
  ...
  function _w_test_cov_0() public {
    ...
    uint256 _veriput_concrete_return = c0.balanceOf(address(uint160(730750818665451459101842416358141509827966271489)));
