...
contract TimeMinerCovTest_TimeMiner_setStableCoinSystem_put2p1 is Test {
  TimeMiner c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, bool _stableCoinSystem) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("setStableCoinSystem(bool)", _stableCoinSystem));
  ...
  function test_put_TimeMiner_setStableCoinSystem_path2p1(address p_msg_sender, uint256 p_msg_value, bool _stableCoinSystem) public {
    _veriput_parameterized(p_msg_sender, p_msg_value, _stableCoinSystem);
  }
}
