...
contract TimeMinerCovTest_TimeMiner_setStableCoinSystem_put2p1 is Test {
  ...
  // claim: sol:@C@TimeMiner@F@setStableCoinSystem#652:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@TimeMiner@F@setStableCoinSystem#652:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, _stableCoinSystem
