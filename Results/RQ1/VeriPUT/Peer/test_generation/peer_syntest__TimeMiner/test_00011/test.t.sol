...
contract TimeMinerCovTest_TimeMiner_balanceOfTokenCirculation_put3p1_p1_part_part0_w is Test {
  TimeMiner c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address _user) internal {
    ...
    _user = address(uint160(bound(uint256(uint160(_user)), 0, 0)));
    ...
    if (p_msg_sender == address(uint160(0)) && _user == address(uint160(0))) {
  ...
  function test_put_TimeMiner_balanceOfTokenCirculation_path3p1_part_part0_w(address p_msg_sender, address _user) public {
    _veriput_parameterized(p_msg_sender, _user);
    
    { TimeMinerCovTest_TimeMiner_balanceOfTokenCirculation_concrete3p1__basis_part0_w__W _veriput_w = new TimeMinerCovTest_TimeMiner_balanceOfTokenCirculation_concrete3p1__basis_part0_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract TimeMinerCovTest_TimeMiner_balanceOfTokenCirculation_concrete3p1__basis_part0_w__W is Test {
  TimeMiner c0;
  function setUp() public {
    vm.warp(1);
    vm.startPrank(address(uint160(1)), address(uint160(1)));
  ...
  function _w_test_cov_0() public {
    ...
    uint256 _veriput_concrete_return = c0.balanceOfTokenCirculation(address(uint160(0)));
