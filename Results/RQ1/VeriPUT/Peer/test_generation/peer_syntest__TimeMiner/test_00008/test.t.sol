...
contract TimeMinerCovTest_TimeMiner_balanceOfTokenCirculation_put2p1 is Test {
  TimeMiner c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address _user) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("balanceOfTokenCirculation(address)", _user));
  ...
  function test_put_TimeMiner_balanceOfTokenCirculation_path2p1(address p_msg_sender, uint256 p_msg_value, address _user) public {
