...
contract TimeMinerCovTest_TimeMiner_isWhitelisted_put3p1_p1_part_part0_w is Test {
  TimeMiner c0;
  ...
  function test_put_TimeMiner_isWhitelisted_path3p1_part_part0_w(address p_msg_sender, address _user) public {
    _veriput_parameterized(p_msg_sender, _user);
    
    { TimeMinerCovTest_TimeMiner_isWhitelisted_concrete3p1__basis_part0_w__W _veriput_w = new TimeMinerCovTest_TimeMiner_isWhitelisted_concrete3p1__basis_part0_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract TimeMinerCovTest_TimeMiner_isWhitelisted_concrete3p1__basis_part0_w__W is Test {
  TimeMiner c0;
  function setUp() public {
    vm.warp(1);
    vm.startPrank(address(uint160(1)), address(uint160(1)));
  ...
  function _w_test_cov_0() public {
    ...
    bool _veriput_concrete_return = c0.isWhitelisted(address(uint160(0)));
