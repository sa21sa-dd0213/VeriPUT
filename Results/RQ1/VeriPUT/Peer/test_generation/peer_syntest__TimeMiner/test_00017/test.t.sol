...
contract TimeMinerCovTest_TimeMiner_setPrizeFromNewAddress_put2p1 is Test {
  TimeMiner c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, uint256 _supplydivision, uint256 _supplymultiply) internal {
    p_msg_sender = address(uint160(bound(uint256(uint160(p_msg_sender)), 1, 1461501637330902918203684832716283019655932542975)));
    p_msg_value = bound(p_msg_value, 1, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
    _supplydivision = bound(_supplydivision, 0, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
    _supplymultiply = bound(_supplymultiply, 0, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("setPrizeFromNewAddress(uint256,uint256)", _supplydivision, _supplymultiply));
  ...
  function test_put_TimeMiner_setPrizeFromNewAddress_path2p1(address p_msg_sender, uint256 p_msg_value, uint256 _supplydivision, uint256 _supplymultiply) public {
    _veriput_parameterized(p_msg_sender, p_msg_value, _supplydivision, _supplymultiply);
  }
}
