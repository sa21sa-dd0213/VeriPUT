...
contract TokenVestingCovTest_TokenVesting_permit_issuer_put14p1 is Test {
  TokenVesting c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address issuer, uint256 amount) internal {
    ...
    assertEq((uint256(vm.load(address(c0), bytes32(uint256(0)))) & 1461501637330902918203684832716283019655932542975), uint256(uint256(uint160(p_msg_sender))), "entry pin state.controller did NOT land: vm.store wrote a word the contract does not read back at this slot, so the test is not inside the certified region and every rung below is about a different state");
    ...
    if (p_msg_sender == address(uint160(0)) && issuer == address(uint160(1461501637330902918203684832716283019655932542975)) && amount == uint256(0)) {
  ...
  function test_put_TokenVesting_permit_issuer_path14p1(address p_msg_sender, address issuer, uint256 amount) public {
    _veriput_parameterized(p_msg_sender, issuer, amount);
    
    { TokenVestingCovTest_TokenVesting_permit_issuer_concrete14p1__basis_root__W _veriput_w = new TokenVestingCovTest_TokenVesting_permit_issuer_concrete14p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract TokenVestingCovTest_TokenVesting_permit_issuer_concrete14p1__basis_root__W is Test {
  TokenVesting c0;
  function setUp() public {
    c0 = new TokenVesting();
  }
  ...
  function _w_test_cov_2() public {
    ...
    try c0.permit_issuer(address(uint160(1461501637330902918203684832716283019655932542975)), uint256(0)) {
