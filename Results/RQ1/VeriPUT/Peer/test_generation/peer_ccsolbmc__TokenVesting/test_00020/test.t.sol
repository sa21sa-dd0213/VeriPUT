...
contract TokenVestingCovTest_TokenVesting_user_total_all_tranches_put2p1 is Test {
  ...
  // claim: sol:@C@TokenVesting@F@user_total_all_tranches#729:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@TokenVesting@F@user_total_all_tranches#729:path:2   depth=1
  ...
  //   level0 = True
  //   level0_perturb = True
  //   level0_points = {'13': 'state.address_migration$150[user]==0, state.v1_migrated$129[user]==0'}
  //   max_holes = 3
  //   max_region_pieces = 4
  //   max_tx = 1
  //   probe_ladder = True
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, user
