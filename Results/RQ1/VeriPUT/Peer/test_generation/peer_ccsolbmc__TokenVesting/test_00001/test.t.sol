...
contract TokenVestingCovTest_TokenVesting_get_tranche_balance_put2p1 is Test {
  ...
  // claim: sol:@C@TokenVesting@F@get_tranche_balance#564:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@TokenVesting@F@get_tranche_balance#564:path:2   depth=1
  ...
  //   level0 = True
  //   level0_perturb = True
  //   level0_points = {'25': 'state.address_migration$150[user]==0, state.v1_migrated$129[user]==0, tranche_id==0', '7': '(none)'}
  //   max_holes = 3
  //   max_region_pieces = 4
  //   max_tx = 1
  //   probe_ladder = True
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, user, tranche_id
  // ORACLE: rollback exit plus 37 restored post-state frame assertion(s).
  ...
  // 26 snapshot local(s) HOISTED to storage: 4 fuzz parameter(s) + 26 snapshot local(s) exceed the 12-slot budget (solc stack reach); the reads and every assertion are unchanged
  ...
  uint256 _pre_user_stats_state_controller__total_in_all_tranches; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_user_stats_state_v1_address__total_in_all_tranches; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_user_stats_state_v2_address__total_in_all_tranches; // VERIPUT_HOISTED_SNAPSHOT
  ...
  uint256 _post_user_stats_state_controller__total_in_all_tranches; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_user_stats_state_v1_address__total_in_all_tranches; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_user_stats_state_v2_address__total_in_all_tranches; // VERIPUT_HOISTED_SNAPSHOT
