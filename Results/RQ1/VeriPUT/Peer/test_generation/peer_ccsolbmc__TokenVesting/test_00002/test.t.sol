...
contract TokenVestingCovTest_TokenVesting_get_vested_for_tranche_put2p1 is Test {
  ...
  // claim: sol:@C@TokenVesting@F@get_vested_for_tranche#661:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@TokenVesting@F@get_vested_for_tranche#661:path:2   depth=1
  ...
  // 24 snapshot local(s) HOISTED to storage: 4 fuzz parameter(s) + 24 snapshot local(s) exceed the 12-slot budget (solc stack reach); the reads and every assertion are unchanged
  uint256 _pre_tranches_tranche_id__cliff_start; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_tranches_tranche_id__duration; // VERIPUT_HOISTED_SNAPSHOT
  ...
  uint256 _post_tranches_tranche_id__cliff_start; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_tranches_tranche_id__duration; // VERIPUT_HOISTED_SNAPSHOT
