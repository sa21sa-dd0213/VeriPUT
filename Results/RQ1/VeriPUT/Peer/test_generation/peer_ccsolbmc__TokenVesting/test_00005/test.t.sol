...
contract TokenVestingCovTest_TokenVesting_move_into_tranche_put2p1 is Test {
  ...
  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@TokenVesting@F@move_into_tranche#523:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, user, tranche_id, amount
  ...
  // 22 snapshot local(s) HOISTED to storage: 5 fuzz parameter(s) + 22 snapshot local(s) exceed the 12-slot budget (solc stack reach); the reads and every assertion are unchanged
