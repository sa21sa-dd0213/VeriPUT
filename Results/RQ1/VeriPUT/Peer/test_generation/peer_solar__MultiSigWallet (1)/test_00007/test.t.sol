...
contract MultiSigWalletCovTest_MultiSigWallet_transferTo_put2p1 is Test {
  ...
  // claim: sol:@C@MultiSigWallet@F@transferTo#220:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@MultiSigWallet@F@transferTo#220:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, to, amount
