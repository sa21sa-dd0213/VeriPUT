...
contract MultiSigWalletCovTest_MultiSigWallet_signTransaction_put2p1 is Test {
  ...
  // claim: sol:@C@MultiSigWallet@F@signTransaction#335:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@MultiSigWallet@F@signTransaction#335:path:2   depth=1
  ...
  //   level0 = True
  //   level0_perturb = True
  //   level0_points = {'14': 'state._transactions$30[transactionId].from==0', '6': '(none)'}
  //   max_holes = 3
  //   max_region_pieces = 4
  //   max_tx = 1
  //   probe_ladder = True
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, transactionId
  ...
  uint256 _pre_transactions_transactionId__amount; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_transactions_transactionId__from; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_transactions_transactionId__signatureCount; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_transactions_transactionId__to; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_owners_msg_sender; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_owner; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_transactions_transactionId__amount; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_transactions_transactionId__from; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_transactions_transactionId__signatureCount; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_transactions_transactionId__to; // VERIPUT_HOISTED_SNAPSHOT
