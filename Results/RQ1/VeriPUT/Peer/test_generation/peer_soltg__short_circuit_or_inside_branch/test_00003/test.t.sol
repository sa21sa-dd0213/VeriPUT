...
contract cs6CovTest_cs6_g_put51p1 is Test {
  ...
  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@cs6@F@g#91:path:51   depth=5
  ...
  // ORACLE: 66 assertion(s) from the surviving (HOLDS) rungs of
  // --path-cov-assert -- 64 over POST-STATE, read through vm.load at
  ...
  //   path guard DROPPED: '!a' (contradicts the certified fixed coordinate value; the region assignment is authoritative)
