...
contract cs6CovTest_cs6_g_put51p1 is Test {
  cs6 c0;
  ...
  function _veriput_parameterized(address p_msg_sender, bool a) internal {
    ...
    unchecked { assertEq(_post_x, (uint256(100) / uint256(100)), "x: post == (100 / 100)"); }
  ...
  function test_put_cs6_g_path51p1(address p_msg_sender, bool a) public {
    _veriput_parameterized(p_msg_sender, a);
    
    { cs6CovTest_cs6_g_concrete51p1__basis_root__W _veriput_w = new cs6CovTest_cs6_g_concrete51p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract cs6CovTest_cs6_g_concrete51p1__basis_root__W is Test {
  cs6 c0;
  function setUp() public {
    c0 = new cs6();
  }
