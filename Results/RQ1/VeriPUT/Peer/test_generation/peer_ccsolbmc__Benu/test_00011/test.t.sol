...
contract BenuCovTest_Benu_balanceOf_put3p1_p1_part_part0_w_w is Test {
  Benu c0;
  ...
  function test_put_Benu_balanceOf_path3p1_part_part0_w_w(address p_msg_sender, address account) public {
    _veriput_parameterized(p_msg_sender, account);
    
    { BenuCovTest_Benu_balanceOf_concrete3p1__basis_part0_w_w__W _veriput_w = new BenuCovTest_Benu_balanceOf_concrete3p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract BenuCovTest_Benu_balanceOf_concrete3p1__basis_part0_w_w__W is Test {
  Benu c0;
  function setUp() public {
    c0 = new Benu();
  }
