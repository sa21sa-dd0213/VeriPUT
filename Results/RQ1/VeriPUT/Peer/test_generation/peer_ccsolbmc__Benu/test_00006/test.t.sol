...
contract BenuCovTest_Benu_approve_put15p1 is Test {
  Benu c0;
  ...
  function test_put_Benu_approve_path15p1(address p_msg_sender, address spender, uint256 amount) public {
    _veriput_parameterized(p_msg_sender, spender, amount);
    
    { BenuCovTest_Benu_approve_concrete15p1__basis_root__W _veriput_w = new BenuCovTest_Benu_approve_concrete15p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract BenuCovTest_Benu_approve_concrete15p1__basis_root__W is Test {
  Benu c0;
  function setUp() public {
    c0 = new Benu();
  }
  ...
  function _w_test_cov_0() public {
    ...
    uint256 _veriput_fixed_state_allowances_161_0__1_0 = uint256(vm.load(address(c0), keccak256(abi.encode(address(uint160(1)), keccak256(abi.encode(address(uint160(0)), uint256(1)))))));
    assertEq(_veriput_fixed_state_allowances_161_0__1_0, uint256(0), "fixed witness state");
