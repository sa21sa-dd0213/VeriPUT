...
contract BenuCovTest_Benu_allowance_put3p1 is Test {
  Benu c0;
  ...
  function test_put_Benu_allowance_path3p1(address p_msg_sender, address owner, address spender) public {
    _veriput_parameterized(p_msg_sender, owner, spender);
    
    { BenuCovTest_Benu_allowance_concrete3p1__basis_root__W _veriput_w = new BenuCovTest_Benu_allowance_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract BenuCovTest_Benu_allowance_concrete3p1__basis_root__W is Test {
  Benu c0;
  function setUp() public {
    c0 = new Benu();
  }
