...
contract BenuCovTest_Benu_transfer_put62p1_p1_part_part0_w_w is Test {
  Benu c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address recipient, uint256 amount) internal {
    ...
    assertFalse(_put_ok, "path enc=62p1_part_part0_w_w exits through a REVERT: the call must fail on the unmodified contract");
  }


  
  function test_put_Benu_transfer_path62p1_part_part0_w_w(address p_msg_sender, address recipient, uint256 amount) public {
    _veriput_parameterized(p_msg_sender, recipient, amount);
    
    { BenuCovTest_Benu_transfer_concrete62p1__basis_part0_w_w__W _veriput_w = new BenuCovTest_Benu_transfer_concrete62p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract BenuCovTest_Benu_transfer_concrete62p1__basis_part0_w_w__W is Test {
  Benu c0;
  function setUp() public {
    c0 = new Benu();
  }
