...
contract BenuCovTest_Benu_owner_put3p1 is Test {
  ...
  // claim: sol:@C@Benu@F@owner#64:path:3
  // witness-fingerprint-sha256: 88d6ad68b8c13c2093d74bc205d31b18eb6f6d1248868e03cf04526a6b2db94d
  // claim: sol:@C@Benu@F@owner#64:path:2
  // witness-fingerprint-sha256: 1173f29a1169c3bac1b6adebc1ec9743775b5ea4f1d1e6cb2ad502bfd29016e9

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@Benu@F@owner#64:path:3   depth=1
  ...
  //   state._owner$27 in [0, 1461501637330902918203684832716283019655932542975]
  //   PIN block.basefee == 0
  ...
  //   rung DROPPED: return: return == state._owner$27 (rung shape not renderable for its declared type)
