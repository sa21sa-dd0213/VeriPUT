...
contract BasicProvenanceCovTest_BasicProvenance_initialize_put3p1_p1_part_part0_w_r is Test {
  ...
  //   supplyChainOwner in [1461501637330902918203684832716283019655932542974, 1461501637330902918203684832716283019655932542974]
  //   PIN block.basefee == 0
  ...
  //   rung IMPLIED (not lost, not asserted twice): SupplyChainOwner: post >= pre (entailed by a stronger rung that also HOLDS on SupplyChainOwner, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): SupplyChainOwner: post != pre (entailed by a stronger rung that also HOLDS on SupplyChainOwner, so asserting it detects nothing the stronger one misses)
