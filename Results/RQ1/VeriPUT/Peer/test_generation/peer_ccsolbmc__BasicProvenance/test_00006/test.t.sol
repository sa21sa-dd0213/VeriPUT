...
contract BasicProvenanceCovTest_BasicProvenance_initialize_put3p1_p1_part_part0_w_r is Test {
  BasicProvenance c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address supplyChainOwner, address supplyChainObserver) internal {
    ...
    supplyChainOwner = address(uint160(bound(uint256(uint160(supplyChainOwner)), 1461501637330902918203684832716283019655932542974, 1461501637330902918203684832716283019655932542974)));
    ...
    if (p_msg_sender == address(uint160(0)) && supplyChainOwner == address(uint160(1461501637330902918203684832716283019655932542974)) && supplyChainObserver == address(uint160(0))) {
      ...
      assertEq((uint256(vm.load(address(c0), bytes32(uint256(3)))) & 1461501637330902918203684832716283019655932542975), uint256(1461501637330902918203684832716283019655932542974), "fixed witness state");
    }
  ...
  function test_put_BasicProvenance_initialize_path3p1_part_part0_w_r(address p_msg_sender, address supplyChainOwner, address supplyChainObserver) public {
    _veriput_parameterized(p_msg_sender, supplyChainOwner, supplyChainObserver);
    
    { BasicProvenanceCovTest_BasicProvenance_initialize_concrete3p1__basis_part0_w_r__W _veriput_w = new BasicProvenanceCovTest_BasicProvenance_initialize_concrete3p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract BasicProvenanceCovTest_BasicProvenance_initialize_concrete3p1__basis_part0_w_r__W is Test {
  BasicProvenance c0;
  function setUp() public {
    c0 = new BasicProvenance();
  }
  ...
  function _w_test_cov_0() public {
    ...
    assertEq(_veriput_fixed_state_SupplyChainOwner_5, uint256(1461501637330902918203684832716283019655932542974), "fixed witness state");
  }
