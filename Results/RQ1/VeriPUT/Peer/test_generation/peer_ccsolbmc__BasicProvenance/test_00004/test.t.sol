...
contract BasicProvenanceCovTest_BasicProvenance_initialize_put3p1_p1_part_part0_r_r is Test {
  ...
  //   supplyChainObserver in [1461501637330902918203684832716283019655932542975, 1461501637330902918203684832716283019655932542975]
  ...
  //   rung IMPLIED (not lost, not asserted twice): SupplyChainObserver: post >= pre (entailed by a stronger rung that also HOLDS on SupplyChainObserver, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): SupplyChainOwner: post != pre (entailed by a stronger rung that also HOLDS on SupplyChainOwner, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): SupplyChainObserver: post != pre (entailed by a stronger rung that also HOLDS on SupplyChainObserver, so asserting it detects nothing the stronger one misses)
