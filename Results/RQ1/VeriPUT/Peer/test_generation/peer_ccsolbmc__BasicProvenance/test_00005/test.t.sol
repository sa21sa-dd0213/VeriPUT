...
contract BasicProvenanceCovTest_BasicProvenance_initialize_put3p1_p1_part_part0_r_w is Test {
  BasicProvenance c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address supplyChainOwner, address supplyChainObserver) internal {
    ...
    supplyChainObserver = address(uint160(bound(uint256(uint160(supplyChainObserver)), 0, 1461501637330902918203684832716283019655932542974)));
    ...
    if (p_msg_sender == address(uint160(0)) && supplyChainOwner == address(uint160(1461501637330902918203684832716283019655932542975)) && supplyChainObserver == address(uint160(0))) {
  ...
  function test_put_BasicProvenance_initialize_path3p1_part_part0_r_w(address p_msg_sender, address supplyChainOwner, address supplyChainObserver) public {
    _veriput_parameterized(p_msg_sender, supplyChainOwner, supplyChainObserver);
    
    { BasicProvenanceCovTest_BasicProvenance_initialize_concrete3p1__basis_part0_r_w__W _veriput_w = new BasicProvenanceCovTest_BasicProvenance_initialize_concrete3p1__basis_part0_r_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract BasicProvenanceCovTest_BasicProvenance_initialize_concrete3p1__basis_part0_r_w__W is Test {
  BasicProvenance c0;
  function setUp() public {
    c0 = new BasicProvenance();
  }
