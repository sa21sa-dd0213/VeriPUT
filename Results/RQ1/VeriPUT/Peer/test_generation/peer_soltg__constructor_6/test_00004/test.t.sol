...
contract B6CovTest_B6_g6_put7p1_p1_part_part0_r_w is Test {
  B6 c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    p_msg_sender = address(uint160(bound(uint256(uint160(p_msg_sender)), 47, 2147483686)));
    ...
    if (p_msg_sender == address(uint160(47))) {
  ...
  function test_put_B6_g6_path7p1_part_part0_r_w(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { B6CovTest_B6_g6_concrete7p1__basis_part0_r_w__W _veriput_w = new B6CovTest_B6_g6_concrete7p1__basis_part0_r_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract B6CovTest_B6_g6_concrete7p1__basis_part0_r_w__W is Test {
  B6 c0;
  function setUp() public {
    c0 = new B6();
  }
  ...
  function _w_test_cov_0() public {
    ...
    vm.txGasPrice(0);
    vm.coinbase(address(uint160(0)));
    vm.prank(address(uint160(47)), address(uint160(0)));
