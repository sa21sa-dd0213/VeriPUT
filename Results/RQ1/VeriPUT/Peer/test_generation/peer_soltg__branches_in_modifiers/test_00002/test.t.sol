...
import {Ci1} from "../src/flat.sol";

contract Ci1CovTest_Ci1_f_put30p1 is Test {
  Ci1 c0;
  ...
  function test_put_Ci1_f_path30p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { Ci1CovTest_Ci1_f_concrete30p1__basis_root__W _veriput_w = new Ci1CovTest_Ci1_f_concrete30p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract Ci1CovTest_Ci1_f_concrete30p1__basis_root__W is Test {
  Ci1 c0;
  function setUp() public {
    c0 = new Ci1();
  }
