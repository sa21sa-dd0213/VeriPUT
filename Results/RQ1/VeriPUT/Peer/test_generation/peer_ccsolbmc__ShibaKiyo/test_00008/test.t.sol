...
contract ShibaKiyoCovTest_ShibaKiyo_isExcludedFromReward_put3p1 is Test {
  ...
  // claim: sol:@C@ShibaKiyo@F@isExcludedFromReward#1760:path:3
  // witness-fingerprint-sha256: fddaeae40acecd4d4b1256e3dced37851bea3eb7e049b1dea8ad19e7fe8cade9
  // claim: sol:@C@ShibaKiyo@F@isExcludedFromReward#1760:path:2
  // witness-fingerprint-sha256: f37377e601160337e3aa86c13b1f60119fbae3c70ab10bc0fe3f26785d21cd04

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@ShibaKiyo@F@isExcludedFromReward#1760:path:3   depth=1
