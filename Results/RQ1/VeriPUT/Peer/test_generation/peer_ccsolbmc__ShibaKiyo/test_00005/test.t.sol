...
contract ShibaKiyoCovTest_ShibaKiyo_isExcludedFromFee_put2p1 is Test {
  ShibaKiyo c0;
  ...
  function test_put_ShibaKiyo_isExcludedFromFee_path2p1(address p_msg_sender, uint256 p_msg_value, address account) public {
