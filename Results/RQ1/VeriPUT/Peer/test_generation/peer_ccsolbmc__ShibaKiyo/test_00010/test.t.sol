...
contract ShibaKiyoCovTest_ShibaKiyo_owner_put3p1 is Test {
  ...
  // claim: sol:@C@ShibaKiyo@F@owner#615:path:3
  // witness-fingerprint-sha256: b42e81e4483aecd216e0e8936d366cd5cdee7ea23a97688a4f63ce9029143a57
  // claim: sol:@C@ShibaKiyo@F@owner#615:path:2
  // witness-fingerprint-sha256: 8dc57abbff017757f6e38c7affcab2f20538ed1af921263c5a72e199d549e5e5

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@ShibaKiyo@F@owner#615:path:3   depth=1
  ...
  //   state._owner$585 in [0, 1461501637330902918203684832716283019655932542975]
  //   PIN block.basefee == 0
  ...
  //   rung DROPPED: return: return == state._owner$585 (rung shape not renderable for its declared type)
