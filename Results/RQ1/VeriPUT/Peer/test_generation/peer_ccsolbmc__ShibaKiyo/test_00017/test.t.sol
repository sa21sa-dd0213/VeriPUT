...
contract ShibaKiyoCovTest_ShibaKiyo_totalFees_put3p1 is Test {
  ShibaKiyo c0;
  ...
  function test_put_ShibaKiyo_totalFees_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { ShibaKiyoCovTest_ShibaKiyo_totalFees_concrete3p1__basis_root__W _veriput_w = new ShibaKiyoCovTest_ShibaKiyo_totalFees_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract ShibaKiyoCovTest_ShibaKiyo_totalFees_concrete3p1__basis_root__W is Test {
  ShibaKiyo c0;
  function setUp() public {
    c0 = new ShibaKiyo();
  }
