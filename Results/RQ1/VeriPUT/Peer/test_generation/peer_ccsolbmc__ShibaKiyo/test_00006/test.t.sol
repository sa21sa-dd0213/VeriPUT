...
contract ShibaKiyoCovTest_ShibaKiyo_isExcludedFromFee_put3p1 is Test {
  ShibaKiyo c0;
  ...
  function test_put_ShibaKiyo_isExcludedFromFee_path3p1(address p_msg_sender, address account) public {
    _veriput_parameterized(p_msg_sender, account);
    
    { ShibaKiyoCovTest_ShibaKiyo_isExcludedFromFee_concrete3p1__basis_root__W _veriput_w = new ShibaKiyoCovTest_ShibaKiyo_isExcludedFromFee_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract ShibaKiyoCovTest_ShibaKiyo_isExcludedFromFee_concrete3p1__basis_root__W is Test {
  ShibaKiyo c0;
  function setUp() public {
    c0 = new ShibaKiyo();
  }
  ...
  function _w_test_cov_0() public {
    ...
    bool _veriput_concrete_return = c0.isExcludedFromFee(address(uint160(0)));
