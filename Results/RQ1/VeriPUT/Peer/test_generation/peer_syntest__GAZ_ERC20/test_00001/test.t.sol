...
contract GAZ_ERC20CovTest_GAZ_ERC20_approve_put2_pf246p1 is Test {
  GAZ_ERC20 c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address guy) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("approve(address)", guy));
  ...
  function test_put_GAZ_ERC20_approve_path2_pf246p1(address p_msg_sender, uint256 p_msg_value, address guy) public {
    _veriput_parameterized(p_msg_sender, p_msg_value, guy);
  }
}
