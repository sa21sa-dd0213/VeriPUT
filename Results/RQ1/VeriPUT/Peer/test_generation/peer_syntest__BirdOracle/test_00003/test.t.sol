...
contract BirdOracleCovTest_BirdOracle_getRatingByAddress_put3p1 is Test {
  ...
  // claim: sol:@C@BirdOracle@F@getRatingByAddress#349:path:3
  // witness-fingerprint-sha256: f2773a251532caa05850199f5afd945148a45a58b71cf40ba22f0470e9f14bbc
  // claim: sol:@C@BirdOracle@F@getRatingByAddress#349:path:2
  // witness-fingerprint-sha256: 59634dc91348a1ddd03582242fe5482be5a4c7fb781b70ca65c9a7da45c5c8f7

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@BirdOracle@F@getRatingByAddress#349:path:3   depth=1
  ...
  //   _addr in [0, 1461501637330902918203684832716283019655932542975]
  ...
  // FUZZ COORDINATES: msg.sender, _addr
  ...
  //   rung IMPLIED (not lost, not asserted twice): ratings[_addr]: post >= pre (entailed by a stronger rung that also HOLDS on ratings[_addr], so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): ratings[_addr]: post <= pre (entailed by a stronger rung that also HOLDS on ratings[_addr], so asserting it detects nothing the stronger one misses)
