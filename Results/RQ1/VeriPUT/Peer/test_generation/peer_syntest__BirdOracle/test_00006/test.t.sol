...
contract BirdOracleCovTest_BirdOracle_updatedChainRequest_put2p1 is Test {
  ...
  // claim: sol:@C@BirdOracle@F@updatedChainRequest#336:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@BirdOracle@F@updatedChainRequest#336:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, _id, _valueResponse
