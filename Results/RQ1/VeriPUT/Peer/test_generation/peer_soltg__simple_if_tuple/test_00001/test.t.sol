...
import {Csi6} from "../src/flat.sol";

contract Csi6CovTest_Csi6_check_put2p1 is Test {
  Csi6 c0;
  ...
  function test_put_Csi6_check_path2p1(address p_msg_sender, uint256 p_msg_value) public {
