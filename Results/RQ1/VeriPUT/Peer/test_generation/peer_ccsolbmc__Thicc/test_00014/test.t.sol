...
contract ThiccCovTest_Thicc_fgh4_put2p1 is Test {
  ...
  // claim: sol:@C@Thicc@F@fgh4#947:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@Thicc@F@fgh4#947:path:2   depth=1
  ...
  uint256 _pre_TokenHolderCount; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_owner; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_communityMarketingAddress; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_communityMarketing; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_initialSupply; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_totalSupply; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_balances_state_communityMarketingAddress; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_balances_state_owner; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_TokenHolderCount; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_owner; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_communityMarketingAddress; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_communityMarketing; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_initialSupply; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_totalSupply; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_balances_state_communityMarketingAddress; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_balances_state_owner; // VERIPUT_HOISTED_SNAPSHOT
