...
contract ThiccCovTest_Thicc_transfer_put2p1 is Test {
  ...
  // claim: sol:@C@Thicc@F@transfer#1064:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@Thicc@F@transfer#1064:path:2   depth=1
  ...
  //   level0 = True
  //   level0_perturb = True
  //   level0_points = {'120': 'state.HolderExist$851[recipient]==0', '124': 'amount==0, state.HolderExist$851[recipient]==0', '24': 'msg.sender==0, state.HolderExist$851[recipient]==0', '56': 'recipient==0, state.HolderExist$851[recipient]==0'}
  //   max_holes = 3
  //   max_region_pieces = 4
  //   max_tx = 1
  //   probe_ladder = True
