...
contract ThiccCovTest_Thicc_balanceOf_put3p1_p1_part_part0_r is Test {
  Thicc c0;
  ...
  function test_put_Thicc_balanceOf_path3p1_part_part0_r(address p_msg_sender, address account) public {
    _veriput_parameterized(p_msg_sender, account);
    
    { ThiccCovTest_Thicc_balanceOf_concrete3p1__basis_part0_r__W _veriput_w = new ThiccCovTest_Thicc_balanceOf_concrete3p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract ThiccCovTest_Thicc_balanceOf_concrete3p1__basis_part0_r__W is Test {
  Thicc c0;
  function setUp() public {
    c0 = new Thicc();
  }
