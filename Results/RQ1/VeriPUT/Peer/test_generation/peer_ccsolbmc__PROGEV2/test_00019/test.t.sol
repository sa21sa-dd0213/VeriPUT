...
contract PROGEV2CovTest_PROGEV2_setFeeEnabled_put3p1_p1_part_part0_w is Test {
  PROGEV2 c0;
  ...
  function _veriput_parameterized(address p_msg_sender, bool enable) internal {
    ...
    assertEq(_post_feeEnabled, _pre_feeEnabled, "feeEnabled: post == pre");
    
  }


  
  function test_put_PROGEV2_setFeeEnabled_path3p1_part_part0_w(address p_msg_sender, bool enable) public {
    _veriput_parameterized(p_msg_sender, enable);
    
    { PROGEV2CovTest_PROGEV2_setFeeEnabled_concrete3p1__basis_part0_w__W _veriput_w = new PROGEV2CovTest_PROGEV2_setFeeEnabled_concrete3p1__basis_part0_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PROGEV2CovTest_PROGEV2_setFeeEnabled_concrete3p1__basis_part0_w__W is Test {
  PROGEV2 c0;
  function setUp() public {
    c0 = new PROGEV2();
  }
