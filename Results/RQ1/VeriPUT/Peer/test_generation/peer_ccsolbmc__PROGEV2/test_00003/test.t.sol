...
contract PROGEV2CovTest_PROGEV2_addLiquidity_put15p1_p1_part_part0_w_r is Test {
  PROGEV2 c0;
  ...
  function test_put_PROGEV2_addLiquidity_path15p1_part_part0_w_r(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { PROGEV2CovTest_PROGEV2_addLiquidity_concrete15p1__basis_part0_w_r__W _veriput_w = new PROGEV2CovTest_PROGEV2_addLiquidity_concrete15p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PROGEV2CovTest_PROGEV2_addLiquidity_concrete15p1__basis_part0_w_r__W is Test {
  PROGEV2 c0;
  function setUp() public {
    c0 = new PROGEV2();
  }
