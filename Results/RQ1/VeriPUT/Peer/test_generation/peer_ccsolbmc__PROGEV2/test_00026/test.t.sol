...
contract PROGEV2CovTest_PROGEV2_transfer_put3p1 is Test {
  PROGEV2 c0;
  ...
  function test_put_PROGEV2_transfer_path3p1(address p_msg_sender, address recipient, uint256 amount) public {
    _veriput_parameterized(p_msg_sender, recipient, amount);
    
    { PROGEV2CovTest_PROGEV2_transfer_concrete3p1__basis_root__W _veriput_w = new PROGEV2CovTest_PROGEV2_transfer_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PROGEV2CovTest_PROGEV2_transfer_concrete3p1__basis_root__W is Test {
  PROGEV2 c0;
  function setUp() public {
    c0 = new PROGEV2();
  }
