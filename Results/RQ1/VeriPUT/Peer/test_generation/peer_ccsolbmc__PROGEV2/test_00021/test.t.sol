...
contract PROGEV2CovTest_PROGEV2_setLimitTx_put3p1_p1_part_part0_r is Test {
  PROGEV2 c0;
  ...
  function _veriput_parameterized(address p_msg_sender, bool enable) internal {
    ...
    assertTrue(_post_limitTX != _pre_limitTX, "limitTX: post != pre");
    
  }


  
  function test_put_PROGEV2_setLimitTx_path3p1_part_part0_r(address p_msg_sender, bool enable) public {
    _veriput_parameterized(p_msg_sender, enable);
    
    { PROGEV2CovTest_PROGEV2_setLimitTx_concrete3p1__basis_part0_r__W _veriput_w = new PROGEV2CovTest_PROGEV2_setLimitTx_concrete3p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PROGEV2CovTest_PROGEV2_setLimitTx_concrete3p1__basis_part0_r__W is Test {
  PROGEV2 c0;
  function setUp() public {
    c0 = new PROGEV2();
  }
  ...
  function _w_test_cov_0() public {
    ...
    assertEq(_veriput_fixed_state_limitTX_16, uint256(1), "fixed witness state");
