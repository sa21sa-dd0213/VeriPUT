...
contract PROGEV2CovTest_PROGEV2_totalSupply_put3p1 is Test {
  ...
  // claim: sol:@C@PROGEV2@F@totalSupply#465:path:3
  // witness-fingerprint-sha256: e26fe821b234cb68ca07c838469b74039b204333a2256a345468f9d788a6a1fa
  // claim: sol:@C@PROGEV2@F@totalSupply#465:path:2
  // witness-fingerprint-sha256: 042ea05f080598ada83eee11aeefa19a9f8ec9a03559a4ebd8e28872dcedbe3a

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@PROGEV2@F@totalSupply#465:path:3   depth=1
  ...
  // ORACLE: 38 assertion(s) from the surviving (HOLDS) rungs of
