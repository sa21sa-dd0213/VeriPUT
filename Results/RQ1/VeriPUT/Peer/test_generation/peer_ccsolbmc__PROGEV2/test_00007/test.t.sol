...
contract PROGEV2CovTest_PROGEV2_approve_put3p1 is Test {
  PROGEV2 c0;
  ...
  function test_put_PROGEV2_approve_path3p1(address p_msg_sender, address spender, uint256 amount) public {
    _veriput_parameterized(p_msg_sender, spender, amount);
    
    { PROGEV2CovTest_PROGEV2_approve_concrete3p1__basis_root__W _veriput_w = new PROGEV2CovTest_PROGEV2_approve_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PROGEV2CovTest_PROGEV2_approve_concrete3p1__basis_root__W is Test {
  PROGEV2 c0;
  function setUp() public {
    c0 = new PROGEV2();
  }
