...
contract PROGEV2CovTest_PROGEV2_setFeeEnabled_put3p1_p1_part_part0_r is Test {
  PROGEV2 c0;
  ...
  function _veriput_parameterized(address p_msg_sender, bool enable) internal {
    ...
    uint256 _pre_feeEnabled = ((uint256(vm.load(address(c0), bytes32(uint256(13)))) >> 192) & 255);
    ...
    c0.setFeeEnabled(enable);
    
    if (p_msg_sender == address(uint160(0)) && enable == true) {
    ...
    uint256 _post_feeEnabled = ((uint256(vm.load(address(c0), bytes32(uint256(13)))) >> 192) & 255);
    assertEq(_post_feeEnabled, (enable ? uint256(1) : uint256(0)), "feeEnabled: post == enable");
    assertTrue(_post_feeEnabled != _pre_feeEnabled, "feeEnabled: post != pre");
    
  }


  
  function test_put_PROGEV2_setFeeEnabled_path3p1_part_part0_r(address p_msg_sender, bool enable) public {
    _veriput_parameterized(p_msg_sender, enable);
    
    { PROGEV2CovTest_PROGEV2_setFeeEnabled_concrete3p1__basis_part0_r__W _veriput_w = new PROGEV2CovTest_PROGEV2_setFeeEnabled_concrete3p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PROGEV2CovTest_PROGEV2_setFeeEnabled_concrete3p1__basis_part0_r__W is Test {
  PROGEV2 c0;
  function setUp() public {
    c0 = new PROGEV2();
  }
  ...
  function _w_test_cov_0() public {
    ...
    assertEq(_veriput_fixed_state_feeEnabled_14, uint256(1), "fixed witness state");
