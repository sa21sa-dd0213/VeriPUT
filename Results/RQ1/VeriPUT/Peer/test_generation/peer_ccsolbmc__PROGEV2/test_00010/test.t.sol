...
contract PROGEV2CovTest_PROGEV2_asaf_put3p1_p1_part_part0_r_w is Test {
  PROGEV2 c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address addr1, address addr2) internal {
    ...
    if (p_msg_sender == address(uint160(0)) && addr1 == address(uint160(1)) && addr2 == address(uint160(0))) {
  ...
  function test_put_PROGEV2_asaf_path3p1_part_part0_r_w(address p_msg_sender, address addr1, address addr2) public {
    _veriput_parameterized(p_msg_sender, addr1, addr2);
    
    { PROGEV2CovTest_PROGEV2_asaf_concrete3p1__basis_part0_r_w__W _veriput_w = new PROGEV2CovTest_PROGEV2_asaf_concrete3p1__basis_part0_r_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PROGEV2CovTest_PROGEV2_asaf_concrete3p1__basis_part0_r_w__W is Test {
  PROGEV2 c0;
  function setUp() public {
    c0 = new PROGEV2();
  }
  ...
  function _w_test_cov_0() public {
    ...
    c0.asaf(address(uint160(1)), address(uint160(0)));
