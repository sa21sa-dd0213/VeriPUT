...
contract PROGEV2CovTest_PROGEV2_manualRoge_put3p1_p1_part_part0_w_r is Test {
  PROGEV2 c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 amount) internal {
    ...
    if (p_msg_sender == address(uint160(0)) && amount == uint256(8)) {
  ...
  function test_put_PROGEV2_manualRoge_path3p1_part_part0_w_r(address p_msg_sender, uint256 amount) public {
    _veriput_parameterized(p_msg_sender, amount);
    
    { PROGEV2CovTest_PROGEV2_manualRoge_concrete3p1__basis_part0_w_r__W _veriput_w = new PROGEV2CovTest_PROGEV2_manualRoge_concrete3p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PROGEV2CovTest_PROGEV2_manualRoge_concrete3p1__basis_part0_w_r__W is Test {
  PROGEV2 c0;
  function setUp() public {
    c0 = new PROGEV2();
  }
