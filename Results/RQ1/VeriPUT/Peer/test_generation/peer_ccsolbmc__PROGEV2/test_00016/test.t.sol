...
contract PROGEV2CovTest_PROGEV2_manualRoge_put3p1_p1_part_part0_w_w is Test {
  PROGEV2 c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 amount) internal {
    ...
    assertEq(_post_ROGE, _pre_ROGE, "ROGE: post == state.ROGE");
    assertGe(_post_ROGE, 0, "ROGE: post in [0, pre]");
    assertLe(_post_ROGE, _pre_ROGE, "ROGE: post in [0, pre]");
    assertGe(_post_ROGE, 0, "ROGE: post in [0, (pre + pre)]");
    unchecked { assertLe(_post_ROGE, (uint256(_pre_ROGE) + uint256(_pre_ROGE)), "ROGE: post in [0, (pre + pre)]"); }
    assertGe(_post_ROGE, 0, "ROGE: post in [0, (pre + 9)]");
    unchecked { assertLe(_post_ROGE, (uint256(_pre_ROGE) + uint256(9)), "ROGE: post in [0, (pre + 9)]"); }
    assertGe(_post_ROGE, 0, "ROGE: post in [0, (msg.value + 1461501637330902918203684832716283019655932542975)]");
    ...
    assertGe(_post_ROGE, 0, "ROGE: post in [0, (1461501637330902918203684832716283019655932542975 - pre)]");
    ...
    assertGe(_post_ROGE, 0, "ROGE: post in [0, (1461501637330902918203684832716283019655932542975 - 9)]");
    ...
    assertGe(_post_ROGE, 0, "ROGE: post in [0, (1461501637330902918203684832716283019655932542975 - amount)]");
    unchecked { assertLe(_post_ROGE, (uint256(1461501637330902918203684832716283019655932542975) - uint256(amount)), "ROGE: post in [0, (1461501637330902918203684832716283019655932542975 - amount)]"); }
    
  }


  
  function test_put_PROGEV2_manualRoge_path3p1_part_part0_w_w(address p_msg_sender, uint256 amount) public {
    _veriput_parameterized(p_msg_sender, amount);
    
    { PROGEV2CovTest_PROGEV2_manualRoge_concrete3p1__basis_part0_w_w__W _veriput_w = new PROGEV2CovTest_PROGEV2_manualRoge_concrete3p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PROGEV2CovTest_PROGEV2_manualRoge_concrete3p1__basis_part0_w_w__W is Test {
  PROGEV2 c0;
  function setUp() public {
    c0 = new PROGEV2();
  }
