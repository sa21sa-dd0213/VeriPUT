...
contract PROGEV2CovTest_PROGEV2_manualRoge_put3p1_p1_part_part0_w_w is Test {
  ...
  // claim: sol:@C@PROGEV2@F@manualRoge#669:path:3
  // witness-fingerprint-sha256: 11438e00649eb8d2581dfbbd99c6ee2531a0a88c9e00c504d1646ec1b9c3c307
  // claim: sol:@C@PROGEV2@F@manualRoge#669:path:2
  // witness-fingerprint-sha256: 385198f7181f443e1637e472046cc4a6ca67ddacaf04868292b784be881f74b6

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@PROGEV2@F@manualRoge#669:path:3   depth=1
  ...
  //   rung IMPLIED (not lost, not asserted twice): ROGE: post >= pre (entailed by a stronger rung that also HOLDS on ROGE, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): ROGE: post <= pre (entailed by a stronger rung that also HOLDS on ROGE, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): ROGE: post == (pre + msg.value) (entailed by a stronger rung that also HOLDS on ROGE, so asserting it detects nothing the stronger one misses)
