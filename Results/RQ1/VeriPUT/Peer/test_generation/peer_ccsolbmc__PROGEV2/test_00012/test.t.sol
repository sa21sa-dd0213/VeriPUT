...
contract PROGEV2CovTest_PROGEV2_asaf_put3p1_p1_part_part0_w_w is Test {
  ...
  // claim: sol:@C@PROGEV2@F@asaf#433:path:3
  // witness-fingerprint-sha256: 27d3a2dba9c545f679f795acd4d494deb59197de2d5bc8f2b43014de05d931b0
  // claim: sol:@C@PROGEV2@F@asaf#433:path:2
  // witness-fingerprint-sha256: 6b9c50358535c45c84fcf8a7fb013f07177246b9a88d7e2a3988803a85916a38

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@PROGEV2@F@asaf#433:path:3   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, addr1, addr2
  ...
  //   rung IMPLIED (not lost, not asserted twice): _presa: post >= pre (entailed by a stronger rung that also HOLDS on _presa, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): _rogeTreasury: post >= pre (entailed by a stronger rung that also HOLDS on _rogeTreasury, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): _presa: post <= pre (entailed by a stronger rung that also HOLDS on _presa, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): _rogeTreasury: post <= pre (entailed by a stronger rung that also HOLDS on _rogeTreasury, so asserting it detects nothing the stronger one misses)
  ...
  uint256 _pre_isExcludedFromFee_addr1; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_isExcludedFromFee_addr2; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_presa; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_rogeTreasury; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_isExcludedFromFee_state__presa; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_isExcludedFromFee_state__rogeTreasury; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_isExcludedFromFee_addr1; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_isExcludedFromFee_addr2; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_presa; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_rogeTreasury; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_isExcludedFromFee_state__presa; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_isExcludedFromFee_state__rogeTreasury; // VERIPUT_HOISTED_SNAPSHOT
