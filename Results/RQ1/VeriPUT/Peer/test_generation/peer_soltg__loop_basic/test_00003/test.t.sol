...
contract SimplelbCovTest_Simplelb_f_put227p1 is Test {
  Simplelb c0;
  ...
  function test_put_Simplelb_f_path227p1(address p_msg_sender, uint256 p_block_timestamp, uint256 p_block_number, uint256 x) public {
    _veriput_parameterized(p_msg_sender, p_block_timestamp, p_block_number, x);
    
    { SimplelbCovTest_Simplelb_f_concrete227p1__basis_root__W _veriput_w = new SimplelbCovTest_Simplelb_f_concrete227p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract SimplelbCovTest_Simplelb_f_concrete227p1__basis_root__W is Test {
  Simplelb c0;
  function setUp() public {
    c0 = new Simplelb();
  }
