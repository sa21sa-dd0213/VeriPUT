...
contract CoCovTest_Co_f_put15_pf59p1__pf59p1_part_part0_r is Test {
  Co c0;
  ...
  function test_put_Co_f_path15_pf59p1_part_part0_r(address p_msg_sender, uint256 x, uint256 y) public {
    _veriput_parameterized(p_msg_sender, x, y);
    
    { CoCovTest_Co_f_concrete15_pf59p1__basis_part0_r__W _veriput_w = new CoCovTest_Co_f_concrete15_pf59p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract CoCovTest_Co_f_concrete15_pf59p1__basis_part0_r__W is Test {
  Co c0;
  function setUp() public {
    c0 = new Co();
  }
  ...
  function _w_test_cov_2() public {
    ...
    c0.f(uint256(0), uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935));
