...
contract CoCovTest_Co_f_put2_pf59p1 is Test {
  Co c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, uint256 x, uint256 y) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("f(uint256,uint256)", x, y));
  ...
  function test_put_Co_f_path2_pf59p1(address p_msg_sender, uint256 p_msg_value, uint256 x, uint256 y) public {
    _veriput_parameterized(p_msg_sender, p_msg_value, x, y);
  }
}
