...
contract SLTDETHlpRewardCovTest_SLTDETHlpReward_isOwner_put3p1 is Test {
  SLTDETHlpReward c0;
  ...
  function test_put_SLTDETHlpReward_isOwner_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { SLTDETHlpRewardCovTest_SLTDETHlpReward_isOwner_concrete3p1__basis_root__W _veriput_w = new SLTDETHlpRewardCovTest_SLTDETHlpReward_isOwner_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract SLTDETHlpRewardCovTest_SLTDETHlpReward_isOwner_concrete3p1__basis_root__W is Test {
  SLTDETHlpReward c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new SLTDETHlpReward();
