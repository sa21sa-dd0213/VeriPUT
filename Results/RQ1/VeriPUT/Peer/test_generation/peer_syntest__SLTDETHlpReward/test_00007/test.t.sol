...
contract SLTDETHlpRewardCovTest_SLTDETHlpReward_isOwner_put3p1 is Test {
  ...
  // claim: sol:@C@SLTDETHlpReward@F@isOwner#308:path:3
  // witness-fingerprint-sha256: 2c36a9dbd15e6b9040e6a90f6eeced6b875bd31509cf2125627ae39b93397621
  // claim: sol:@C@SLTDETHlpReward@F@isOwner#308:path:2
  // witness-fingerprint-sha256: c4404a466c3a13ffe1c05ce504ae6963ff594daf3b1a8363890c38aedf2174dd

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@SLTDETHlpReward@F@isOwner#308:path:3   depth=1
  ...
  //   state._owner$256 in [0, 1461501637330902918203684832716283019655932542975]
  //   PIN block.basefee == 0
