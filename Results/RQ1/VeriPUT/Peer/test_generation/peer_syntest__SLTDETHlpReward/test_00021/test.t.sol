...
contract SLTDETHlpRewardCovTest_1_SLTDETHlpReward_transferOwnership_put6p1 is Test {
  SLTDETHlpReward c0;
  function setUp() public {
  ...
  function test_put_SLTDETHlpReward_transferOwnership_path6p1(address newOwner) public {
    _veriput_parameterized(newOwner);
    
    { SLTDETHlpRewardCovTest_1_SLTDETHlpReward_transferOwnership_concrete6p1__basis_root__W _veriput_w = new SLTDETHlpRewardCovTest_1_SLTDETHlpReward_transferOwnership_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract SLTDETHlpRewardCovTest_1_SLTDETHlpReward_transferOwnership_concrete6p1__basis_root__W is Test {
  SLTDETHlpReward c0;
  function setUp() public {
    vm.startPrank(address(uint160(2147483647)), address(uint160(2147483647)));
    c0 = new SLTDETHlpReward();
  ...
  function _w_test_cov_2() public {
    ...
    assertEq(_veriput_fixed_state_owner_256_1, uint256(2147483647), "fixed witness state");
    ...
    assertEq(_veriput_fixed_state_rewardDistribution_746_5, uint256(2147483647), "fixed witness state");
...
contract SLTDETHlpRewardCovTest_2__W is Test {
  SLTDETHlpReward c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new SLTDETHlpReward();
