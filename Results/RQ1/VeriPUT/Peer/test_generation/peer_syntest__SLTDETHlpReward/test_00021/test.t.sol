...
contract SLTDETHlpRewardCovTest_0 is Test {
  ...
  // claim: sol:@C@SLTDETHlpReward@F@transferOwnership#341:path:15
  // witness-fingerprint-sha256: 93d2805e48e851170786038b0f49ac2c977318096987a66829a2ad64d82f5b77
  // claim: sol:@C@SLTDETHlpReward@F@transferOwnership#341:path:14
  // witness-fingerprint-sha256: 3c9465bb312277ce06c3f70c228fd9aeb0935e30e47db3844c24dd12968e812e
}
...
contract SLTDETHlpRewardCovTest_1_SLTDETHlpReward_transferOwnership_put6p1 is Test {
  ...
  // claim: sol:@C@SLTDETHlpReward@F@transferOwnership#341:path:6
  // witness-fingerprint-sha256: 7bad2d5b1d58aae338ccaf73fed76c6f6edeb078debbd07b489671a7690cb0a2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@SLTDETHlpReward@F@transferOwnership#341:path:6   depth=2
  ...
  //   state._owner$256 in [0, 1461501637330902918203684832716283019655932542975]  \ {4294967295}
  //   PIN block.basefee == 0
  ...
  //   level0 = True
  //   level0_perturb = True
  //   level0_points = {'14': 'newOwner==0, state._owner$256==4294967295', '15': 'state._owner$256==4294967295', '6': '(none)'}
  //   max_holes = 3
  //   max_region_pieces = 4
  //   max_tx = 1
  //   probe_ladder = True
...
contract SLTDETHlpRewardCovTest_2 is Test {
  ...
  // claim: sol:@C@SLTDETHlpReward@F@transferOwnership#341:path:2
  // witness-fingerprint-sha256: 260e86bc5f69a77d17507831584752506d1cc3c0948f0dbdf93c16a12d727346
}
