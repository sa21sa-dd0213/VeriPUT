...
contract SLTDETHlpRewardCovTest_SLTDETHlpReward_balanceOf_put3p1_p1_part_part0_w_w is Test {
  SLTDETHlpReward c0;
  ...
  function test_put_SLTDETHlpReward_balanceOf_path3p1_part_part0_w_w(address p_msg_sender, address account) public {
    _veriput_parameterized(p_msg_sender, account);
    
    { SLTDETHlpRewardCovTest_SLTDETHlpReward_balanceOf_concrete3p1__basis_part0_w_w__W _veriput_w = new SLTDETHlpRewardCovTest_SLTDETHlpReward_balanceOf_concrete3p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract SLTDETHlpRewardCovTest_SLTDETHlpReward_balanceOf_concrete3p1__basis_part0_w_w__W is Test {
  SLTDETHlpReward c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new SLTDETHlpReward();
