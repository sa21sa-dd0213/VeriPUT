...
contract SLTDETHlpRewardCovTest_SLTDETHlpReward_owner_put3p1 is Test {
  ...
  // claim: sol:@C@SLTDETHlpReward@F@owner#287:path:3
  // witness-fingerprint-sha256: 433b5d4cc54d978bfbb6cb8a00614bfee97f531660808271a44818616a086034
  // claim: sol:@C@SLTDETHlpReward@F@owner#287:path:2
  // witness-fingerprint-sha256: 72fb4095b7994b388c98bb030b2a0e1eaf8607f3fc4c8de2eb7182dfedbc3930

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@SLTDETHlpReward@F@owner#287:path:3   depth=1
  ...
  //   rung DROPPED: return: return == state._owner$256 (rung shape not renderable for its declared type)
