...
contract SLTDETHlpRewardCovTest_SLTDETHlpReward_earned_put107p1 is Test {
  ...
  // claim: sol:@C@SLTDETHlpReward@F@earned#1098:path:107
  // witness-fingerprint-sha256: 1ec8f961cf0d3dab899470a6fc0fd52c980bddac975c1c7268c2f3ad05b4f8e8
  // claim: sol:@C@SLTDETHlpReward@F@earned#1098:path:2
  // witness-fingerprint-sha256: d21520f79719f1a5887d977c2bc809fd46d35e485408deae3be4e876da307fb0

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@SLTDETHlpReward@F@earned#1098:path:107   depth=6
  ...
  //   level0 = True
  //   level0_perturb = True
  //   level0_points = {'107': 'state._totalSupply$788==0'}
  //   max_holes = 3
  //   max_region_pieces = 4
  //   max_tx = 1
  //   probe_ladder = True
  ...
  //   rung IMPLIED (not lost, not asserted twice): _totalSupply: post <= pre (entailed by a stronger rung that also HOLDS on _totalSupply, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): rewards[account]: post >= pre (entailed by a stronger rung that also HOLDS on rewards[account], so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): rewards[account]: post <= pre (entailed by a stronger rung that also HOLDS on rewards[account], so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): userRewardPerTokenPaid[msg.sender]: post >= pre (entailed by a stronger rung that also HOLDS on userRewardPerTokenPaid[msg.sender], so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): userRewardPerTokenPaid[msg.sender]: post <= pre (entailed by a stronger rung that also HOLDS on userRewardPerTokenPaid[msg.sender], so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): userRewardPerTokenPaid[account]: post >= pre (entailed by a stronger rung that also HOLDS on userRewardPerTokenPaid[account], so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): userRewardPerTokenPaid[account]: post <= pre (entailed by a stronger rung that also HOLDS on userRewardPerTokenPaid[account], so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): userRewardPerTokenPaid[state._owner]: post >= pre (entailed by a stronger rung that also HOLDS on userRewardPerTokenPaid[state._owner], so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): userRewardPerTokenPaid[state._owner]: post <= pre (entailed by a stronger rung that also HOLDS on userRewardPerTokenPaid[state._owner], so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): userRewardPerTokenPaid[state.rewardDistribution]: post >= pre (entailed by a stronger rung that also HOLDS on userRewardPerTokenPaid[state.rewardDistribution], so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): userRewardPerTokenPaid[state.rewardDistribution]: post <= pre (entailed by a stronger rung that also HOLDS on userRewardPerTokenPaid[state.rewardDistribution], so asserting it detects nothing the stronger one misses)
  ...
  //   rung IMPLIED (not lost, not asserted twice): _balances[account]: post <= pre (entailed by a stronger rung that also HOLDS on _balances[account], so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): _balances[state._owner]: post >= pre (entailed by a stronger rung that also HOLDS on _balances[state._owner], so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): _balances[state._owner]: post <= pre (entailed by a stronger rung that also HOLDS on _balances[state._owner], so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): _balances[state.rewardDistribution]: post >= pre (entailed by a stronger rung that also HOLDS on _balances[state.rewardDistribution], so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): _balances[state.rewardDistribution]: post <= pre (entailed by a stronger rung that also HOLDS on _balances[state.rewardDistribution], so asserting it detects nothing the stronger one misses)
  ...
  //   path guard DROPPED: '!(a == 0)' (`a` is not nameable in this PUT)
  //   path guard DROPPED: '!(b > 0)' (`b` is not nameable in this PUT)
  ...
  // 29 snapshot local(s) HOISTED to storage: 2 fuzz parameter(s) + 29 snapshot local(s) exceed the 12-slot budget (solc stack reach); the reads and every assertion are unchanged
  uint256 _ret_pre_balances_account; // VERIPUT_HOISTED_SNAPSHOT
