...
contract SLTDETHlpRewardCovTest_0 is Test {
  ...
  // claim: sol:@C@SLTDETHlpReward@F@setRewardDistribution#775:path:7
  // witness-fingerprint-sha256: d2892b8310637b4100b0112882e8423d596b44aa4c859398a61c95453e3e8efb
  // claim: sol:@C@SLTDETHlpReward@F@setRewardDistribution#775:path:2
  // witness-fingerprint-sha256: fd874b45c67fa6734e1198731a3b794ded13612a542834aab9dca71cbf6a10c6
}
...
contract SLTDETHlpRewardCovTest_1_SLTDETHlpReward_setRewardDistribution_put6p1 is Test {
  ...
  // claim: sol:@C@SLTDETHlpReward@F@setRewardDistribution#775:path:6
  // witness-fingerprint-sha256: 3298c0d0e74596597877f82c663c6769887fdff1066971daebf17a47f7369600

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@SLTDETHlpReward@F@setRewardDistribution#775:path:6   depth=2
  ...
  //   state._owner$256 in [2147483647, 2147483647]
  //   state.rewardDistribution$746 in [0, 1461501637330902918203684832716283019655932542975]
  //   PIN block.basefee == 0
