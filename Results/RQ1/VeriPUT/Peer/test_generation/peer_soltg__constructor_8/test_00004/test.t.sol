...
contract B8CovTest_B8_f8_put15p1_p1_part_part0_w_w is Test {
  B8 c0;
  ...
  function test_put_B8_f8_path15p1_part_part0_w_w(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { B8CovTest_B8_f8_concrete15p1__basis_part0_w_w__W _veriput_w = new B8CovTest_B8_f8_concrete15p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract B8CovTest_B8_f8_concrete15p1__basis_part0_w_w__W is Test {
  B8 c0;
  function setUp() public {
    c0 = new B8();
  }
  ...
  function _w_test_cov_0() public {
    ...
    c0.f8();
    uint256 _veriput_fixed_state_y_0 = uint256(vm.load(address(c0), bytes32(uint256(1))));
    assertEq(_veriput_fixed_state_y_0, uint256(1), "fixed witness state");
  }
