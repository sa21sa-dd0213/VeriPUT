...
contract BasicTokenCovTest_BasicToken_balanceOf_put3p1 is Test {
  BasicToken c0;
  ...
  function test_put_BasicToken_balanceOf_path3p1(address p_msg_sender, address _owner) public {
    _veriput_parameterized(p_msg_sender, _owner);
    
    { BasicTokenCovTest_BasicToken_balanceOf_concrete3p1__basis_root__W _veriput_w = new BasicTokenCovTest_BasicToken_balanceOf_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract BasicTokenCovTest_BasicToken_balanceOf_concrete3p1__basis_root__W is Test {
  BasicToken c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new BasicToken(0);
