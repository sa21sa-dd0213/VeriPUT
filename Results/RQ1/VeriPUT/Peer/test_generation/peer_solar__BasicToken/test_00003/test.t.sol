...
contract BasicTokenCovTest_0_BasicToken_transfer_put14p1 is Test {
  ...
  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@BasicToken@F@transfer#75:path:14   depth=3
  ...
  //   _amount in [0, 115792089237316195423570985008687907853269984665640564039457584007913129639935]  \ {0}
  //   _recipient in [4294967295, 4294967295]
  ...
  //   state.balances$7[msg.sender] in [115792089237316195423570985008687907853269984665640564039457584007913129639935, 115792089237316195423570985008687907853269984665640564039457584007913129639935]
  //   PIN block.basefee == 0
  ...
  // FUZZ COORDINATES: block.timestamp, block.number, _recipient, _amount
  ...
  //   path guard ESTABLISHED: `!(balances[msg.sender] >= _amount)` -> `vm.assume(115792089237316195423570985008687907853269984665640564039457584007913129639935 >= _amount);`
  ...
  function _veriput_parameterized(uint256 p_block_timestamp, uint256 p_block_number, address _recipient, uint256 _amount) internal {
    ...
    //   state.balances$7[msg.sender] := 115792089237316195423570985008687907853269984665640564039457584007913129639935
    {
