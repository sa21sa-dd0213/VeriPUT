...
import {Csi3} from "../src/flat.sol";

contract Csi3CovTest_Csi3_check_put30p1 is Test {
  Csi3 c0;
  ...
  function test_put_Csi3_check_path30p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { Csi3CovTest_Csi3_check_concrete30p1__basis_root__W _veriput_w = new Csi3CovTest_Csi3_check_concrete30p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract Csi3CovTest_Csi3_check_concrete30p1__basis_root__W is Test {
  Csi3 c0;
  function setUp() public {
    c0 = new Csi3();
  }
