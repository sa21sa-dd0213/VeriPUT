...
contract TetherTokenCovTest_TetherToken_totalSupply_put7p1_p1_part_part0_w_w is Test {
  ...
  // claim: sol:@C@TetherToken@F@totalSupply#1095:path:7
  // witness-fingerprint-sha256: e7743230e60bf7ca73254f80d2eb598ae468b95671bdd410c09487c8ef94bfc5
  // claim: sol:@C@TetherToken@F@totalSupply#1095:path:2
  // witness-fingerprint-sha256: a6769badc3c5557f18c1c2ffdb3919e754f79dce05468970f6b8dcc8b4d67778

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@TetherToken@F@totalSupply#1095:path:7   depth=2
  ...
  //   rung IMPLIED (not lost, not asserted twice): _totalSupply: post <= pre (entailed by a stronger rung that also HOLDS on _totalSupply, so asserting it detects nothing the stronger one misses)
  //   path guard ESTABLISHED: `deprecated` -> `vm.assume(_pre_deprecated == 0);`
