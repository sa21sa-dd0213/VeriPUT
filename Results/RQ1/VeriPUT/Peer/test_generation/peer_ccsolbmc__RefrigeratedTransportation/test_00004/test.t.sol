...
contract RefrigeratedTransportationCovTest_RefrigeratedTransportation_TransferResponsibility_put2p1 is Test {
  ...
  // claim: sol:@C@RefrigeratedTransportation@F@TransferResponsibility#291:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@RefrigeratedTransportation@F@TransferResponsibility#291:path:2   depth=1
  ...
  //   level0 = True
  //   level0_perturb = True
  //   level0_points = {'126': '(none)', '30': '(none)', '62': '(none)'}
  //   max_holes = 3
  //   max_region_pieces = 4
  //   max_tx = 1
  //   probe_ladder = True
  ...
  uint256 _pre_PreviousCounterparty; // VERIPUT_HOISTED_SNAPSHOT
  ...
  uint256 _post_PreviousCounterparty; // VERIPUT_HOISTED_SNAPSHOT
