...
contract ShibaAstronautCovTest_ShibaAstronaut_transfer_put2p1 is Test {
  ShibaAstronaut c0;
  ...
  function test_put_ShibaAstronaut_transfer_path2p1(address p_msg_sender, uint256 p_msg_value, address to, uint256 value) public {
