...
contract ShibaAstronautCovTest_ShibaAstronaut_approve_put3p1 is Test {
  ShibaAstronaut c0;
  ...
  function test_put_ShibaAstronaut_approve_path3p1(address p_msg_sender, address spender, uint256 value) public {
    _veriput_parameterized(p_msg_sender, spender, value);
    
    { ShibaAstronautCovTest_ShibaAstronaut_approve_concrete3p1__basis_root__W _veriput_w = new ShibaAstronautCovTest_ShibaAstronaut_approve_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract ShibaAstronautCovTest_ShibaAstronaut_approve_concrete3p1__basis_root__W is Test {
  ShibaAstronaut c0;
  function setUp() public {
    c0 = new ShibaAstronaut();
  }
