...
contract ShibaAstronautCovTest_ShibaAstronaut_transfer_put6p1_p1_part_part0_w_r is Test {
  ShibaAstronaut c0;
  ...
  function test_put_ShibaAstronaut_transfer_path6p1_part_part0_w_r(address p_msg_sender, address to, uint256 value) public {
    _veriput_parameterized(p_msg_sender, to, value);
    
    { ShibaAstronautCovTest_ShibaAstronaut_transfer_concrete6p1__basis_part0_w_r__W _veriput_w = new ShibaAstronautCovTest_ShibaAstronaut_transfer_concrete6p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract ShibaAstronautCovTest_ShibaAstronaut_transfer_concrete6p1__basis_part0_w_r__W is Test {
  ShibaAstronaut c0;
  function setUp() public {
    c0 = new ShibaAstronaut();
  }
