...
contract MultiSigWalletCovTest_MultiSigWallet_transferTo_concrete14_fb is Test {
  MultiSigWallet c0;
  ...
  function test_cov_1() public {
    ...
    try c0.transferTo(address(uint160(0)), 115792089237316195423570985008687907853269984665640564039457584007913129639935) {
