...
contract TokenCovTest_Token_transfer_put6p1_p1_part_part0_w_w is Test {
  Token c0;
  ...
  function test_put_Token_transfer_path6p1_part_part0_w_w(address p_msg_sender, address to, uint256 value) public {
    _veriput_parameterized(p_msg_sender, to, value);
    
    { TokenCovTest_Token_transfer_concrete6p1__basis_part0_w_w__W _veriput_w = new TokenCovTest_Token_transfer_concrete6p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract TokenCovTest_Token_transfer_concrete6p1__basis_part0_w_w__W is Test {
  Token c0;
  function setUp() public {
    c0 = new Token();
  }
