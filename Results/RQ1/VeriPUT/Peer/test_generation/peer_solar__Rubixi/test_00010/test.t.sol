...
contract RubixiCovTest_Rubixi_collectAllFees_put7p1_p1_part_part0_w_r is Test {
  Rubixi c0;
  ...
  function test_put_Rubixi_collectAllFees_path7p1_part_part0_w_r(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { RubixiCovTest_Rubixi_collectAllFees_concrete7p1__basis_part0_w_r__W _veriput_w = new RubixiCovTest_Rubixi_collectAllFees_concrete7p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract RubixiCovTest_Rubixi_collectAllFees_concrete7p1__basis_part0_w_r__W is Test {
  Rubixi c0;
  function setUp() public {
    c0 = new Rubixi();
  }
