...
contract RubixiCovTest_Rubixi_DynamicPyramid_put3p1_p1_part_part0_w_w is Test {
  Rubixi c0;
  ...
  function test_put_Rubixi_DynamicPyramid_path3p1_part_part0_w_w(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { RubixiCovTest_Rubixi_DynamicPyramid_concrete3p1__basis_part0_w_w__W _veriput_w = new RubixiCovTest_Rubixi_DynamicPyramid_concrete3p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract RubixiCovTest_Rubixi_DynamicPyramid_concrete3p1__basis_part0_w_w__W is Test {
  Rubixi c0;
  function setUp() public {
    c0 = new Rubixi();
  }
