...
contract RubixiCovTest_Rubixi_collectPercentOfFees_put2p1 is Test {
  ...
  // claim: sol:@C@Rubixi@F@collectPercentOfFees#287:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@Rubixi@F@collectPercentOfFees#287:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, _pcent
