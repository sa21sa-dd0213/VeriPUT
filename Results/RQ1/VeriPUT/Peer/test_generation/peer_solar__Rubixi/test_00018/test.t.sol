...
contract RubixiCovTest_Rubixi_fallback_put6p1_p1_part_part0_w_r is Test {
  Rubixi c0;
  ...
  function _veriput_parameterized(uint256 p_block_timestamp, uint256 p_block_number) internal {
    ...
    if (p_block_timestamp == uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935) && p_block_number == uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)) {
  ...
  function test_put_Rubixi_fallback_path6p1_part_part0_w_r(uint256 p_block_timestamp, uint256 p_block_number) public {
    _veriput_parameterized(p_block_timestamp, p_block_number);
    
    { RubixiCovTest_Rubixi_fallback_concrete6p1__basis_part0_w_r__W _veriput_w = new RubixiCovTest_Rubixi_fallback_concrete6p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract RubixiCovTest_Rubixi_fallback_concrete6p1__basis_part0_w_r__W is Test {
  Rubixi c0;
  function setUp() public {
    c0 = new Rubixi();
  }
