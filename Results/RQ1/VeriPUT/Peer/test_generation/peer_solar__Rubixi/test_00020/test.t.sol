...
contract RubixiCovTest_Rubixi_fallback_put6p1_p1_part_part0_w_w is Test {
  Rubixi c0;
  ...
  function test_put_Rubixi_fallback_path6p1_part_part0_w_w(address p_msg_sender, uint256 p_block_timestamp, uint256 p_block_number) public {
    _veriput_parameterized(p_msg_sender, p_block_timestamp, p_block_number);
    
    { RubixiCovTest_Rubixi_fallback_concrete6p1__basis_part0_w_w__W _veriput_w = new RubixiCovTest_Rubixi_fallback_concrete6p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract RubixiCovTest_Rubixi_fallback_concrete6p1__basis_part0_w_w__W is Test {
  Rubixi c0;
  function setUp() public {
    c0 = new Rubixi();
  }
