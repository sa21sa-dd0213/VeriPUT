...
contract RubixiCovTest_Rubixi_changeOwner_put7p1 is Test {
  ...
  // claim: sol:@C@Rubixi@F@changeOwner#299:path:7
  // witness-fingerprint-sha256: 258050d675f2a0b085e70976282db5f7ac4990cc3194c629588b21ce61426daf
  // claim: sol:@C@Rubixi@F@changeOwner#299:path:6
  // witness-fingerprint-sha256: 0b1aa457941ebd623d6904e5d44e945979949cdab4d7a4f4dd28336d53a210b1
  // claim: sol:@C@Rubixi@F@changeOwner#299:path:2
  // witness-fingerprint-sha256: afed4448ec744b5a2adc9039cfe68fe93a44b177b5f8ccefe546488e0be6bb56

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@Rubixi@F@changeOwner#299:path:7   depth=2
  ...
  //   rung IMPLIED (not lost, not asserted twice): creator: post in [0, pre] (entailed by a stronger rung that also HOLDS on creator, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): creator: post in [0, (msg.value + 1461501637330902918203684832716283019655932542975)] (entailed by a stronger rung that also HOLDS on creator, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): creator: post in [0, (pre / 1)] (entailed by a stronger rung that also HOLDS on creator, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): creator: post in [0, (1461501637330902918203684832716283019655932542975 / 1)] (entailed by a stronger rung that also HOLDS on creator, so asserting it detects nothing the stronger one misses)
  //   path guard DROPPED: 'msg.sender == creator' (`creator` is assigned inside the unit before this source decision may execute, so it is not the calldata coordinate)
