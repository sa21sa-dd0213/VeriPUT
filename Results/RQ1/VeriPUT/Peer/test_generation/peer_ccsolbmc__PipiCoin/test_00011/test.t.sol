...
contract PipiCoinCovTest_PipiCoin_balanceOf_put3p1_p1_part_part0_w_w is Test {
  PipiCoin c0;
  ...
  function test_put_PipiCoin_balanceOf_path3p1_part_part0_w_w(address p_msg_sender, address account) public {
    _veriput_parameterized(p_msg_sender, account);
    
    { PipiCoinCovTest_PipiCoin_balanceOf_concrete3p1__basis_part0_w_w__W _veriput_w = new PipiCoinCovTest_PipiCoin_balanceOf_concrete3p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PipiCoinCovTest_PipiCoin_balanceOf_concrete3p1__basis_part0_w_w__W is Test {
  PipiCoin c0;
  function setUp() public {
    c0 = new PipiCoin();
  }
