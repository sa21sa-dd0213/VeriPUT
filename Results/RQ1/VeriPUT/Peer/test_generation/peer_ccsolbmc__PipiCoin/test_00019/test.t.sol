...
contract PipiCoinCovTest_PipiCoin_transfer_put14p1_p1_part_part0_w_w is Test {
  PipiCoin c0;
  ...
  function test_put_PipiCoin_transfer_path14p1_part_part0_w_w(address p_msg_sender, address recipient, uint256 amount) public {
    _veriput_parameterized(p_msg_sender, recipient, amount);
    
    { PipiCoinCovTest_PipiCoin_transfer_concrete14p1__basis_part0_w_w__W _veriput_w = new PipiCoinCovTest_PipiCoin_transfer_concrete14p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract PipiCoinCovTest_PipiCoin_transfer_concrete14p1__basis_part0_w_w__W is Test {
  PipiCoin c0;
  function setUp() public {
    c0 = new PipiCoin();
  }
