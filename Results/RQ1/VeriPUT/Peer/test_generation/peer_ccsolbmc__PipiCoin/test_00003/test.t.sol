...
contract PipiCoinCovTest_PipiCoin_approve_put14p1_p1_part_part0_r is Test {
  PipiCoin c0;
  ...
  function test_put_PipiCoin_approve_path14p1_part_part0_r(address p_msg_sender, address spender, uint256 amount) public {
    _veriput_parameterized(p_msg_sender, spender, amount);
    
    { PipiCoinCovTest_PipiCoin_approve_concrete14p1__basis_part0_r__W _veriput_w = new PipiCoinCovTest_PipiCoin_approve_concrete14p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract PipiCoinCovTest_PipiCoin_approve_concrete14p1__basis_part0_r__W is Test {
  PipiCoin c0;
  function setUp() public {
    c0 = new PipiCoin();
  }
