...
contract PipiCoinCovTest_PipiCoin_approve_put15p1 is Test {
  PipiCoin c0;
  ...
  function test_put_PipiCoin_approve_path15p1(address p_msg_sender, address spender, uint256 amount) public {
    _veriput_parameterized(p_msg_sender, spender, amount);
    
    { PipiCoinCovTest_PipiCoin_approve_concrete15p1__basis_root__W _veriput_w = new PipiCoinCovTest_PipiCoin_approve_concrete15p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PipiCoinCovTest_PipiCoin_approve_concrete15p1__basis_root__W is Test {
  PipiCoin c0;
  function setUp() public {
    c0 = new PipiCoin();
  }
