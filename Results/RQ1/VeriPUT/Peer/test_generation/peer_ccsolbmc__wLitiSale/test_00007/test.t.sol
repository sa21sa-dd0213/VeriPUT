...
contract wLitiSaleCovTest_wLitiSale_addReferrer_put2p1 is Test {
  wLitiSale c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address referrer, uint256 bonusPercent) internal {
    ...
    bonusPercent = bound(bonusPercent, 0, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("addReferrer(address,uint256)", referrer, bonusPercent));
    ...
    assertGe(_post_maxBonusPercent, _pre_maxBonusPercent, "_maxBonusPercent: post >= pre");
    assertLe(_post_maxBonusPercent, _pre_maxBonusPercent, "_maxBonusPercent: post <= pre");
  ...
  function test_put_wLitiSale_addReferrer_path2p1(address p_msg_sender, uint256 p_msg_value, address referrer, uint256 bonusPercent) public {
    _veriput_parameterized(p_msg_sender, p_msg_value, referrer, bonusPercent);
  }
}
