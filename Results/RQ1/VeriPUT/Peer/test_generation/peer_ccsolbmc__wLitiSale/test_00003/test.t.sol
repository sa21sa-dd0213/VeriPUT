...
contract wLitiSaleCovTest_wLitiSale_abcs_put3p1_p1_part_part0_r_r is Test {
  wLitiSale c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address token, address ETHWallet, address masterReferrerWallet) internal {
    ...
    ETHWallet = address(uint160(bound(uint256(uint160(ETHWallet)), 1, 1461501637330902918203684832716283019655932542975)));
    masterReferrerWallet = address(uint160(bound(uint256(uint160(masterReferrerWallet)), 1, 1461501637330902918203684832716283019655932542975)));
    ...
    if (p_msg_sender == address(uint160(0)) && token == address(uint160(0)) && ETHWallet == address(uint160(1)) && masterReferrerWallet == address(uint160(1))) {
      assertEq((uint256(vm.load(address(c0), bytes32(uint256(5)))) & 1461501637330902918203684832716283019655932542975), uint256(1), "fixed witness state");
    ...
    assertGt(_post_masterReferrerWallet, _pre_masterReferrerWallet, "_masterReferrerWallet: post > pre");
    assertGt(_post_ETHWallet, _pre_ETHWallet, "_ETHWallet: post > pre");
    
  }


  
  function test_put_wLitiSale_abcs_path3p1_part_part0_r_r(address p_msg_sender, address token, address ETHWallet, address masterReferrerWallet) public {
    _veriput_parameterized(p_msg_sender, token, ETHWallet, masterReferrerWallet);
    
    { wLitiSaleCovTest_wLitiSale_abcs_concrete3p1__basis_part0_r_r__W _veriput_w = new wLitiSaleCovTest_wLitiSale_abcs_concrete3p1__basis_part0_r_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract wLitiSaleCovTest_wLitiSale_abcs_concrete3p1__basis_part0_r_r__W is Test {
  wLitiSale c0;
  function setUp() public {
    c0 = new wLitiSale();
  }
  ...
  function _w_test_cov_0() public {
    ...
    c0.abcs(address(uint160(0)), address(uint160(1)), address(uint160(1)));
    ...
    assertEq(_veriput_fixed_state_ETHWallet_0, uint256(1), "fixed witness state");
    ...
    assertEq(_veriput_fixed_state_masterReferrerWallet_1, uint256(1), "fixed witness state");
