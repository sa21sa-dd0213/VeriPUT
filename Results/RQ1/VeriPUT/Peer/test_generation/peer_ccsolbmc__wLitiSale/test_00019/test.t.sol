...
contract wLitiSaleCovTest_wLitiSale_getSaleEndTime_put3p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    unchecked { assertEq(_post_saleEndTime, (uint256(0) - uint256(_pre_saleEndTime)), "_saleEndTime: post == (msg.value - state._saleEndTime)"); }
    unchecked { assertEq(_post_saleEndTime, (uint256(_pre_saleEndTime) - uint256(_pre_saleEndTime)), "_saleEndTime: post == (state._saleEndTime - pre)"); }
    unchecked { assertEq(_post_saleEndTime, (uint256(_pre_saleEndTime) + uint256(_pre_saleEndTime)), "_saleEndTime: post == (state._saleEndTime + state._saleEndTime)"); }
    unchecked { assertEq(_post_saleEndTime, (uint256(_pre_saleEndTime) * uint256(_pre_saleEndTime)), "_saleEndTime: post == (state._saleEndTime * state._saleEndTime)"); }
    unchecked { assertEq(_post_saleEndTime, (uint256(_pre_saleEndTime) * uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)), "_saleEndTime: post == (state._saleEndTime * 115792089237316195423570985008687907853269984665640564039457584007913129639935)"); }
    unchecked { assertEq(_post_saleEndTime, (uint256(_pre_saleEndTime) * uint256(115792089237316195423570985008687907853269984665640564039457584007913129639934)), "_saleEndTime: post == (state._saleEndTime * 115792089237316195423570985008687907853269984665640564039457584007913129639934)"); }
    unchecked { assertEq(_post_saleEndTime, (uint256(_pre_saleEndTime) / uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)), "_saleEndTime: post == (pre / 115792089237316195423570985008687907853269984665640564039457584007913129639935)"); }
    unchecked { assertEq(_post_saleEndTime, (uint256(_pre_saleEndTime) / uint256(115792089237316195423570985008687907853269984665640564039457584007913129639934)), "_saleEndTime: post == (pre / 115792089237316195423570985008687907853269984665640564039457584007913129639934)"); }
