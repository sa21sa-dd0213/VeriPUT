...
contract wLitiSaleCovTest_wLitiSale_getWeiRaised_put3p1 is Test {
  ...
  // claim: sol:@C@wLitiSale@F@getWeiRaised#545:path:3
  // witness-fingerprint-sha256: d4536705a9863fa8ede4b02620076780931553a1cdd929f668048d626751302a
  // claim: sol:@C@wLitiSale@F@getWeiRaised#545:path:2
  // witness-fingerprint-sha256: 3c684216d62f33b02f5e1754a75c7419270667c8fbe6b00a007252b12c008130

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@wLitiSale@F@getWeiRaised#545:path:3   depth=1
  ...
  //   sale in [0, 115792089237316195423570985008687907853269984665640564039457584007913129639935]
  //   PIN block.basefee == 0
  ...
  // FUZZ COORDINATES: msg.sender, sale
  ...
  //   rung IMPLIED (not lost, not asserted twice): _weiRaised[sale]: post >= pre (entailed by a stronger rung that also HOLDS on _weiRaised[sale], so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): _weiRaised[sale]: post <= pre (entailed by a stronger rung that also HOLDS on _weiRaised[sale], so asserting it detects nothing the stronger one misses)
