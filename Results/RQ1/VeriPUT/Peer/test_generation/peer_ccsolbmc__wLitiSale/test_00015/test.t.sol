...
contract wLitiSaleCovTest_wLitiSale_getReferrerBonusPercent_put3p1 is Test {
  ...
  // claim: sol:@C@wLitiSale@F@getReferrerBonusPercent#477:path:3
  // witness-fingerprint-sha256: 227d09b9cc561c2a46b7065df76c4ecf153a2813fb5e052354dbb7670e98b221
  // claim: sol:@C@wLitiSale@F@getReferrerBonusPercent#477:path:2
  // witness-fingerprint-sha256: 44aec739716f0b51514b6f0fbe700b2f037cbd6cecb23008ac12643e62a363eb

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@wLitiSale@F@getReferrerBonusPercent#477:path:3   depth=1
  ...
  uint256 _ret_pre_referrers_referrer__bonusPercent; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_referrers_referrer__bonusPercent; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_referrers_msg_sender__isReferrer; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_referrers_referrer__isReferrer; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_referrers_state__ETHWallet__isReferrer; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_referrers_state__masterReferrerWallet__isReferrer; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_referrers_state__owner__isReferrer; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_referrers_referrer__bonusPercent; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_referrers_msg_sender__isReferrer; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_referrers_referrer__isReferrer; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_referrers_state__ETHWallet__isReferrer; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_referrers_state__masterReferrerWallet__isReferrer; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_referrers_state__owner__isReferrer; // VERIPUT_HOISTED_SNAPSHOT
