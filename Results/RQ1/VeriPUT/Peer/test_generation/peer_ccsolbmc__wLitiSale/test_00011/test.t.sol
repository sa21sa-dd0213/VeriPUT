...
contract wLitiSaleCovTest_wLitiSale_getMasterReferrerWallet_put3p1 is Test {
  ...
  // claim: sol:@C@wLitiSale@F@getMasterReferrerWallet#464:path:3
  // witness-fingerprint-sha256: 193d6840762d6ccf570637503a0da9323a5f1de02d34786a422c6ee2a2559481
  // claim: sol:@C@wLitiSale@F@getMasterReferrerWallet#464:path:2
  // witness-fingerprint-sha256: 6b7695490a77df46585b27704a9711542a75b97cace2aaca430602608e5ab50d

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@wLitiSale@F@getMasterReferrerWallet#464:path:3   depth=1
  ...
  //   state._masterReferrerWallet in [0, 1461501637330902918203684832716283019655932542975]
  //   PIN block.basefee == 0
  ...
  //   rung IMPLIED (not lost, not asserted twice): _masterReferrerWallet: post <= pre (entailed by a stronger rung that also HOLDS on _masterReferrerWallet, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): _masterReferrerWallet: post == (pre + msg.value) (entailed by a stronger rung that also HOLDS on _masterReferrerWallet, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): _masterReferrerWallet: post in [msg.value, msg.value] (entailed by a stronger rung that also HOLDS on _masterReferrerWallet, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): _masterReferrerWallet: post in [0, pre] (entailed by a stronger rung that also HOLDS on _masterReferrerWallet, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): _masterReferrerWallet: post in [0, (pre + pre)] (entailed by a stronger rung that also HOLDS on _masterReferrerWallet, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): _masterReferrerWallet: post in [0, (pre * pre)] (entailed by a stronger rung that also HOLDS on _masterReferrerWallet, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): _masterReferrerWallet: post in [0, (pre + 1461501637330902918203684832716283019655932542975)] (entailed by a stronger rung that also HOLDS on _masterReferrerWallet, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): _masterReferrerWallet: post in [0, (pre * 1461501637330902918203684832716283019655932542975)] (entailed by a stronger rung that also HOLDS on _masterReferrerWallet, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): _masterReferrerWallet: post in [0, (msg.value - pre)] (entailed by a stronger rung that also HOLDS on _masterReferrerWallet, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): _masterReferrerWallet: post in [0, (msg.value + 1461501637330902918203684832716283019655932542975)] (entailed by a stronger rung that also HOLDS on _masterReferrerWallet, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): _masterReferrerWallet: post in [0, (1461501637330902918203684832716283019655932542975 - pre)] (entailed by a stronger rung that also HOLDS on _masterReferrerWallet, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): _masterReferrerWallet: post in [0, (pre / 1461501637330902918203684832716283019655932542975)] (entailed by a stronger rung that also HOLDS on _masterReferrerWallet, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): _masterReferrerWallet: post in [0, (msg.value / 1461501637330902918203684832716283019655932542975)] (entailed by a stronger rung that also HOLDS on _masterReferrerWallet, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): _masterReferrerWallet: post in [0, (1461501637330902918203684832716283019655932542975 / 1461501637330902918203684832716283019655932542975)] (entailed by a stronger rung that also HOLDS on _masterReferrerWallet, so asserting it detects nothing the stronger one misses)
  //   entry-state bound DROPPED: state._masterReferrerWallet in [0, 1461501637330902918203684832716283019655932542975] (width > 1, DROPPED: the entry state is not havoc'd, so this bound constrained nothing in the query -- the rungs were proved about the constructor's own value. Establishing a fuzz-chosen value here would test entry states the proof never covered, which is how this PUT came back RED on the unmodified contract. Both endpoints are the type's own limits, so there is not even an in-region check to make: the bound says nothing at all)
