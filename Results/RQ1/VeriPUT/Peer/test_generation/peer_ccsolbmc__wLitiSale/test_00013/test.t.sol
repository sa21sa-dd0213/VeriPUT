...
contract wLitiSaleCovTest_wLitiSale_getMaxBonusPercent_put3p1 is Test {
  wLitiSale c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    uint256 _ret_pre_maxBonusPercent = uint256(vm.load(address(c0), bytes32(uint256(2))));
    uint256 _pre_maxBonusPercent = uint256(vm.load(address(c0), bytes32(uint256(2))));
    ...
    uint256 _put_ret = c0.getMaxBonusPercent();
    ...
    uint256 _post_maxBonusPercent = uint256(vm.load(address(c0), bytes32(uint256(2))));
    assertEq(_post_maxBonusPercent, _pre_maxBonusPercent, "_maxBonusPercent: post == pre");
    assertEq(_post_maxBonusPercent, 0, "_maxBonusPercent: post == msg.value");
    assertEq(_post_maxBonusPercent, _pre_maxBonusPercent, "_maxBonusPercent: post == state._maxBonusPercent");
    unchecked { assertEq(_post_maxBonusPercent, (uint256(_pre_maxBonusPercent) + uint256(_pre_maxBonusPercent)), "_maxBonusPercent: post == (pre + pre)"); }
    unchecked { assertEq(_post_maxBonusPercent, (uint256(_pre_maxBonusPercent) * uint256(_pre_maxBonusPercent)), "_maxBonusPercent: post == (pre * pre)"); }
    unchecked { assertEq(_post_maxBonusPercent, (uint256(_pre_maxBonusPercent) + uint256(_pre_maxBonusPercent)), "_maxBonusPercent: post == (pre + state._maxBonusPercent)"); }
    unchecked { assertEq(_post_maxBonusPercent, (uint256(_pre_maxBonusPercent) - uint256(_pre_maxBonusPercent)), "_maxBonusPercent: post == (pre - state._maxBonusPercent)"); }
    unchecked { assertEq(_post_maxBonusPercent, (uint256(_pre_maxBonusPercent) * uint256(_pre_maxBonusPercent)), "_maxBonusPercent: post == (pre * state._maxBonusPercent)"); }
    unchecked { assertEq(_post_maxBonusPercent, (uint256(_pre_maxBonusPercent) * uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)), "_maxBonusPercent: post == (pre * 115792089237316195423570985008687907853269984665640564039457584007913129639935)"); }
    unchecked { assertEq(_post_maxBonusPercent, (uint256(_pre_maxBonusPercent) * uint256(115792089237316195423570985008687907853269984665640564039457584007913129639934)), "_maxBonusPercent: post == (pre * 115792089237316195423570985008687907853269984665640564039457584007913129639934)"); }
    unchecked { assertEq(_post_maxBonusPercent, (uint256(0) - uint256(_pre_maxBonusPercent)), "_maxBonusPercent: post == (msg.value - pre)"); }
    unchecked { assertEq(_post_maxBonusPercent, (uint256(0) - uint256(_pre_maxBonusPercent)), "_maxBonusPercent: post == (msg.value - state._maxBonusPercent)"); }
    unchecked { assertEq(_post_maxBonusPercent, (uint256(_pre_maxBonusPercent) - uint256(_pre_maxBonusPercent)), "_maxBonusPercent: post == (state._maxBonusPercent - pre)"); }
    unchecked { assertEq(_post_maxBonusPercent, (uint256(_pre_maxBonusPercent) + uint256(_pre_maxBonusPercent)), "_maxBonusPercent: post == (state._maxBonusPercent + state._maxBonusPercent)"); }
    unchecked { assertEq(_post_maxBonusPercent, (uint256(_pre_maxBonusPercent) * uint256(_pre_maxBonusPercent)), "_maxBonusPercent: post == (state._maxBonusPercent * state._maxBonusPercent)"); }
    unchecked { assertEq(_post_maxBonusPercent, (uint256(_pre_maxBonusPercent) * uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)), "_maxBonusPercent: post == (state._maxBonusPercent * 115792089237316195423570985008687907853269984665640564039457584007913129639935)"); }
    unchecked { assertEq(_post_maxBonusPercent, (uint256(_pre_maxBonusPercent) * uint256(115792089237316195423570985008687907853269984665640564039457584007913129639934)), "_maxBonusPercent: post == (state._maxBonusPercent * 115792089237316195423570985008687907853269984665640564039457584007913129639934)"); }
    unchecked { assertEq(_post_maxBonusPercent, (uint256(_pre_maxBonusPercent) / uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)), "_maxBonusPercent: post == (pre / 115792089237316195423570985008687907853269984665640564039457584007913129639935)"); }
    unchecked { assertEq(_post_maxBonusPercent, (uint256(_pre_maxBonusPercent) / uint256(115792089237316195423570985008687907853269984665640564039457584007913129639934)), "_maxBonusPercent: post == (pre / 115792089237316195423570985008687907853269984665640564039457584007913129639934)"); }
    unchecked { assertEq(_post_maxBonusPercent, (uint256(0) / uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)), "_maxBonusPercent: post == (msg.value / 115792089237316195423570985008687907853269984665640564039457584007913129639935)"); }
    unchecked { assertEq(_post_maxBonusPercent, (uint256(0) / uint256(115792089237316195423570985008687907853269984665640564039457584007913129639934)), "_maxBonusPercent: post == (msg.value / 115792089237316195423570985008687907853269984665640564039457584007913129639934)"); }
    unchecked { assertEq(_post_maxBonusPercent, (uint256(_pre_maxBonusPercent) / uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)), "_maxBonusPercent: post == (state._maxBonusPercent / 115792089237316195423570985008687907853269984665640564039457584007913129639935)"); }
    unchecked { assertEq(_post_maxBonusPercent, (uint256(_pre_maxBonusPercent) / uint256(115792089237316195423570985008687907853269984665640564039457584007913129639934)), "_maxBonusPercent: post == (state._maxBonusPercent / 115792089237316195423570985008687907853269984665640564039457584007913129639934)"); }
    unchecked { assertEq(_post_maxBonusPercent, (uint256(115792089237316195423570985008687907853269984665640564039457584007913129639934) / uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)), "_maxBonusPercent: post == (115792089237316195423570985008687907853269984665640564039457584007913129639934 / 115792089237316195423570985008687907853269984665640564039457584007913129639935)"); }
    assertEq(uint256(_put_ret), 0, "return: return == 0");
    assertEq(uint256(_put_ret), _ret_pre_maxBonusPercent, "return: return == state._maxBonusPercent");
    
  }


  
  function test_put_wLitiSale_getMaxBonusPercent_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { wLitiSaleCovTest_wLitiSale_getMaxBonusPercent_concrete3p1__basis_root__W _veriput_w = new wLitiSaleCovTest_wLitiSale_getMaxBonusPercent_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract wLitiSaleCovTest_wLitiSale_getMaxBonusPercent_concrete3p1__basis_root__W is Test {
  wLitiSale c0;
  function setUp() public {
    c0 = new wLitiSale();
  }
  ...
  function _w_test_cov_0() public {
    ...
    uint256 _veriput_concrete_return = c0.getMaxBonusPercent();
