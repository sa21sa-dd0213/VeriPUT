...
contract wLitiSaleCovTest_wLitiSale_setReferrerBonusPercent_put2p1 is Test {
  wLitiSale c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address referrer, uint256 bonusPercent) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("setReferrerBonusPercent(address,uint256)", referrer, bonusPercent));
  ...
  function test_put_wLitiSale_setReferrerBonusPercent_path2p1(address p_msg_sender, uint256 p_msg_value, address referrer, uint256 bonusPercent) public {
