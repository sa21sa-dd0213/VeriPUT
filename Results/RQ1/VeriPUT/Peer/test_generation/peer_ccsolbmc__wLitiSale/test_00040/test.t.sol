...
contract wLitiSaleCovTest_wLitiSale_setReferrerBonusPercent_put2p1 is Test {
  ...
  // claim: sol:@C@wLitiSale@F@setReferrerBonusPercent#907:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@wLitiSale@F@setReferrerBonusPercent#907:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, referrer, bonusPercent
