...
contract wLitiSaleCovTest_wLitiSale_getSaleCount_put3p1 is Test {
  wLitiSale c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    uint256 _ret_pre_saleCount = uint256(vm.load(address(c0), bytes32(uint256(6))));
    uint256 _pre_saleCount = uint256(vm.load(address(c0), bytes32(uint256(6))));
    ...
    uint256 _put_ret = c0.getSaleCount();
  ...
  function test_put_wLitiSale_getSaleCount_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { wLitiSaleCovTest_wLitiSale_getSaleCount_concrete3p1__basis_root__W _veriput_w = new wLitiSaleCovTest_wLitiSale_getSaleCount_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract wLitiSaleCovTest_wLitiSale_getSaleCount_concrete3p1__basis_root__W is Test {
  wLitiSale c0;
  function setUp() public {
    c0 = new wLitiSale();
  }
