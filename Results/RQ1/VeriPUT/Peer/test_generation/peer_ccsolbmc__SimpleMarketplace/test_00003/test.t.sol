...
contract SimpleMarketplaceCovTest_SimpleMarketplace_AcceptOffer_put7p1_p1_part_part0_w is Test {
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    vm.assume(uint256(uint160(p_msg_sender)) == _pre_InstanceOwner);
    ...
    if (p_msg_sender == address(uint160(0))) {
      ...
      assertEq((uint256(vm.load(address(c0), bytes32(uint256(3)))) & 255), uint256(2), "fixed witness state");
    }
  ...
  function test_put_SimpleMarketplace_AcceptOffer_path7p1_part_part0_w(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { SimpleMarketplaceCovTest_SimpleMarketplace_AcceptOffer_concrete7p1__basis_part0_w__W _veriput_w = new SimpleMarketplaceCovTest_SimpleMarketplace_AcceptOffer_concrete7p1__basis_part0_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract SimpleMarketplaceCovTest_SimpleMarketplace_AcceptOffer_concrete7p1__basis_part0_w__W is Test {
  SimpleMarketplace c0;
  function setUp() public {
    c0 = new SimpleMarketplace();
  }
  ...
  function _w_test_cov_0() public {
    ...
    assertEq(_veriput_fixed_state_State_4, uint256(2), "fixed witness state");
  }
