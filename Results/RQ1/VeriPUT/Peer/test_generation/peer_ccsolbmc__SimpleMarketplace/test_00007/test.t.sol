...
contract SimpleMarketplaceCovTest_SimpleMarketplace_acbd_put2p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, string memory description) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("acbd(string,int256)", description, int256(1)));
  ...
  function test_put_SimpleMarketplace_acbd_path2p1(address p_msg_sender, uint256 p_msg_value, string memory description) public {
