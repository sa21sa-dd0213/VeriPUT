...
contract SimpleMarketplaceCovTest_SimpleMarketplace_AcceptOffer_put6p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    bool _put_ok = true;
    try c0.AcceptOffer() {} catch { _put_ok = false; }
  ...
  function test_put_SimpleMarketplace_AcceptOffer_path6p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { SimpleMarketplaceCovTest_SimpleMarketplace_AcceptOffer_concrete6p1__basis_root__W _veriput_w = new SimpleMarketplaceCovTest_SimpleMarketplace_AcceptOffer_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract SimpleMarketplaceCovTest_SimpleMarketplace_AcceptOffer_concrete6p1__basis_root__W is Test {
  SimpleMarketplace c0;
  function setUp() public {
    c0 = new SimpleMarketplace();
  }
