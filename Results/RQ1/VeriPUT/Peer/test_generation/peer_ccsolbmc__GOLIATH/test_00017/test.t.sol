...
contract GOLIATHCovTest_GOLIATH_transfer_put31p1_p1_part_part0_r_w is Test {
  GOLIATH c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address recipient, uint256 amount) internal {
    p_msg_sender = address(uint160(bound(uint256(uint160(p_msg_sender)), 4186961192, 4240965535)));
    ...
    if (p_msg_sender == address(uint160(4186961192)) && recipient == address(uint160(1)) && amount == uint256(0)) {
      ...
      assertEq(uint256(vm.load(address(c0), keccak256(abi.encode(address(uint160(4186961192)), uint256(1))))), uint256(0), "fixed witness state");
  ...
  function test_put_GOLIATH_transfer_path31p1_part_part0_r_w(address p_msg_sender, address recipient, uint256 amount) public {
    _veriput_parameterized(p_msg_sender, recipient, amount);
    
    { GOLIATHCovTest_GOLIATH_transfer_concrete31p1__basis_part0_r_w__W _veriput_w = new GOLIATHCovTest_GOLIATH_transfer_concrete31p1__basis_part0_r_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract GOLIATHCovTest_GOLIATH_transfer_concrete31p1__basis_part0_r_w__W is Test {
  GOLIATH c0;
  function setUp() public {
    c0 = new GOLIATH();
  }
  ...
  function _w_test_cov_0() public {
    ...
    uint256 _veriput_fixed_state_balances_4186961192_2 = uint256(vm.load(address(c0), keccak256(abi.encode(address(uint160(4186961192)), uint256(1)))));
    assertEq(_veriput_fixed_state_balances_4186961192_2, uint256(0), "fixed witness state");
