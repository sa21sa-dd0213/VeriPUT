...
contract GOLIATHCovTest_GOLIATH_getTaxPercent_put3p1 is Test {
  ...
  // claim: sol:@C@GOLIATH@F@getTaxPercent#240:path:3
  // witness-fingerprint-sha256: 4a1dcef8a8ca4a7779a7ece9e2c2e29f5b2f411959ff088e43422701e4c08782
  // claim: sol:@C@GOLIATH@F@getTaxPercent#240:path:2
  // witness-fingerprint-sha256: 283a9c0e50ff5042e927c131122c09e32d47eb37e6334b274fe43ffb8108f7fc

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@GOLIATH@F@getTaxPercent#240:path:3   depth=1
  ...
  // --path-cov-assert -- 34 over POST-STATE, read through vm.load at
  ...
  //   rung IMPLIED (not lost, not asserted twice): taxPercent: post <= pre (entailed by a stronger rung that also HOLDS on taxPercent, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): taxPercent: post == (pre + msg.value) (entailed by a stronger rung that also HOLDS on taxPercent, so asserting it detects nothing the stronger one misses)
