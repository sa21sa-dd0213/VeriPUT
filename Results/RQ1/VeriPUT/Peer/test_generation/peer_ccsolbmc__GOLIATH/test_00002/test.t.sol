...
contract GOLIATHCovTest_GOLIATH_allowance_put3p1 is Test {
  GOLIATH c0;
  ...
  function test_put_GOLIATH_allowance_path3p1(address p_msg_sender, address owner, address spender) public {
    _veriput_parameterized(p_msg_sender, owner, spender);
    
    { GOLIATHCovTest_GOLIATH_allowance_concrete3p1__basis_root__W _veriput_w = new GOLIATHCovTest_GOLIATH_allowance_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract GOLIATHCovTest_GOLIATH_allowance_concrete3p1__basis_root__W is Test {
  GOLIATH c0;
  function setUp() public {
    c0 = new GOLIATH();
  }
