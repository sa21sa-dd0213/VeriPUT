...
contract GOLIATHCovTest_GOLIATH_owner_put3p1 is Test {
  ...
  // claim: sol:@C@GOLIATH@F@owner#74:path:3
  // witness-fingerprint-sha256: fb3aac24d5b76cfb3054e79d385b84470d964ba2eabc7ed9a5bdb6cf90bbedf8
  // claim: sol:@C@GOLIATH@F@owner#74:path:2
  // witness-fingerprint-sha256: e0d4e258de512dd51ddac4ef926192d0d39da628628da79293714ec5c3b304f5

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@GOLIATH@F@owner#74:path:3   depth=1
  ...
  //   state._owner$44 in [0, 1461501637330902918203684832716283019655932542975]
  //   PIN block.basefee == 0
  ...
  //   rung DROPPED: return: return == state._owner$44 (rung shape not renderable for its declared type)
