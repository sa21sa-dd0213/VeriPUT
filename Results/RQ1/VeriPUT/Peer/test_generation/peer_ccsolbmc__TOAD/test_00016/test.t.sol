...
contract TOADCovTest_TOAD_reflectionFromToken_put6p1_p1_part_part0_r is Test {
  TOAD c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 tAmount, bool deductTransferFee) internal {
    ...
    vm.assume(tAmount > 100000000000000);
  ...
  function test_put_TOAD_reflectionFromToken_path6p1_part_part0_r(address p_msg_sender, uint256 tAmount, bool deductTransferFee) public {
    _veriput_parameterized(p_msg_sender, tAmount, deductTransferFee);
    
    { TOADCovTest_TOAD_reflectionFromToken_concrete6p1__basis_part0_r__W _veriput_w = new TOADCovTest_TOAD_reflectionFromToken_concrete6p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract TOADCovTest_TOAD_reflectionFromToken_concrete6p1__basis_part0_r__W is Test {
  TOAD c0;
  function setUp() public {
    c0 = new TOAD();
  }
