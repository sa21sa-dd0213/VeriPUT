...
contract TOADCovTest_TOAD_owner_put3p1 is Test {
  TOAD c0;
  ...
  function test_put_TOAD_owner_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { TOADCovTest_TOAD_owner_concrete3p1__basis_root__W _veriput_w = new TOADCovTest_TOAD_owner_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract TOADCovTest_TOAD_owner_concrete3p1__basis_root__W is Test {
  TOAD c0;
  function setUp() public {
    c0 = new TOAD();
  }
