...
contract TOADCovTest_TOAD_reflectionFromToken_put15p1 is Test {
  TOAD c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 tAmount, bool deductTransferFee) internal {
    ...
    if (p_msg_sender == address(uint160(0)) && tAmount == uint256(87933285515264) && deductTransferFee == true) {
  ...
  function test_put_TOAD_reflectionFromToken_path15p1(address p_msg_sender, uint256 tAmount, bool deductTransferFee) public {
    _veriput_parameterized(p_msg_sender, tAmount, deductTransferFee);
    
    { TOADCovTest_TOAD_reflectionFromToken_concrete15p1__basis_root__W _veriput_w = new TOADCovTest_TOAD_reflectionFromToken_concrete15p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract TOADCovTest_TOAD_reflectionFromToken_concrete15p1__basis_root__W is Test {
  TOAD c0;
  function setUp() public {
    c0 = new TOAD();
  }
  ...
  function _w_test_cov_2() public {
    ...
    uint256 _veriput_concrete_return = c0.reflectionFromToken(uint256(87933285515264), true);
