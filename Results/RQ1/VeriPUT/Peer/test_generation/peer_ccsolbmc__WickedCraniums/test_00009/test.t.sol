...
contract WickedCraniumsCovTest_WickedCraniums_supportsInterface_put3p1 is Test {
  WickedCraniums c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint32 interfaceId) internal {
    ...
    uint256 _pre_supportedInterfaces_interfaceId = (uint256(vm.load(address(c0), keccak256(abi.encode(bytes4(interfaceId), uint256(0))))) & 255);
    ...
    uint256 _post_supportedInterfaces_interfaceId = (uint256(vm.load(address(c0), keccak256(abi.encode(bytes4(interfaceId), uint256(0))))) & 255);
    assertEq(_post_supportedInterfaces_interfaceId, _pre_supportedInterfaces_interfaceId, "_supportedInterfaces[interfaceId]: post == pre");
  ...
  function test_put_WickedCraniums_supportsInterface_path3p1(address p_msg_sender, uint32 interfaceId) public {
    _veriput_parameterized(p_msg_sender, interfaceId);
    
    { WickedCraniumsCovTest_WickedCraniums_supportsInterface_concrete3p1__basis_root__W _veriput_w = new WickedCraniumsCovTest_WickedCraniums_supportsInterface_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract WickedCraniumsCovTest_WickedCraniums_supportsInterface_concrete3p1__basis_root__W is Test {
  WickedCraniums c0;
  function setUp() public {
    c0 = new WickedCraniums();
  }
