...
contract WickedCraniumsCovTest_WickedCraniums_tokenURI_put2p1 is Test {
  WickedCraniums c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, uint256 tokenId) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("tokenURI(uint256)", tokenId));
  ...
  function test_put_WickedCraniums_tokenURI_path2p1(address p_msg_sender, uint256 p_msg_value, uint256 tokenId) public {
