...
contract KOALACovTest_KOALA_approve_put14p1_p1_part_part0_w_r is Test {
  KOALA c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address spender, uint256 amount) internal {
    ...
    if (p_msg_sender == address(uint160(2093481895)) && spender == address(uint160(0)) && amount == uint256(0)) {
  ...
  function test_put_KOALA_approve_path14p1_part_part0_w_r(address p_msg_sender, address spender, uint256 amount) public {
    _veriput_parameterized(p_msg_sender, spender, amount);
    
    { KOALACovTest_KOALA_approve_concrete14p1__basis_part0_w_r__W _veriput_w = new KOALACovTest_KOALA_approve_concrete14p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract KOALACovTest_KOALA_approve_concrete14p1__basis_part0_w_r__W is Test {
  KOALA c0;
  function setUp() public {
    c0 = new KOALA();
  }
