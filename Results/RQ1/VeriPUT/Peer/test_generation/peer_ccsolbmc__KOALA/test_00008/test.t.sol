...
contract KOALACovTest_KOALA_decimals_put3p1 is Test {
  KOALA c0;
  ...
  function test_put_KOALA_decimals_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { KOALACovTest_KOALA_decimals_concrete3p1__basis_root__W _veriput_w = new KOALACovTest_KOALA_decimals_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract KOALACovTest_KOALA_decimals_concrete3p1__basis_root__W is Test {
  KOALA c0;
  function setUp() public {
    c0 = new KOALA();
  }
