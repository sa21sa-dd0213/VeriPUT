...
contract KOALACovTest_KOALA_reflectionFromToken_put6p1_p1_part_part0_r is Test {
  KOALA c0;
  ...
  function test_put_KOALA_reflectionFromToken_path6p1_part_part0_r(address p_msg_sender, uint256 tAmount, bool deductTransferFee) public {
    _veriput_parameterized(p_msg_sender, tAmount, deductTransferFee);
    
    { KOALACovTest_KOALA_reflectionFromToken_concrete6p1__basis_part0_r__W _veriput_w = new KOALACovTest_KOALA_reflectionFromToken_concrete6p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract KOALACovTest_KOALA_reflectionFromToken_concrete6p1__basis_part0_r__W is Test {
  KOALA c0;
  function setUp() public {
    c0 = new KOALA();
  }
