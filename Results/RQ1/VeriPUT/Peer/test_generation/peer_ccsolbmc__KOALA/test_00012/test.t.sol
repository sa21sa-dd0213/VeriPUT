...
contract KOALACovTest_KOALA_owner_put3p1 is Test {
  KOALA c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    assertEq(_post_owner, _pre_owner_396, "_owner: post == state._owner$396");
  ...
  function test_put_KOALA_owner_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { KOALACovTest_KOALA_owner_concrete3p1__basis_root__W _veriput_w = new KOALACovTest_KOALA_owner_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract KOALACovTest_KOALA_owner_concrete3p1__basis_root__W is Test {
  KOALA c0;
  function setUp() public {
    c0 = new KOALA();
  }
