...
contract KOALACovTest_KOALA_totalFees_put3p1 is Test {
  KOALA c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    unchecked { assertEq(_post_tFeeTotal, (uint256(_pre_tFeeTotal) - uint256(_pre_tFeeTotal)), "_tFeeTotal: post == (pre - state._tFeeTotal)"); }
    unchecked { assertEq(_post_tFeeTotal, (uint256(_pre_tFeeTotal) * uint256(_pre_tFeeTotal)), "_tFeeTotal: post == (pre * state._tFeeTotal)"); }
    unchecked { assertEq(_post_tFeeTotal, (uint256(_pre_tFeeTotal) * uint256(100000000000000000)), "_tFeeTotal: post == (pre * 100000000000000000)"); }
    ...
    unchecked { assertEq(_post_tFeeTotal, (uint256(_pre_tFeeTotal) * uint256(_pre_tFeeTotal)), "_tFeeTotal: post == (state._tFeeTotal * state._tFeeTotal)"); }
    unchecked { assertEq(_post_tFeeTotal, (uint256(_pre_tFeeTotal) * uint256(100000000000000000)), "_tFeeTotal: post == (state._tFeeTotal * 100000000000000000)"); }
  ...
  function test_put_KOALA_totalFees_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { KOALACovTest_KOALA_totalFees_concrete3p1__basis_root__W _veriput_w = new KOALACovTest_KOALA_totalFees_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract KOALACovTest_KOALA_totalFees_concrete3p1__basis_root__W is Test {
  KOALA c0;
  function setUp() public {
    c0 = new KOALA();
  }
