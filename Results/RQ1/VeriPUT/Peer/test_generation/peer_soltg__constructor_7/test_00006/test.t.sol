...
contract B7CovTest_B7_g7_put7p1_p1_part_part0_w_r is Test {
  B7 c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    p_msg_sender = address(uint160(bound(uint256(uint160(p_msg_sender)), 41, 42)));
    ...
    if (p_msg_sender == address(uint160(41))) {
  ...
  function test_put_B7_g7_path7p1_part_part0_w_r(address p_msg_sender) public {
