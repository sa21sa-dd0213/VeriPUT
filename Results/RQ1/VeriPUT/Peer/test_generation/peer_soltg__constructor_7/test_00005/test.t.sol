...
contract B7CovTest_B7_g7_put7p1_p1_part_part0_r_w is Test {
  B7 c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    p_msg_sender = address(uint160(bound(uint256(uint160(p_msg_sender)), 43, 2147483688)));
    ...
    if (p_msg_sender == address(uint160(43))) {
  ...
  function test_put_B7_g7_path7p1_part_part0_r_w(address p_msg_sender) public {
