...
contract B7CovTest_B7_g7_put7p1_p1_part_part0_r_r is Test {
  B7 c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    p_msg_sender = address(uint160(bound(uint256(uint160(p_msg_sender)), 2147483689, 1461501637330902918203684832716283019655932542975)));
    ...
    uint256 _put_ret = c0.g7();
    
    if (p_msg_sender == address(uint160(2147483689))) {
  ...
  function test_put_B7_g7_path7p1_part_part0_r_r(address p_msg_sender) public {
