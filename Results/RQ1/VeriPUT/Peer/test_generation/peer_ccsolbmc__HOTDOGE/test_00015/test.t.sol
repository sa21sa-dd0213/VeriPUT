...
contract HOTDOGECovTest_HOTDOGE_totalFees_put3p1 is Test {
  HOTDOGE c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    uint256 _ret_pre_tFeeTotal = uint256(vm.load(address(c0), bytes32(uint256(12))));
  ...
  function test_put_HOTDOGE_totalFees_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { HOTDOGECovTest_HOTDOGE_totalFees_concrete3p1__basis_root__W _veriput_w = new HOTDOGECovTest_HOTDOGE_totalFees_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract HOTDOGECovTest_HOTDOGE_totalFees_concrete3p1__basis_root__W is Test {
  HOTDOGE c0;
  function setUp() public {
    c0 = new HOTDOGE();
