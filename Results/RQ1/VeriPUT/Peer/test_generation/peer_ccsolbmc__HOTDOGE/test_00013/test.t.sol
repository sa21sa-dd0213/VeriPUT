...
contract HOTDOGECovTest_HOTDOGE_reflectionFromToken_put6p1_p1_part_part0_w is Test {
  HOTDOGE c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 tAmount, bool deductTransferFee) internal {
    ...
    tAmount = bound(tAmount, 57896044618658097711785492504343953926634992332820282403512837448143516729345, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
    ...
    if (p_msg_sender == address(uint160(0)) && tAmount == uint256(57896044618658097711785492504343953926634992332820282595305246729909361967104) && deductTransferFee == false) {
  ...
  function test_put_HOTDOGE_reflectionFromToken_path6p1_part_part0_w(address p_msg_sender, uint256 tAmount, bool deductTransferFee) public {
    _veriput_parameterized(p_msg_sender, tAmount, deductTransferFee);
    
    { HOTDOGECovTest_HOTDOGE_reflectionFromToken_concrete6p1__basis_part0_w__W _veriput_w = new HOTDOGECovTest_HOTDOGE_reflectionFromToken_concrete6p1__basis_part0_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract HOTDOGECovTest_HOTDOGE_reflectionFromToken_concrete6p1__basis_part0_w__W is Test {
  HOTDOGE c0;
  function setUp() public {
    c0 = new HOTDOGE();
  ...
  function _w_test_cov_0() public {
    ...
    try c0.reflectionFromToken(uint256(57896044618658097711785492504343953926634992332820282595305246729909361967104), false) {
