...
contract HOTDOGECovTest_HOTDOGE_reflectionFromToken_put6p1_p1_part_part0_w is Test {
  ...
  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@HOTDOGE@F@reflectionFromToken#909:path:6   depth=2
  ...
  //   tAmount in [57896044618658097711785492504343953926634992332820282403512837448143516729345, 115792089237316195423570985008687907853269984665640564039457584007913129639935]
  //   PIN block.basefee == 0
