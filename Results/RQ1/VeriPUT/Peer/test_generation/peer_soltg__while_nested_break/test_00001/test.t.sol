...
contract Cwb9CovTest_Cwb9_f_put1895p1 is Test {
  Cwb9 c0;
  ...
  function test_put_Cwb9_f_path1895p1(address p_msg_sender, uint256 p_block_timestamp, uint256 p_block_number, uint256 x, uint256 y, bool b, bool c) public {
    _veriput_parameterized(p_msg_sender, p_block_timestamp, p_block_number, x, y, b, c);
    
    { Cwb9CovTest_Cwb9_f_concrete1895p1__basis_root__W _veriput_w = new Cwb9CovTest_Cwb9_f_concrete1895p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract Cwb9CovTest_Cwb9_f_concrete1895p1__basis_root__W is Test {
  Cwb9 c0;
  function setUp() public {
    c0 = new Cwb9();
  }
  ...
  function _w_test_cov_1() public {
    ...
    c0.f(uint256(9), uint256(9), false, true);
