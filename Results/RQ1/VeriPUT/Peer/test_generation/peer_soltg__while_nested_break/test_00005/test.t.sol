...
contract Cwb9CovTest_Cwb9_f_put6p1 is Test {
  Cwb9 c0;
  ...
  function test_put_Cwb9_f_path6p1(address p_msg_sender, uint256 p_block_timestamp, uint256 p_block_number, uint256 x, uint256 y, bool b, bool c) public {
    _veriput_parameterized(p_msg_sender, p_block_timestamp, p_block_number, x, y, b, c);
    
    { Cwb9CovTest_Cwb9_f_concrete6p1__basis_root__W _veriput_w = new Cwb9CovTest_Cwb9_f_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_4(); }
}
}
...
contract Cwb9CovTest_Cwb9_f_concrete6p1__basis_root__W is Test {
  Cwb9 c0;
  function setUp() public {
    c0 = new Cwb9();
  }
  ...
  function _w_test_cov_4() public {
    ...
    try c0.f(uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935), uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935), true, true) {
