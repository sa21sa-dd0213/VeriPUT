...
contract goldinuCovTest_goldinu_transfer_put3p1 is Test {
  goldinu c0;
  ...
  function test_put_goldinu_transfer_path3p1(address p_msg_sender, address recipient, uint256 amount) public {
    _veriput_parameterized(p_msg_sender, recipient, amount);
    
    { goldinuCovTest_goldinu_transfer_concrete3p1__basis_root__W _veriput_w = new goldinuCovTest_goldinu_transfer_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract goldinuCovTest_goldinu_transfer_concrete3p1__basis_root__W is Test {
  goldinu c0;
  function setUp() public {
    c0 = new goldinu();
  }
