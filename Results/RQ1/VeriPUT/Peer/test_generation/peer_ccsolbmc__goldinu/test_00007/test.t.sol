...
contract goldinuCovTest_goldinu_delBot_put3p1 is Test {
  goldinu c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address notbot) internal {
    ...
    if (p_msg_sender == address(uint160(0)) && notbot == address(uint160(0))) {
      ...
      assertEq((uint256(vm.load(address(c0), keccak256(abi.encode(address(uint160(0)), uint256(4))))) & 255), uint256(0), "fixed witness state");
    ...
    assertEq(_post_bots_notbot, 0, "bots[notbot]: post == false");
    
  }


  
  function test_put_goldinu_delBot_path3p1(address p_msg_sender, address notbot) public {
    _veriput_parameterized(p_msg_sender, notbot);
    
    { goldinuCovTest_goldinu_delBot_concrete3p1__basis_root__W _veriput_w = new goldinuCovTest_goldinu_delBot_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract goldinuCovTest_goldinu_delBot_concrete3p1__basis_root__W is Test {
  goldinu c0;
  function setUp() public {
    c0 = new goldinu();
  }
  ...
  function _w_test_cov_0() public {
    ...
    uint256 _veriput_fixed_state_bots_0_12 = (uint256(vm.load(address(c0), keccak256(abi.encode(address(uint160(0)), uint256(4))))) & 255);
    assertEq(_veriput_fixed_state_bots_0_12, uint256(0), "fixed witness state");
