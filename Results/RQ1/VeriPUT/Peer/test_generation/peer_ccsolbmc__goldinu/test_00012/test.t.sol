...
contract goldinuCovTest_goldinu_setBots_put25p1 is Test {
  goldinu c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address[] memory bots_) internal {
    ...
    if (p_msg_sender == address(uint160(0)) && bots_.length == uint256(2)) {
  ...
  function test_put_goldinu_setBots_path25p1(address p_msg_sender, address[] memory bots_) public {
    _veriput_parameterized(p_msg_sender, bots_);
    
    { goldinuCovTest_goldinu_setBots_concrete25p1__basis_root__W _veriput_w = new goldinuCovTest_goldinu_setBots_concrete25p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract goldinuCovTest_goldinu_setBots_concrete25p1__basis_root__W is Test {
  goldinu c0;
  function setUp() public {
    c0 = new goldinu();
  }
  ...
  function _w_test_cov_0() public {
    ...
    try c0.setBots(new address[](2)) {} catch {}
    ...
    uint256 _veriput_fixed_state_cooldownEnabled_14 = ((uint256(vm.load(address(c0), bytes32(uint256(15)))) >> 184) & 255);

    uint256 _veriput_fixed_state_inSwap_15 = ((uint256(vm.load(address(c0), bytes32(uint256(15)))) >> 168) & 255);

    uint256 _veriput_fixed_state_swapEnabled_16 = ((uint256(vm.load(address(c0), bytes32(uint256(15)))) >> 176) & 255);

    uint256 _veriput_fixed_state_tradingOpen_17 = ((uint256(vm.load(address(c0), bytes32(uint256(15)))) >> 160) & 255);

    uint256 _veriput_fixed_state_uniswapV2Pair_18 = (uint256(vm.load(address(c0), bytes32(uint256(15)))) & 1461501637330902918203684832716283019655932542975);
