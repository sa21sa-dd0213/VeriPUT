...
contract goldinuCovTest_goldinu_setBots_put13p1 is Test {
  goldinu c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address[] memory bots_) internal {
    ...
    if (p_msg_sender == address(uint160(0)) && bots_.length == uint256(1)) {
  ...
  function test_put_goldinu_setBots_path13p1(address p_msg_sender, address[] memory bots_) public {
    _veriput_parameterized(p_msg_sender, bots_);
    
    { goldinuCovTest_goldinu_setBots_concrete13p1__basis_root__W _veriput_w = new goldinuCovTest_goldinu_setBots_concrete13p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract goldinuCovTest_goldinu_setBots_concrete13p1__basis_root__W is Test {
  goldinu c0;
  function setUp() public {
    c0 = new goldinu();
  }
  ...
  function _w_test_cov_0() public {
    ...
    try c0.setBots(new address[](1)) {} catch {}
