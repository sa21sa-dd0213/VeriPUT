...
contract goldinuCovTest_goldinu_setBots_put2p1 is Test {
  goldinu c0;
  ...
  function test_put_goldinu_setBots_path2p1(address p_msg_sender, uint256 p_msg_value, address[] memory bots_) public {
