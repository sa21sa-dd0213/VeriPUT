...
contract goldinuCovTest_goldinu_addLiquidity_put2p1 is Test {
  ...
  // claim: sol:@C@goldinu@F@addLiquidity#991:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@goldinu@F@addLiquidity#991:path:2   depth=1
  ...
  // 32 snapshot local(s) HOISTED to storage: 2 fuzz parameter(s) + 32 snapshot local(s) exceed the 12-slot budget (solc stack reach); the reads and every assertion are unchanged
  ...
  uint256 _pre_allowances_state_uniswapV2Pair__msg_sender; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_allowances_state_uniswapV2Pair__state__FeeAddress; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_allowances_state_uniswapV2Pair__state__marketingWalletAddress; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_allowances_state_uniswapV2Pair__state_uniswapV2Pair; // VERIPUT_HOISTED_SNAPSHOT
  ...
  uint256 _post_allowances_state_uniswapV2Pair__msg_sender; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_allowances_state_uniswapV2Pair__state__FeeAddress; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_allowances_state_uniswapV2Pair__state__marketingWalletAddress; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_allowances_state_uniswapV2Pair__state_uniswapV2Pair; // VERIPUT_HOISTED_SNAPSHOT
