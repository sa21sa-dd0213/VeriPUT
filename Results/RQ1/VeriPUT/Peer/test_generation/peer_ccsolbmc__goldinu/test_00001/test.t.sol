...
contract goldinuCovTest_goldinu_addLiquidity_put2p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value) internal {
    ...
    assertGe(_post_allowances_state_uniswapV2Pair__msg_sender, _pre_allowances_state_uniswapV2Pair__msg_sender, "_allowances[state.uniswapV2Pair][msg.sender]: post >= pre");
    assertLe(_post_allowances_state_uniswapV2Pair__msg_sender, _pre_allowances_state_uniswapV2Pair__msg_sender, "_allowances[state.uniswapV2Pair][msg.sender]: post <= pre");
    assertGe(_post_allowances_state_uniswapV2Pair__state__FeeAddress, _pre_allowances_state_uniswapV2Pair__state__FeeAddress, "_allowances[state.uniswapV2Pair][state._FeeAddress]: post >= pre");
    assertLe(_post_allowances_state_uniswapV2Pair__state__FeeAddress, _pre_allowances_state_uniswapV2Pair__state__FeeAddress, "_allowances[state.uniswapV2Pair][state._FeeAddress]: post <= pre");
    assertGe(_post_allowances_state_uniswapV2Pair__state__marketingWalletAddress, _pre_allowances_state_uniswapV2Pair__state__marketingWalletAddress, "_allowances[state.uniswapV2Pair][state._marketingWalletAddress]: post >= pre");
    assertLe(_post_allowances_state_uniswapV2Pair__state__marketingWalletAddress, _pre_allowances_state_uniswapV2Pair__state__marketingWalletAddress, "_allowances[state.uniswapV2Pair][state._marketingWalletAddress]: post <= pre");
    assertGe(_post_allowances_state_uniswapV2Pair__state_uniswapV2Pair, _pre_allowances_state_uniswapV2Pair__state_uniswapV2Pair, "_allowances[state.uniswapV2Pair][state.uniswapV2Pair]: post >= pre");
    assertLe(_post_allowances_state_uniswapV2Pair__state_uniswapV2Pair, _pre_allowances_state_uniswapV2Pair__state_uniswapV2Pair, "_allowances[state.uniswapV2Pair][state.uniswapV2Pair]: post <= pre");
