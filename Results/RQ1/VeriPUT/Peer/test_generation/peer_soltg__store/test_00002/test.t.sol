...
contract StorageCovTest_Storage_deposit_put3p1_p1_part_part0_r is Test {
  Storage c0;
  ...
  function test_put_Storage_deposit_path3p1_part_part0_r(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { StorageCovTest_Storage_deposit_concrete3p1__basis_part0_r__W _veriput_w = new StorageCovTest_Storage_deposit_concrete3p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract StorageCovTest_Storage_deposit_concrete3p1__basis_part0_r__W is Test {
  Storage c0;
  function setUp() public {
    c0 = new Storage();
  }
