...
contract FrontRunnerCovTest_1_FrontRunner_drainETH_put6p1_p1_part_part0_r_w is Test {
  FrontRunner c0;
  function setUp() public {
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 amount) internal {
    ...
    if (p_msg_sender == address(uint160(2147483646)) && amount == uint256(0)) {
  ...
  function test_put_FrontRunner_drainETH_path6p1_part_part0_r_w(address p_msg_sender, uint256 amount) public {
    _veriput_parameterized(p_msg_sender, amount);
    
    { FrontRunnerCovTest_1_FrontRunner_drainETH_concrete6p1__basis_part0_r_w__W _veriput_w = new FrontRunnerCovTest_1_FrontRunner_drainETH_concrete6p1__basis_part0_r_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract FrontRunnerCovTest_1_FrontRunner_drainETH_concrete6p1__basis_part0_r_w__W is Test {
  FrontRunner c0;
  function setUp() public {
    vm.startPrank(address(uint160(2147483647)), address(uint160(2147483647)));
    c0 = new FrontRunner();
