...
contract FrontRunnerCovTest_1_FrontRunner_kill_put6p1_p1_part_part0_w is Test {
  FrontRunner c0;
  function setUp() public {
  ...
  function test_put_FrontRunner_kill_path6p1_part_part0_w(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { FrontRunnerCovTest_1_FrontRunner_kill_concrete6p1__basis_part0_w__W _veriput_w = new FrontRunnerCovTest_1_FrontRunner_kill_concrete6p1__basis_part0_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract FrontRunnerCovTest_1_FrontRunner_kill_concrete6p1__basis_part0_w__W is Test {
  FrontRunner c0;
  function setUp() public {
    vm.startPrank(address(uint160(2147483647)), address(uint160(2147483647)));
    c0 = new FrontRunner();
