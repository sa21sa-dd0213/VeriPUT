...
contract IdentityManagerCovTest_IdentityManager_addressKnown_put2p1 is Test {
  IdentityManager c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address account) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("addressKnown(address)", account));
  ...
  function test_put_IdentityManager_addressKnown_path2p1(address p_msg_sender, uint256 p_msg_value, address account) public {
