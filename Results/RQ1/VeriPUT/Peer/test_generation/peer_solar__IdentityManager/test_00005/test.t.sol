...
contract IdentityManagerCovTest_IdentityManager_equals_put2p1 is Test {
  IdentityManager c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, uint256 identity, address account) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("equals(uint256,address)", identity, account));
    ...
    assertGe(_post_identities_identity__pointer, _pre_identities_identity__pointer, "_identities[identity].pointer: post >= pre");
    assertLe(_post_identities_identity__pointer, _pre_identities_identity__pointer, "_identities[identity].pointer: post <= pre");
  ...
  function test_put_IdentityManager_equals_path2p1(address p_msg_sender, uint256 p_msg_value, uint256 identity, address account) public {
    _veriput_parameterized(p_msg_sender, p_msg_value, identity, account);
  }
}
