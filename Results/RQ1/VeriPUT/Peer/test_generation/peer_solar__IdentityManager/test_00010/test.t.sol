...
contract IdentityManagerCovTest_IdentityManager_identityExists_put3p1 is Test {
  IdentityManager c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 index) internal {
    ...
    bool _put_ret = c0.identityExists(index);
  ...
  function test_put_IdentityManager_identityExists_path3p1(address p_msg_sender, uint256 index) public {
    _veriput_parameterized(p_msg_sender, index);
    
    { IdentityManagerCovTest_IdentityManager_identityExists_concrete3p1__basis_root__W _veriput_w = new IdentityManagerCovTest_IdentityManager_identityExists_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract IdentityManagerCovTest_IdentityManager_identityExists_concrete3p1__basis_root__W is Test {
  IdentityManager c0;
  function setUp() public {
    c0 = new IdentityManager();
  }
  ...
  function _w_test_cov_0() public {
    ...
    bool _veriput_concrete_return = c0.identityExists(uint256(0));
