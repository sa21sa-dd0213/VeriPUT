...
contract IdentityManagerCovTest_IdentityManager_removeValidator_put2p1 is Test {
  IdentityManager c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, uint256 validator) internal {
    p_msg_sender = address(uint160(bound(uint256(uint160(p_msg_sender)), 1, 1461501637330902918203684832716283019655932542975)));
    p_msg_value = bound(p_msg_value, 1, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
    validator = bound(validator, 0, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
    
    uint256 _pre_index_msg_sender = uint256(vm.load(address(c0), keccak256(abi.encode(p_msg_sender, uint256(1)))));
    uint256 _pre_identities_validator__pointer = (uint256(vm.load(address(c0), keccak256(abi.encode(validator, uint256(0))))) & 1461501637330902918203684832716283019655932542975);
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("removeValidator(uint256)", validator));
    
    uint256 _post_index_msg_sender = uint256(vm.load(address(c0), keccak256(abi.encode(p_msg_sender, uint256(1)))));
    uint256 _post_identities_validator__pointer = (uint256(vm.load(address(c0), keccak256(abi.encode(validator, uint256(0))))) & 1461501637330902918203684832716283019655932542975);
    ...
    assertEq(_post_identities_validator__pointer, _pre_identities_validator__pointer, "_identities[validator].pointer: post == pre");
    ...
    assertGe(_post_identities_validator__pointer, _pre_identities_validator__pointer, "_identities[validator].pointer: post >= pre");
    assertLe(_post_identities_validator__pointer, _pre_identities_validator__pointer, "_identities[validator].pointer: post <= pre");
  ...
  function test_put_IdentityManager_removeValidator_path2p1(address p_msg_sender, uint256 p_msg_value, uint256 validator) public {
    _veriput_parameterized(p_msg_sender, p_msg_value, validator);
  }
}
