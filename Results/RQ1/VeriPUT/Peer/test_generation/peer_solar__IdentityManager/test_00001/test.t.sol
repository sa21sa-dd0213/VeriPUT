...
contract IdentityManagerCovTest_IdentityManager_addValidator_put2p1 is Test {
  ...
  // claim: sol:@C@IdentityManager@F@addValidator#107:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@IdentityManager@F@addValidator#107:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, newValidator
