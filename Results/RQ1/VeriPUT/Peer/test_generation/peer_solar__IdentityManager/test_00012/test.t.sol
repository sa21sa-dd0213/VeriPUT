...
contract IdentityManagerCovTest_IdentityManager_isSender_put3p1 is Test {
  IdentityManager c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 identity) internal {
    ...
    bool _veriput_fixed_return_0 = c0.isSender(identity);
  ...
  function test_put_IdentityManager_isSender_path3p1(address p_msg_sender, uint256 identity) public {
    _veriput_parameterized(p_msg_sender, identity);
    
    { IdentityManagerCovTest_IdentityManager_isSender_concrete3p1__basis_root__W _veriput_w = new IdentityManagerCovTest_IdentityManager_isSender_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract IdentityManagerCovTest_IdentityManager_isSender_concrete3p1__basis_root__W is Test {
  IdentityManager c0;
  function setUp() public {
    c0 = new IdentityManager();
  }
  ...
  function _w_test_cov_0() public {
    ...
    bool _veriput_concrete_return = c0.isSender(uint256(0));
