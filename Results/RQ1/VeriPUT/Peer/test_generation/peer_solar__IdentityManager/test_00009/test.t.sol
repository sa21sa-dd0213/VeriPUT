...
contract IdentityManagerCovTest_IdentityManager_identityExists_put2p1 is Test {
  IdentityManager c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, uint256 index) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("identityExists(uint256)", index));
  ...
  function test_put_IdentityManager_identityExists_path2p1(address p_msg_sender, uint256 p_msg_value, uint256 index) public {
