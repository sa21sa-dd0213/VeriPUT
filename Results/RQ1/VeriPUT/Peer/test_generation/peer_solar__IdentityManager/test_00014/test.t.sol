...
contract IdentityManagerCovTest_IdentityManager_recover_put6p1 is Test {
  ...
  // claim: sol:@C@IdentityManager@F@recover#327:path:6
  // witness-fingerprint-sha256: b91dd08689e65a1f003f2cafef0398625959c9147931bdb0849577c2dbf41cf1
  // claim: sol:@C@IdentityManager@F@recover#327:path:2
  // witness-fingerprint-sha256: b8fc24ba0e43b0c5741c7b26aa662872913add291ba6b7fd897b0b8e3d06d538

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@IdentityManager@F@recover#327:path:6   depth=2
  ...
  //   newPointer in [0, 1461501637330902918203684832716283019655932542975]
  //   PIN block.basefee == 0
  ...
  // FUZZ COORDINATES: msg.sender, index, newPointer
