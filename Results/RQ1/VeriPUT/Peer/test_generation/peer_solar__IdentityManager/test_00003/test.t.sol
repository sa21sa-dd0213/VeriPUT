...
contract IdentityManagerCovTest_IdentityManager_addressKnown_put3p1 is Test {
  IdentityManager c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address account) internal {
    ...
    bool _put_ret = c0.addressKnown(account);
  ...
  function test_put_IdentityManager_addressKnown_path3p1(address p_msg_sender, address account) public {
    _veriput_parameterized(p_msg_sender, account);
    
    { IdentityManagerCovTest_IdentityManager_addressKnown_concrete3p1__basis_root__W _veriput_w = new IdentityManagerCovTest_IdentityManager_addressKnown_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract IdentityManagerCovTest_IdentityManager_addressKnown_concrete3p1__basis_root__W is Test {
  IdentityManager c0;
  function setUp() public {
    c0 = new IdentityManager();
  }
  ...
  function _w_test_cov_0() public {
    ...
    bool _veriput_concrete_return = c0.addressKnown(address(uint160(0)));
