...
contract DosAuctionCovTest_DosAuction_bid_put2p1_p1_part_part0_r_w is Test {
  DosAuction c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    assertFalse(_put_ok, "path enc=2p1_part_part0_r_w exits through a REVERT: the call must fail on the unmodified contract");
  }


  
  function test_put_DosAuction_bid_path2p1_part_part0_r_w(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { DosAuctionCovTest_DosAuction_bid_concrete2p1__basis_part0_r_w__W _veriput_w = new DosAuctionCovTest_DosAuction_bid_concrete2p1__basis_part0_r_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract DosAuctionCovTest_DosAuction_bid_concrete2p1__basis_part0_r_w__W is Test {
  DosAuction c0;
  function setUp() public {
    c0 = new DosAuction();
  }
