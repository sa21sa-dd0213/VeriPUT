...
contract DosAuctionCovTest_DosAuction_bid_put2p1_p1_part_part0_w_r is Test {
  DosAuction c0;
  ...
  function test_put_DosAuction_bid_path2p1_part_part0_w_r(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { DosAuctionCovTest_DosAuction_bid_concrete2p1__basis_part0_w_r__W _veriput_w = new DosAuctionCovTest_DosAuction_bid_concrete2p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract DosAuctionCovTest_DosAuction_bid_concrete2p1__basis_part0_w_r__W is Test {
  DosAuction c0;
  function setUp() public {
    c0 = new DosAuction();
  }
