...
contract PONYCovTest_PONY_isExcluded_put3p1 is Test {
  PONY c0;
  ...
  function test_put_PONY_isExcluded_path3p1(address p_msg_sender, address account) public {
    _veriput_parameterized(p_msg_sender, account);
    
    { PONYCovTest_PONY_isExcluded_concrete3p1__basis_root__W _veriput_w = new PONYCovTest_PONY_isExcluded_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PONYCovTest_PONY_isExcluded_concrete3p1__basis_root__W is Test {
  PONY c0;
  function setUp() public {
    c0 = new PONY();
  }
