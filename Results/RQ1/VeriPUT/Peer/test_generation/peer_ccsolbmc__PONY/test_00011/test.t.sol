...
contract PONYCovTest_PONY_reflectionFromToken_put14p1 is Test {
  PONY c0;
  ...
  function test_put_PONY_reflectionFromToken_path14p1(address p_msg_sender, uint256 tAmount, bool deductTransferFee) public {
    _veriput_parameterized(p_msg_sender, tAmount, deductTransferFee);
    
    { PONYCovTest_PONY_reflectionFromToken_concrete14p1__basis_root__W _veriput_w = new PONYCovTest_PONY_reflectionFromToken_concrete14p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract PONYCovTest_PONY_reflectionFromToken_concrete14p1__basis_root__W is Test {
  PONY c0;
  function setUp() public {
    c0 = new PONY();
  }
