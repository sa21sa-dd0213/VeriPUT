...
contract KyuseishuCovTest_Kyuseishu_owner_put3p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    assertEq(_post_owner, _pre_owner_45, "_owner: post == state._owner$45");
  ...
  function test_put_Kyuseishu_owner_path3p1(address p_msg_sender) public {
    ...
    { KyuseishuCovTest_Kyuseishu_owner_concrete3p1__basis_root__W _veriput_w = new KyuseishuCovTest_Kyuseishu_owner_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract KyuseishuCovTest_Kyuseishu_owner_concrete3p1__basis_root__W is Test {
  Kyuseishu c0;
  function setUp() public {
    c0 = new Kyuseishu();
  }
