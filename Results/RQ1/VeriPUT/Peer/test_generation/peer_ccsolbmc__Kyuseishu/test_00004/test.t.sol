...
contract KyuseishuCovTest_Kyuseishu_approve_put14p1_p1_part_part0_w_r is Test {
  ...
  function test_put_Kyuseishu_approve_path14p1_part_part0_w_r(address p_msg_sender, address spender, uint256 amount) public {
    ...
    { KyuseishuCovTest_Kyuseishu_approve_concrete14p1__basis_part0_w_r__W _veriput_w = new KyuseishuCovTest_Kyuseishu_approve_concrete14p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract KyuseishuCovTest_Kyuseishu_approve_concrete14p1__basis_part0_w_r__W is Test {
  Kyuseishu c0;
  function setUp() public {
    c0 = new Kyuseishu();
  }
