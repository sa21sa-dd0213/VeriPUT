...
contract KyuseishuCovTest_Kyuseishu_balanceOf_put3p1 is Test {
  Kyuseishu c0;
  ...
  function test_put_Kyuseishu_balanceOf_path3p1(address p_msg_sender, address account) public {
    _veriput_parameterized(p_msg_sender, account);
    
    { KyuseishuCovTest_Kyuseishu_balanceOf_concrete3p1__basis_root__W _veriput_w = new KyuseishuCovTest_Kyuseishu_balanceOf_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract KyuseishuCovTest_Kyuseishu_balanceOf_concrete3p1__basis_root__W is Test {
  Kyuseishu c0;
  function setUp() public {
    c0 = new Kyuseishu();
  }
