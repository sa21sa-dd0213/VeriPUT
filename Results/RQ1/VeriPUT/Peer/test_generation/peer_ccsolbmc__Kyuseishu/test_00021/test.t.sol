...
contract KyuseishuCovTest_Kyuseishu_increaseAllowance_put14p1_p1_part_part0_w_r is Test {
  Kyuseishu c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address spender, uint256 addedValue) internal {
    ...
    if (p_msg_sender == address(uint160(1912875088)) && spender == address(uint160(0)) && addedValue == uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)) {
  ...
  function test_put_Kyuseishu_increaseAllowance_path14p1_part_part0_w_r(address p_msg_sender, address spender, uint256 addedValue) public {
