...
contract KyuseishuCovTest_Kyuseishu_decreaseAllowance_put6p1_p1_part_part0_w_r is Test {
  Kyuseishu c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address spender, uint256 subtractedValue) internal {
    ...
    if (p_msg_sender == address(uint160(1912875072)) && spender == address(uint160(0)) && subtractedValue == uint256(57896044618658097711785492504343953926634992332820282019728792003956564819968)) {
  ...
  function test_put_Kyuseishu_decreaseAllowance_path6p1_part_part0_w_r(address p_msg_sender, address spender, uint256 subtractedValue) public {
