...
contract GreeterCovTest_Greeter_changeGoodbye_put2p1 is Test {
  Greeter c0;
  ...
  function test_put_Greeter_changeGoodbye_path2p1(address p_msg_sender, uint256 p_msg_value, uint8 lang, string memory _goodbye) public {
