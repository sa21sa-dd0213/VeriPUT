...
contract Cfc3CovTest_Cfc3_f1_put15p1 is Test {
  Cfc3 c0;
  ...
  function test_put_Cfc3_f1_path15p1(address p_msg_sender, uint256 a) public {
    _veriput_parameterized(p_msg_sender, a);
    
    { Cfc3CovTest_Cfc3_f1_concrete15p1__basis_root__W _veriput_w = new Cfc3CovTest_Cfc3_f1_concrete15p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract Cfc3CovTest_Cfc3_f1_concrete15p1__basis_root__W is Test {
  Cfc3 c0;
  function setUp() public {
    c0 = new Cfc3();
  }
  ...
  function _w_test_cov_1() public {
    ...
    uint256 _veriput_concrete_return = c0.f1(uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935));
