...
contract Rootkit_financeCovTest_Rootkit_finance_allowance_put3p1 is Test {
  Rootkit_finance c0;
  ...
  function test_put_Rootkit_finance_allowance_path3p1(address p_msg_sender, address owner, address spender) public {
    _veriput_parameterized(p_msg_sender, owner, spender);
    
    { Rootkit_financeCovTest_Rootkit_finance_allowance_concrete3p1__basis_root__W _veriput_w = new Rootkit_financeCovTest_Rootkit_finance_allowance_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract Rootkit_financeCovTest_Rootkit_finance_allowance_concrete3p1__basis_root__W is Test {
  Rootkit_finance c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new Rootkit_finance();
