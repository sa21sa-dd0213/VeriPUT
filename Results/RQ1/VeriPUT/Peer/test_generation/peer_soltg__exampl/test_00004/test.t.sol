...
contract ACovTest_A_set_put3p1_p1_part_part0_r is Test {
  A c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 j) internal {
    ...
    j = bound(j, 115792089237316195423570985008687907853269984665640564039457584007913129639935, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
    ...
    if (p_msg_sender == address(uint160(0)) && j == uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)) {
  ...
  function test_put_A_set_path3p1_part_part0_r(address p_msg_sender, uint256 j) public {
    _veriput_parameterized(p_msg_sender, j);
    
    { ACovTest_A_set_concrete3p1__basis_part0_r__W _veriput_w = new ACovTest_A_set_concrete3p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract ACovTest_A_set_concrete3p1__basis_part0_r__W is Test {
  A c0;
  function setUp() public {
    c0 = new A();
  }
