...
contract ACovTest_A_set_put3p1_p1_part_part0_w_w is Test {
  ...
  function test_put_A_set_path3p1_part_part0_w_w(address p_msg_sender, uint256 j) public {
    ...
    { ACovTest_A_set_concrete3p1__basis_part0_w_w__W _veriput_w = new ACovTest_A_set_concrete3p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract ACovTest_A_set_concrete3p1__basis_part0_w_w__W is Test {
  A c0;
  function setUp() public {
    c0 = new A();
  }
