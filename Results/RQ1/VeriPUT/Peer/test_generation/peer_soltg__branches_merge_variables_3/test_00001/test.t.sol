...
contract Cb6CovTest_Cb6_f_put13p1 is Test {
  Cb6 c0;
  ...
  function test_put_Cb6_f_path13p1(address p_msg_sender, uint256 x) public {
    _veriput_parameterized(p_msg_sender, x);
    
    { Cb6CovTest_Cb6_f_concrete13p1__basis_root__W _veriput_w = new Cb6CovTest_Cb6_f_concrete13p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract Cb6CovTest_Cb6_f_concrete13p1__basis_root__W is Test {
  Cb6 c0;
  function setUp() public {
    c0 = new Cb6();
  }
