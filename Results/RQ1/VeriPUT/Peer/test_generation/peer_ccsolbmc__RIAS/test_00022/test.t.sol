...
contract RIASCovTest_RIAS_setMaxTxBlack_put7p1_p1_part_part0_w_r is Test {
  RIAS c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 maxTxBlackPercent) internal {
    ...
    maxTxBlackPercent = bound(maxTxBlackPercent, 113754843944567746159774252359973978899966910006635987699680, 114417646949184976169479587424697730143824288740496585985951);
    ...
    if (p_msg_sender == address(uint160(0)) && maxTxBlackPercent == uint256(113754843944567746159774252359973978899966910006635987699680)) {
      assertEq((uint256(vm.load(address(c0), bytes32(uint256(8)))) & 255), uint256(18), "fixed witness state");
      assertEq(uint256(vm.load(address(c0), bytes32(uint256(9)))), uint256(113754843944567746159774252359973978899966910006635987699680000000000000000000), "fixed witness state");
  ...
  function test_put_RIAS_setMaxTxBlack_path7p1_part_part0_w_r(address p_msg_sender, uint256 maxTxBlackPercent) public {
    _veriput_parameterized(p_msg_sender, maxTxBlackPercent);
    
    { RIASCovTest_RIAS_setMaxTxBlack_concrete7p1__basis_part0_w_r__W _veriput_w = new RIASCovTest_RIAS_setMaxTxBlack_concrete7p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract RIASCovTest_RIAS_setMaxTxBlack_concrete7p1__basis_part0_w_r__W is Test {
  RIAS c0;
  function setUp() public {
    c0 = new RIAS();
  }
  ...
  function _w_test_cov_0() public {
    ...
    c0.setMaxTxBlack(uint256(113754843944567746159774252359973978899966910006635987699680));
    ...
    assertEq(_veriput_fixed_state_maxBlack_1, uint256(113754843944567746159774252359973978899966910006635987699680000000000000000000), "fixed witness state");
