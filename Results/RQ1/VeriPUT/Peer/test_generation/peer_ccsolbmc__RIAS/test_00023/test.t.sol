...
contract RIASCovTest_RIAS_setMaxTxBlack_put7p1_p1_part_part0_w_w is Test {
  RIAS c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 maxTxBlackPercent) internal {
    ...
    maxTxBlackPercent = bound(maxTxBlackPercent, 0, 113754843944567746159774252359973978899966910006635987699679);
    ...
    if (p_msg_sender == address(uint160(0)) && maxTxBlackPercent == uint256(0)) {
  ...
  function test_put_RIAS_setMaxTxBlack_path7p1_part_part0_w_w(address p_msg_sender, uint256 maxTxBlackPercent) public {
    _veriput_parameterized(p_msg_sender, maxTxBlackPercent);
    
    { RIASCovTest_RIAS_setMaxTxBlack_concrete7p1__basis_part0_w_w__W _veriput_w = new RIASCovTest_RIAS_setMaxTxBlack_concrete7p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract RIASCovTest_RIAS_setMaxTxBlack_concrete7p1__basis_part0_w_w__W is Test {
  RIAS c0;
  function setUp() public {
    c0 = new RIAS();
  }
  ...
  function _w_test_cov_0() public {
    ...
    assertEq(_veriput_fixed_state_maxBlack_1, uint256(0), "fixed witness state");
