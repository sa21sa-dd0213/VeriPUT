...
contract RIASCovTest_RIAS_transferOwnership_put6p1 is Test {
  RIAS c0;
  ...
  function test_put_RIAS_transferOwnership_path6p1(address p_msg_sender, address newOwner) public {
    _veriput_parameterized(p_msg_sender, newOwner);
    
    { RIASCovTest_RIAS_transferOwnership_concrete6p1__basis_root__W _veriput_w = new RIASCovTest_RIAS_transferOwnership_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract RIASCovTest_RIAS_transferOwnership_concrete6p1__basis_root__W is Test {
  RIAS c0;
  function setUp() public {
    c0 = new RIAS();
  }
