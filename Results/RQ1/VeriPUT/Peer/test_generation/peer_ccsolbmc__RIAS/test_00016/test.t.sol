...
contract RIASCovTest_RIAS_setBlackListBot_put7p1_p1_part_part0_w_r is Test {
  RIAS c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address blackListAddress) internal {
    ...
    blackListAddress = address(uint160(bound(uint256(uint160(blackListAddress)), 730750818665451459101842416358141509827966271487, 1461501637330902918203684832716283019655932542974)));
    ...
    if (p_msg_sender == address(uint160(0)) && blackListAddress == address(uint160(730750818665451459101842416358141509827966271487))) {
      ...
      assertEq((uint256(vm.load(address(c0), bytes32(uint256(3)))) & 1461501637330902918203684832716283019655932542975), uint256(730750818665451459101842416358141509827966271487), "fixed witness state");
  ...
  function test_put_RIAS_setBlackListBot_path7p1_part_part0_w_r(address p_msg_sender, address blackListAddress) public {
    _veriput_parameterized(p_msg_sender, blackListAddress);
    
    { RIASCovTest_RIAS_setBlackListBot_concrete7p1__basis_part0_w_r__W _veriput_w = new RIASCovTest_RIAS_setBlackListBot_concrete7p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract RIASCovTest_RIAS_setBlackListBot_concrete7p1__basis_part0_w_r__W is Test {
  RIAS c0;
  function setUp() public {
    c0 = new RIAS();
  }
  ...
  function _w_test_cov_0() public {
    ...
    c0.setBlackListBot(address(uint160(730750818665451459101842416358141509827966271487)));
    ...
    assertEq(_veriput_fixed_state_tBotAddress_4, uint256(730750818665451459101842416358141509827966271487), "fixed witness state");
