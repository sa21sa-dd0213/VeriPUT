...
contract RIASCovTest_RIAS_setFeeTotal_put6p1 is Test {
  ...
  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@RIAS@F@setFeeTotal#746:path:6   depth=2
  ...
  // 12 snapshot local(s) HOISTED to storage: 2 fuzz parameter(s) + 12 snapshot local(s) exceed the 12-slot budget (solc stack reach); the reads and every assertion are unchanged
  ...
  uint256 _pre_balances_state__tBlackAddress; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_balances_state__tBotAddress; // VERIPUT_HOISTED_SNAPSHOT
  ...
  uint256 _post_balances_state__tBlackAddress; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_balances_state__tBotAddress; // VERIPUT_HOISTED_SNAPSHOT
