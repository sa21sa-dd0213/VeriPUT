...
contract RIASCovTest_RIAS_setBlackListBot_put6p1 is Test {
  RIAS c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address blackListAddress) internal {
    ...
    blackListAddress = address(uint160(bound(uint256(uint160(blackListAddress)), 0, 1461501637330902918203684832716283019655932542975)));
    ...
    bool _put_ok = true;
    try c0.setBlackListBot(blackListAddress) {} catch { _put_ok = false; }
    
    if (p_msg_sender == address(uint160(1)) && blackListAddress == address(uint160(0))) {
    ...
    assertEq(_post_tBotAddress, _pre_tBotAddress, "_tBotAddress: post == pre");
    assertEq(_post_owner, _pre_owner, "_owner: post == pre");
    assertGe(_post_tBotAddress, _pre_tBotAddress, "_tBotAddress: post >= pre");
    assertLe(_post_tBotAddress, _pre_tBotAddress, "_tBotAddress: post <= pre");
  ...
  function test_put_RIAS_setBlackListBot_path6p1(address p_msg_sender, address blackListAddress) public {
    _veriput_parameterized(p_msg_sender, blackListAddress);
    
    { RIASCovTest_RIAS_setBlackListBot_concrete6p1__basis_root__W _veriput_w = new RIASCovTest_RIAS_setBlackListBot_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract RIASCovTest_RIAS_setBlackListBot_concrete6p1__basis_root__W is Test {
  RIAS c0;
  function setUp() public {
    c0 = new RIAS();
  }
  ...
  function _w_test_cov_1() public {
    ...
    try c0.setBlackListBot(address(uint160(0))) {
