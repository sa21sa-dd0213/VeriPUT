...
contract RIASCovTest_RIAS_setBlackAddress_put7p1_p1_part_part0_w_w is Test {
  RIAS c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address blackAddress) internal {
    ...
    blackAddress = address(uint160(bound(uint256(uint160(blackAddress)), 0, 730750818665451459101842416358141509827966271486)));
    ...
    if (p_msg_sender == address(uint160(0)) && blackAddress == address(uint160(0))) {
  ...
  function test_put_RIAS_setBlackAddress_path7p1_part_part0_w_w(address p_msg_sender, address blackAddress) public {
    _veriput_parameterized(p_msg_sender, blackAddress);
    
    { RIASCovTest_RIAS_setBlackAddress_concrete7p1__basis_part0_w_w__W _veriput_w = new RIASCovTest_RIAS_setBlackAddress_concrete7p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract RIASCovTest_RIAS_setBlackAddress_concrete7p1__basis_part0_w_w__W is Test {
  RIAS c0;
  function setUp() public {
    c0 = new RIAS();
  }
  ...
  function _w_test_cov_0() public {
    ...
    c0.setBlackAddress(address(uint160(0)));
