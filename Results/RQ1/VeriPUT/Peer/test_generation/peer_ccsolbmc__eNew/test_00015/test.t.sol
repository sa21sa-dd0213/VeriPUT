...
contract eNewCovTest_eNew_reflectionFromToken_put14p1 is Test {
  eNew c0;
  ...
  function test_put_eNew_reflectionFromToken_path14p1(address p_msg_sender, uint256 tAmount, bool deductTransferFee) public {
    _veriput_parameterized(p_msg_sender, tAmount, deductTransferFee);
    
    { eNewCovTest_eNew_reflectionFromToken_concrete14p1__basis_root__W _veriput_w = new eNewCovTest_eNew_reflectionFromToken_concrete14p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract eNewCovTest_eNew_reflectionFromToken_concrete14p1__basis_root__W is Test {
  eNew c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new eNew();
