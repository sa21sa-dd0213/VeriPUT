...
contract eNewCovTest_eNew_isExcluded_put2p1 is Test {
  eNew c0;
  ...
  function test_put_eNew_isExcluded_path2p1(address p_msg_sender, uint256 p_msg_value, address account) public {
