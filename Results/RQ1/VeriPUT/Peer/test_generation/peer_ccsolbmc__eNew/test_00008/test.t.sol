...
contract eNewCovTest_eNew_decimals_put3p1 is Test {
  eNew c0;
  ...
  function test_put_eNew_decimals_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { eNewCovTest_eNew_decimals_concrete3p1__basis_root__W _veriput_w = new eNewCovTest_eNew_decimals_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract eNewCovTest_eNew_decimals_concrete3p1__basis_root__W is Test {
  eNew c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new eNew();
