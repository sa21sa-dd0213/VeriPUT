...
contract eNewCovTest_eNew_approve_concrete15p1__basis_root__W is Test {
  ...
  function _w_test_cov_0() public {
    ...
    assertEq(_veriput_fixed_state_decimals_2, uint256(0), "fixed witness state");
    ...
    assertEq(_veriput_fixed_state_owner_389_3, uint256(0), "fixed witness state");
    uint256 _veriput_fixed_state_rOwned_0_4 = uint256(vm.load(address(c0), keccak256(abi.encode(address(uint160(0)), uint256(1)))));
    assertEq(_veriput_fixed_state_rOwned_0_4, uint256(115792089237316195423570985008687907853269984665640564039457584000000000000000), "fixed witness state");
    uint256 _veriput_fixed_state_rTotal_5 = uint256(vm.load(address(c0), bytes32(uint256(6))));
    assertEq(_veriput_fixed_state_rTotal_5, uint256(115792089237316195423570985008687907853269984665640564039457584000000000000000), "fixed witness state");
    uint256 _veriput_fixed_state_tFeeTotal_6 = uint256(vm.load(address(c0), bytes32(uint256(7))));
    assertEq(_veriput_fixed_state_tFeeTotal_6, uint256(0), "fixed witness state");
  }
