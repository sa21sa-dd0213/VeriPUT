...
contract eNewCovTest_eNew_transferOwnership_put14p1 is Test {
  eNew c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address newOwner) internal {
    ...
    assertEq((uint256(vm.load(address(c0), bytes32(uint256(0)))) & 1461501637330902918203684832716283019655932542975), uint256(uint256(uint160(p_msg_sender))), "entry pin state._owner$389 did NOT land: vm.store wrote a word the contract does not read back at this slot, so the test is not inside the certified region and every rung below is about a different state");
    
    uint256 _pre_owner = (uint256(vm.load(address(c0), bytes32(uint256(0)))) & 1461501637330902918203684832716283019655932542975);
    uint256 _pre_owner_389 = (uint256(vm.load(address(c0), bytes32(uint256(0)))) & 1461501637330902918203684832716283019655932542975);
    
    vm.assume(_pre_owner_389 == uint256(uint160(p_msg_sender)));
  ...
  function test_put_eNew_transferOwnership_path14p1(address p_msg_sender, address newOwner) public {
    _veriput_parameterized(p_msg_sender, newOwner);
    
    { eNewCovTest_eNew_transferOwnership_concrete14p1__basis_root__W _veriput_w = new eNewCovTest_eNew_transferOwnership_concrete14p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract eNewCovTest_eNew_transferOwnership_concrete14p1__basis_root__W is Test {
  eNew c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new eNew();
