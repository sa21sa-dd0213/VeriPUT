...
contract eNewCovTest_eNew_transferOwnership_put6p1 is Test {
  eNew c0;
  ...
  function test_put_eNew_transferOwnership_path6p1(address p_msg_sender, address newOwner) public {
    _veriput_parameterized(p_msg_sender, newOwner);
    
    { eNewCovTest_eNew_transferOwnership_concrete6p1__basis_root__W _veriput_w = new eNewCovTest_eNew_transferOwnership_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract eNewCovTest_eNew_transferOwnership_concrete6p1__basis_root__W is Test {
  eNew c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new eNew();
