...
contract eNewCovTest_eNew_transferOwnership_put6p1 is Test {
  ...
  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@eNew@F@transferOwnership#482:path:6   depth=2
  ...
  //   path guard ESTABLISHED: `!(!(_owner$389 == return_value$__msgSender$1))` -> `vm.assume(0 != uint256(uint160(p_msg_sender)));`
