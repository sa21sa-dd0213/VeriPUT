...
contract EdenCoinCovTest_EdenCoin_balanceOf_put2p1 is Test {
  EdenCoin c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address _owner) internal {
    ...
    uint256 _pre_balances__owner = uint256(vm.load(address(c0), keccak256(abi.encode(_owner, uint256(4)))));
    ...
    uint256 _post_balances__owner = uint256(vm.load(address(c0), keccak256(abi.encode(_owner, uint256(4)))));
  ...
  function test_put_EdenCoin_balanceOf_path2p1(address p_msg_sender, uint256 p_msg_value, address _owner) public {
