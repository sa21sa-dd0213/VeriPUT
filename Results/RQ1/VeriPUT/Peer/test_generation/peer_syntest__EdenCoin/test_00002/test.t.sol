...
contract EdenCoinCovTest_EdenCoin_allowance_put3p1 is Test {
  EdenCoin c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address _owner, address _spender) internal {
    ...
    uint256 _ret_pre_allowed__owner___spender = uint256(vm.load(address(c0), keccak256(abi.encode(_spender, keccak256(abi.encode(_owner, uint256(5)))))));
  ...
  function test_put_EdenCoin_allowance_path3p1(address p_msg_sender, address _owner, address _spender) public {
    _veriput_parameterized(p_msg_sender, _owner, _spender);
    
    { EdenCoinCovTest_EdenCoin_allowance_concrete3p1__basis_root__W _veriput_w = new EdenCoinCovTest_EdenCoin_allowance_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract EdenCoinCovTest_EdenCoin_allowance_concrete3p1__basis_root__W is Test {
  EdenCoin c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new EdenCoin();
