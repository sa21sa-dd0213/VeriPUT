...
contract EdenCoinCovTest_EdenCoin_transfer_put2p1 is Test {
  EdenCoin c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address _to, uint256 _value) internal {
    ...
    uint256 _pre_deployer = (uint256(vm.load(address(c0), bytes32(uint256(0)))) & 1461501637330902918203684832716283019655932542975);
    uint256 _pre_multisend = (uint256(vm.load(address(c0), bytes32(uint256(1)))) & 1461501637330902918203684832716283019655932542975);
    ...
    uint256 _post_deployer = (uint256(vm.load(address(c0), bytes32(uint256(0)))) & 1461501637330902918203684832716283019655932542975);
    uint256 _post_multisend = (uint256(vm.load(address(c0), bytes32(uint256(1)))) & 1461501637330902918203684832716283019655932542975);
  ...
  function test_put_EdenCoin_transfer_path2p1(address p_msg_sender, uint256 p_msg_value, address _to, uint256 _value) public {
