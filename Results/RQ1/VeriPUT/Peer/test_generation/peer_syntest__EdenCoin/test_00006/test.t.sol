...
contract EdenCoinCovTest_EdenCoin_balanceOf_put3p1 is Test {
  EdenCoin c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address _owner) internal {
    ...
    uint256 _ret_pre_balances__owner = uint256(vm.load(address(c0), keccak256(abi.encode(_owner, uint256(4)))));
    uint256 _pre_balances_195_msg_sender = uint256(vm.load(address(c0), keccak256(abi.encode(p_msg_sender, uint256(4)))));
    ...
    if (p_msg_sender == address(uint160(0)) && _owner == address(uint160(0))) {
      assertEq(_put_ret, uint256(1000000000000000000000000000), "fixed witness return");
    ...
    uint256 _post_balances_195_msg_sender = uint256(vm.load(address(c0), keccak256(abi.encode(p_msg_sender, uint256(4)))));
    assertEq(_post_balances_195_msg_sender, _pre_balances_195_msg_sender, "balances$195[msg.sender]: post == pre");
    assertGe(_post_balances_195_msg_sender, 0, "balances$195[msg.sender]: post in [0, pre]");
    assertLe(_post_balances_195_msg_sender, _pre_balances_195_msg_sender, "balances$195[msg.sender]: post in [0, pre]");
    assertGe(_post_balances_195_msg_sender, 0, "balances$195[msg.sender]: post in [0, (msg.value + 115792089237316195423570985008687907853269984665640564039457584007913129639935)]");
    unchecked { assertLe(_post_balances_195_msg_sender, (uint256(0) + uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)), "balances$195[msg.sender]: post in [0, (msg.value + 115792089237316195423570985008687907853269984665640564039457584007913129639935)]"); }
  ...
  function test_put_EdenCoin_balanceOf_path3p1(address p_msg_sender, address _owner) public {
    _veriput_parameterized(p_msg_sender, _owner);
    
    { EdenCoinCovTest_EdenCoin_balanceOf_concrete3p1__basis_root__W _veriput_w = new EdenCoinCovTest_EdenCoin_balanceOf_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract EdenCoinCovTest_EdenCoin_balanceOf_concrete3p1__basis_root__W is Test {
  EdenCoin c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new EdenCoin();
  ...
  function _w_test_cov_0() public {
    ...
    assertEq(_veriput_concrete_return, uint256(1000000000000000000000000000), "fixed witness return must match");
