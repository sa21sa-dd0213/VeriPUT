...
contract Cwb11CovTest_Cwb11_f_put58p1 is Test {
  Cwb11 c0;
  ...
  function test_put_Cwb11_f_path58p1(address p_msg_sender, uint256 p_block_timestamp, uint256 p_block_number, uint256 x, uint256 y, bool b, bool c) public {
    _veriput_parameterized(p_msg_sender, p_block_timestamp, p_block_number, x, y, b, c);
    
    { Cwb11CovTest_Cwb11_f_concrete58p1__basis_root__W _veriput_w = new Cwb11CovTest_Cwb11_f_concrete58p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}



contract Cwb11CovTest_Cwb11_f_concrete58p1__basis_root__W is Test {
  Cwb11 c0;
  function setUp() public {
    c0 = new Cwb11();
  }
  ...
  function _w_test_cov_0() public {
    ...
    vm.expectRevert();
    c0.f(uint256(9), uint256(15), false, false);
  }
}
