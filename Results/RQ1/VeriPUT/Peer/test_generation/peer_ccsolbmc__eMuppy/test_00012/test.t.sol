...
contract eMuppyCovTest_eMuppy_balanceOf_put2p1 is Test {
  eMuppy c0;
  ...
  function test_put_eMuppy_balanceOf_path2p1(address p_msg_sender, uint256 p_msg_value, address account) public {
