...
contract eMuppyCovTest_eMuppy_balanceOf_put3p1_p1_part_part0_w_r is Test {
  eMuppy c0;
  ...
  function test_put_eMuppy_balanceOf_path3p1_part_part0_w_r(address p_msg_sender, address account) public {
    _veriput_parameterized(p_msg_sender, account);
    
    { eMuppyCovTest_eMuppy_balanceOf_concrete3p1__basis_part0_w_r__W _veriput_w = new eMuppyCovTest_eMuppy_balanceOf_concrete3p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract eMuppyCovTest_eMuppy_balanceOf_concrete3p1__basis_part0_w_r__W is Test {
  eMuppy c0;
  function setUp() public {
    c0 = new eMuppy();
  }
