...
contract eMuppyCovTest_eMuppy_asbd_put3p1 is Test {
  ...
  // claim: sol:@C@eMuppy@F@asbd#434:path:2, sol:@C@eMuppy@F@asbd#434:path:3
  // witness-fingerprint-sha256: 167c5747c7c3d56facdbdec8361cd0e3eaa531ac08f9f28634934767b1637686

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@eMuppy@F@asbd#434:path:3   depth=1
