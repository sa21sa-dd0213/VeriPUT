...
contract eMuppyCovTest_eMuppy_transfer_put63p1_p1_part_part0_w is Test {
  eMuppy c0;
  ...
  function test_put_eMuppy_transfer_path63p1_part_part0_w(address p_msg_sender, address recipient, uint256 amount) public {
    _veriput_parameterized(p_msg_sender, recipient, amount);
    
    { eMuppyCovTest_eMuppy_transfer_concrete63p1__basis_part0_w__W _veriput_w = new eMuppyCovTest_eMuppy_transfer_concrete63p1__basis_part0_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract eMuppyCovTest_eMuppy_transfer_concrete63p1__basis_part0_w__W is Test {
  eMuppy c0;
  function setUp() public {
    c0 = new eMuppy();
  }
  ...
  function _w_test_cov_0() public {
    ...
    assertEq(_veriput_fixed_state_decimals_413_1, uint256(0), "fixed witness state");
    uint256 _veriput_fixed_state_totalSupply_407_2 = uint256(vm.load(address(c0), bytes32(uint256(2))));
    assertEq(_veriput_fixed_state_totalSupply_407_2, uint256(0), "fixed witness state");
  }
