...
contract AnyswapV5ERC20CovTest_AnyswapV5ERC20_Swapout_put31p1_p1_part_part0_r is Test {
  ...
  //   msg.sender in [2147483648, 1099511627776]
  //   PIN block.basefee == 0
  ...
  //   environment ESTABLISHED: msg.sender in [2147483648, 1099511627776] is ESTABLISHED and FUZZED: the governing vm.prank now takes the bound() fuzz parameter `p_msg_sender`, so this PUT ranges over the certified sender interval rather than over one point of it (replacing `vm.prank(address(uint160(1)));`)
