...
contract AnyswapV5ERC20CovTest_AnyswapV5ERC20_Swapout_put31p1_p1_part_part0_r is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 amount, address bindaddr) internal {
    ...
    if (p_msg_sender == address(uint160(2147483648)) && amount == uint256(0) && bindaddr == address(uint160(1))) {
      ...
      assertEq(uint256(vm.load(address(c0), keccak256(abi.encode(address(uint160(2147483648)), uint256(4))))), uint256(0), "fixed witness state");
...
contract AnyswapV5ERC20CovTest_AnyswapV5ERC20_Swapout_concrete31p1__basis_part0_r__W is Test {
  ...
  function _w_test_cov_1() public {
    ...
    assertEq(_veriput_fixed_state_balanceOf_2147483648_5, uint256(0), "fixed witness state");
    ...
    assertEq(_veriput_fixed_state_delay_7, uint256(172800), "fixed witness state");
    uint256 _veriput_fixed_state_delayDelay_8 = uint256(vm.load(address(c0), bytes32(uint256(16))));
    assertEq(_veriput_fixed_state_delayDelay_8, uint256(0), "fixed witness state");
    uint256 _veriput_fixed_state_delayMinter_9 = uint256(vm.load(address(c0), bytes32(uint256(12))));
    assertEq(_veriput_fixed_state_delayMinter_9, uint256(0), "fixed witness state");
    uint256 _veriput_fixed_state_delayVault_10 = uint256(vm.load(address(c0), bytes32(uint256(14))));
    assertEq(_veriput_fixed_state_delayVault_10, uint256(0), "fixed witness state");
    uint256 _veriput_fixed_state_pendingDelay_11 = uint256(vm.load(address(c0), bytes32(uint256(15))));
    assertEq(_veriput_fixed_state_pendingDelay_11, uint256(0), "fixed witness state");
    ...
    assertEq(_veriput_fixed_state_pendingMinter_12, uint256(0), "fixed witness state");
    ...
    assertEq(_veriput_fixed_state_pendingVault_13, uint256(0), "fixed witness state");
    ...
    assertEq(_veriput_fixed_state_underlying_14, uint256(0), "fixed witness state");
    ...
    assertEq(_veriput_fixed_state_vault_15, uint256(0), "fixed witness state");
  }
