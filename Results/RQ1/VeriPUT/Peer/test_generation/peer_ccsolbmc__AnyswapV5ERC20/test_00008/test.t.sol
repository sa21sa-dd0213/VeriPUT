...
contract AnyswapV5ERC20CovTest_AnyswapV5ERC20_mpc_put2p1 is Test {
  AnyswapV5ERC20 c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("mpc()"));
  ...
  function test_put_AnyswapV5ERC20_mpc_path2p1(address p_msg_sender, uint256 p_msg_value) public {
