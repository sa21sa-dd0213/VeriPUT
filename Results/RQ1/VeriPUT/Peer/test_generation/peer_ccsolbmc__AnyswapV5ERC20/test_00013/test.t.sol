...
contract AnyswapV5ERC20CovTest_AnyswapV5ERC20_setVaultOnly_put2p1 is Test {
  AnyswapV5ERC20 c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, bool enabled) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("setVaultOnly(bool)", enabled));
  ...
  function test_put_AnyswapV5ERC20_setVaultOnly_path2p1(address p_msg_sender, uint256 p_msg_value, bool enabled) public {
    _veriput_parameterized(p_msg_sender, p_msg_value, enabled);
  }
}
