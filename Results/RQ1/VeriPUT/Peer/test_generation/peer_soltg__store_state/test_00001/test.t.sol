...
contract StorageCovTest_Storage_balanceCheck_put2p1 is Test {
  Storage c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("balanceCheck()"));
    ...
    assertGe(_post_UNIQUE_STATE_VAR, _pre_UNIQUE_STATE_VAR, "UNIQUE_STATE_VAR: post >= pre");
    assertLe(_post_UNIQUE_STATE_VAR, _pre_UNIQUE_STATE_VAR, "UNIQUE_STATE_VAR: post <= pre");
  ...
  function test_put_Storage_balanceCheck_path2p1(address p_msg_sender, uint256 p_msg_value) public {
