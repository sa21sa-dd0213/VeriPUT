...
contract VamprireDogeCovTest_VamprireDoge_balanceOf_put3p1 is Test {
  VamprireDoge c0;
  ...
  function test_put_VamprireDoge_balanceOf_path3p1(address p_msg_sender, address owner) public {
    _veriput_parameterized(p_msg_sender, owner);
    
    { VamprireDogeCovTest_VamprireDoge_balanceOf_concrete3p1__basis_root__W _veriput_w = new VamprireDogeCovTest_VamprireDoge_balanceOf_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract VamprireDogeCovTest_VamprireDoge_balanceOf_concrete3p1__basis_root__W is Test {
  VamprireDoge c0;
  function setUp() public {
    c0 = new VamprireDoge();
  }
