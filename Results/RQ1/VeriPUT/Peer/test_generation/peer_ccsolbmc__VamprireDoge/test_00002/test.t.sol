...
contract VamprireDogeCovTest_VamprireDoge_approve_put3p1 is Test {
  VamprireDoge c0;
  ...
  function test_put_VamprireDoge_approve_path3p1(address p_msg_sender, address spender, uint256 value) public {
    _veriput_parameterized(p_msg_sender, spender, value);
    
    { VamprireDogeCovTest_VamprireDoge_approve_concrete3p1__basis_root__W _veriput_w = new VamprireDogeCovTest_VamprireDoge_approve_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract VamprireDogeCovTest_VamprireDoge_approve_concrete3p1__basis_root__W is Test {
  VamprireDoge c0;
  function setUp() public {
    c0 = new VamprireDoge();
  }
