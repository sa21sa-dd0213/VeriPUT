...
contract cs3CovTest_cs3_g_put6p1_p1_part_part0_w_w is Test {
  cs3 c0;
  ...
  function test_put_cs3_g_path6p1_part_part0_w_w(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { cs3CovTest_cs3_g_concrete6p1__basis_part0_w_w__W _veriput_w = new cs3CovTest_cs3_g_concrete6p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract cs3CovTest_cs3_g_concrete6p1__basis_part0_w_w__W is Test {
  cs3 c0;
  function setUp() public {
    c0 = new cs3();
  }
