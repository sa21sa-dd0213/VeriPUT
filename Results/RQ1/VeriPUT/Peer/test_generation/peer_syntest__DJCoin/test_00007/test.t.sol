...
contract DJCoinCovTest_DJCoin_owner_put3p1 is Test {
  ...
  // claim: sol:@C@DJCoin@F@owner#268:path:3
  // witness-fingerprint-sha256: 88b671ec633aaf423875277168887612d5ea19fcf9f266a195a313a4ff382d37
  // claim: sol:@C@DJCoin@F@owner#268:path:2
  // witness-fingerprint-sha256: dee2b8402fb1ebeb04e5206156e65493240a4966511cdb2080560beba6a71b88

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@DJCoin@F@owner#268:path:3   depth=1
  ...
  //   state._owner$236 in [0, 1461501637330902918203684832716283019655932542975]
  //   PIN block.basefee == 0
  ...
  //   rung DROPPED: return: return == state._owner$236 (rung shape not renderable for its declared type)
