...
contract DJCoinCovTest_DJCoin_balanceOf_put2p1 is Test {
  ...
  // claim: sol:@C@DJCoin@F@balanceOf#589:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@DJCoin@F@balanceOf#589:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, who
  ...
  uint256 _pre_gonsPerFragment; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_gonBalances_msg_sender; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_gonBalances_who; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_gonBalances_state__owner; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_gonBalances_state_tokencontractAddress; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_gonsPerFragment; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_gonBalances_msg_sender; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_gonBalances_who; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_gonBalances_state__owner; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_gonBalances_state_tokencontractAddress; // VERIPUT_HOISTED_SNAPSHOT
