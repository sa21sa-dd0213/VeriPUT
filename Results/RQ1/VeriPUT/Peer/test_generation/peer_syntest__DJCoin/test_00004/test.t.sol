...
contract DJCoinCovTest_DJCoin_approve_put3p1 is Test {
  DJCoin c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address spender, uint256 value) internal {
    ...
    assertEq(_post_allowedFragments_msg_sender__spender, value, "_allowedFragments[msg.sender][spender]: post == value");
  ...
  function test_put_DJCoin_approve_path3p1(address p_msg_sender, address spender, uint256 value) public {
