...
contract DJCoinCovTest_DJCoin_totalSupply_put3p1 is Test {
  DJCoin c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    uint256 _ret_pre_totalSupply = uint256(vm.load(address(c0), bytes32(uint256(1))));
    ...
    if (p_msg_sender == address(uint160(0))) {
      assertEq(_put_ret, uint256(2100000000000), "fixed witness return");
  ...
  function test_put_DJCoin_totalSupply_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { DJCoinCovTest_DJCoin_totalSupply_concrete3p1__basis_root__W _veriput_w = new DJCoinCovTest_DJCoin_totalSupply_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract DJCoinCovTest_DJCoin_totalSupply_concrete3p1__basis_root__W is Test {
  DJCoin c0;
  function setUp() public {
    vm.warp(1);
    vm.startPrank(address(uint160(1)), address(uint160(1)));
  ...
  function _w_test_cov_0() public {
    ...
    assertEq(_veriput_concrete_return, uint256(2100000000000), "fixed witness return must match");
