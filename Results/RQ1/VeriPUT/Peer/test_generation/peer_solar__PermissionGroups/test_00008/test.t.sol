...
contract PermissionGroupsCovTest_0_PermissionGroups_transferAdminQuickly_put6p1 is Test {
  PermissionGroups c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address newAdmin) internal {
    ...
    bool _put_ok = true;
    try c0.transferAdminQuickly(newAdmin) {} catch { _put_ok = false; }
  ...
  function test_put_PermissionGroups_transferAdminQuickly_path6p1(address p_msg_sender, address newAdmin) public {
    _veriput_parameterized(p_msg_sender, newAdmin);
    
    { PermissionGroupsCovTest_0_PermissionGroups_transferAdminQuickly_concrete6p1__basis_root__W _veriput_w = new PermissionGroupsCovTest_0_PermissionGroups_transferAdminQuickly_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract PermissionGroupsCovTest_0_PermissionGroups_transferAdminQuickly_concrete6p1__basis_root__W is Test {
  PermissionGroups c0;
  function setUp() public {
    vm.startPrank(address(uint160(4294967295)), address(uint160(4294967295)));
    c0 = new PermissionGroups();
  ...
  function _w_test_cov_2() public {
    ...
    try c0.transferAdminQuickly(address(uint160(0))) {
