...
contract PermissionGroupsCovTest_PermissionGroups_transferAdmin_put2p1 is Test {
  PermissionGroups c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address newAdmin) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("transferAdmin(address)", newAdmin));
  ...
  function test_put_PermissionGroups_transferAdmin_path2p1(address p_msg_sender, uint256 p_msg_value, address newAdmin) public {
