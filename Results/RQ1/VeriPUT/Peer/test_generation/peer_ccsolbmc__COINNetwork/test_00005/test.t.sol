...
contract ESBMCConcrete_COINNetworkCovTest_COINNetwork_supportsInterface_put2p1 is COINNetwork {
  constructor() ERC20Permit("VeriPUT3000") {}
}

contract COINNetworkCovTest_COINNetwork_supportsInterface_put2p1 is Test {
  COINNetwork c0;
  function setUp() public {
    c0 = new ESBMCConcrete_COINNetworkCovTest_COINNetwork_supportsInterface_put2p1();
  }
  ...
  function test_put_COINNetwork_supportsInterface_path2p1(address p_msg_sender, uint256 p_msg_value, uint32 interfaceId) public {
