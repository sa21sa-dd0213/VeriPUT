...
contract ESBMCConcrete_COINNetworkCovTest_COINNetwork_balanceOf_put3p1 is COINNetwork {
  constructor() ERC20Permit("VeriPUT3000") {}
}

contract COINNetworkCovTest_COINNetwork_balanceOf_put3p1 is Test {
  COINNetwork c0;
  function setUp() public {
    c0 = new ESBMCConcrete_COINNetworkCovTest_COINNetwork_balanceOf_put3p1();
  }
  ...
  function test_put_COINNetwork_balanceOf_path3p1(address p_msg_sender, address account) public {
    _veriput_parameterized(p_msg_sender, account);
    
    { COINNetworkCovTest_COINNetwork_balanceOf_concrete3p1__basis_root__W _veriput_w = new COINNetworkCovTest_COINNetwork_balanceOf_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}



contract ESBMCConcrete_COINNetworkCovTest_COINNetwork_balanceOf_concrete3p1__basis_root__W is COINNetwork {
  constructor() ERC20Permit("VeriPUT3000") {}
}

contract COINNetworkCovTest_COINNetwork_balanceOf_concrete3p1__basis_root__W is Test {
  COINNetwork c0;
  function setUp() public {
    c0 = new ESBMCConcrete_COINNetworkCovTest_COINNetwork_balanceOf_concrete3p1__basis_root__W();
  }
