...
contract Core_Fi_V3CovTest_Core_Fi_V3_transferFrom_put2p1 is Test {
  Core_Fi_V3 c0;
  ...
  function test_put_Core_Fi_V3_transferFrom_path2p1(address p_msg_sender, uint256 p_msg_value, address from, address to, uint256 value) public {
