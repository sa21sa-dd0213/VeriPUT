...
contract Core_Fi_V3CovTest_Core_Fi_V3_totalSupply_put3p1 is Test {
  Core_Fi_V3 c0;
  ...
  function test_put_Core_Fi_V3_totalSupply_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { Core_Fi_V3CovTest_Core_Fi_V3_totalSupply_concrete3p1__basis_root__W _veriput_w = new Core_Fi_V3CovTest_Core_Fi_V3_totalSupply_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract Core_Fi_V3CovTest_Core_Fi_V3_totalSupply_concrete3p1__basis_root__W is Test {
  Core_Fi_V3 c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new Core_Fi_V3();
