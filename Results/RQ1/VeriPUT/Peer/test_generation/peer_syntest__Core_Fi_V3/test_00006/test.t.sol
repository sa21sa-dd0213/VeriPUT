...
contract Core_Fi_V3CovTest_Core_Fi_V3_balanceOf_put3p1 is Test {
  Core_Fi_V3 c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address owner) internal {
    ...
    if (p_msg_sender == address(uint160(0)) && owner == address(uint160(0))) {
      assertEq(_put_ret, uint256(84000000000000000000000), "fixed witness return");
  ...
  function test_put_Core_Fi_V3_balanceOf_path3p1(address p_msg_sender, address owner) public {
    _veriput_parameterized(p_msg_sender, owner);
    
    { Core_Fi_V3CovTest_Core_Fi_V3_balanceOf_concrete3p1__basis_root__W _veriput_w = new Core_Fi_V3CovTest_Core_Fi_V3_balanceOf_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract Core_Fi_V3CovTest_Core_Fi_V3_balanceOf_concrete3p1__basis_root__W is Test {
  Core_Fi_V3 c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new Core_Fi_V3();
  ...
  function _w_test_cov_0() public {
    ...
    assertEq(_veriput_concrete_return, uint256(84000000000000000000000), "fixed witness return must match");
