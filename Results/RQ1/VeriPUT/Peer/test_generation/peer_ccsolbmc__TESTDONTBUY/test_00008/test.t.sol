...
contract TESTDONTBUYCovTest_TESTDONTBUY_owner_put3p1 is Test {
  TESTDONTBUY c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    assertEq(_post_owner, _pre_owner_156, "_owner: post == state._owner$156");
  ...
  function test_put_TESTDONTBUY_owner_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { TESTDONTBUYCovTest_TESTDONTBUY_owner_concrete3p1__basis_root__W _veriput_w = new TESTDONTBUYCovTest_TESTDONTBUY_owner_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract TESTDONTBUYCovTest_TESTDONTBUY_owner_concrete3p1__basis_root__W is Test {
  TESTDONTBUY c0;
  function setUp() public {
    c0 = new TESTDONTBUY();
  }
