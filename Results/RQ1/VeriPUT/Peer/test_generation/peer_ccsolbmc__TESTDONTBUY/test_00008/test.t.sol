...
contract TESTDONTBUYCovTest_TESTDONTBUY_owner_put3p1 is Test {
  ...
  // claim: sol:@C@TESTDONTBUY@F@owner#193:path:3
  // witness-fingerprint-sha256: b892e5ce07d6e1ff03e65e01b78400ca702bf64a8e8899638b102769f78d46e5
  // claim: sol:@C@TESTDONTBUY@F@owner#193:path:2
  // witness-fingerprint-sha256: 46443917e57e5db35cb0fc01775320ceeacef541d147e4557dbfcd0cd18be28f

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@TESTDONTBUY@F@owner#193:path:3   depth=1
  ...
  //   state._owner$156 in [0, 1461501637330902918203684832716283019655932542975]
  //   PIN block.basefee == 0
  ...
  //   rung DROPPED: return: return == state._owner$156 (rung shape not renderable for its declared type)
