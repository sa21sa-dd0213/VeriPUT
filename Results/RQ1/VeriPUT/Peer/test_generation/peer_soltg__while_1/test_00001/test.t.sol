...
contract Cwb1CovTest_Cwb1_f_put115p1 is Test {
  Cwb1 c0;
  ...
  function test_put_Cwb1_f_path115p1(address p_msg_sender, uint256 p_block_timestamp, uint256 p_block_number, uint256 x, bool b) public {
    _veriput_parameterized(p_msg_sender, p_block_timestamp, p_block_number, x, b);
    
    { Cwb1CovTest_Cwb1_f_concrete115p1__basis_root__W _veriput_w = new Cwb1CovTest_Cwb1_f_concrete115p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract Cwb1CovTest_Cwb1_f_concrete115p1__basis_root__W is Test {
  Cwb1 c0;
  function setUp() public {
    c0 = new Cwb1();
  }
