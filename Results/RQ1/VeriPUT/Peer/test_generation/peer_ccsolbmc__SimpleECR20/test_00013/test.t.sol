...
contract SimpleERC20CovTest_SimpleERC20_balanceOf_put3p1_p1_part_part0_r is Test {
  SimpleERC20 c0;
  ...
  function test_put_SimpleERC20_balanceOf_path3p1_part_part0_r(address p_msg_sender, address account) public {
    _veriput_parameterized(p_msg_sender, account);
    
    { SimpleERC20CovTest_SimpleERC20_balanceOf_concrete3p1__basis_part0_r__W _veriput_w = new SimpleERC20CovTest_SimpleERC20_balanceOf_concrete3p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract SimpleERC20CovTest_SimpleERC20_balanceOf_concrete3p1__basis_part0_r__W is Test {
  SimpleERC20 c0;
  function setUp() public {
    c0 = new SimpleERC20();
  }
