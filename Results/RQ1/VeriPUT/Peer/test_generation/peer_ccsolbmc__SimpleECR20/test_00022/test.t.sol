...
contract SimpleERC20CovTest_SimpleERC20_totalSupply_put3p1 is Test {
  SimpleERC20 c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    uint256 _pre_totalSupply_53 = uint256(vm.load(address(c0), bytes32(uint256(2))));
    ...
    unchecked { assertEq(_post_totalSupply, (uint256(_pre_totalSupply) - uint256(_pre_totalSupply_53)), "_totalSupply: post == (pre - state._totalSupply$53)"); }
  ...
  function test_put_SimpleERC20_totalSupply_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { SimpleERC20CovTest_SimpleERC20_totalSupply_concrete3p1__basis_root__W _veriput_w = new SimpleERC20CovTest_SimpleERC20_totalSupply_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract SimpleERC20CovTest_SimpleERC20_totalSupply_concrete3p1__basis_root__W is Test {
  SimpleERC20 c0;
  function setUp() public {
    c0 = new SimpleERC20();
  }
