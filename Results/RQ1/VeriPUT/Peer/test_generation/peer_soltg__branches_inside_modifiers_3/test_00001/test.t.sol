...
import {Cb4} from "../src/flat.sol";

contract Cb4CovTest_Cb4_g_put14p1 is Test {
  Cb4 c0;
  ...
  function test_put_Cb4_g_path14p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { Cb4CovTest_Cb4_g_concrete14p1__basis_root__W _veriput_w = new Cb4CovTest_Cb4_g_concrete14p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract Cb4CovTest_Cb4_g_concrete14p1__basis_root__W is Test {
  Cb4 c0;
  function setUp() public {
    c0 = new Cb4();
  }
