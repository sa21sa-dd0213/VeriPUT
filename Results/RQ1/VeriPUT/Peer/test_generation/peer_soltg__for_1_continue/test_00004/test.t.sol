...
contract Cfb3CovTest_Cfb3_f_put6p1 is Test {
  Cfb3 c0;
  ...
  function test_put_Cfb3_f_path6p1(address p_msg_sender, uint256 x, bool b) public {
    _veriput_parameterized(p_msg_sender, x, b);
    
    { Cfb3CovTest_Cfb3_f_concrete6p1__basis_root__W _veriput_w = new Cfb3CovTest_Cfb3_f_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract Cfb3CovTest_Cfb3_f_concrete6p1__basis_root__W is Test {
  Cfb3 c0;
  function setUp() public {
    c0 = new Cfb3();
  }
