...
contract SHIBABREADCovTest_SHIBABREAD_setCooldownEnabled_put7p1_p1_part_part0_w_w is Test {
  SHIBABREAD c0;
  ...
  function test_put_SHIBABREAD_setCooldownEnabled_path7p1_part_part0_w_w(address p_msg_sender, bool onoff) public {
    _veriput_parameterized(p_msg_sender, onoff);
    
    { SHIBABREADCovTest_SHIBABREAD_setCooldownEnabled_concrete7p1__basis_part0_w_w__W _veriput_w = new SHIBABREADCovTest_SHIBABREAD_setCooldownEnabled_concrete7p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract SHIBABREADCovTest_SHIBABREAD_setCooldownEnabled_concrete7p1__basis_part0_w_w__W is Test {
  SHIBABREAD c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new SHIBABREAD(payable(address(uint160(0))), payable(address(uint160(0))));
