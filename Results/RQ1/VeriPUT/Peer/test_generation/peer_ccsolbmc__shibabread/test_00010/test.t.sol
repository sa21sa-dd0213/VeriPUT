...
contract SHIBABREADCovTest_SHIBABREAD_setCooldownEnabled_put7p1_p1_part_part0_w_w is Test {
  ...
  // claim: sol:@C@SHIBABREAD@F@setCooldownEnabled#672:path:7
  // witness-fingerprint-sha256: a3fd9420da7eb563fe17263e58a99e1385f1ee3a10f722816c8935e8dee0317d
  // claim: sol:@C@SHIBABREAD@F@setCooldownEnabled#672:path:6
  // witness-fingerprint-sha256: 386b9656db268a73562d483dd2f35ec556d309bed6fd645d430b17e3d4d899d2
  // claim: sol:@C@SHIBABREAD@F@setCooldownEnabled#672:path:2
  // witness-fingerprint-sha256: f24e97211c62da967d8c1bf911598c4f01db4095f54e84704c2aea6ebf6916fa

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@SHIBABREAD@F@setCooldownEnabled#672:path:7   depth=2
  ...
  //   path guard ESTABLISHED: `!(_owner$228 == return_value$__msgSender$1)` -> `vm.assume(_pre_owner_228 == uint256(uint160(p_msg_sender)));`
