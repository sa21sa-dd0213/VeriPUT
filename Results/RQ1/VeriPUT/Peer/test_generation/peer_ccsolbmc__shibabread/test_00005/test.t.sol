...
contract SHIBABREADCovTest_SHIBABREAD_openTrading_put2p1 is Test {
  ...
  // claim: sol:@C@SHIBABREAD@F@openTrading#1143:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@SHIBABREAD@F@openTrading#1143:path:2   depth=1
  ...
  // 54 snapshot local(s) HOISTED to storage: 2 fuzz parameter(s) + 54 snapshot local(s) exceed the 12-slot budget (solc stack reach); the reads and every assertion are unchanged
