...
contract SHIBABREADCovTest_SHIBABREAD_manualswap_put2p1 is Test {
  ...
  // claim: sol:@C@SHIBABREAD@F@manualswap#1365:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@SHIBABREAD@F@manualswap#1365:path:2   depth=1
  ...
  // ORACLE: rollback exit plus 88 restored post-state frame assertion(s).
  ...
  // 60 snapshot local(s) HOISTED to storage: 2 fuzz parameter(s) + 60 snapshot local(s) exceed the 12-slot budget (solc stack reach); the reads and every assertion are unchanged
  uint256 _pre_rTotal; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_FeeAddress; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_inSwap; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_rOwned_msg_sender; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_rOwned_state__FeeAddress; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_rOwned_state__marketingWalletAddress; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_rOwned_state__owner; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_rOwned_state__previousOwner; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_rOwned_state_uniswapV2Pair; // VERIPUT_HOISTED_SNAPSHOT
  ...
  uint256 _post_FeeAddress; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_inSwap; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_rOwned_msg_sender; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_rOwned_state__FeeAddress; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_rOwned_state__marketingWalletAddress; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_rOwned_state__owner; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_rOwned_state__previousOwner; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_rOwned_state_uniswapV2Pair; // VERIPUT_HOISTED_SNAPSHOT
