...
contract DogeMojoCovTest_DogeMojo_balanceOf_put3p1 is Test {
  DogeMojo c0;
  ...
  function test_put_DogeMojo_balanceOf_path3p1(address p_msg_sender, address owner) public {
    _veriput_parameterized(p_msg_sender, owner);
    
    { DogeMojoCovTest_DogeMojo_balanceOf_concrete3p1__basis_root__W _veriput_w = new DogeMojoCovTest_DogeMojo_balanceOf_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract DogeMojoCovTest_DogeMojo_balanceOf_concrete3p1__basis_root__W is Test {
  DogeMojo c0;
  function setUp() public {
    c0 = new DogeMojo();
  }
