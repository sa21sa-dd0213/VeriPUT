...
contract RBCCovTest_RBC_approve_put2p1 is Test {
  RBC c0;
  ...
  function test_put_RBC_approve_path2p1(address p_msg_sender, uint256 p_msg_value, address spender, uint256 amount) public {
