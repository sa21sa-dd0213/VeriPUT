...
contract RBCCovTest_RBC_transfer_put14p1_p1_part_part0_w_w is Test {
  RBC c0;
  ...
  function test_put_RBC_transfer_path14p1_part_part0_w_w(address p_msg_sender, address recipient, uint256 amount) public {
    _veriput_parameterized(p_msg_sender, recipient, amount);
    
    { RBCCovTest_RBC_transfer_concrete14p1__basis_part0_w_w__W _veriput_w = new RBCCovTest_RBC_transfer_concrete14p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract RBCCovTest_RBC_transfer_concrete14p1__basis_part0_w_w__W is Test {
  RBC c0;
  function setUp() public {
    c0 = new RBC();
  }
