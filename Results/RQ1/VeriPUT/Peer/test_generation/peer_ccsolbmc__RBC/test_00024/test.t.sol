...
contract RBCCovTest_RBC_transfer_put31p1_p1_part_part0_w_r is Test {
  RBC c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address recipient, uint256 amount) internal {
    ...
    if (p_msg_sender == address(uint160(1912875088)) && recipient == address(uint160(1)) && amount == uint256(0)) {
      assertEq(_put_ret, true, "fixed witness return");
      assertEq(uint256(vm.load(address(c0), keccak256(abi.encode(address(uint160(1912875088)), uint256(0))))), uint256(0), "fixed witness state");
  ...
  function test_put_RBC_transfer_path31p1_part_part0_w_r(address p_msg_sender, address recipient, uint256 amount) public {
    _veriput_parameterized(p_msg_sender, recipient, amount);
    
    { RBCCovTest_RBC_transfer_concrete31p1__basis_part0_w_r__W _veriput_w = new RBCCovTest_RBC_transfer_concrete31p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract RBCCovTest_RBC_transfer_concrete31p1__basis_part0_w_r__W is Test {
  RBC c0;
  function setUp() public {
    c0 = new RBC();
  }
  ...
  function _w_test_cov_0() public {
    ...
    uint256 _veriput_fixed_state_balances_51_1912875088_0 = uint256(vm.load(address(c0), keccak256(abi.encode(address(uint160(1912875088)), uint256(0)))));
    assertEq(_veriput_fixed_state_balances_51_1912875088_0, uint256(0), "fixed witness state");
    uint256 _veriput_fixed_state_balances_51_1_1 = uint256(vm.load(address(c0), keccak256(abi.encode(address(uint160(1)), uint256(0)))));
    assertEq(_veriput_fixed_state_balances_51_1_1, uint256(0), "fixed witness state");
    uint256 _veriput_fixed_state_totalSupply_59_2 = uint256(vm.load(address(c0), bytes32(uint256(2))));
    assertEq(_veriput_fixed_state_totalSupply_59_2, uint256(0), "fixed witness state");
  }
