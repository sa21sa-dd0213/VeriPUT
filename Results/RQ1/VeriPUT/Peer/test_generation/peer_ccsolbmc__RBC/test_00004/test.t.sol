...
contract RBCCovTest_RBC_approve_put14p1_p1_part_part0_w_r is Test {
  RBC c0;
  ...
  function test_put_RBC_approve_path14p1_part_part0_w_r(address p_msg_sender, address spender, uint256 amount) public {
    _veriput_parameterized(p_msg_sender, spender, amount);
    
    { RBCCovTest_RBC_approve_concrete14p1__basis_part0_w_r__W _veriput_w = new RBCCovTest_RBC_approve_concrete14p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract RBCCovTest_RBC_approve_concrete14p1__basis_part0_w_r__W is Test {
  RBC c0;
  function setUp() public {
    c0 = new RBC();
  }
