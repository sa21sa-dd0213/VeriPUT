...
contract RBCCovTest_RBC_transfer_put2p1 is Test {
  RBC c0;
  ...
  function test_put_RBC_transfer_path2p1(address p_msg_sender, uint256 p_msg_value, address recipient, uint256 amount) public {
