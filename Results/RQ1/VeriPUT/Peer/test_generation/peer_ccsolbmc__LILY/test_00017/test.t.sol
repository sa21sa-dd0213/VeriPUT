...
contract LILYCovTest_LILY_totalFees_put3p1 is Test {
  LILY c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    unchecked { assertEq(_post_tFeeTotal, (uint256(_pre_tFeeTotal) - uint256(_pre_tFeeTotal)), "_tFeeTotal: post == (pre - state._tFeeTotal)"); }
    unchecked { assertEq(_post_tFeeTotal, (uint256(_pre_tFeeTotal) * uint256(_pre_tFeeTotal)), "_tFeeTotal: post == (pre * state._tFeeTotal)"); }
    unchecked { assertEq(_post_tFeeTotal, (uint256(_pre_tFeeTotal) * uint256(1000000000)), "_tFeeTotal: post == (pre * 1000000000)"); }
    ...
    unchecked { assertEq(_post_tFeeTotal, (uint256(_pre_tFeeTotal) * uint256(_pre_tFeeTotal)), "_tFeeTotal: post == (state._tFeeTotal * state._tFeeTotal)"); }
    unchecked { assertEq(_post_tFeeTotal, (uint256(_pre_tFeeTotal) * uint256(1000000000)), "_tFeeTotal: post == (state._tFeeTotal * 1000000000)"); }
  ...
  function test_put_LILY_totalFees_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { LILYCovTest_LILY_totalFees_concrete3p1__basis_root__W _veriput_w = new LILYCovTest_LILY_totalFees_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract LILYCovTest_LILY_totalFees_concrete3p1__basis_root__W is Test {
  LILY c0;
  function setUp() public {
    c0 = new LILY();
  }
