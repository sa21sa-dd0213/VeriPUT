...
contract LILYCovTest_LILY_isExcluded_put3p1 is Test {
  LILY c0;
  ...
  function test_put_LILY_isExcluded_path3p1(address p_msg_sender, address account) public {
    _veriput_parameterized(p_msg_sender, account);
    
    { LILYCovTest_LILY_isExcluded_concrete3p1__basis_root__W _veriput_w = new LILYCovTest_LILY_isExcluded_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract LILYCovTest_LILY_isExcluded_concrete3p1__basis_root__W is Test {
  LILY c0;
  function setUp() public {
    c0 = new LILY();
  }
