...
contract LILYCovTest_LILY_approve_put14p1_p1_part_part0_r is Test {
  LILY c0;
  ...
  function test_put_LILY_approve_path14p1_part_part0_r(address p_msg_sender, address spender, uint256 amount) public {
    _veriput_parameterized(p_msg_sender, spender, amount);
    
    { LILYCovTest_LILY_approve_concrete14p1__basis_part0_r__W _veriput_w = new LILYCovTest_LILY_approve_concrete14p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract LILYCovTest_LILY_approve_concrete14p1__basis_part0_r__W is Test {
  LILY c0;
  function setUp() public {
    c0 = new LILY();
  }
