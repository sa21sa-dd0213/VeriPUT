...
contract LILYCovTest_LILY_transferOwnership_put6p1 is Test {
  LILY c0;
  ...
  function test_put_LILY_transferOwnership_path6p1(address p_msg_sender, address newOwner) public {
    _veriput_parameterized(p_msg_sender, newOwner);
    
    { LILYCovTest_LILY_transferOwnership_concrete6p1__basis_root__W _veriput_w = new LILYCovTest_LILY_transferOwnership_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract LILYCovTest_LILY_transferOwnership_concrete6p1__basis_root__W is Test {
  LILY c0;
  function setUp() public {
    c0 = new LILY();
  }
