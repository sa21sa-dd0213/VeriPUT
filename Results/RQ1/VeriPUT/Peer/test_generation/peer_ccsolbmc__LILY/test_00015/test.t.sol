...
contract LILYCovTest_LILY_owner_put3p1 is Test {
  ...
  // claim: sol:@C@LILY@F@owner#432:path:3
  // witness-fingerprint-sha256: 7a1dfd3d0cb28a5b849483d3eda72cd7a9e458030235f61715de5c929e3c4fa7
  // claim: sol:@C@LILY@F@owner#432:path:2
  // witness-fingerprint-sha256: dbc5f6f5f7f9d59523ca56c286477489d75fc3ba762b664989a0ebd3f16bd195

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@LILY@F@owner#432:path:3   depth=1
  ...
  //   state._owner$397 in [0, 1461501637330902918203684832716283019655932542975]
  //   PIN block.basefee == 0
  ...
  //   rung DROPPED: return: return == state._owner$397 (rung shape not renderable for its declared type)
