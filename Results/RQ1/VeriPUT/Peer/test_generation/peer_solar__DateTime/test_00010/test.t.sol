...
contract DateTimeCovTest_DateTime_isLeapYear_put254p1_p1_part_part0_r is Test {
  ...
  function test_put_DateTime_isLeapYear_path254p1_part_part0_r(address p_msg_sender, uint256 p_block_timestamp, uint16 year) public {
    ...
    { DateTimeCovTest_DateTime_isLeapYear_concrete254p1__basis_part0_r__W _veriput_w = new DateTimeCovTest_DateTime_isLeapYear_concrete254p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract DateTimeCovTest_DateTime_isLeapYear_concrete254p1__basis_part0_r__W is Test {
  DateTime c0;
  function setUp() public {
    c0 = new DateTime();
  }
