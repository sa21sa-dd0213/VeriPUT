...
contract DateTimeCovTest_DateTime_isLeapYear_put255p1_p1_part_part0_w_w is Test {
  ...
  function test_put_DateTime_isLeapYear_path255p1_part_part0_w_w(address p_msg_sender, uint256 p_block_timestamp, uint256 p_block_number, uint16 year) public {
    ...
    { DateTimeCovTest_DateTime_isLeapYear_concrete255p1__basis_part0_w_w__W _veriput_w = new DateTimeCovTest_DateTime_isLeapYear_concrete255p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_3(); }
}
}
...
contract DateTimeCovTest_DateTime_isLeapYear_concrete255p1__basis_part0_w_w__W is Test {
  DateTime c0;
  function setUp() public {
    c0 = new DateTime();
  }
