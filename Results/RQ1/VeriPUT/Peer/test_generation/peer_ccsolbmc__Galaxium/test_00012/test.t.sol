...
contract GalaxiumCovTest_Galaxium_owner_put3p1 is Test {
  ...
  // claim: sol:@C@Galaxium@F@owner#86:path:3
  // witness-fingerprint-sha256: 5c7debe6572a0583569ea590cce140671acab83ba1b17d13f1241979e56410e6
  // claim: sol:@C@Galaxium@F@owner#86:path:2
  // witness-fingerprint-sha256: f51534bca49605e4bc7d84bdca00f7bac52dc4386be5b0ad7787e1bbc3708650

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@Galaxium@F@owner#86:path:3   depth=1
  ...
  //   state._owner$49 in [0, 1461501637330902918203684832716283019655932542975]
  //   PIN block.basefee == 0
  ...
  //   rung DROPPED: return: return == state._owner$49 (rung shape not renderable for its declared type)
