...
contract GalaxiumCovTest_Galaxium_owner_put3p1 is Test {
  Galaxium c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    uint256 _pre_owner_49 = (uint256(vm.load(address(c0), bytes32(uint256(0)))) & 1461501637330902918203684832716283019655932542975);
    ...
    assertEq(_post_owner, _pre_owner_49, "_owner: post == state._owner$49");
  ...
  function test_put_Galaxium_owner_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { GalaxiumCovTest_Galaxium_owner_concrete3p1__basis_root__W _veriput_w = new GalaxiumCovTest_Galaxium_owner_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract GalaxiumCovTest_Galaxium_owner_concrete3p1__basis_root__W is Test {
  Galaxium c0;
  function setUp() public {
    c0 = new Galaxium();
  }
