...
contract GalaxiumCovTest_Galaxium_approve_put14p1_p1_part_part0_w_r is Test {
  Galaxium c0;
  ...
  function test_put_Galaxium_approve_path14p1_part_part0_w_r(address p_msg_sender, address spender, uint256 amount) public {
    _veriput_parameterized(p_msg_sender, spender, amount);
    
    { GalaxiumCovTest_Galaxium_approve_concrete14p1__basis_part0_w_r__W _veriput_w = new GalaxiumCovTest_Galaxium_approve_concrete14p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract GalaxiumCovTest_Galaxium_approve_concrete14p1__basis_part0_w_r__W is Test {
  Galaxium c0;
  function setUp() public {
    c0 = new Galaxium();
  }
