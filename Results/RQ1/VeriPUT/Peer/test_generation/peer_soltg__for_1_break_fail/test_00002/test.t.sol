...
contract Cfb2CovTest_Cfb2_f_put195p1 is Test {
  Cfb2 c0;
  ...
  function test_put_Cfb2_f_path195p1(address p_msg_sender, uint256 p_block_timestamp, uint256 p_block_number, uint256 x, bool b) public {
    _veriput_parameterized(p_msg_sender, p_block_timestamp, p_block_number, x, b);
    
    { Cfb2CovTest_Cfb2_f_concrete195p1__basis_root__W _veriput_w = new Cfb2CovTest_Cfb2_f_concrete195p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_3(); }
}
}
...
contract Cfb2CovTest_Cfb2_f_concrete195p1__basis_root__W is Test {
  Cfb2 c0;
  function setUp() public {
    c0 = new Cfb2();
  }
