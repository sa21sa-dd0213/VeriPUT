...
contract Cfb2CovTest_Cfb2_f_put15p1 is Test {
  Cfb2 c0;
  ...
  function test_put_Cfb2_f_path15p1(address p_msg_sender, uint256 p_block_timestamp, uint256 p_block_number, uint256 x, bool b) public {
    _veriput_parameterized(p_msg_sender, p_block_timestamp, p_block_number, x, b);
    
    { Cfb2CovTest_Cfb2_f_concrete15p1__basis_root__W _veriput_w = new Cfb2CovTest_Cfb2_f_concrete15p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract Cfb2CovTest_Cfb2_f_concrete15p1__basis_root__W is Test {
  Cfb2 c0;
  function setUp() public {
    c0 = new Cfb2();
  }
  ...
  function _w_test_cov_0() public {
    ...
    c0.f(uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935), true);
