...
contract DogeRocketCovTest_DogeRocket_setCooldownEnabled_put7p1_p1_part_part0_w_w is Test {
  ...
  // claim: sol:@C@DogeRocket@F@setCooldownEnabled#596:path:7
  // witness-fingerprint-sha256: eb3c701bc9ed6ded752f79d2224f18bd6bb285165f2d0ba8f6650b08c03485ba
  // claim: sol:@C@DogeRocket@F@setCooldownEnabled#596:path:6
  // witness-fingerprint-sha256: 1eb099d7e899005fcfb0ba44aff1bcb374658f069887029487c7cf1d3ca6d980
  // claim: sol:@C@DogeRocket@F@setCooldownEnabled#596:path:2
  // witness-fingerprint-sha256: 56650ee1b84a2ddd4a60f6bbba9e89690f74dac67a608d62d82f3088299aeb9c

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@DogeRocket@F@setCooldownEnabled#596:path:7   depth=2
  ...
  //   path guard ESTABLISHED: `!(_owner$157 == return_value$__msgSender$1)` -> `vm.assume(_pre_owner_157 == uint256(uint160(p_msg_sender)));`
