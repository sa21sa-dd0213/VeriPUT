...
contract DogeRocketCovTest_DogeRocket_openTrading_put2p1 is Test {
  ...
  // claim: sol:@C@DogeRocket@F@openTrading#1045:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@DogeRocket@F@openTrading#1045:path:2   depth=1
  ...
  // ORACLE: rollback exit plus 72 restored post-state frame assertion(s).
  ...
  // 52 snapshot local(s) HOISTED to storage: 2 fuzz parameter(s) + 52 snapshot local(s) exceed the 12-slot budget (solc stack reach); the reads and every assertion are unchanged
