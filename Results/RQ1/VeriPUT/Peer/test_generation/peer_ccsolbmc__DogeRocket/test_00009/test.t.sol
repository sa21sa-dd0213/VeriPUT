...
contract DogeRocketCovTest_DogeRocket_delBot_put6p1 is Test {
  DogeRocket c0;
  ...
  function test_put_DogeRocket_delBot_path6p1(address p_msg_sender, address notbot) public {
    _veriput_parameterized(p_msg_sender, notbot);
    
    { DogeRocketCovTest_DogeRocket_delBot_concrete6p1__basis_root__W _veriput_w = new DogeRocketCovTest_DogeRocket_delBot_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract DogeRocketCovTest_DogeRocket_delBot_concrete6p1__basis_root__W is Test {
  DogeRocket c0;
  function setUp() public {
    c0 = new DogeRocket();
  }
