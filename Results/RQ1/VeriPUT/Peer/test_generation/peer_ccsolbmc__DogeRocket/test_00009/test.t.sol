...
contract DogeRocketCovTest_DogeRocket_delBot_put6p1 is Test {
  ...
  // claim: sol:@C@DogeRocket@F@delBot#1136:path:7
  // witness-fingerprint-sha256: 8e1c058b5fe8da5e0c9f7f4161ae27ce90654fecf4390533ec6f85bbb6bacd49
  // claim: sol:@C@DogeRocket@F@delBot#1136:path:6
  // witness-fingerprint-sha256: d9d230db4efe37abbef6c18ff013f4b04a3da5cc6f458c0a89482d05a201d807
  // claim: sol:@C@DogeRocket@F@delBot#1136:path:2
  // witness-fingerprint-sha256: a3a4218075b05035fbf103ce1d6f6bba6a25038a6873d37af39d71717d49d289

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@DogeRocket@F@delBot#1136:path:6   depth=2
  ...
  //   path guard ESTABLISHED: `!(!(_owner$157 == return_value$__msgSender$1))` -> `vm.assume(0 != uint256(uint160(p_msg_sender)));`
