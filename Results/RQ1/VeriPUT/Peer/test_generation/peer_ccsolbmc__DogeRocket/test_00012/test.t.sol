...
contract DogeRocketCovTest_DogeRocket_owner_put3p1 is Test {
  ...
  // claim: sol:@C@DogeRocket@F@owner#194:path:3
  // witness-fingerprint-sha256: 821bb55f6a6bd23ce4b5b557db4998d28345a7d022eba2b412bd7b6e6cf3ac2c
  // claim: sol:@C@DogeRocket@F@owner#194:path:2
  // witness-fingerprint-sha256: 59817ded0fef44e346f9d2e43aca1313cd89a355edcaec1f92aea8398c7f8af0

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@DogeRocket@F@owner#194:path:3   depth=1
  ...
  //   state._owner$157 in [0, 1461501637330902918203684832716283019655932542975]
  //   PIN block.basefee == 0
  ...
  //   rung DROPPED: return: return == state._owner$157 (rung shape not renderable for its declared type)
