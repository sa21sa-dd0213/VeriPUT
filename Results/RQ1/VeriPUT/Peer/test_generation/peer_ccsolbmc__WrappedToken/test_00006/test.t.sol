...
contract WrappedTokenCovTest_WrappedToken_decimals_put3p1 is Test {
  WrappedToken c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    uint256 _ret_pre_decimals = ((uint256(vm.load(address(c0), bytes32(uint256(9)))) >> 160) & 255);
    uint256 _pre_decimals = ((uint256(vm.load(address(c0), bytes32(uint256(9)))) >> 160) & 255);
  ...
  function test_put_WrappedToken_decimals_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { WrappedTokenCovTest_WrappedToken_decimals_concrete3p1__basis_root__W _veriput_w = new WrappedTokenCovTest_WrappedToken_decimals_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract WrappedTokenCovTest_WrappedToken_decimals_concrete3p1__basis_root__W is Test {
  WrappedToken c0;
  function setUp() public {
    c0 = new WrappedToken();
  }
