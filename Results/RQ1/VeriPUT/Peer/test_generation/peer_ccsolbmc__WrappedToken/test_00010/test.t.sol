...
contract WrappedTokenCovTest_WrappedToken_queryPaused_put3p1 is Test {
  WrappedToken c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    assertLe((uint256(vm.load(address(c0), bytes32(uint256(1)))) & 255), uint256(1), "the entry state is OUTSIDE the certified region: state.paused_$1501 was assumed in [0, 1] when the path was certified, so a value outside it means the assumption was vacuous and the rungs below were proved about no execution this test can reach");
  ...
  function test_put_WrappedToken_queryPaused_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { WrappedTokenCovTest_WrappedToken_queryPaused_concrete3p1__basis_root__W _veriput_w = new WrappedTokenCovTest_WrappedToken_queryPaused_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract WrappedTokenCovTest_WrappedToken_queryPaused_concrete3p1__basis_root__W is Test {
  WrappedToken c0;
  function setUp() public {
    c0 = new WrappedToken();
  }
  ...
  function _w_test_cov_0() public {
    ...
    bool _veriput_concrete_return = c0.queryPaused();
