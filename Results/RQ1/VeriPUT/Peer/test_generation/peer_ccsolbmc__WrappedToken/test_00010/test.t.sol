...
contract WrappedTokenCovTest_WrappedToken_queryPaused_put3p1 is Test {
  ...
  // claim: sol:@C@WrappedToken@F@queryPaused#1605:path:3
  // witness-fingerprint-sha256: b62566e73cfef49421460ad35c3559193a6e3889b2fb71eb8b9a49083e6a1f80
  // claim: sol:@C@WrappedToken@F@queryPaused#1605:path:2
  // witness-fingerprint-sha256: 53633bccb462052a787ddd8911f5f0880740be26cea5a899d5f18c14115874a9

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@WrappedToken@F@queryPaused#1605:path:3   depth=1
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    //   state.paused_$1501 in [0, 1] (checked, not set)
