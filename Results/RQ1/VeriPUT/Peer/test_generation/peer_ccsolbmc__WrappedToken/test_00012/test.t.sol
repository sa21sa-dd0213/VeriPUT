...
contract WrappedTokenCovTest_WrappedToken_supportsInterface_put3p1 is Test {
  WrappedToken c0;
  ...
  function test_put_WrappedToken_supportsInterface_path3p1(address p_msg_sender, uint32 interfaceId) public {
    _veriput_parameterized(p_msg_sender, interfaceId);
    
    { WrappedTokenCovTest_WrappedToken_supportsInterface_concrete3p1__basis_root__W _veriput_w = new WrappedTokenCovTest_WrappedToken_supportsInterface_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract WrappedTokenCovTest_WrappedToken_supportsInterface_concrete3p1__basis_root__W is Test {
  WrappedToken c0;
  function setUp() public {
    c0 = new WrappedToken();
  }
