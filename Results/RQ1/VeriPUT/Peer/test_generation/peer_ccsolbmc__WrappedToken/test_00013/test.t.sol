...
contract WrappedTokenCovTest_WrappedToken_totalSupply_put3p1 is Test {
  WrappedToken c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    uint256 _pre_totalSupply_317 = uint256(vm.load(address(c0), bytes32(uint256(4))));
    ...
    unchecked { assertEq(_post_totalSupply, (uint256(_pre_totalSupply) - uint256(_pre_totalSupply_317)), "_totalSupply: post == (pre - state._totalSupply$317)"); }
  ...
  function test_put_WrappedToken_totalSupply_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { WrappedTokenCovTest_WrappedToken_totalSupply_concrete3p1__basis_root__W _veriput_w = new WrappedTokenCovTest_WrappedToken_totalSupply_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract WrappedTokenCovTest_WrappedToken_totalSupply_concrete3p1__basis_root__W is Test {
  WrappedToken c0;
  function setUp() public {
    c0 = new WrappedToken();
  }
