...
contract WrappedTokenCovTest_WrappedToken_balanceOf_put3p1_p1_part_part0_w is Test {
  WrappedToken c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address account) internal {
    ...
    account = address(uint160(bound(uint256(uint160(account)), 0, 730750818665451459101842416358141509827966271487)));
  ...
  function test_put_WrappedToken_balanceOf_path3p1_part_part0_w(address p_msg_sender, address account) public {
    _veriput_parameterized(p_msg_sender, account);
    
    { WrappedTokenCovTest_WrappedToken_balanceOf_concrete3p1__basis_part0_w__W _veriput_w = new WrappedTokenCovTest_WrappedToken_balanceOf_concrete3p1__basis_part0_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract WrappedTokenCovTest_WrappedToken_balanceOf_concrete3p1__basis_part0_w__W is Test {
  WrappedToken c0;
  function setUp() public {
    c0 = new WrappedToken();
  }
