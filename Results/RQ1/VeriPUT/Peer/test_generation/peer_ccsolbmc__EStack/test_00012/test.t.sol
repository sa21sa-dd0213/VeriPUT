...
contract EStackCovTest_EStack_setCooldownEnabled_put7p1_p1_part_part0_r_w is Test {
  EStack c0;
  ...
  function _veriput_parameterized(address p_msg_sender, bool onoff) internal {
    ...
    assertEq((uint256(vm.load(address(c0), bytes32(uint256(0)))) & 1461501637330902918203684832716283019655932542975), uint256(uint256(uint160(p_msg_sender))), "entry pin state._owner$222 did NOT land: vm.store wrote a word the contract does not read back at this slot, so the test is not inside the certified region and every rung below is about a different state");
    
    uint256 _pre_owner = (uint256(vm.load(address(c0), bytes32(uint256(0)))) & 1461501637330902918203684832716283019655932542975);
    uint256 _pre_cooldownEnabled = ((uint256(vm.load(address(c0), bytes32(uint256(17)))) >> 184) & 255);
    uint256 _pre_owner_222 = (uint256(vm.load(address(c0), bytes32(uint256(0)))) & 1461501637330902918203684832716283019655932542975);
    
    vm.assume(_pre_owner_222 == uint256(uint160(p_msg_sender)));
  ...
  function test_put_EStack_setCooldownEnabled_path7p1_part_part0_r_w(address p_msg_sender, bool onoff) public {
    _veriput_parameterized(p_msg_sender, onoff);
    
    { EStackCovTest_EStack_setCooldownEnabled_concrete7p1__basis_part0_r_w__W _veriput_w = new EStackCovTest_EStack_setCooldownEnabled_concrete7p1__basis_part0_r_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract EStackCovTest_EStack_setCooldownEnabled_concrete7p1__basis_part0_r_w__W is Test {
  EStack c0;
  function setUp() public {
    c0 = new EStack();
  }
