...
contract EStackCovTest_EStack_setCooldownEnabled_put7p1_p1_part_part0_r_w is Test {
  ...
  // claim: sol:@C@EStack@F@setCooldownEnabled#674:path:7
  // witness-fingerprint-sha256: 0fa08a3b449c9754795a66e1c5adcaf4ee168f2f2ae511e481c2f9aa0da4c558
  // claim: sol:@C@EStack@F@setCooldownEnabled#674:path:6
  // witness-fingerprint-sha256: a4baed298598022fe987479c742249524e01ef896908b6a2718645866dead201
  // claim: sol:@C@EStack@F@setCooldownEnabled#674:path:2
  // witness-fingerprint-sha256: 6e7938d214b57091be917c4da4639c1dab69c072990650bc59dee52facbf55f9

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@EStack@F@setCooldownEnabled#674:path:7   depth=2
  ...
  //   path guard ESTABLISHED: `!(_owner$222 == return_value$__msgSender$1)` -> `vm.assume(_pre_owner_222 == uint256(uint160(p_msg_sender)));`
