...
contract EStackCovTest_EStack_approve_put2p1 is Test {
  EStack c0;
  ...
  function test_put_EStack_approve_path2p1(address p_msg_sender, uint256 p_msg_value, address spender, uint256 amount) public {
