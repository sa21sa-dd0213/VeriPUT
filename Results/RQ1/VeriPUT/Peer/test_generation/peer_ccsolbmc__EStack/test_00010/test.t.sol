...
contract EStackCovTest_EStack_owner_put3p1 is Test {
  ...
  // claim: sol:@C@EStack@F@owner#259:path:3
  // witness-fingerprint-sha256: e87ad03e619e9e1a54087d4c30fa5889daa7c2b293dd1cd3f1e362800f735234
  // claim: sol:@C@EStack@F@owner#259:path:2
  // witness-fingerprint-sha256: 01b278aaa3e9b545a1533997ab1ccd66a0d89db256ff7b0bf746f6766d69614b

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@EStack@F@owner#259:path:3   depth=1
  ...
  //   state._owner$222 in [0, 1461501637330902918203684832716283019655932542975]
  //   PIN block.basefee == 0
  ...
  //   rung DROPPED: return: return == state._owner$222 (rung shape not renderable for its declared type)
