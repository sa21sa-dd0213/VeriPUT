...
contract RoomThermostatCovTest_RoomThermostat_SetTargetTemperature_put6p1 is Test {
  RoomThermostat c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    vm.assume((_pre_User != uint256(uint160(p_msg_sender)) || _pre_State != 1));
    ...
    bool _put_ok = true;
    try c0.SetTargetTemperature(0) {} catch { _put_ok = false; }
  ...
  function test_put_RoomThermostat_SetTargetTemperature_path6p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { RoomThermostatCovTest_RoomThermostat_SetTargetTemperature_concrete6p1__basis_root__W _veriput_w = new RoomThermostatCovTest_RoomThermostat_SetTargetTemperature_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract RoomThermostatCovTest_RoomThermostat_SetTargetTemperature_concrete6p1__basis_root__W is Test {
  RoomThermostat c0;
  function setUp() public {
    c0 = new RoomThermostat();
  }
  ...
  function _w_test_cov_0() public {
    ...
    try c0.SetTargetTemperature(int256(0)) {
    ...
    assertEq(_veriput_fixed_state_TargetTemperature_3, uint256(0), "fixed witness state");
