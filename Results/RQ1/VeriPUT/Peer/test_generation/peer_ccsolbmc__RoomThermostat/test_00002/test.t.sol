...
contract RoomThermostatCovTest_RoomThermostat_SetTargetTemperature_put2p1 is Test {
  RoomThermostat c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("SetTargetTemperature(int256)", int256(1)));
  ...
  function test_put_RoomThermostat_SetTargetTemperature_path2p1(address p_msg_sender, uint256 p_msg_value) public {
