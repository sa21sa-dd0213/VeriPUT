...
contract RoomThermostatCovTest_RoomThermostat_initialize_put3p1_p1_part_part0_r_w is Test {
  RoomThermostat c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address thermostatInstaller, address thermostatUser) internal {
    ...
    thermostatUser = address(uint160(bound(uint256(uint160(thermostatUser)), 0, 1461501637330902918203684832716283019655932542974)));
    ...
    if (p_msg_sender == address(uint160(0)) && thermostatInstaller == address(uint160(1461501637330902918203684832716283019655932542975)) && thermostatUser == address(uint160(0))) {
  ...
  function test_put_RoomThermostat_initialize_path3p1_part_part0_r_w(address p_msg_sender, address thermostatInstaller, address thermostatUser) public {
    _veriput_parameterized(p_msg_sender, thermostatInstaller, thermostatUser);
    
    { RoomThermostatCovTest_RoomThermostat_initialize_concrete3p1__basis_part0_r_w__W _veriput_w = new RoomThermostatCovTest_RoomThermostat_initialize_concrete3p1__basis_part0_r_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract RoomThermostatCovTest_RoomThermostat_initialize_concrete3p1__basis_part0_r_w__W is Test {
  RoomThermostat c0;
  function setUp() public {
    c0 = new RoomThermostat();
  }
  ...
  function _w_test_cov_0() public {
    ...
    c0.initialize(address(uint160(1461501637330902918203684832716283019655932542975)), address(uint160(0)));
    ...
    assertEq(_veriput_fixed_state_User_4, uint256(0), "fixed witness state");
