...
contract Csm1CovTest_Csm1_h_put7p1 is Test {
  Csm1 c0;
  ...
  function test_put_Csm1_h_path7p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { Csm1CovTest_Csm1_h_concrete7p1__basis_root__W _veriput_w = new Csm1CovTest_Csm1_h_concrete7p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract Csm1CovTest_Csm1_h_concrete7p1__basis_root__W is Test {
  Csm1 c0;
  function setUp() public {
    c0 = new Csm1();
  }
