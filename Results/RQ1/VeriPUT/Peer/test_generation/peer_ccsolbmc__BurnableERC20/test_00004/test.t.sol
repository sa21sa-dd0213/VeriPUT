...
contract BurnableERC20CovTest_BurnableERC20_balanceOf_put3p1_p1_part_part0_w is Test {
  BurnableERC20 c0;
  ...
  function test_put_BurnableERC20_balanceOf_path3p1_part_part0_w(address p_msg_sender, address account) public {
    _veriput_parameterized(p_msg_sender, account);
    
    { BurnableERC20CovTest_BurnableERC20_balanceOf_concrete3p1__basis_part0_w__W _veriput_w = new BurnableERC20CovTest_BurnableERC20_balanceOf_concrete3p1__basis_part0_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract BurnableERC20CovTest_BurnableERC20_balanceOf_concrete3p1__basis_part0_w__W is Test {
  BurnableERC20 c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
