...
contract BurnableERC20CovTest_BurnableERC20_allowance_put3p1 is Test {
  BurnableERC20 c0;
  ...
  function test_put_BurnableERC20_allowance_path3p1(address p_msg_sender, address owner, address spender) public {
    _veriput_parameterized(p_msg_sender, owner, spender);
    
    { BurnableERC20CovTest_BurnableERC20_allowance_concrete3p1__basis_root__W _veriput_w = new BurnableERC20CovTest_BurnableERC20_allowance_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract BurnableERC20CovTest_BurnableERC20_allowance_concrete3p1__basis_root__W is Test {
  BurnableERC20 c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
