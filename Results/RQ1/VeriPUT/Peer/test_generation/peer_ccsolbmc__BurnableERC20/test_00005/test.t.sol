...
contract BurnableERC20CovTest_BurnableERC20_increaseAllowance_put2p1 is Test {
  BurnableERC20 c0;
  function setUp() public {
    
    address _esbmc_ctor_arg_mock_0_0 = payable(address(uint160(1004)));
    ...
    c0 = new BurnableERC20("VeriPUT1000", "VeriPUT1001", 0, uint256(1), payable(address(uint160(1004))));
    vm.clearMockedCalls();
  ...
  function test_put_BurnableERC20_increaseAllowance_path2p1(address p_msg_sender, uint256 p_msg_value, address spender, uint256 addedValue) public {
