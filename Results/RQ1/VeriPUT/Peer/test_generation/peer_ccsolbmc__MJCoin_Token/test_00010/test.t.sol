...
contract MJCoin_TokenCovTest_MJCoin_Token_balanceOf_put3p1_p1_part_part0_w_w is Test {
  MJCoin_Token c0;
  ...
  function test_put_MJCoin_Token_balanceOf_path3p1_part_part0_w_w(address p_msg_sender, address account) public {
    _veriput_parameterized(p_msg_sender, account);
    
    { MJCoin_TokenCovTest_MJCoin_Token_balanceOf_concrete3p1__basis_part0_w_w__W _veriput_w = new MJCoin_TokenCovTest_MJCoin_Token_balanceOf_concrete3p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract MJCoin_TokenCovTest_MJCoin_Token_balanceOf_concrete3p1__basis_part0_w_w__W is Test {
  MJCoin_Token c0;
  function setUp() public {
    c0 = new MJCoin_Token();
  }
