...
contract MJCoin_TokenCovTest_MJCoin_Token_setTokenPrice_put7p1_p1_part_part0_r_w is Test {
  MJCoin_Token c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 priceWeiTokens) internal {
    ...
    priceWeiTokens = bound(priceWeiTokens, 115792089237316195423570985008687907853269984665640564039457584007913129639935, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
    ...
    if (p_msg_sender == address(uint160(0)) && priceWeiTokens == uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)) {
      ...
      assertEq(uint256(vm.load(address(c0), bytes32(uint256(7)))), uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935), "fixed witness state");
    }
  ...
  function test_put_MJCoin_Token_setTokenPrice_path7p1_part_part0_r_w(address p_msg_sender, uint256 priceWeiTokens) public {
    _veriput_parameterized(p_msg_sender, priceWeiTokens);
    
    { MJCoin_TokenCovTest_MJCoin_Token_setTokenPrice_concrete7p1__basis_part0_r_w__W _veriput_w = new MJCoin_TokenCovTest_MJCoin_Token_setTokenPrice_concrete7p1__basis_part0_r_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract MJCoin_TokenCovTest_MJCoin_Token_setTokenPrice_concrete7p1__basis_part0_r_w__W is Test {
  MJCoin_Token c0;
  function setUp() public {
    c0 = new MJCoin_Token();
  }
  ...
  function _w_test_cov_1() public {
    ...
    bool _veriput_concrete_return = c0.setTokenPrice(uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935));
    ...
    assertEq(_veriput_fixed_state_priceEthToken_66_3, uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935), "fixed witness state");
  }
