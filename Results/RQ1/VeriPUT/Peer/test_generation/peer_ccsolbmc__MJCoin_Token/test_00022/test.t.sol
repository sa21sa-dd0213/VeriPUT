...
contract MJCoin_TokenCovTest_MJCoin_Token_transfer_put14p1_p1_part_part0_w_r is Test {
  MJCoin_Token c0;
  ...
  function test_put_MJCoin_Token_transfer_path14p1_part_part0_w_r(address p_msg_sender, address recipient, uint256 amount) public {
    _veriput_parameterized(p_msg_sender, recipient, amount);
    
    { MJCoin_TokenCovTest_MJCoin_Token_transfer_concrete14p1__basis_part0_w_r__W _veriput_w = new MJCoin_TokenCovTest_MJCoin_Token_transfer_concrete14p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract MJCoin_TokenCovTest_MJCoin_Token_transfer_concrete14p1__basis_part0_w_r__W is Test {
  MJCoin_Token c0;
  function setUp() public {
    c0 = new MJCoin_Token();
  }
