...
contract MJCoin_TokenCovTest_MJCoin_Token_allowance_put2p1 is Test {
  MJCoin_Token c0;
  ...
  function test_put_MJCoin_Token_allowance_path2p1(address p_msg_sender, uint256 p_msg_value, address Owner, address spender) public {
