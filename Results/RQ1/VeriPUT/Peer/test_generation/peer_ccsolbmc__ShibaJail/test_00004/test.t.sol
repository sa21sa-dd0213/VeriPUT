...
contract ShibaJailCovTest_ShibaJail_blockBots_put2p1 is Test {
  ShibaJail c0;
  ...
  function test_put_ShibaJail_blockBots_path2p1(address p_msg_sender, uint256 p_msg_value, address[] memory bots_) public {
