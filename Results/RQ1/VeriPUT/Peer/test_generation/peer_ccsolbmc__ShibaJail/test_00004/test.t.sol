...
contract ShibaJailCovTest_ShibaJail_blockBots_put2p1 is Test {
  ...
  // claim: sol:@C@ShibaJail@F@blockBots#1116:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@ShibaJail@F@blockBots#1116:path:2   depth=1
  ...
  uint256 _pre_bots_state__marketingFunds; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_bots_state__owner; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_bots_state__previousOwner; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_bots_state__teamAddress; // VERIPUT_HOISTED_SNAPSHOT
  ...
  uint256 _post_bots_state__marketingFunds; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_bots_state__owner; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_bots_state__previousOwner; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_bots_state__teamAddress; // VERIPUT_HOISTED_SNAPSHOT
