...
contract ShibaJailCovTest_ShibaJail_unblockBot_put6p1 is Test {
  ...
  // claim: sol:@C@ShibaJail@F@unblockBot#1130:path:7
  // witness-fingerprint-sha256: 1829c300430fe67a2ed4f2e2a88fdc4c45c70a2df2ce53037570a8fdb6c5cea4
  // claim: sol:@C@ShibaJail@F@unblockBot#1130:path:6
  // witness-fingerprint-sha256: 3f0fc5458379fb2428b8c5204f2d9842515bd568908288833057317cb0dcecfd
  // claim: sol:@C@ShibaJail@F@unblockBot#1130:path:2
  // witness-fingerprint-sha256: 97e223b78b252bb10ce050cc2684c0e8ae5ff0f086084358f46ebaf88ff11170

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@ShibaJail@F@unblockBot#1130:path:6   depth=2
  ...
  //   path guard ESTABLISHED: `!(!(_owner$33 == return_value$__msgSender$1))` -> `vm.assume(0 != uint256(uint160(p_msg_sender)));`
