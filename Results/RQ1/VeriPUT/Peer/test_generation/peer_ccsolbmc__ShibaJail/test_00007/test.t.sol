...
contract ShibaJailCovTest_ShibaJail_setCooldownEnabled_put7p1_p1_part_part0_r_w is Test {
  ShibaJail c0;
  ...
  function test_put_ShibaJail_setCooldownEnabled_path7p1_part_part0_r_w(address p_msg_sender, bool onoff) public {
    _veriput_parameterized(p_msg_sender, onoff);
    
    { ShibaJailCovTest_ShibaJail_setCooldownEnabled_concrete7p1__basis_part0_r_w__W _veriput_w = new ShibaJailCovTest_ShibaJail_setCooldownEnabled_concrete7p1__basis_part0_r_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract ShibaJailCovTest_ShibaJail_setCooldownEnabled_concrete7p1__basis_part0_r_w__W is Test {
  ShibaJail c0;
  function setUp() public {
    c0 = new ShibaJail();
  }
