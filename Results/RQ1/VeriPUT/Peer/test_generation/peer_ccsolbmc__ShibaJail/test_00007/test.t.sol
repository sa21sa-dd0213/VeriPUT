...
contract ShibaJailCovTest_ShibaJail_setCooldownEnabled_put7p1_p1_part_part0_r_w is Test {
  ...
  // claim: sol:@C@ShibaJail@F@setCooldownEnabled#603:path:7
  // witness-fingerprint-sha256: dfa19b58c4a8493a14d5c4581852db88cc334b7a376377c0ce7d6ed41301eedf
  // claim: sol:@C@ShibaJail@F@setCooldownEnabled#603:path:6
  // witness-fingerprint-sha256: 688166b0987a72cebaa85a4c966b6b059405f68c4b338ec387cd7062ce6a7ea7
  // claim: sol:@C@ShibaJail@F@setCooldownEnabled#603:path:2
  // witness-fingerprint-sha256: 44703ba9a5324ed04d0494a1f2fe336840ac400f5069bd5a2a91833cfd7a4b2b

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@ShibaJail@F@setCooldownEnabled#603:path:7   depth=2
  ...
  //   path guard ESTABLISHED: `!(_owner$33 == return_value$__msgSender$1)` -> `vm.assume(_pre_owner_33 == uint256(uint160(p_msg_sender)));`
