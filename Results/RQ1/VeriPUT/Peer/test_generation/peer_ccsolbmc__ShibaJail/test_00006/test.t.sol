...
contract ShibaJailCovTest_ShibaJail_owner_put3p1 is Test {
  ShibaJail c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    assertEq(_post_owner, _pre_owner_33, "_owner: post == state._owner$33");
  ...
  function test_put_ShibaJail_owner_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { ShibaJailCovTest_ShibaJail_owner_concrete3p1__basis_root__W _veriput_w = new ShibaJailCovTest_ShibaJail_owner_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract ShibaJailCovTest_ShibaJail_owner_concrete3p1__basis_root__W is Test {
  ShibaJail c0;
  function setUp() public {
    c0 = new ShibaJail();
  }
