...
contract ShibaJailCovTest_ShibaJail_owner_put3p1 is Test {
  ...
  // claim: sol:@C@ShibaJail@F@owner#70:path:3
  // witness-fingerprint-sha256: a6b8d9de4e0d73c38bed1ab66a4d40f26f139573a8931955b7a3116d9346652c
  // claim: sol:@C@ShibaJail@F@owner#70:path:2
  // witness-fingerprint-sha256: 545ed76e7ac842c6e1b50d4f4f3ae271dd928e868be4c2f87d6698f4e0c5e61b

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@ShibaJail@F@owner#70:path:3   depth=1
  ...
  //   state._owner$33 in [0, 1461501637330902918203684832716283019655932542975]
  //   PIN block.basefee == 0
  ...
  //   rung DROPPED: return: return == state._owner$33 (rung shape not renderable for its declared type)
