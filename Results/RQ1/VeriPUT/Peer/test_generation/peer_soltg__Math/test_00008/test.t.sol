...
contract MathCovTest_Math_max_put13p1_p1_part_part0_w_w is Test {
  Math c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 a, uint256 b) internal {
    ...
    if (p_msg_sender == address(uint160(0)) && a == uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935) && b == uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)) {
  ...
  function test_put_Math_max_path13p1_part_part0_w_w(address p_msg_sender, uint256 a, uint256 b) public {
    _veriput_parameterized(p_msg_sender, a, b);
    
    { MathCovTest_Math_max_concrete13p1__basis_part0_w_w__W _veriput_w = new MathCovTest_Math_max_concrete13p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract MathCovTest_Math_max_concrete13p1__basis_part0_w_w__W is Test {
  Math c0;
  function setUp() public {
    c0 = new Math();
  }
  ...
  function _w_test_cov_0() public {
    ...
    uint256 _veriput_concrete_return = c0.max(uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935), uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935));
