...
contract MathCovTest_Math_average_put2p1 is Test {
  Math c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, uint256 a, uint256 b) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("average(uint256,uint256)", a, b));
  ...
  function test_put_Math_average_path2p1(address p_msg_sender, uint256 p_msg_value, uint256 a, uint256 b) public {
