...
contract CryptoSecureBankTokenCovTest_CryptoSecureBankToken_removeBlackList_put2p1 is Test {
  ...
  // claim: sol:@C@CryptoSecureBankToken@F@removeBlackList#728:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@CryptoSecureBankToken@F@removeBlackList#728:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, _clearedUser
