...
contract CryptoSecureBankTokenCovTest_CryptoSecureBankToken_totalSupply_put7p1 is Test {
  ...
  function test_put_CryptoSecureBankToken_totalSupply_path7p1(address p_msg_sender) public {
    ...
    { CryptoSecureBankTokenCovTest_CryptoSecureBankToken_totalSupply_concrete7p1__basis_root__W _veriput_w = new CryptoSecureBankTokenCovTest_CryptoSecureBankToken_totalSupply_concrete7p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract CryptoSecureBankTokenCovTest_CryptoSecureBankToken_totalSupply_concrete7p1__basis_root__W is Test {
  CryptoSecureBankToken c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new CryptoSecureBankToken();
  ...
  function _w_test_cov_0() public {
    ...
    assertEq(_veriput_concrete_return, uint256(100000000000000000000000000), "fixed witness return must match");
