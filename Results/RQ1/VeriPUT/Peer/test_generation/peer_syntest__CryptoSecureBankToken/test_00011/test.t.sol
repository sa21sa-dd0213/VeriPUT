...
contract CryptoSecureBankTokenCovTest_CryptoSecureBankToken_totalSupply_put7p1 is Test {
  ...
  // claim: sol:@C@CryptoSecureBankToken@F@totalSupply#1075:path:7
  // witness-fingerprint-sha256: 27b0c20c41a2f531abdba850175eec38120dda4064ec3789f0e70f1308adda7d
  // claim: sol:@C@CryptoSecureBankToken@F@totalSupply#1075:path:2
  // witness-fingerprint-sha256: f79c8ea6dd9bdc417de05e87b82054ecdbcfacf186dabfa94dae1d8255f9fca4

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@CryptoSecureBankToken@F@totalSupply#1075:path:7   depth=2
  ...
  //   state._totalSupply$167 in [0, 115792089237316195423570985008687907853269984665640564039457584007913129639935]
  ...
  //   rung IMPLIED (not lost, not asserted twice): upgradedAddress: post >= pre (entailed by a stronger rung that also HOLDS on upgradedAddress, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): upgradedAddress: post <= pre (entailed by a stronger rung that also HOLDS on upgradedAddress, so asserting it detects nothing the stronger one misses)
