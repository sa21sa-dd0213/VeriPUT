...
contract MiraNftCovTest_MiraNft_getApproved_put6p1 is Test {
  MiraNft c0;
  ...
  function test_put_MiraNft_getApproved_path6p1(address p_msg_sender, uint256 tokenId) public {
    _veriput_parameterized(p_msg_sender, tokenId);
    
    { MiraNftCovTest_MiraNft_getApproved_concrete6p1__basis_root__W _veriput_w = new MiraNftCovTest_MiraNft_getApproved_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract MiraNftCovTest_MiraNft_getApproved_concrete6p1__basis_root__W is Test {
  MiraNft c0;
  function setUp() public {
    c0 = new MiraNft("", "");
  }
