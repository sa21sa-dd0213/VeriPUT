...
contract MiraNftCovTest_MiraNft_balanceOf_put7p1 is Test {
  MiraNft c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address owner) internal {
    ...
    uint256 _pre_balances_owner = uint256(vm.load(address(c0), keccak256(abi.encode(owner, uint256(4)))));
    ...
    uint256 _post_balances_owner = uint256(vm.load(address(c0), keccak256(abi.encode(owner, uint256(4)))));
  ...
  function test_put_MiraNft_balanceOf_path7p1(address p_msg_sender, address owner) public {
    _veriput_parameterized(p_msg_sender, owner);
    
    { MiraNftCovTest_MiraNft_balanceOf_concrete7p1__basis_root__W _veriput_w = new MiraNftCovTest_MiraNft_balanceOf_concrete7p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract MiraNftCovTest_MiraNft_balanceOf_concrete7p1__basis_root__W is Test {
  MiraNft c0;
  function setUp() public {
    c0 = new MiraNft("", "");
  }
