...
contract AIRBetsCovTest_AIRBets_renounceOwnership_put6p1 is Test {
  AIRBets c0;
  ...
  function test_put_AIRBets_renounceOwnership_path6p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { AIRBetsCovTest_AIRBets_renounceOwnership_concrete6p1__basis_root__W _veriput_w = new AIRBetsCovTest_AIRBets_renounceOwnership_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract AIRBetsCovTest_AIRBets_renounceOwnership_concrete6p1__basis_root__W is Test {
  AIRBets c0;
  function setUp() public {
    c0 = new AIRBets();
  }
