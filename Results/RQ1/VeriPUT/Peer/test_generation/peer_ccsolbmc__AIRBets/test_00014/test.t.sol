...
contract AIRBetsCovTest_AIRBets_renounceOwnership_put6p1 is Test {
  ...
  // claim: sol:@C@AIRBets@F@renounceOwnership#253:path:7
  // witness-fingerprint-sha256: 315c51201e9405c11e602d280e5fab22243ff3fabb0967f74a19174567c31d39
  // claim: sol:@C@AIRBets@F@renounceOwnership#253:path:6
  // witness-fingerprint-sha256: 67d1a9e0a53285b57a6049d3811929bd7d2468b9fe8140bfcf9d27851653f2d4
  // claim: sol:@C@AIRBets@F@renounceOwnership#253:path:2
  // witness-fingerprint-sha256: 33bb1142dcaad337b0c08c1d472c9a52e4948fd56504a3a5a6f66634190bf1ed

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@AIRBets@F@renounceOwnership#253:path:6   depth=2
  ...
  //   path guard ESTABLISHED: `!(!(_owner$175 == return_value$__msgSender$1))` -> `vm.assume(0 != uint256(uint160(p_msg_sender)));`
