...
contract AIRBetsCovTest_AIRBets_manualsend_put6p1 is Test {
  ...
  // claim: sol:@C@AIRBets@F@manualsend#1175:path:6
  // witness-fingerprint-sha256: d3ea63a47d208c4317fd19ab9ae0dabff824e332106357a3e35ec245b7599e56
  // claim: sol:@C@AIRBets@F@manualsend#1175:path:2
  // witness-fingerprint-sha256: 921361dfb2a0195d37645c0b944c04e305e754f0e9472962c3adaba8ece472d4

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@AIRBets@F@manualsend#1175:path:6   depth=2
  ...
  //   msg.sender in [0, 1461501637330902918203684832716283019655932542975]  \ {548567122026358740483782921156981144507769862359}
  //   state._charityAddress in [548567122026358740483782921156981144507769862359, 548567122026358740483782921156981144507769862359]
  //   PIN block.basefee == 0
  ...
  //   path guard ESTABLISHED: `!(!(return_value$__msgSender$1 == _charityAddress))` -> `vm.assume(uint256(uint160(p_msg_sender)) != 548567122026358740483782921156981144507769862359);`
  //   environment ESTABLISHED: msg.sender in [0, 1461501637330902918203684832716283019655932542975]  \ {0, 548567122026358740483782921156981144507769862359} is ESTABLISHED and FUZZED: the governing vm.prank now takes the bound() fuzz parameter `p_msg_sender`, so this PUT ranges over the certified sender interval rather than over one point of it, and the 2 punched value(s) are excluded by vm.assume; 0 is excluded because Foundry cannot prank address(0), and the remaining executable subregion is a subset of the certified region (replacing `vm.prank(address(uint160(4294967295)));`)
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    //   state._charityAddress := 548567122026358740483782921156981144507769862359
    {
