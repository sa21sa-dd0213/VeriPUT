...
contract salvadorCovTest_salvador_balanceOf_put2p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address tokenOwner) internal {
    ...
    assertGe(_post_balances_tokenOwner, _pre_balances_tokenOwner, "balances[tokenOwner]: post >= pre");
    assertLe(_post_balances_tokenOwner, _pre_balances_tokenOwner, "balances[tokenOwner]: post <= pre");
