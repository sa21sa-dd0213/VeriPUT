...
contract salvadorCovTest_salvador_sdfd_put3p1_p1_part_part0_w_w is Test {
  ...
  // claim: sol:@C@salvador@F@sdfd#244:path:3
  // witness-fingerprint-sha256: b0063d53d999edff3008fc0e67ad5f114a9502f9670417299a6b6c38d6c73c13
  // claim: sol:@C@salvador@F@sdfd#244:path:2
  // witness-fingerprint-sha256: 1f8fb09f68d701cd13ee916297475f3fc2971cdb33cf1413252ebacb0302c8f9

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@salvador@F@sdfd#244:path:3   depth=1
  ...
  // ORACLE: 52 assertion(s) from the surviving (HOLDS) rungs of
  // --path-cov-assert -- 52 over POST-STATE, read through vm.load at
  ...
  //   environment ESTABLISHED: msg.sender in [0, 2147483648]  \ {0} is ESTABLISHED and FUZZED: the governing vm.prank now takes the bound() fuzz parameter `p_msg_sender`, so this PUT ranges over the certified sender interval rather than over one point of it, and the 1 punched value(s) are excluded by vm.assume; 0 is excluded because Foundry cannot prank address(0), and the remaining executable subregion is a subset of the certified region (replacing `vm.prank(address(uint160(0)));`)
