...
contract salvadorCovTest_salvador_sdfd_put3p1_p1_part_part0_w_w is Test {
  salvador c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    p_msg_sender = address(uint160(bound(uint256(uint160(p_msg_sender)), 0, 2147483648)));
    ...
    if (p_msg_sender == address(uint160(0))) {
      ...
      assertEq(uint256(vm.load(address(c0), keccak256(abi.encode(address(uint160(0)), uint256(6))))), uint256(10000000000000000000000000000), "fixed witness state");
  ...
  function test_put_salvador_sdfd_path3p1_part_part0_w_w(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { salvadorCovTest_salvador_sdfd_concrete3p1__basis_part0_w_w__W _veriput_w = new salvadorCovTest_salvador_sdfd_concrete3p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract salvadorCovTest_salvador_sdfd_concrete3p1__basis_part0_w_w__W is Test {
  salvador c0;
  function setUp() public {
    c0 = new salvador();
  }
  ...
  function _w_test_cov_0() public {
    ...
    uint256 _veriput_fixed_state_balances_0_1 = uint256(vm.load(address(c0), keccak256(abi.encode(address(uint160(0)), uint256(6)))));
    assertEq(_veriput_fixed_state_balances_0_1, uint256(10000000000000000000000000000), "fixed witness state");
