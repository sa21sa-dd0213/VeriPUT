...
contract salvadorCovTest_salvador_sdfd_put3p1_p1_part_part0_r is Test {
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    if (p_msg_sender == address(uint160(4294967295))) {
      ...
      assertEq(uint256(vm.load(address(c0), keccak256(abi.encode(address(uint160(4294967295)), uint256(6))))), uint256(10000000000000000000000000000), "fixed witness state");
...
contract salvadorCovTest_salvador_sdfd_concrete3p1__basis_part0_r__W is Test {
  ...
  function _w_test_cov_0() public {
    ...
    assertEq(_veriput_fixed_state_admin_0, uint256(4294967295), "fixed witness state");
    ...
    assertEq(_veriput_fixed_state_balances_4294967295_1, uint256(10000000000000000000000000000), "fixed witness state");
