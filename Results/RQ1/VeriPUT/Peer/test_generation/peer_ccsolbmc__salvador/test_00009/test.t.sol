...
contract salvadorCovTest_salvador_sdfd_put3p1_p1_part_part0_w_r is Test {
  salvador c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    p_msg_sender = address(uint160(bound(uint256(uint160(p_msg_sender)), 2147483649, 4294967294)));
  ...
  function test_put_salvador_sdfd_path3p1_part_part0_w_r(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { salvadorCovTest_salvador_sdfd_concrete3p1__basis_part0_w_r__W _veriput_w = new salvadorCovTest_salvador_sdfd_concrete3p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract salvadorCovTest_salvador_sdfd_concrete3p1__basis_part0_w_r__W is Test {
  salvador c0;
  function setUp() public {
    c0 = new salvador();
  }
