...
contract salvadorCovTest_salvador_approve_put3p1 is Test {
  ...
  // claim: sol:@C@salvador@F@approve#150:path:3
  // witness-fingerprint-sha256: a4c7e215b3ee5bde6b57bfc7072eff704f0d77edb39817402796e8ecf13fa310
  // claim: sol:@C@salvador@F@approve#150:path:2
  // witness-fingerprint-sha256: d06dcb57438ca2e6b678d46885f1d437fab3ce2a070c377935523dda29d3e238

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@salvador@F@approve#150:path:3   depth=1
  ...
  //   delegate in [0, 1461501637330902918203684832716283019655932542975]
  //   msg.sender in [1, 1461501637330902918203684832716283019655932542975]
  //   numTokens in [0, 115792089237316195423570985008687907853269984665640564039457584007913129639935]
  //   PIN block.basefee == 0
  ...
  // FUZZ COORDINATES: msg.sender, delegate, numTokens
