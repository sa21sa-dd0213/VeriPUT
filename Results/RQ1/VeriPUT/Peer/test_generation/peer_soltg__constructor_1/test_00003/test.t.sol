...
contract C1CovTest_C1_f1_put15p1_p1_part_part0_w_w is Test {
  C1 c0;
  ...
  function test_put_C1_f1_path15p1_part_part0_w_w(address p_msg_sender, uint256 _x) public {
    _veriput_parameterized(p_msg_sender, _x);
    
    { C1CovTest_C1_f1_concrete15p1__basis_part0_w_w__W _veriput_w = new C1CovTest_C1_f1_concrete15p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract C1CovTest_C1_f1_concrete15p1__basis_part0_w_w__W is Test {
  C1 c0;
  function setUp() public {
    c0 = new C1(0);
  }
