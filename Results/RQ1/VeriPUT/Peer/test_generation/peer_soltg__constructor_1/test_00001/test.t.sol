...
contract C1CovTest_C1_f1_put15p1_p1_part_part0_r is Test {
  C1 c0;
  ...
  function test_put_C1_f1_path15p1_part_part0_r(address p_msg_sender, uint256 _x) public {
    _veriput_parameterized(p_msg_sender, _x);
    
    { C1CovTest_C1_f1_concrete15p1__basis_part0_r__W _veriput_w = new C1CovTest_C1_f1_concrete15p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract C1CovTest_C1_f1_concrete15p1__basis_part0_r__W is Test {
  C1 c0;
  function setUp() public {
    c0 = new C1(0);
  }
  ...
  function _w_test_cov_0() public {
    ...
    c0.f1(uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935));
