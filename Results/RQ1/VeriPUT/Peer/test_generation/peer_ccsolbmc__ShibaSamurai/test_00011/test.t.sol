...
contract ShibaSamuraiCovTest_ShibaSamurai_owner_put3p1 is Test {
  ShibaSamurai c0;
  ...
  function test_put_ShibaSamurai_owner_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { ShibaSamuraiCovTest_ShibaSamurai_owner_concrete3p1__basis_root__W _veriput_w = new ShibaSamuraiCovTest_ShibaSamurai_owner_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract ShibaSamuraiCovTest_ShibaSamurai_owner_concrete3p1__basis_root__W is Test {
  ShibaSamurai c0;
  function setUp() public {
    c0 = new ShibaSamurai();
  }
