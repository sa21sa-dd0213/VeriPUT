...
contract ShibaSamuraiCovTest_ShibaSamurai_reflectionFromToken_put15p1 is Test {
  ShibaSamurai c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 tAmount, bool deductTransferFee) internal {
    ...
    if (p_msg_sender == address(uint160(0)) && tAmount == uint256(9971991590534381568) && deductTransferFee == true) {
  ...
  function test_put_ShibaSamurai_reflectionFromToken_path15p1(address p_msg_sender, uint256 tAmount, bool deductTransferFee) public {
    _veriput_parameterized(p_msg_sender, tAmount, deductTransferFee);
    
    { ShibaSamuraiCovTest_ShibaSamurai_reflectionFromToken_concrete15p1__basis_root__W _veriput_w = new ShibaSamuraiCovTest_ShibaSamurai_reflectionFromToken_concrete15p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract ShibaSamuraiCovTest_ShibaSamurai_reflectionFromToken_concrete15p1__basis_root__W is Test {
  ShibaSamurai c0;
  function setUp() public {
    c0 = new ShibaSamurai();
  }
  ...
  function _w_test_cov_2() public {
    ...
    uint256 _veriput_concrete_return = c0.reflectionFromToken(uint256(9971991590534381568), true);
