...
contract MayoOchoCovTest_MayoOcho_approve_put2p1 is Test {
  MayoOcho c0;
  ...
  function test_put_MayoOcho_approve_path2p1(address p_msg_sender, uint256 p_msg_value, address spender, uint256 amount) public {
