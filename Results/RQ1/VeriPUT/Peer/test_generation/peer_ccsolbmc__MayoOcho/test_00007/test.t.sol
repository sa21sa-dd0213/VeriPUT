...
contract MayoOchoCovTest_MayoOcho_balanceOf_put2p1 is Test {
  MayoOcho c0;
  ...
  function test_put_MayoOcho_balanceOf_path2p1(address p_msg_sender, uint256 p_msg_value, address account) public {
