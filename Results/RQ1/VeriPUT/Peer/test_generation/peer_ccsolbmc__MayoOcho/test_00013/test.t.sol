...
contract MayoOchoCovTest_MayoOcho_transfer_put14p1_p1_part_part0_w_r is Test {
  ...
  function test_put_MayoOcho_transfer_path14p1_part_part0_w_r(address p_msg_sender, address recipient, uint256 amount) public {
    ...
    { MayoOchoCovTest_MayoOcho_transfer_concrete14p1__basis_part0_w_r__W _veriput_w = new MayoOchoCovTest_MayoOcho_transfer_concrete14p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract MayoOchoCovTest_MayoOcho_transfer_concrete14p1__basis_part0_w_r__W is Test {
  MayoOcho c0;
  function setUp() public {
    c0 = new MayoOcho();
  }
