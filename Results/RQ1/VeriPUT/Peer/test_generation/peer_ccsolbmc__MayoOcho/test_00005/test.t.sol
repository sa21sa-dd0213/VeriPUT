...
contract MayoOchoCovTest_MayoOcho_approve_put14p1_p1_part_part0_w_w is Test {
  MayoOcho c0;
  ...
  function test_put_MayoOcho_approve_path14p1_part_part0_w_w(address p_msg_sender, address spender, uint256 amount) public {
    _veriput_parameterized(p_msg_sender, spender, amount);
    
    { MayoOchoCovTest_MayoOcho_approve_concrete14p1__basis_part0_w_w__W _veriput_w = new MayoOchoCovTest_MayoOcho_approve_concrete14p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract MayoOchoCovTest_MayoOcho_approve_concrete14p1__basis_part0_w_w__W is Test {
  MayoOcho c0;
  function setUp() public {
    c0 = new MayoOcho();
  }
