...
contract MayoOchoCovTest_MayoOcho_totalSupply_put3p1 is Test {
  ...
  function test_put_MayoOcho_totalSupply_path3p1(address p_msg_sender) public {
    ...
    { MayoOchoCovTest_MayoOcho_totalSupply_concrete3p1__basis_root__W _veriput_w = new MayoOchoCovTest_MayoOcho_totalSupply_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract MayoOchoCovTest_MayoOcho_totalSupply_concrete3p1__basis_root__W is Test {
  MayoOcho c0;
  function setUp() public {
    c0 = new MayoOcho();
  }
