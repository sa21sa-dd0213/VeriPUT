...
contract ThriftTokenCovTest_0_ThriftToken_transferOwnership_put6p1 is Test {
  ThriftToken c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address _newOwner) internal {
    ...
    vm.assume(uint256(uint160(p_msg_sender)) != 1);
    _newOwner = address(uint160(bound(uint256(uint160(_newOwner)), 0, 1461501637330902918203684832716283019655932542975)));
    ...
    assertEq((uint256(vm.load(address(c0), bytes32(uint256(0)))) & 1461501637330902918203684832716283019655932542975), uint256(1), "entry pin state.owner did NOT land: vm.store wrote a word the contract does not read back at this slot, so the test is not inside the certified region and every rung below is about a different state");
    ...
    bool _put_ok = true;
    try c0.transferOwnership(_newOwner) {} catch { _put_ok = false; }
    
    if (p_msg_sender == address(uint160(2147483649)) && _newOwner == address(uint160(730750818665451459101842416358141509827966271489))) {
  ...
  function test_put_ThriftToken_transferOwnership_path6p1(address p_msg_sender, address _newOwner) public {
    _veriput_parameterized(p_msg_sender, _newOwner);
    
    { ThriftTokenCovTest_0_ThriftToken_transferOwnership_concrete6p1__basis_root__W _veriput_w = new ThriftTokenCovTest_0_ThriftToken_transferOwnership_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}

contract ThriftTokenCovTest_1 is Test {
  ThriftToken c0;
  function setUp() public {
...
contract ThriftTokenCovTest_2 is Test {
  ThriftToken c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new ThriftToken();
...
contract ThriftTokenCovTest_0_ThriftToken_transferOwnership_concrete6p1__basis_root__W is Test {
  ThriftToken c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new ThriftToken();
  ...
  function _w_test_cov_2() public {
    ...
    try c0.transferOwnership(address(uint160(730750818665451459101842416358141509827966271489))) {
    ...
    assertEq(_veriput_fixed_state_owner_2, uint256(1), "fixed witness state");
...
contract ThriftTokenCovTest_1__W is Test {
  ThriftToken c0;
  function setUp() public {
    vm.startPrank(address(uint160(2147483649)), address(uint160(2147483649)));
    c0 = new ThriftToken();
...
contract ThriftTokenCovTest_2__W is Test {
  ThriftToken c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new ThriftToken();
