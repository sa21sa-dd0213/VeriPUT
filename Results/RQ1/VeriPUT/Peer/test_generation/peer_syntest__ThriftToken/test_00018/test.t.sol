...
contract ThriftTokenCovTest_ThriftToken_transferableTokens_put3p1 is Test {
  ...
  // claim: sol:@C@ThriftToken@F@transferableTokens#631:path:3
  // witness-fingerprint-sha256: bcd4cfe5de5ba4fc0ab4f74df106ac9edc069feeca8f3ba7bd62c444c5bc2222
  // claim: sol:@C@ThriftToken@F@transferableTokens#631:path:2
  // witness-fingerprint-sha256: 1216361d8d3caa5269425f0f158bed4b4e22b477a552c540292551ad64e69ed2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@ThriftToken@F@transferableTokens#631:path:3   depth=1
  ...
  //   holder in [0, 1461501637330902918203684832716283019655932542975]
  ...
  // FUZZ COORDINATES: msg.sender, holder
  ...
  //   rung IMPLIED (not lost, not asserted twice): balances[holder]: post >= pre (entailed by a stronger rung that also HOLDS on balances[holder], so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): balances[holder]: post <= pre (entailed by a stronger rung that also HOLDS on balances[holder], so asserting it detects nothing the stronger one misses)
