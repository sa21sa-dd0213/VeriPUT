...
contract ThriftTokenCovTest_ThriftToken_decreaseApproval_put6p1 is Test {
  ...
  // claim: sol:@C@ThriftToken@F@decreaseApproval#246:path:6
  // witness-fingerprint-sha256: 47a008c109277322a50a24f9c66b1c49781e121ea3e4bac7a52dc30b1b3cf96a
  // claim: sol:@C@ThriftToken@F@decreaseApproval#246:path:14
  // witness-fingerprint-sha256: dc9eebc9c71b655ce74cb429db1cb02c8466d30c54dd9d49689730662f5fd37d

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@ThriftToken@F@decreaseApproval#246:path:6   depth=2
  ...
  //   _spender in [0, 0]
  //   _subtractedValue in [0, 115792089237316195423570985008687907853269984665640564039457584007913129639935]
  ...
  // FUZZ COORDINATES: msg.sender, _spender, _subtractedValue
