...
contract ThriftTokenCovTest_ThriftToken_increaseApproval_put6p1 is Test {
  ThriftToken c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address _spender, uint256 _addedValue) internal {
    ...
    _addedValue = bound(_addedValue, 0, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
    ...
    bool _put_ok = true;
    try c0.increaseApproval(_spender, _addedValue) {} catch { _put_ok = false; }
    
    if (p_msg_sender == address(uint160(0)) && _spender == address(uint160(0)) && _addedValue == uint256(0)) {
  ...
  function test_put_ThriftToken_increaseApproval_path6p1(address p_msg_sender, address _spender, uint256 _addedValue) public {
    _veriput_parameterized(p_msg_sender, _spender, _addedValue);
    
    { ThriftTokenCovTest_ThriftToken_increaseApproval_concrete6p1__basis_root__W _veriput_w = new ThriftTokenCovTest_ThriftToken_increaseApproval_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract ThriftTokenCovTest_ThriftToken_increaseApproval_concrete6p1__basis_root__W is Test {
  ThriftToken c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new ThriftToken();
  ...
  function _w_test_cov_0() public {
    ...
    try c0.increaseApproval(address(uint160(0)), uint256(0)) {
