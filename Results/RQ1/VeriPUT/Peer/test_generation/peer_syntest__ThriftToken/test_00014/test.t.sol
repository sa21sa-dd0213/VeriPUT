...
contract ThriftTokenCovTest_0 is Test {
  ThriftToken c0;
...
contract ThriftTokenCovTest_2_ThriftToken_transferOwnership_put14p1 is Test {
  ThriftToken c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new ThriftToken();
  ...
  function _veriput_parameterized(address p_msg_sender, address _newOwner) internal {
    ...
    _newOwner = address(uint160(bound(uint256(uint160(_newOwner)), 0, 0)));
  ...
  function test_put_ThriftToken_transferOwnership_path14p1(address p_msg_sender, address _newOwner) public {
    _veriput_parameterized(p_msg_sender, _newOwner);
    
    { ThriftTokenCovTest_2_ThriftToken_transferOwnership_concrete14p1__basis_root__W _veriput_w = new ThriftTokenCovTest_2_ThriftToken_transferOwnership_concrete14p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_5(); }
}
}
...
contract ThriftTokenCovTest_0__W is Test {
  ThriftToken c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new ThriftToken();
...
contract ThriftTokenCovTest_2_ThriftToken_transferOwnership_concrete14p1__basis_root__W is Test {
  ThriftToken c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new ThriftToken();
