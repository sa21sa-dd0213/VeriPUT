...
contract ThriftTokenCovTest_ThriftToken_transferFrom_put6p1 is Test {
  ThriftToken c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address _from, address _to, uint256 _value) internal {
    ...
    _from = address(uint160(bound(uint256(uint160(_from)), 0, 0)));
  ...
  function test_put_ThriftToken_transferFrom_path6p1(address p_msg_sender, address _from, address _to, uint256 _value) public {
    _veriput_parameterized(p_msg_sender, _from, _to, _value);
    
    { ThriftTokenCovTest_ThriftToken_transferFrom_concrete6p1__basis_root__W _veriput_w = new ThriftTokenCovTest_ThriftToken_transferFrom_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract ThriftTokenCovTest_ThriftToken_transferFrom_concrete6p1__basis_root__W is Test {
  ThriftToken c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new ThriftToken();
