...
contract eMastiffCovTest_eMastiff_openTrading_put6p1 is Test {
  ...
  // claim: sol:@C@eMastiff@F@openTrading#1055:path:14
  // witness-fingerprint-sha256: f916a4e88b7bc63d29443a295df8f2cfb7d5042de302be258b098f4b92d61750
  // claim: sol:@C@eMastiff@F@openTrading#1055:path:6
  // witness-fingerprint-sha256: 8698ee511836b0aa78aa3ab946ce9f1d7cdb8267def133c9bb53bac44ff567f0
  // claim: sol:@C@eMastiff@F@openTrading#1055:path:2
  // witness-fingerprint-sha256: 80c782621c7282a9ba1794cda7adf63cb5b1d49077915abf90701d280dd84202

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@eMastiff@F@openTrading#1055:path:6   depth=2
  ...
  function _veriput_parameterized(address p_msg_sender, uint8 s_liquidityAdded, uint8 s_tradingOpen) internal {
    ...
    //   state._owner$173 := 0; state.liquidityAdded := s_liquidityAdded in [0, 1] (SET and FUZZED: freed at the certification entry); state.tradingOpen := s_tradingOpen in [0, 1] (SET and FUZZED: freed at the certification entry)
    {
