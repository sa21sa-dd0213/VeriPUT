...
contract SOTHCovTest_SOTH_owner_put3p1 is Test {
  ...
  // claim: sol:@C@SOTH@F@owner#210:path:3
  // witness-fingerprint-sha256: 59f95e66be8f0659082137895cf3e18463f44791cd7a305f2facd68e1271d8b3
  // claim: sol:@C@SOTH@F@owner#210:path:2
  // witness-fingerprint-sha256: f9db2c0050d3cb1bb70ce109d8c021ed60cac2d4206b80cb17af5022accd1722

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@SOTH@F@owner#210:path:3   depth=1
  ...
  //   state._owner$173 in [0, 1461501637330902918203684832716283019655932542975]
  //   PIN block.basefee == 0
  ...
  //   rung DROPPED: return: return == state._owner$173 (rung shape not renderable for its declared type)
