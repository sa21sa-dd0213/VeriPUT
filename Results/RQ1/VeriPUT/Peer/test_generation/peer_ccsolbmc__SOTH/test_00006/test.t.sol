...
contract SOTHCovTest_SOTH_openTrading_put6p1 is Test {
  ...
  // claim: sol:@C@SOTH@F@openTrading#1067:path:63
  // witness-fingerprint-sha256: 71dfcae82703369295c96279737b5988c7f7818a2f231e609e664fb6581e2dc3
  // claim: sol:@C@SOTH@F@openTrading#1067:path:6
  // witness-fingerprint-sha256: 768d10335268dd7f702bad734336a5b08bfb55335ff9bd32586984663cd5cfa4
  // claim: sol:@C@SOTH@F@openTrading#1067:path:2
  // witness-fingerprint-sha256: b977643f3494f2f6ac7848b9bc0b8920d88328f1b34cfc1045ef9335dfe65ed5

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@SOTH@F@openTrading#1067:path:6   depth=2
  ...
  //   PIN msg.value == 0
  //   PIN state._tTotal == 10000000000000000000000000   [NOT ESTABLISHED -- see the dropped-bound line]
  //   PIN tx.gasprice == 0
  ...
  function _veriput_parameterized(address p_msg_sender, uint8 s_cooldownEnabled, uint8 s_swapEnabled, uint8 s_tradingOpen) internal {
    ...
    // VERIPUT_FIXED_REPLAY_STATE_PROJECTION {"state._tTotal":{"certificate":"fixed-replay-state-constant-or-immutable/v1","kind":"fixed-replay-state-constant-or-immutable","value":10000000000000000000000000}}
