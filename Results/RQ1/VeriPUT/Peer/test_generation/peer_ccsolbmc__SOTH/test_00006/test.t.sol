...
import {SOTH} from "../src/flat.sol";

contract SOTHCovTest_SOTH_openTrading_put6p1 is Test {
  SOTH c0;
  ...
  function test_put_SOTH_openTrading_path6p1(address p_msg_sender, uint8 s_cooldownEnabled, uint8 s_swapEnabled, uint8 s_tradingOpen) public {
    _veriput_parameterized(p_msg_sender, s_cooldownEnabled, s_swapEnabled, s_tradingOpen);
    
    { SOTHCovTest_SOTH_openTrading_concrete6p1__basis_root__W _veriput_w = new SOTHCovTest_SOTH_openTrading_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract SOTHCovTest_SOTH_openTrading_concrete6p1__basis_root__W is Test {
  SOTH c0;
  function setUp() public {
    c0 = new SOTH();
  ...
  function _w_test_cov_1() public {
    ...
    assertEq(_veriput_fixed_state_rTotal_9, uint256(115792089237316195423570985008687907853269984665640560000000000000000000000000), "fixed witness state");
