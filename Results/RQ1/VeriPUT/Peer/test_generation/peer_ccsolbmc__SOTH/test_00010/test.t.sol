...
contract SOTHCovTest_SOTH_setBots_put2p1 is Test {
  ...
  // claim: sol:@C@SOTH@F@setBots#1097:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@SOTH@F@setBots#1097:path:2   depth=1
  ...
  //   level0 = True
  //   level0_perturb = True
  //   level0_points = {'113': 'bots_.length==3', '15': 'bots_.length==0', '29': 'bots_.length==1', '57': 'bots_.length==2', '6': '(none)'}
  //   max_holes = 3
  //   max_region_pieces = 4
  //   max_tx = 1
  //   probe_ladder = True
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, bots_
  ...
  uint256 _pre_bots_msg_sender; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_bots_state__FeeAddress; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_bots_state__marketingWalletAddress; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_bots_state__owner; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_bots_state__previousOwner; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_bots_state_uniswapV2Pair; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_owner; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_bots_msg_sender; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_bots_state__FeeAddress; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_bots_state__marketingWalletAddress; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_bots_state__owner; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_bots_state__previousOwner; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_bots_state_uniswapV2Pair; // VERIPUT_HOISTED_SNAPSHOT
