...
contract SOTHCovTest_SOTH_delBot_put6p1 is Test {
  SOTH c0;
  ...
  function test_put_SOTH_delBot_path6p1(address p_msg_sender, address notbot) public {
    _veriput_parameterized(p_msg_sender, notbot);
    
    { SOTHCovTest_SOTH_delBot_concrete6p1__basis_root__W _veriput_w = new SOTHCovTest_SOTH_delBot_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract SOTHCovTest_SOTH_delBot_concrete6p1__basis_root__W is Test {
  SOTH c0;
  function setUp() public {
    c0 = new SOTH();
