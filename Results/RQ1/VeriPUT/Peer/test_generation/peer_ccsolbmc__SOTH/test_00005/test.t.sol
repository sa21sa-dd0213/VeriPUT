...
contract SOTHCovTest_SOTH_openTrading_put2p1 is Test {
  SOTH c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value) internal {
    ...
    _pre_uniswapV2Pair = (uint256(vm.load(address(c0), bytes32(uint256(17)))) & 1461501637330902918203684832716283019655932542975);
    _pre_tradingOpen = ((uint256(vm.load(address(c0), bytes32(uint256(17)))) >> 160) & 255);
    _pre_swapEnabled = ((uint256(vm.load(address(c0), bytes32(uint256(17)))) >> 176) & 255);
    _pre_cooldownEnabled = ((uint256(vm.load(address(c0), bytes32(uint256(17)))) >> 184) & 255);
    _pre_maxTxAmount = uint256(vm.load(address(c0), bytes32(uint256(18))));
    ...
    _post_uniswapV2Pair = (uint256(vm.load(address(c0), bytes32(uint256(17)))) & 1461501637330902918203684832716283019655932542975);
    _post_tradingOpen = ((uint256(vm.load(address(c0), bytes32(uint256(17)))) >> 160) & 255);
    _post_swapEnabled = ((uint256(vm.load(address(c0), bytes32(uint256(17)))) >> 176) & 255);
    _post_cooldownEnabled = ((uint256(vm.load(address(c0), bytes32(uint256(17)))) >> 184) & 255);
    _post_maxTxAmount = uint256(vm.load(address(c0), bytes32(uint256(18))));
  ...
  function test_put_SOTH_openTrading_path2p1(address p_msg_sender, uint256 p_msg_value) public {
