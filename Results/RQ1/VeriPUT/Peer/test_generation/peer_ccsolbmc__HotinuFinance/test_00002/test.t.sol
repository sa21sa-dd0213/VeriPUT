...
contract HotinuFinanceCovTest_HotinuFinance_allowance_put3p1 is Test {
  ...
  // claim: sol:@C@HotinuFinance@F@allowance#1434:path:3
  // witness-fingerprint-sha256: 15f3859730760dd15ebed934b76c09bd109c3bfeff503c5300788e6f2830ccd4
  // claim: sol:@C@HotinuFinance@F@allowance#1434:path:2
  // witness-fingerprint-sha256: 48fade1441f0f1669c540164e5bef5ee31c52ee7843f5d897619e31ed31ecc6a

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@HotinuFinance@F@allowance#1434:path:3   depth=1
