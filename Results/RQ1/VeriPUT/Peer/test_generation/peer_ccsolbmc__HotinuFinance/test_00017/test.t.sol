...
contract HotinuFinanceCovTest_HotinuFinance_totalFees_put3p1 is Test {
  ...
  function test_put_HotinuFinance_totalFees_path3p1(address p_msg_sender) public {
    ...
    { HotinuFinanceCovTest_HotinuFinance_totalFees_concrete3p1__basis_root__W _veriput_w = new HotinuFinanceCovTest_HotinuFinance_totalFees_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract HotinuFinanceCovTest_HotinuFinance_totalFees_concrete3p1__basis_root__W is Test {
  HotinuFinance c0;
  function setUp() public {
    c0 = new HotinuFinance();
  }
