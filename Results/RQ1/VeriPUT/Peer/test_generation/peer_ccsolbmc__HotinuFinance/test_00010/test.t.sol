...
contract HotinuFinanceCovTest_HotinuFinance_owner_put3p1 is Test {
  ...
  // claim: sol:@C@HotinuFinance@F@owner#652:path:3
  // witness-fingerprint-sha256: a5652c6f230dc3fd9bcb3b840fb584b70ed569e50038bb6e23fa42fcb482f1a1
  // claim: sol:@C@HotinuFinance@F@owner#652:path:2
  // witness-fingerprint-sha256: 55011f0e63f2f36022af760fc33a415e2a0653f8eff4ed4f82851f28dfbfbda7

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@HotinuFinance@F@owner#652:path:3   depth=1
  ...
  //   state._owner$619 in [0, 1461501637330902918203684832716283019655932542975]
  //   PIN block.basefee == 0
  ...
  //   rung DROPPED: return: return == state._owner$619 (rung shape not renderable for its declared type)
