...
contract HotinuFinanceCovTest_HotinuFinance_reflectionFromToken_concrete15_fb is Test {
  HotinuFinance c0;
  ...
  function test_cov_2() public {
    ...
    uint256 _veriput_concrete_return = c0.reflectionFromToken(519826685970589706150039519232, true);
