...
contract HotinuFinanceCovTest_HotinuFinance_isExcludedFromReward_put3p1 is Test {
  HotinuFinance c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address account) internal {
    ...
    uint256 _ret_pre_isExcluded_account = (uint256(vm.load(address(c0), keccak256(abi.encode(account, uint256(5))))) & 255);
    ...
    bool _put_ret = c0.isExcludedFromReward(account);
  ...
  function test_put_HotinuFinance_isExcludedFromReward_path3p1(address p_msg_sender, address account) public {
    _veriput_parameterized(p_msg_sender, account);
    
    { HotinuFinanceCovTest_HotinuFinance_isExcludedFromReward_concrete3p1__basis_root__W _veriput_w = new HotinuFinanceCovTest_HotinuFinance_isExcludedFromReward_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract HotinuFinanceCovTest_HotinuFinance_isExcludedFromReward_concrete3p1__basis_root__W is Test {
  HotinuFinance c0;
  function setUp() public {
    c0 = new HotinuFinance();
  }
  ...
  function _w_test_cov_0() public {
    ...
    bool _veriput_concrete_return = c0.isExcludedFromReward(address(uint160(0)));
