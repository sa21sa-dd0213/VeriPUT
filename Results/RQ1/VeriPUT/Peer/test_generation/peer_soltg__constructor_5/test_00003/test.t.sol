...
contract C5CovTest_1_C5_f5_put13p1_p1_part_part0_w_r is Test {
  C5 c0;
  function setUp() public {
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_block_timestamp, uint256 p_block_number, uint256 _x) internal {
    ...
    _x = bound(_x, 115792089237316195423570985008687907853269984665640564039457584007913129639933, 115792089237316195423570985008687907853269984665640564039457584007913129639933);
    ...
    if (p_msg_sender == address(uint160(0)) && p_block_timestamp == uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935) && p_block_number == uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935) && _x == uint256(115792089237316195423570985008687907853269984665640564039457584007913129639933)) {
      assertEq(uint256(vm.load(address(c0), bytes32(uint256(0)))), uint256(115792089237316195423570985008687907853269984665640564039457584007913129639933), "fixed witness state");
    }
  ...
  function test_put_C5_f5_path13p1_part_part0_w_r(address p_msg_sender, uint256 p_block_timestamp, uint256 p_block_number, uint256 _x) public {
    _veriput_parameterized(p_msg_sender, p_block_timestamp, p_block_number, _x);
    
    { C5CovTest_1_C5_f5_concrete13p1__basis_part0_w_r__W _veriput_w = new C5CovTest_1_C5_f5_concrete13p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract C5CovTest_1_C5_f5_concrete13p1__basis_part0_w_r__W is Test {
  C5 c0;
  function setUp() public {
    c0 = new C5(115792089237316195423570985008687907853269984665640564039457584007913129639935, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
  }
  ...
  function _w_test_cov_2() public {
    ...
    c0.f5(uint256(115792089237316195423570985008687907853269984665640564039457584007913129639933));
    uint256 _veriput_fixed_state_x_0 = uint256(vm.load(address(c0), bytes32(uint256(0))));
    assertEq(_veriput_fixed_state_x_0, uint256(115792089237316195423570985008687907853269984665640564039457584007913129639933), "fixed witness state");
  }
}
