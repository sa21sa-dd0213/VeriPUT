...
contract C5CovTest_C5_f5_put2p1 is Test {
  C5 c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, uint256 _x) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("f5(uint256)", _x));
  ...
  function test_put_C5_f5_path2p1(address p_msg_sender, uint256 p_msg_value, uint256 _x) public {
