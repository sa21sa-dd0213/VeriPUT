...
contract C2CovTest_C2_f2_put2_pf56p1 is Test {
  C2 c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, uint256 _x) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("f2(uint256)", _x));
  ...
  function test_put_C2_f2_path2_pf56p1(address p_msg_sender, uint256 p_msg_value, uint256 _x) public {
