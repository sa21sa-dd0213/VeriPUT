...
contract C2CovTest_0_C2_f2_put13_pf89p1 is Test {
  C2 c0;
  ...
  function test_put_C2_f2_path13_pf89p1(address p_msg_sender, uint256 _x, uint256 _y) public {
    _veriput_parameterized(p_msg_sender, _x, _y);
    
    { C2CovTest_0_C2_f2_concrete13_pf89p1__basis_root__W _veriput_w = new C2CovTest_0_C2_f2_concrete13_pf89p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_3(); }
}
}
...
contract C2CovTest_0_C2_f2_concrete13_pf89p1__basis_root__W is Test {
  C2 c0;
  function setUp() public {
    c0 = new C2(0, 0);
  }
