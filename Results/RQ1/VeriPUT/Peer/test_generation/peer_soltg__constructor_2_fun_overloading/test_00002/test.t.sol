...
contract C2CovTest_C2_f2_put13_pf56p1__pf56p1_part_part0_w_w is Test {
  C2 c0;
  function setUp() public {
    c0 = new C2(6981463658333, 6981463658333);
  }
  ...
  function test_put_C2_f2_path13_pf56p1_part_part0_w_w(address p_msg_sender, uint256 p_block_timestamp, uint256 p_block_number, uint256 _x) public {
    _veriput_parameterized(p_msg_sender, p_block_timestamp, p_block_number, _x);
    
    { C2CovTest_C2_f2_concrete13_pf56p1__basis_part0_w_w__W _veriput_w = new C2CovTest_C2_f2_concrete13_pf56p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}



contract C2CovTest_C2_f2_concrete13_pf56p1__basis_part0_w_w__W is Test {
  C2 c0;
  function setUp() public {
    c0 = new C2(6981463658333, 6981463658333);
  }
