...
contract BERNIECovTest_BERNIE_totalFees_put3p1 is Test {
  ...
  function test_put_BERNIE_totalFees_path3p1(address p_msg_sender) public {
    ...
    { BERNIECovTest_BERNIE_totalFees_concrete3p1__basis_root__W _veriput_w = new BERNIECovTest_BERNIE_totalFees_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract BERNIECovTest_BERNIE_totalFees_concrete3p1__basis_root__W is Test {
  BERNIE c0;
  function setUp() public {
    c0 = new BERNIE();
