...
contract BERNIECovTest_BERNIE_transferOwnership_put6p1 is Test {
  BERNIE c0;
  ...
  function test_put_BERNIE_transferOwnership_path6p1(address p_msg_sender, address newOwner) public {
    _veriput_parameterized(p_msg_sender, newOwner);
    
    { BERNIECovTest_BERNIE_transferOwnership_concrete6p1__basis_root__W _veriput_w = new BERNIECovTest_BERNIE_transferOwnership_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract BERNIECovTest_BERNIE_transferOwnership_concrete6p1__basis_root__W is Test {
  BERNIE c0;
  function setUp() public {
    c0 = new BERNIE();
