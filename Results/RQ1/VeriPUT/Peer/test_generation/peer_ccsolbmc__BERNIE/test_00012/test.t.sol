...
contract BERNIECovTest_BERNIE_reflectionFromToken_concrete15_fb is Test {
  BERNIE c0;
  ...
  function test_cov_2() public {
    ...
    uint256 _veriput_concrete_return = c0.reflectionFromToken(99517602309951796983084613632, true);
