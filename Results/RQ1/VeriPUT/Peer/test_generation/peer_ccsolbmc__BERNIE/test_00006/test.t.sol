...
contract BERNIECovTest_BERNIE_isExcluded_put2p1 is Test {
  BERNIE c0;
  ...
  function test_put_BERNIE_isExcluded_path2p1(address p_msg_sender, uint256 p_msg_value, address account) public {
