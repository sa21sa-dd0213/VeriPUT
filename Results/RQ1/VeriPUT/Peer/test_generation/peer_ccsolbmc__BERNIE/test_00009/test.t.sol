...
contract BERNIECovTest_BERNIE_owner_put3p1 is Test {
  ...
  // claim: sol:@C@BERNIE@F@owner#470:path:3
  // witness-fingerprint-sha256: d09bff38607fedcf8684d5c626b79b7f66277bef78ef19206d36880f24ed765e
  // claim: sol:@C@BERNIE@F@owner#470:path:2
  // witness-fingerprint-sha256: 7b26eb746fbc871a007129884798e4411c24b316d7b0214b9abe7a724eac83b3

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@BERNIE@F@owner#470:path:3   depth=1
  ...
  //   state._owner$433 in [0, 1461501637330902918203684832716283019655932542975]
  //   PIN block.basefee == 0
  ...
  //   rung DROPPED: return: return == state._owner$433 (rung shape not renderable for its declared type)
