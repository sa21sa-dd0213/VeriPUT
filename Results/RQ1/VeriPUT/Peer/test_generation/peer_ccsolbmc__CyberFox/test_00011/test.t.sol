...
contract CyberFoxCovTest_CyberFox_approve_put2p1 is Test {
  ...
  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@CyberFox@F@approve#637:path:2   depth=1
  ...
  // 18 snapshot local(s) HOISTED to storage: 4 fuzz parameter(s) + 18 snapshot local(s) exceed the 12-slot budget (solc stack reach); the reads and every assertion are unchanged
