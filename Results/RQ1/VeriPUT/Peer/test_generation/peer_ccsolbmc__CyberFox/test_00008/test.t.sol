...
contract CyberFoxCovTest_CyberFox_approve_put14p1_p1_part_part0_w_r is Test {
  ...
  // claim: sol:@C@CyberFox@F@approve#637:path:15
  // witness-fingerprint-sha256: a3dcb850c7e345f0549a72e0bc5c08eb67ffc884b5ccf9e3afcfabf0870099b2
  // claim: sol:@C@CyberFox@F@approve#637:path:14
  // witness-fingerprint-sha256: 1eca778a9e93ed376ea1d0d8dd936cff8ffcdb2fd1fd4fbcba224770a91bb674
  // claim: sol:@C@CyberFox@F@approve#637:path:6
  // witness-fingerprint-sha256: c486c1e522e1425486def215bc42b17c547329808d1c3473a0777fcc09c5ccd5
  // claim: sol:@C@CyberFox@F@approve#637:path:2
  // witness-fingerprint-sha256: 80f119219c80a58a255970e2226dd13cbe730111afbf3334ff631a182cf7c6c2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@CyberFox@F@approve#637:path:14   depth=3
  ...
  //   msg.sender in [1912875088, 3791923280]
  //   spender in [0, 0]
  //   PIN block.basefee == 0
  ...
  //   environment ESTABLISHED: msg.sender in [1912875088, 3791923280] is ESTABLISHED and FUZZED: the governing vm.prank now takes the bound() fuzz parameter `p_msg_sender`, so this PUT ranges over the certified sender interval rather than over one point of it (replacing `vm.prank(address(uint160(1)));`)
