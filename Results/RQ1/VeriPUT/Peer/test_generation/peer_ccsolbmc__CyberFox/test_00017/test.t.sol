...
contract CyberFoxCovTest_CyberFox_renounceOwnership_put6p1 is Test {
  CyberFox c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    bool _put_ok = true;
    try c0.renounceOwnership() {} catch { _put_ok = false; }
  ...
  function test_put_CyberFox_renounceOwnership_path6p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { CyberFoxCovTest_CyberFox_renounceOwnership_concrete6p1__basis_root__W _veriput_w = new CyberFoxCovTest_CyberFox_renounceOwnership_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract CyberFoxCovTest_CyberFox_renounceOwnership_concrete6p1__basis_root__W is Test {
  CyberFox c0;
  function setUp() public {
    c0 = new CyberFox();
  }
