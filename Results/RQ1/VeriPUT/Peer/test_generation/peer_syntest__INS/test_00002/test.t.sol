...
contract INSCovTest_INS_approve_put3p1 is Test {
  INS c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address _spender, uint256 _value) internal {
    ...
    assertEq(_post_allowance_msg_sender___spender, _value, "allowance[msg.sender][_spender]: post == _value");
  ...
  function test_put_INS_approve_path3p1(address p_msg_sender, address _spender, uint256 _value) public {
