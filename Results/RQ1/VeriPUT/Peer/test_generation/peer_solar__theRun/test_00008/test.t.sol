...
contract theRunCovTest_theRun_WatchBalance_put3p1 is Test {
  ...
  // claim: sol:@C@theRun@F@WatchBalance#387:path:3
  // witness-fingerprint-sha256: 8b0286db83396525416834467f14121e4370a99d48363d2a07929c7888dcb21b
  // claim: sol:@C@theRun@F@WatchBalance#387:path:2
  // witness-fingerprint-sha256: 616e81bedd4935ecc7e5c62069fe3ecf35ef71eb16a29cd8bbc24e6bfb6a4980

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@theRun@F@WatchBalance#387:path:3   depth=1
  ...
  //   state.Balance in [0, 115792089237316195423570985008687907853269984665640564039457584007913129639935]
  //   PIN block.basefee == 0
