...
contract theRunCovTest_theRun_PlayerInfo_put2p1 is Test {
  theRun c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, uint256 id) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("PlayerInfo(uint256)", id));
  ...
  function test_put_theRun_PlayerInfo_path2p1(address p_msg_sender, uint256 p_msg_value, uint256 id) public {
