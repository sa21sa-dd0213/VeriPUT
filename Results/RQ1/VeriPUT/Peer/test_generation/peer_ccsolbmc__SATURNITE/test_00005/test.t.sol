...
contract SATURNITECovTest_SATURNITE_delBot_put6p1 is Test {
  SATURNITE c0;
  ...
  function test_put_SATURNITE_delBot_path6p1(address p_msg_sender, address notbot) public {
    _veriput_parameterized(p_msg_sender, notbot);
    
    { SATURNITECovTest_SATURNITE_delBot_concrete6p1__basis_root__W _veriput_w = new SATURNITECovTest_SATURNITE_delBot_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract SATURNITECovTest_SATURNITE_delBot_concrete6p1__basis_root__W is Test {
  SATURNITE c0;
  function setUp() public {
    c0 = new SATURNITE();
  }
