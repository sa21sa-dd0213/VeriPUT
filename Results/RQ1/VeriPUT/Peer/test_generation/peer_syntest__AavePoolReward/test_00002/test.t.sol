...
contract AavePoolRewardCovTest_AavePoolReward_balanceOf_put3p1_p1_part_part0_r is Test {
  AavePoolReward c0;
  ...
  function test_put_AavePoolReward_balanceOf_path3p1_part_part0_r(address p_msg_sender, address account) public {
    _veriput_parameterized(p_msg_sender, account);
    
    { AavePoolRewardCovTest_AavePoolReward_balanceOf_concrete3p1__basis_part0_r__W _veriput_w = new AavePoolRewardCovTest_AavePoolReward_balanceOf_concrete3p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract AavePoolRewardCovTest_AavePoolReward_balanceOf_concrete3p1__basis_part0_r__W is Test {
  AavePoolReward c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new AavePoolReward();
