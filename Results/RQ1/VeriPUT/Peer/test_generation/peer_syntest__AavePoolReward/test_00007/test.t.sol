...
contract AavePoolRewardCovTest_AavePoolReward_isOwner_put3p1 is Test {
  AavePoolReward c0;
  ...
  function test_put_AavePoolReward_isOwner_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { AavePoolRewardCovTest_AavePoolReward_isOwner_concrete3p1__basis_root__W _veriput_w = new AavePoolRewardCovTest_AavePoolReward_isOwner_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract AavePoolRewardCovTest_AavePoolReward_isOwner_concrete3p1__basis_root__W is Test {
  AavePoolReward c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new AavePoolReward();
