...
contract AavePoolRewardCovTest_AavePoolReward_transferOwnership_put2p1 is Test {
  AavePoolReward c0;
  ...
  function test_put_AavePoolReward_transferOwnership_path2p1(address p_msg_sender, uint256 p_msg_value, address newOwner) public {
