...
contract FixedSupplyTokenCovTest_FixedSupplyToken_balanceOf_put3p1_p1_part_part0_r_w is Test {
  FixedSupplyToken c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address _owner) internal {
    ...
    _owner = address(uint160(bound(uint256(uint160(_owner)), 4294967295, 730750818665451459101842416358141509830113755134)));
    ...
    if (p_msg_sender == address(uint160(0)) && _owner == address(uint160(4294967295))) {
  ...
  function test_put_FixedSupplyToken_balanceOf_path3p1_part_part0_r_w(address p_msg_sender, address _owner) public {
    _veriput_parameterized(p_msg_sender, _owner);
    
    { FixedSupplyTokenCovTest_FixedSupplyToken_balanceOf_concrete3p1__basis_part0_r_w__W _veriput_w = new FixedSupplyTokenCovTest_FixedSupplyToken_balanceOf_concrete3p1__basis_part0_r_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract FixedSupplyTokenCovTest_FixedSupplyToken_balanceOf_concrete3p1__basis_part0_r_w__W is Test {
  FixedSupplyToken c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new FixedSupplyToken();
  ...
  function _w_test_cov_0() public {
    ...
    assertEq(uint256(vm.load(address(c0), keccak256(abi.encode(uint256(4294967295), uint256(2))))), uint256(1000000), "entry pin state.balances[(&_ESBMC_Object_FixedSupplyToken)->owner] did NOT land: vm.store wrote a word the contract does not read back at this slot, so the test is not inside the certified region and every rung below is about a different state");
    {
    ...
    assertEq((uint256(vm.load(address(c0), bytes32(uint256(1)))) & 1461501637330902918203684832716283019655932542975), uint256(4294967295), "entry pin state.owner did NOT land: vm.store wrote a word the contract does not read back at this slot, so the test is not inside the certified region and every rung below is about a different state");
