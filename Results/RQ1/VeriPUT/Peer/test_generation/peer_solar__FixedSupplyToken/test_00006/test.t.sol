...
contract FixedSupplyTokenCovTest_FixedSupplyToken_balanceOf_put3p1_p1_part_part0_r_r is Test {
  FixedSupplyToken c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address _owner) internal {
    ...
    _owner = address(uint160(bound(uint256(uint160(_owner)), 730750818665451459101842416358141509830113755135, 1461501637330902918203684832716283019655932542975)));
    ...
    if (p_msg_sender == address(uint160(0)) && _owner == address(uint160(730750818665451459101842416358141509830113755135))) {
  ...
  function test_put_FixedSupplyToken_balanceOf_path3p1_part_part0_r_r(address p_msg_sender, address _owner) public {
    _veriput_parameterized(p_msg_sender, _owner);
    
    { FixedSupplyTokenCovTest_FixedSupplyToken_balanceOf_concrete3p1__basis_part0_r_r__W _veriput_w = new FixedSupplyTokenCovTest_FixedSupplyToken_balanceOf_concrete3p1__basis_part0_r_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract FixedSupplyTokenCovTest_FixedSupplyToken_balanceOf_concrete3p1__basis_part0_r_r__W is Test {
  FixedSupplyToken c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new FixedSupplyToken();
  ...
  function _w_test_cov_0() public {
    ...
    uint256 _veriput_concrete_return = c0.balanceOf(address(uint160(730750818665451459101842416358141509830113755135)));
