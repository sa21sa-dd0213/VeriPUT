...
contract FixedSupplyTokenCovTest_FixedSupplyToken_balanceOf_put3p1_p1_part_part0_w_r is Test {
  FixedSupplyToken c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address _owner) internal {
    ...
    _owner = address(uint160(bound(uint256(uint160(_owner)), 2147483647, 4294967294)));
    ...
    if (p_msg_sender == address(uint160(0)) && _owner == address(uint160(2147483647))) {
  ...
  function test_put_FixedSupplyToken_balanceOf_path3p1_part_part0_w_r(address p_msg_sender, address _owner) public {
    _veriput_parameterized(p_msg_sender, _owner);
    
    { FixedSupplyTokenCovTest_FixedSupplyToken_balanceOf_concrete3p1__basis_part0_w_r__W _veriput_w = new FixedSupplyTokenCovTest_FixedSupplyToken_balanceOf_concrete3p1__basis_part0_w_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract FixedSupplyTokenCovTest_FixedSupplyToken_balanceOf_concrete3p1__basis_part0_w_r__W is Test {
  FixedSupplyToken c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new FixedSupplyToken();
  ...
  function _w_test_cov_0() public {
    ...
    {
      uint256 _w = uint256(vm.load(address(c0), keccak256(abi.encode(uint256(2147483647), uint256(2)))));
      _w = (_w & ~uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)) | ((uint256(1000000) & 115792089237316195423570985008687907853269984665640564039457584007913129639935) << 0);
      vm.store(address(c0), keccak256(abi.encode(uint256(2147483647), uint256(2))), bytes32(_w));
    }
    assertEq(uint256(vm.load(address(c0), keccak256(abi.encode(uint256(2147483647), uint256(2))))), uint256(1000000), "entry pin state.balances[(&_ESBMC_Object_FixedSupplyToken)->owner] did NOT land: vm.store wrote a word the contract does not read back at this slot, so the test is not inside the certified region and every rung below is about a different state");
    {
    ...
    uint256 _veriput_concrete_return = c0.balanceOf(address(uint160(2147483647)));
    ...
    assertEq(_veriput_fixed_state_owner_3, uint256(2147483647), "fixed witness state");
  }
