...
contract MetaCoinCovTest_MetaCoin_sendCoin_put2p1 is Test {
  MetaCoin c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address receiver, uint256 amount) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("sendCoin(address,uint256)", receiver, amount));
  ...
  function test_put_MetaCoin_sendCoin_path2p1(address p_msg_sender, uint256 p_msg_value, address receiver, uint256 amount) public {
