...
contract CsmaCovTest_Csma_f_put6p1 is Test {
  Csma c0;
  ...
  function test_put_Csma_f_path6p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { CsmaCovTest_Csma_f_concrete6p1__basis_root__W _veriput_w = new CsmaCovTest_Csma_f_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract CsmaCovTest_Csma_f_concrete6p1__basis_root__W is Test {
  Csma c0;
  function setUp() public {
    c0 = new Csma();
  }
