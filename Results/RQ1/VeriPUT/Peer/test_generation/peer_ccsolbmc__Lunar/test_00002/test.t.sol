...
contract LunarCovTest_Lunar_allowance_put3p1 is Test {
  Lunar c0;
  ...
  function test_put_Lunar_allowance_path3p1(address p_msg_sender, address owner, address spender) public {
    _veriput_parameterized(p_msg_sender, owner, spender);
    
    { LunarCovTest_Lunar_allowance_concrete3p1__basis_root__W _veriput_w = new LunarCovTest_Lunar_allowance_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract LunarCovTest_Lunar_allowance_concrete3p1__basis_root__W is Test {
  Lunar c0;
  function setUp() public {
    c0 = new Lunar();
  }
