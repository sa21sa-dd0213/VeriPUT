...
contract LunarCovTest_Lunar_reflectionFromToken_put14p1 is Test {
  Lunar c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 tAmount, bool deductTransferFee) internal {
    ...
    if (p_msg_sender == address(uint160(0)) && tAmount == uint256(9996458008965065652305920) && deductTransferFee == false) {
  ...
  function test_put_Lunar_reflectionFromToken_path14p1(address p_msg_sender, uint256 tAmount, bool deductTransferFee) public {
    _veriput_parameterized(p_msg_sender, tAmount, deductTransferFee);
    
    { LunarCovTest_Lunar_reflectionFromToken_concrete14p1__basis_root__W _veriput_w = new LunarCovTest_Lunar_reflectionFromToken_concrete14p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract LunarCovTest_Lunar_reflectionFromToken_concrete14p1__basis_root__W is Test {
  Lunar c0;
  function setUp() public {
    c0 = new Lunar();
  }
  ...
  function _w_test_cov_1() public {
    ...
    uint256 _veriput_concrete_return = c0.reflectionFromToken(uint256(9996458008965065652305920), false);
