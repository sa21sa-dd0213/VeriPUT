...
contract LunarCovTest_Lunar_approve_put15p1 is Test {
  Lunar c0;
  ...
  function test_put_Lunar_approve_path15p1(address p_msg_sender, address spender, uint256 amount) public {
    _veriput_parameterized(p_msg_sender, spender, amount);
    
    { LunarCovTest_Lunar_approve_concrete15p1__basis_root__W _veriput_w = new LunarCovTest_Lunar_approve_concrete15p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract LunarCovTest_Lunar_approve_concrete15p1__basis_root__W is Test {
  Lunar c0;
  function setUp() public {
    c0 = new Lunar();
  }
  ...
  function _w_test_cov_0() public {
    ...
    assertEq(_veriput_fixed_state_decimals_2, uint256(9), "fixed witness state");
    uint256 _veriput_fixed_state_owner_396_3 = (uint256(vm.load(address(c0), bytes32(uint256(0)))) & 1461501637330902918203684832716283019655932542975);
    assertEq(_veriput_fixed_state_owner_396_3, uint256(0), "fixed witness state");
