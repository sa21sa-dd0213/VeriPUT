...
contract BallotCovTest_Ballot_delegate_put2p1 is Test {
  ...
  // claim: sol:@C@Ballot@F@delegate#201:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@Ballot@F@delegate#201:path:2   depth=1
  ...
  //   level0 = True
  //   level0_perturb = True
  //   level0_points = {'14': 'state.voters$23[to].voted==0, to==4294967295', '63': 'state.voters$23[msg.sender].voted==0, state.voters$23[to].delegate==0, state.voters$23[to].voted==0'}
  //   max_holes = 3
  //   max_region_pieces = 4
  //   max_tx = 1
  //   probe_ladder = True
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, to
  ...
  uint256 _pre_voters_to__delegate; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_voters_to__vote; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_voters_to__voted; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_voters_to__weight; // VERIPUT_HOISTED_SNAPSHOT
  ...
  uint256 _post_voters_to__delegate; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_voters_to__vote; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_voters_to__voted; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_voters_to__weight; // VERIPUT_HOISTED_SNAPSHOT
