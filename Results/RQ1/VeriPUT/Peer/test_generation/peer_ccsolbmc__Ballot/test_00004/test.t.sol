...
contract BallotCovTest_Ballot_giveRightToVote_put2p1 is Test {
  ...
  // claim: sol:@C@Ballot@F@giveRightToVote#108:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@Ballot@F@giveRightToVote#108:path:2   depth=1
  ...
  //   level0 = True
  //   level0_perturb = True
  //   level0_points = {'31': 'state.voters$23[voter].voted==0, state.voters$23[voter].weight==0', '6': '(none)'}
  //   max_holes = 3
  //   max_region_pieces = 4
  //   max_tx = 1
  //   probe_ladder = True
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, voter
  ...
  uint256 _pre_voters_voter__voted; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_voters_voter__weight; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_voters_msg_sender__delegate; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_voters_voter__delegate; // VERIPUT_HOISTED_SNAPSHOT
  ...
  uint256 _pre_voters_voter__vote; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_voters_state_chairperson__vote; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_chairperson; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_voters_voter__voted; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_voters_voter__weight; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_voters_msg_sender__delegate; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_voters_voter__delegate; // VERIPUT_HOISTED_SNAPSHOT
  ...
  uint256 _post_voters_voter__vote; // VERIPUT_HOISTED_SNAPSHOT
