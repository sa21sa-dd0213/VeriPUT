...
contract Straight_Fire_FinanceCovTest_Straight_Fire_Finance_totalSupply_put3p1 is Test {
  ...
  function test_put_Straight_Fire_Finance_totalSupply_path3p1(address p_msg_sender) public {
    ...
    { Straight_Fire_FinanceCovTest_Straight_Fire_Finance_totalSupply_concrete3p1__basis_root__W _veriput_w = new Straight_Fire_FinanceCovTest_Straight_Fire_Finance_totalSupply_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract Straight_Fire_FinanceCovTest_Straight_Fire_Finance_totalSupply_concrete3p1__basis_root__W is Test {
  Straight_Fire_Finance c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new Straight_Fire_Finance();
  ...
  function _w_test_cov_0() public {
    {
      ...
      _w = (_w & ~uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)) | ((uint256(80000000000000000000000) & 115792089237316195423570985008687907853269984665640564039457584007913129639935) << 0);
      vm.store(address(c0), keccak256(abi.encode(uint256(0), uint256(2))), bytes32(_w));
    }
    assertEq(uint256(vm.load(address(c0), keccak256(abi.encode(uint256(0), uint256(2))))), uint256(80000000000000000000000), "entry pin state.balances[(&_ESBMC_Object_Straight_Fire_Finance)->teamAddress] did NOT land: vm.store wrote a word the contract does not read back at this slot, so the test is not inside the certified region and every rung below is about a different state");
    {
      uint256 _w = uint256(vm.load(address(c0), bytes32(uint256(0))));
      _w = (_w & ~uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)) | ((uint256(80000000000000000000000) & 115792089237316195423570985008687907853269984665640564039457584007913129639935) << 0);
      vm.store(address(c0), bytes32(uint256(0)), bytes32(_w));
    }
    assertEq(uint256(vm.load(address(c0), bytes32(uint256(0)))), uint256(80000000000000000000000), "entry pin state.initialSupply did NOT land: vm.store wrote a word the contract does not read back at this slot, so the test is not inside the certified region and every rung below is about a different state");
    {
    ...
    assertEq(_veriput_concrete_return, uint256(80000000000000000000000), "fixed witness return must match");
    uint256 _veriput_fixed_state_initialSupply_2 = uint256(vm.load(address(c0), bytes32(uint256(0))));
    assertEq(_veriput_fixed_state_initialSupply_2, uint256(80000000000000000000000), "fixed witness state");
