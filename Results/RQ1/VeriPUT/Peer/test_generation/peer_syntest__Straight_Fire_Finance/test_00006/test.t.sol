...
contract Straight_Fire_FinanceCovTest_Straight_Fire_Finance_balanceOf_put3p1 is Test {
  ...
  function test_put_Straight_Fire_Finance_balanceOf_path3p1(address p_msg_sender, address owner) public {
    ...
    { Straight_Fire_FinanceCovTest_Straight_Fire_Finance_balanceOf_concrete3p1__basis_root__W _veriput_w = new Straight_Fire_FinanceCovTest_Straight_Fire_Finance_balanceOf_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract Straight_Fire_FinanceCovTest_Straight_Fire_Finance_balanceOf_concrete3p1__basis_root__W is Test {
  Straight_Fire_Finance c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new Straight_Fire_Finance();
