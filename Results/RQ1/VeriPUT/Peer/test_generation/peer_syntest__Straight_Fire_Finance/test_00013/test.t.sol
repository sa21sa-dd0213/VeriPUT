...
contract Straight_Fire_FinanceCovTest_Straight_Fire_Finance_transferFrom_concrete7_fb is Test {
  ...
  function test_cov_0() public {
    ...
    c0.transferFrom(address(uint160(4294967295)), address(uint160(0)), uint256(0));
