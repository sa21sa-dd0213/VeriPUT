...
contract Straight_Fire_FinanceCovTest_Straight_Fire_Finance_allowance_put2p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address owner, address spender) internal {
    ...
    assertGe(_post_allowed_owner__spender, _pre_allowed_owner__spender, "allowed[owner][spender]: post >= pre");
    assertLe(_post_allowed_owner__spender, _pre_allowed_owner__spender, "allowed[owner][spender]: post <= pre");
  ...
  function test_put_Straight_Fire_Finance_allowance_path2p1(address p_msg_sender, uint256 p_msg_value, address owner, address spender) public {
