...
contract BazCovTest_Baz_baz_concrete26_fb is Test {
  Baz c0;
  ...
  function test_cov_1() public {
    ...
    int256 _veriput_concrete_return = c0.baz(42, 28948022309329048855892746252171976963317496166410141009864396001978282409984, -28948022309329048855892746252171976963317496166410141009864396001978282409984);
    assertEq(_veriput_concrete_return, int256(2), "fixed witness return must match");
