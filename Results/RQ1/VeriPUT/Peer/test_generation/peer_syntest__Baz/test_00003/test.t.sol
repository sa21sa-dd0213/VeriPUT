...
contract BazCovTest_Baz_echidna_all_states_put63p1_p1_part_part0_r is Test {
  ...
  function test_put_Baz_echidna_all_states_path63p1_part_part0_r(address p_msg_sender) public {
    ...
    { BazCovTest_Baz_echidna_all_states_concrete63p1__basis_part0_r__W _veriput_w = new BazCovTest_Baz_echidna_all_states_concrete63p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract BazCovTest_Baz_echidna_all_states_concrete63p1__basis_part0_r__W is Test {
  Baz c0;
  function setUp() public {
    c0 = new Baz();
  }
