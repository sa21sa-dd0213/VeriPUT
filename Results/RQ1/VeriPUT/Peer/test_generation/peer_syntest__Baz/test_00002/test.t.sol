...
contract BazCovTest_Baz_baz_concrete14_fb is Test {
  Baz c0;
  ...
  function test_cov_3() public {
    ...
    int256 _veriput_concrete_return = c0.baz(0, 57896044618658097711785492504343953926634992332820282019728792003956564819967, -1);
    assertEq(_veriput_concrete_return, int256(4), "fixed witness return must match");
