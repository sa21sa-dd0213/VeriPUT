...
contract Cb1CovTest_Cb1_f_put13p1 is Test {
  Cb1 c0;
  ...
  function test_put_Cb1_f_path13p1(address p_msg_sender, uint256 x) public {
    _veriput_parameterized(p_msg_sender, x);
    
    { Cb1CovTest_Cb1_f_concrete13p1__basis_root__W _veriput_w = new Cb1CovTest_Cb1_f_concrete13p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract Cb1CovTest_Cb1_f_concrete13p1__basis_root__W is Test {
  Cb1 c0;
  function setUp() public {
    c0 = new Cb1();
  }
  ...
  function _w_test_cov_0() public {
    ...
    bool _veriput_concrete_return = c0.f(uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935));
