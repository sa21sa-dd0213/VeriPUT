...
contract FreakCoinCovTest_FreakCoin_setUniswapAddress_put2p1 is Test {
  ...
  // claim: sol:@C@FreakCoin@F@setUniswapAddress#200:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@FreakCoin@F@setUniswapAddress#200:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, _uniswapV2PairAddress
