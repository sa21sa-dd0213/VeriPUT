...
contract FreakCoinCovTest_FreakCoin_balanceOf_put3p1_p1_part_part0_r is Test {
  FreakCoin c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address _user) internal {
    ...
    _user = address(uint160(bound(uint256(uint160(_user)), 1, 1461501637330902918203684832716283019655932542975)));
    ...
    if (p_msg_sender == address(uint160(0)) && _user == address(uint160(1))) {
      assertEq(_veriput_fixed_return_0, uint256(1000000), "fixed witness return");
    }
  ...
  function test_put_FreakCoin_balanceOf_path3p1_part_part0_r(address p_msg_sender, address _user) public {
    _veriput_parameterized(p_msg_sender, _user);
    
    { FreakCoinCovTest_FreakCoin_balanceOf_concrete3p1__basis_part0_r__W _veriput_w = new FreakCoinCovTest_FreakCoin_balanceOf_concrete3p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract FreakCoinCovTest_FreakCoin_balanceOf_concrete3p1__basis_part0_r__W is Test {
  FreakCoin c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new FreakCoin();
