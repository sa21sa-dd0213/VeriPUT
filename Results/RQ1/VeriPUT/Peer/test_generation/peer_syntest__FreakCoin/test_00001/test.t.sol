...
contract FreakCoinCovTest_FreakCoin_allowance_put2p1 is Test {
  FreakCoin c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address _user, address _spender) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("allowance(address,address)", _user, _spender));
  ...
  function test_put_FreakCoin_allowance_path2p1(address p_msg_sender, uint256 p_msg_value, address _user, address _spender) public {
    _veriput_parameterized(p_msg_sender, p_msg_value, _user, _spender);
  }
}
