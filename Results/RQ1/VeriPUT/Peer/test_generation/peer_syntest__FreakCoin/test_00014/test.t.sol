...
contract FreakCoinCovTest_FreakCoin_uniswapAddress_put3p1 is Test {
  FreakCoin c0;
  ...
  uint256 _ret_pre_info_uniswapV2PairAddress; 
  ...
  function _veriput_parameterized(address p_msg_sender, uint8 s_info_initialSetup) internal {
    ...
    _ret_pre_info_uniswapV2PairAddress = (uint256(vm.load(address(c0), bytes32(uint256(3)))) & 1461501637330902918203684832716283019655932542975);
    ...
    address _put_ret = c0.uniswapAddress();
    ...
    assertEq(uint256(uint160(_put_ret)), _ret_pre_info_uniswapV2PairAddress, "return: return == state.info.uniswapV2PairAddress");
    
  }


  
  function test_put_FreakCoin_uniswapAddress_path3p1(address p_msg_sender, uint8 s_info_initialSetup) public {
    _veriput_parameterized(p_msg_sender, s_info_initialSetup);
    
    { FreakCoinCovTest_FreakCoin_uniswapAddress_concrete3p1__basis_root__W _veriput_w = new FreakCoinCovTest_FreakCoin_uniswapAddress_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract FreakCoinCovTest_FreakCoin_uniswapAddress_concrete3p1__basis_root__W is Test {
  FreakCoin c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new FreakCoin();
  ...
  function _w_test_cov_0() public {
    ...
    address _veriput_concrete_return = c0.uniswapAddress();
