...
import {RSASHA1Algorithm} from "../src/flat.sol";

contract RSASHA1AlgorithmCovTest_RSASHA1Algorithm_verify_put2p1 is Test {
  RSASHA1Algorithm c0;
  function setUp() public {
    c0 = new RSASHA1Algorithm();
  }
  ...
  function test_put_RSASHA1Algorithm_verify_path2p1(address p_msg_sender, uint256 p_msg_value, bytes memory key, bytes memory data, bytes memory sig) public {
