...
contract PausableZoneCovTest_0_PausableZone_assignOperator_put15p1_p1_part_part0_r_w is Test {
  PausableZone c0;
  ...
  function _veriput_parameterized(address operatorToAssign) internal {
    operatorToAssign = address(uint160(bound(uint256(uint160(operatorToAssign)), 730750818665451459101842416358141509827966271487, 1461501637330902918203684832716283019655932542974)));
    ...
    if (operatorToAssign == address(uint160(730750818665451459101842416358141509827966271487))) {
      assertEq(((uint256(vm.load(address(c0), bytes32(uint256(0)))) >> 160) & 255), uint256(0), "fixed witness state");
      assertEq((uint256(vm.load(address(c0), bytes32(uint256(0)))) & 1461501637330902918203684832716283019655932542975), uint256(730750818665451459101842416358141509827966271487), "fixed witness state");
    }
  ...
  function test_put_PausableZone_assignOperator_path15p1_part_part0_r_w(address operatorToAssign) public {
    _veriput_parameterized(operatorToAssign);
    
    { PausableZoneCovTest_0_PausableZone_assignOperator_concrete15p1__basis_part0_r_w__W _veriput_w = new PausableZoneCovTest_0_PausableZone_assignOperator_concrete15p1__basis_part0_r_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PausableZoneCovTest_0_PausableZone_assignOperator_concrete15p1__basis_part0_r_w__W is Test {
  PausableZone c0;
  function setUp() public {
    vm.startPrank(address(uint160(4294967295)), address(uint160(4294967295)));
    c0 = new PausableZone();
  ...
  function _w_test_cov_0() public {
    ...
    c0.assignOperator(address(uint160(730750818665451459101842416358141509827966271487)));
    ...
    assertEq(_veriput_fixed_state_operator_2, uint256(730750818665451459101842416358141509827966271487), "fixed witness state");
  }
