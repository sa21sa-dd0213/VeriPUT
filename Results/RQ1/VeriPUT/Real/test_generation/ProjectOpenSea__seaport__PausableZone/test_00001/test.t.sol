...
contract PausableZoneCovTest_0_PausableZone_assignOperator_put14p1 is Test {
  PausableZone c0;
  ...
  function test_put_PausableZone_assignOperator_path14p1(address operatorToAssign) public {
    operatorToAssign = address(uint160(bound(uint256(uint160(operatorToAssign)), 0, 0)));
