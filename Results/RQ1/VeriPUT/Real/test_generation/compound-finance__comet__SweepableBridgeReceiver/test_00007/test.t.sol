...
contract SweepableBridgeReceiverCovTest_SweepableBridgeReceiver_sweepToken_put6p1 is Test {
  ...
  function test_put_SweepableBridgeReceiver_sweepToken_path6p1(address p_msg_sender, address recipient, address asset, uint8 s_initialized_50) public {
    _veriput_parameterized(p_msg_sender, recipient, asset, s_initialized_50);
    
    { SweepableBridgeReceiverCovTest_SweepableBridgeReceiver_sweepToken_concrete6p1__basis_root__W _veriput_w = new SweepableBridgeReceiverCovTest_SweepableBridgeReceiver_sweepToken_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract SweepableBridgeReceiverCovTest_SweepableBridgeReceiver_sweepToken_concrete6p1__basis_root__W is Test {
  SweepableBridgeReceiver c0;
  function setUp() public {
    c0 = new SweepableBridgeReceiver();
  }
