...
contract SweepableBridgeReceiverCovTest_SweepableBridgeReceiver_state_put6p1 is Test {
  ...
  // claim: sol:@C@SweepableBridgeReceiver@F@state#448:path:6
  // witness-fingerprint-sha256: d79a9a77eef5bc0b0e3eea5cd9b799884bbc26a3f5ba4dc2de09836a9f3cfdca
  // claim: sol:@C@SweepableBridgeReceiver@F@state#448:path:2
  // witness-fingerprint-sha256: 8470d0e103aa430c3249663f9f32d78b4143f0821559c5acd96fd17153fa3618

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@SweepableBridgeReceiver@F@state#448:path:6   depth=2
