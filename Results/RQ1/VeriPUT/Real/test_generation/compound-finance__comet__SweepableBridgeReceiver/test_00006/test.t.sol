...
contract SweepableBridgeReceiverCovTest_SweepableBridgeReceiver_sweepToken_put2p1 is Test {
...
vm.mockCall(asset, abi.encodeWithSignature("balanceOf(address)"), abi.encode(uint256(1)));
  ...
  function test_put_SweepableBridgeReceiver_sweepToken_path2p1(address p_msg_sender, uint256 p_msg_value, address recipient, address asset) public {
