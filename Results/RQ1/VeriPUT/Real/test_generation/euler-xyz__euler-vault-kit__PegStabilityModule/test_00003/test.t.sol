...
contract PegStabilityModuleCovTest_PegStabilityModule_quoteToUnderlyingGivenIn_put2p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, uint256 amountIn) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("quoteToUnderlyingGivenIn(uint256)", amountIn));
  ...
  function test_put_PegStabilityModule_quoteToUnderlyingGivenIn_path2p1(address p_msg_sender, uint256 p_msg_value, uint256 amountIn) public {
