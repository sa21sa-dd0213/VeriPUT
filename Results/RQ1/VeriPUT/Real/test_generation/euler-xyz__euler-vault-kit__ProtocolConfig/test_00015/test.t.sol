...
contract ProtocolConfigCovTest_ProtocolConfig_setVaultInterestFeeRange_put2p1 is Test {
  ...
  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@ProtocolConfig@F@setVaultInterestFeeRange#441:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, vault, exists_, minInterestFee_, maxInterestFee_
