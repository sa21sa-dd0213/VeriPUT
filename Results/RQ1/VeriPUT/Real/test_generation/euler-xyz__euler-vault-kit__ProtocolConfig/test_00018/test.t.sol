...
contract ProtocolConfigCovTest_2_ProtocolConfig_setVaultInterestFeeRange_put6p1_p1_part_part0_w_w is Test {
  ProtocolConfig c0;
  function setUp() public {
  ...
  function _veriput_parameterized(address p_msg_sender, address vault, bool exists_, uint16 minInterestFee_, uint16 maxInterestFee_) internal {
    ...
    if (p_msg_sender == address(uint160(4294967295)) && vault == address(uint160(1)) && exists_ == false && minInterestFee_ == uint16(0) && maxInterestFee_ == uint16(9104)) {
  ...
  function test_put_ProtocolConfig_setVaultInterestFeeRange_path6p1_part_part0_w_w(address p_msg_sender, address vault, bool exists_, uint16 minInterestFee_, uint16 maxInterestFee_) public {
    _veriput_parameterized(p_msg_sender, vault, exists_, minInterestFee_, maxInterestFee_);
    
    { ProtocolConfigCovTest_2_ProtocolConfig_setVaultInterestFeeRange_concrete6p1__basis_part0_w_w__W _veriput_w = new ProtocolConfigCovTest_2_ProtocolConfig_setVaultInterestFeeRange_concrete6p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_4(); }
}
}
...
contract ProtocolConfigCovTest_2_ProtocolConfig_setVaultInterestFeeRange_concrete6p1__basis_part0_w_w__W is Test {
  ProtocolConfig c0;
  function setUp() public {
    c0 = new ProtocolConfig(address(uint160(730750818665451459101842416358141509832261238783)), address(uint160(1001)));
  }
  ...
  function _w_test_cov_4() public {
    ...
    try c0.setVaultInterestFeeRange(address(uint160(1)), false, uint16(0), uint16(9104)) {
