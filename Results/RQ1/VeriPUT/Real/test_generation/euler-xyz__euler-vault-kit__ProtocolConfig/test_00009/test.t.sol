...
contract ProtocolConfigCovTest_1_ProtocolConfig_setInterestFeeRange_put6p1 is Test {
  ProtocolConfig c0;
  function setUp() public {
  ...
  function _veriput_parameterized(address p_msg_sender, uint16 minInterestFee_, uint16 maxInterestFee_) internal {
    ...
    bool _put_ok = true;
    try c0.setInterestFeeRange(minInterestFee_, maxInterestFee_) {} catch { _put_ok = false; }
    
    if (p_msg_sender == address(uint160(4294967295)) && minInterestFee_ == uint16(0) && maxInterestFee_ == uint16(0)) {
  ...
  function test_put_ProtocolConfig_setInterestFeeRange_path6p1(address p_msg_sender, uint16 minInterestFee_, uint16 maxInterestFee_) public {
    _veriput_parameterized(p_msg_sender, minInterestFee_, maxInterestFee_);
    
    { ProtocolConfigCovTest_1_ProtocolConfig_setInterestFeeRange_concrete6p1__basis_root__W _veriput_w = new ProtocolConfigCovTest_1_ProtocolConfig_setInterestFeeRange_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract ProtocolConfigCovTest_1_ProtocolConfig_setInterestFeeRange_concrete6p1__basis_root__W is Test {
  ProtocolConfig c0;
  function setUp() public {
    c0 = new ProtocolConfig(address(uint160(730750818665451459101842416358141509832261238783)), address(uint160(1001)));
  }
  ...
  function _w_test_cov_2() public {
    ...
    try c0.setInterestFeeRange(uint16(0), uint16(0)) {
