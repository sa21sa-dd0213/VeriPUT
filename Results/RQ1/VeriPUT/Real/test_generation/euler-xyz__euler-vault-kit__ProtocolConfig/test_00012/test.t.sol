...
contract ProtocolConfigCovTest_1_ProtocolConfig_setVaultInterestFeeRange_put14p1_p1_part_part0_r is Test {
  ProtocolConfig c0;
  function setUp() public {
  ...
  function _veriput_parameterized(address p_msg_sender, address vault, bool exists_, uint16 minInterestFee_, uint16 maxInterestFee_) internal {
    ...
    if (p_msg_sender == address(uint160(0)) && vault == address(uint160(0)) && exists_ == false && minInterestFee_ == uint16(0) && maxInterestFee_ == uint16(0)) {
  ...
  function test_put_ProtocolConfig_setVaultInterestFeeRange_path14p1_part_part0_r(address p_msg_sender, address vault, bool exists_, uint16 minInterestFee_, uint16 maxInterestFee_) public {
    _veriput_parameterized(p_msg_sender, vault, exists_, minInterestFee_, maxInterestFee_);
    
    { ProtocolConfigCovTest_1_ProtocolConfig_setVaultInterestFeeRange_concrete14p1__basis_part0_r__W _veriput_w = new ProtocolConfigCovTest_1_ProtocolConfig_setVaultInterestFeeRange_concrete14p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract ProtocolConfigCovTest_1_ProtocolConfig_setVaultInterestFeeRange_concrete14p1__basis_part0_r__W is Test {
  ProtocolConfig c0;
  function setUp() public {
    c0 = new ProtocolConfig(address(uint160(4294967295)), address(uint160(1001)));
  }
  ...
  function _w_test_cov_2() public {
    ...
    try c0.setVaultInterestFeeRange(address(uint160(0)), false, uint16(0), uint16(0)) {
