...
contract ProtocolConfigCovTest_0 is Test {
  ...
  // claim: sol:@C@ProtocolConfig@F@setFeeReceiver#331:path:15
  // witness-fingerprint-sha256: ae3258decf124fce4eea0be865bbbc1e62c9a8dce0ffb337701cc92076a2d665
  // claim: sol:@C@ProtocolConfig@F@setFeeReceiver#331:path:14
  // witness-fingerprint-sha256: 428cfc38cd0d1df71fcd6d3ac2bf5de60d55d5a4efbf02605a2749426d891354
}
...
contract ProtocolConfigCovTest_1_ProtocolConfig_setFeeReceiver_put6p1 is Test {
  ...
  // claim: sol:@C@ProtocolConfig@F@setFeeReceiver#331:path:6
  // witness-fingerprint-sha256: 6c3fb9ef0ebc40996fc1ea2a80c7df660e0da55b025161b1586a2ca34d8f8a10

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@ProtocolConfig@F@setFeeReceiver#331:path:6   depth=2
  ...
  //   newReceiver in [0, 1461501637330902918203684832716283019655932542975]
  ...
  // FUZZ COORDINATES: msg.sender, newReceiver
...
contract ProtocolConfigCovTest_2 is Test {
  ...
  // claim: sol:@C@ProtocolConfig@F@setFeeReceiver#331:path:2
  // witness-fingerprint-sha256: 78ba7ecdac0ed729f713c0069a99a4abd8df96c804db2fc95d696084032ed79f
}
