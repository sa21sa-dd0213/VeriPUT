...
contract OwnableAuthenticationCovTest_OwnableAuthentication_pendingOwner_put3p1 is Test {
  ...
  // claim: sol:@C@OwnableAuthentication@F@pendingOwner#260:path:3

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@OwnableAuthentication@F@pendingOwner#260:path:3   depth=1
  ...
  //   rung DROPPED: return: return == state._pendingOwner$246 (rung shape not renderable for its declared type)
...
contract OwnableAuthenticationCovTest_OwnableAuthentication_pendingOwner_concrete3p1__basis_root__W is Test {
  ...
  // claim: sol:@C@OwnableAuthentication@F@pendingOwner#260:path:3
  // witness-fingerprint-sha256: e072b16abc5afdbca63d21075eb138a09e153451d4dda3761c8bf8d4dd8ff7ab
