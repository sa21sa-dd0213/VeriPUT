...
contract SignMessageLibCovTest_SignMessageLib_getMessageHash_put3p1 is Test {
  ...
  // claim: sol:@C@SignMessageLib@F@getMessageHash#106:path:2, sol:@C@SignMessageLib@F@getMessageHash#106:path:3
  // witness-fingerprint-sha256: d7927940ab3a6bf858c55cafc42d193615465b440addd2547b56377eefb5a604

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@SignMessageLib@F@getMessageHash#106:path:3   depth=1
  ...
  //   message.length in [0, 18446744073709551615]
  ...
  //   PIN msg.value == 0
  //   PIN state.SAFE_MSG_TYPEHASH == 43739706848186989041152069077571617734008543096732098246335109361212071148490   [NOT ESTABLISHED -- see the dropped-bound line]
  //   PIN tx.gasprice == 0
  ...
  // FUZZ COORDINATES: msg.sender, message
  ...
  //   entry-state bound DROPPED: state.SAFE_MSG_TYPEHASH (no storage slot: solc's layout does not list it, so it is a constant/immutable and no test can set it)
  ...
  function _veriput_parameterized(address p_msg_sender, bytes memory message) internal {
    ...
    // VERIPUT_FIXED_REPLAY_STATE_PROJECTION {"state.SAFE_MSG_TYPEHASH":{"certificate":"fixed-replay-state-constant-or-immutable/v1","kind":"fixed-replay-state-constant-or-immutable","value":43739706848186989041152069077571617734008543096732098246335109361212071148490}}
