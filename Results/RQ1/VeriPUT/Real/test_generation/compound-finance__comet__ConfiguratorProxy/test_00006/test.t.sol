...
contract ConfiguratorProxyCovTest_ConfiguratorProxy_upgradeTo_put2p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address newImplementation) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("upgradeTo(address)", newImplementation));
  ...
  function test_put_ConfiguratorProxy_upgradeTo_path2p1(address p_msg_sender, uint256 p_msg_value, address newImplementation) public {
