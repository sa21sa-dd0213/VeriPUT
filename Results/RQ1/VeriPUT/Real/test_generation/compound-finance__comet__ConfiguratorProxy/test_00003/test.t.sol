...
contract ConfiguratorProxyCovTest_ConfiguratorProxy_changeAdmin_put2p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address newAdmin) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("changeAdmin(address)", newAdmin));
  ...
  function test_put_ConfiguratorProxy_changeAdmin_path2p1(address p_msg_sender, uint256 p_msg_value, address newAdmin) public {
