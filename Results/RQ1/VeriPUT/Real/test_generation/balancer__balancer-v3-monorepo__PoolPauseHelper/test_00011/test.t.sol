...
import {PoolPauseHelper, IVault, IAuthorizer} from "../src/flat.sol";

contract PoolPauseHelperCovTest_PoolPauseHelper_pendingOwner_put3p1 is Test {
  PoolPauseHelper c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    uint256 _pre_pendingOwner_423 = (uint256(vm.load(address(c0), bytes32(uint256(1)))) & 1461501637330902918203684832716283019655932542975);
  ...
  function test_put_PoolPauseHelper_pendingOwner_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { PoolPauseHelperCovTest_PoolPauseHelper_pendingOwner_concrete3p1__basis_root__W _veriput_w = new PoolPauseHelperCovTest_PoolPauseHelper_pendingOwner_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}



contract PoolPauseHelperCovTest_PoolPauseHelper_pendingOwner_concrete3p1__basis_root__W is Test {
  PoolPauseHelper c0;
  function setUp() public {
    c0 = new PoolPauseHelper(IVault(address(uint160(1000))), address(uint160(1001)));
