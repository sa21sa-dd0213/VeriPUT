...
contract PoolPauseHelperCovTest_PoolPauseHelper_getManagerForPoolSet_put3p1 is Test {
  PoolPauseHelper c0;
  ...
  function test_put_PoolPauseHelper_getManagerForPoolSet_path3p1(address p_msg_sender, uint256 poolSetId) public {
    _veriput_parameterized(p_msg_sender, poolSetId);
    
    { PoolPauseHelperCovTest_PoolPauseHelper_getManagerForPoolSet_concrete3p1__basis_root__W _veriput_w = new PoolPauseHelperCovTest_PoolPauseHelper_getManagerForPoolSet_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}



contract PoolPauseHelperCovTest_PoolPauseHelper_getManagerForPoolSet_concrete3p1__basis_root__W is Test {
  PoolPauseHelper c0;
  function setUp() public {
    c0 = new PoolPauseHelper(IVault(address(uint160(1000))), address(uint160(1001)));
  }
