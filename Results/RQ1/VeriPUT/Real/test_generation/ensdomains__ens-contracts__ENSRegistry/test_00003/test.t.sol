...
contract ENSRegistryCovTest_ENSRegistry_recordExists_put2p1 is Test {
  ENSRegistry c0;
  ...
  function test_put_ENSRegistry_recordExists_path2p1(address p_msg_sender, uint256 p_msg_value, uint256 node) public {
