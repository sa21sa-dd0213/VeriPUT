...
contract ENSRegistryCovTest_ENSRegistry_resolver_put2p1 is Test {
  ENSRegistry c0;
  ...
  function test_put_ENSRegistry_resolver_path2p1(address p_msg_sender, uint256 p_msg_value, uint256 node) public {
