...
contract ENSRegistryCovTest_ENSRegistry_recordExists_put3p1 is Test {
  ENSRegistry c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 node) internal {
    ...
    bool _veriput_fixed_return_0 = c0.recordExists(bytes32(node));
  ...
  function test_put_ENSRegistry_recordExists_path3p1(address p_msg_sender, uint256 node) public {
    _veriput_parameterized(p_msg_sender, node);
    
    { ENSRegistryCovTest_ENSRegistry_recordExists_concrete3p1__basis_root__W _veriput_w = new ENSRegistryCovTest_ENSRegistry_recordExists_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract ENSRegistryCovTest_ENSRegistry_recordExists_concrete3p1__basis_root__W is Test {
  ENSRegistry c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new ENSRegistry();
  ...
  function _w_test_cov_0() public {
    ...
    bool _veriput_concrete_return = c0.recordExists(bytes32(uint256(0)));
