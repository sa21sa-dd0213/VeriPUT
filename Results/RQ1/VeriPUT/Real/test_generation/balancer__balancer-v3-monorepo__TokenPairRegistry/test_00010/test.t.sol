...
contract TokenPairRegistryCovTest_TokenPairRegistry_transferOwnership_put6p1_p1_part_part0_w_w is Test {
  ...
  function test_put_TokenPairRegistry_transferOwnership_path6p1_part_part0_w_w(address p_msg_sender, address newOwner) public {
    _veriput_parameterized(p_msg_sender, newOwner);
    
    { TokenPairRegistryCovTest_TokenPairRegistry_transferOwnership_concrete6p1__basis_part0_w_w__W _veriput_w = new TokenPairRegistryCovTest_TokenPairRegistry_transferOwnership_concrete6p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}



contract TokenPairRegistryCovTest_TokenPairRegistry_transferOwnership_concrete6p1__basis_part0_w_w__W is Test {
  TokenPairRegistry c0;
  function setUp() public {
    c0 = new TokenPairRegistry(IVault(address(uint160(1000))), address(uint160(1001)));
