...
contract TokenPairRegistryCovTest_TokenPairRegistry_getPathCount_put3p1_p1_part_part0_w_w is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, address tokenIn, address tokenOut) internal {
    ...
    tokenIn = address(uint160(bound(uint256(uint160(tokenIn)), 0, 0)));
    tokenOut = address(uint160(bound(uint256(uint160(tokenOut)), 0, 0)));
    ...
    uint256 _put_ret = c0.getPathCount(tokenIn, tokenOut);
    ...
    assertEq(uint256(_put_ret), uint256(uint160(tokenIn)), "return: return == tokenIn");
    
  }


  
  function test_put_TokenPairRegistry_getPathCount_path3p1_part_part0_w_w(address p_msg_sender, address tokenIn, address tokenOut) public {
    _veriput_parameterized(p_msg_sender, tokenIn, tokenOut);
    
    { TokenPairRegistryCovTest_TokenPairRegistry_getPathCount_concrete3p1__basis_part0_w_w__W _veriput_w = new TokenPairRegistryCovTest_TokenPairRegistry_getPathCount_concrete3p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}



contract TokenPairRegistryCovTest_TokenPairRegistry_getPathCount_concrete3p1__basis_part0_w_w__W is Test {
  TokenPairRegistry c0;
  function setUp() public {
    c0 = new TokenPairRegistry(IVault(address(uint160(1000))), address(uint160(1001)));
  }
  ...
  function _w_test_cov_0() public {
    ...
    uint256 _veriput_concrete_return = c0.getPathCount(address(uint160(0)), address(uint160(0)));
