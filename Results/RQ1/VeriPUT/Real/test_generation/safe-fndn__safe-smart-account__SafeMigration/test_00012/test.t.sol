...
contract SafeMigrationCovTest_SafeMigration_migrateSingleton_put6p1_p1_part_part0_r_w is Test {
  SafeMigration c0;
  ...
  function test_put_SafeMigration_migrateSingleton_path6p1_part_part0_r_w(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { SafeMigrationCovTest_SafeMigration_migrateSingleton_concrete6p1__basis_part0_r_w__W _veriput_w = new SafeMigrationCovTest_SafeMigration_migrateSingleton_concrete6p1__basis_part0_r_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract SafeMigrationCovTest_SafeMigration_migrateSingleton_concrete6p1__basis_part0_r_w__W is Test {
  SafeMigration c0;
  function setUp() public {
