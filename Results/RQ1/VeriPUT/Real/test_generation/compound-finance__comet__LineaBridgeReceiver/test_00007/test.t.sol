...
contract LineaBridgeReceiverCovTest_LineaBridgeReceiver_sweepNativeToken_put6p1 is Test {
  ...
  function test_put_LineaBridgeReceiver_sweepNativeToken_path6p1(address p_msg_sender, address recipient) public {
    _veriput_parameterized(p_msg_sender, recipient);
    
    { LineaBridgeReceiverCovTest_LineaBridgeReceiver_sweepNativeToken_concrete6p1__basis_root__W _veriput_w = new LineaBridgeReceiverCovTest_LineaBridgeReceiver_sweepNativeToken_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract LineaBridgeReceiverCovTest_LineaBridgeReceiver_sweepNativeToken_concrete6p1__basis_root__W is Test {
  LineaBridgeReceiver c0;
  function setUp() public {
    c0 = new LineaBridgeReceiver(address(uint160(0)));
