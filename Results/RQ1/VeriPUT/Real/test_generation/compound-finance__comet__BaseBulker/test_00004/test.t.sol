...
contract BaseBulkerCovTest_BaseBulker_sweepToken_put2p1 is Test {
  BaseBulker c0;
...
vm.mockCall(asset, abi.encodeWithSignature("balanceOf(address)"), abi.encode(uint256(1)));
  ...
  function test_put_BaseBulker_sweepToken_path2p1(address p_msg_sender, uint256 p_msg_value, address recipient, address asset) public {
