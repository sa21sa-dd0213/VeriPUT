...
contract BaseBulkerCovTest_1_BaseBulker_sweepToken_put6p1 is Test {
  BaseBulker c0;
  function setUp() public {
  ...
  function test_put_BaseBulker_sweepToken_path6p1(address p_msg_sender, address recipient, address asset) public {
    _veriput_parameterized(p_msg_sender, recipient, asset);
    
    { BaseBulkerCovTest_1_BaseBulker_sweepToken_concrete6p1__basis_root__W _veriput_w = new BaseBulkerCovTest_1_BaseBulker_sweepToken_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract BaseBulkerCovTest_1_BaseBulker_sweepToken_concrete6p1__basis_root__W is Test {
  BaseBulker c0;
  function setUp() public {
    c0 = new BaseBulker(address(uint160(1461501637330902918203684832716283019655932542975)), payable(address(uint160(0))));
  }
