...
contract LocalConduitControllerCovTest_LocalConduitController_cancelOwnershipTransfer_put28p1 is Test {
  ...
  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@LocalConduitController@F@cancelOwnershipTransfer#587:path:28   depth=4
  ...
  //   level0 = True
  //   level0_perturb = True
  //   level0_points = {'28': '(none)', '30': 'msg.sender==0'}
  //   max_holes = 3
  //   max_region_pieces = 4
  //   max_tx = 1
  //   probe_ladder = True
  ...
  //   path guard ESTABLISHED: `!(_conduits$204[conduit].potentialOwner == 0)` -> `vm.assume(_pre_conduits_204_conduit__potentialOwner == 0);`
