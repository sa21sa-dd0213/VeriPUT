...
contract LocalConduitControllerCovTest_LocalConduitController_getChannelStatus_put2p1 is Test {
  ...
  // claim: sol:@C@LocalConduitController@F@getChannelStatus#785:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@LocalConduitController@F@getChannelStatus#785:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, conduit, channel
  // ORACLE: rollback exit plus 21 restored post-state frame assertion(s).
  ...
  uint256 _pre_conduits_channel__owner; // VERIPUT_HOISTED_SNAPSHOT
  ...
  uint256 _pre_conduits_channel__potentialOwner; // VERIPUT_HOISTED_SNAPSHOT
  ...
  uint256 _post_conduits_channel__owner; // VERIPUT_HOISTED_SNAPSHOT
  ...
  uint256 _post_conduits_channel__potentialOwner; // VERIPUT_HOISTED_SNAPSHOT
