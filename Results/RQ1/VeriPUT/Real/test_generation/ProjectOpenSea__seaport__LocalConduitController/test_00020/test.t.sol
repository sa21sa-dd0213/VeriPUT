...
contract LocalConduitControllerCovTest_LocalConduitController_updateChannel_put2p1 is Test {
  ...
  // claim: sol:@C@LocalConduitController@F@updateChannel#495:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@LocalConduitController@F@updateChannel#495:path:2   depth=1
  ...
  //   level0 = True
  //   level0_perturb = True
  //   level0_points = {'59': 'isOpen==0', '63': 'isOpen==0, msg.sender==0'}
  //   max_holes = 3
  //   max_region_pieces = 4
  //   max_tx = 1
  //   probe_ladder = True
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, conduit, channel, isOpen
