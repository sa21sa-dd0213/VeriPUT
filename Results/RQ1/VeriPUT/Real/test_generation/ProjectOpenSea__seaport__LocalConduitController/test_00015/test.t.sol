...
contract LocalConduitControllerCovTest_LocalConduitController_ownerOf_put2p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address conduit) internal {
    ...
    uint256 _pre_conduits_msg_sender__potentialOwner = (uint256(vm.load(address(c0), bytes32(uint256(keccak256(abi.encode(p_msg_sender, uint256(0)))) + 2))) & 1461501637330902918203684832716283019655932542975);
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("ownerOf(address)", conduit));
    ...
    uint256 _post_conduits_msg_sender__potentialOwner = (uint256(vm.load(address(c0), bytes32(uint256(keccak256(abi.encode(p_msg_sender, uint256(0)))) + 2))) & 1461501637330902918203684832716283019655932542975);
  ...
  function test_put_LocalConduitController_ownerOf_path2p1(address p_msg_sender, uint256 p_msg_value, address conduit) public {
