...
contract LocalConduitControllerCovTest_LocalConduitController_transferOwnership_put28p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, address conduit, address newPotentialOwner) internal {
    ...
    newPotentialOwner = address(uint160(bound(uint256(uint160(newPotentialOwner)), 0, 0)));
  ...
  function test_put_LocalConduitController_transferOwnership_path28p1(address p_msg_sender, address conduit, address newPotentialOwner) public {
    _veriput_parameterized(p_msg_sender, conduit, newPotentialOwner);
    
    { LocalConduitControllerCovTest_LocalConduitController_transferOwnership_concrete28p1__basis_root__W _veriput_w = new LocalConduitControllerCovTest_LocalConduitController_transferOwnership_concrete28p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_3(); }
}
}
...
contract LocalConduitControllerCovTest_LocalConduitController_transferOwnership_concrete28p1__basis_root__W is Test {
  LocalConduitController c0;
  function setUp() public {
    c0 = new LocalConduitController();
  }
