...
contract MarketAdminPermissionCheckerCovTest_0_MarketAdminPermissionChecker_checkUpdatePermission_put6p1 is Test {
  ...
  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@MarketAdminPermissionChecker@F@checkUpdatePermission#317:path:6   depth=2
  ...
  //   callerAddress in [0, 1461501637330902918203684832716283019655932542974]
  //   msg.sender in [1, 1461501637330902918203684832716283019655932542975]
  //   state.marketAdmin in [1461501637330902918203684832716283019655932542975, 1461501637330902918203684832716283019655932542975]
  ...
  //   path guard ESTABLISHED: `!(callerAddress != marketAdmin)` -> `vm.assume(uint256(uint160(callerAddress)) != 1461501637330902918203684832716283019655932542975);`
  ...
  function _veriput_parameterized(address p_msg_sender, address callerAddress, uint8 s_marketAdminPaused) internal {
    ...
    //   state.marketAdmin := 1461501637330902918203684832716283019655932542975; state.marketAdminPaused := s_marketAdminPaused in [0, 1] (SET and FUZZED: freed at the certification entry)
    {
