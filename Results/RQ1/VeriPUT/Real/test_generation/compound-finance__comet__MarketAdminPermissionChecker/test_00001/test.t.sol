...
contract MarketAdminPermissionCheckerCovTest_0_MarketAdminPermissionChecker_checkUpdatePermission_put15p1_p1_part_part0_r is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, address callerAddress) internal {
    ...
    callerAddress = address(uint160(bound(uint256(uint160(callerAddress)), 0, 0)));
    ...
    if (p_msg_sender == address(uint160(0)) && callerAddress == address(uint160(0))) {
  ...
  function test_put_MarketAdminPermissionChecker_checkUpdatePermission_path15p1_part_part0_r(address p_msg_sender, address callerAddress) public {
    _veriput_parameterized(p_msg_sender, callerAddress);
    
    { MarketAdminPermissionCheckerCovTest_0_MarketAdminPermissionChecker_checkUpdatePermission_concrete15p1__basis_part0_r__W _veriput_w = new MarketAdminPermissionCheckerCovTest_0_MarketAdminPermissionChecker_checkUpdatePermission_concrete15p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract MarketAdminPermissionCheckerCovTest_0_MarketAdminPermissionChecker_checkUpdatePermission_concrete15p1__basis_part0_r__W is Test {
  MarketAdminPermissionChecker c0;
  function setUp() public {
    c0 = new MarketAdminPermissionChecker(address(uint160(1000)), address(uint160(1461501637330902918203684832716283019655932542975)), address(uint160(0)));
  }
  ...
  function _w_test_cov_0() public {
    ...
    c0.checkUpdatePermission(address(uint160(0)));
