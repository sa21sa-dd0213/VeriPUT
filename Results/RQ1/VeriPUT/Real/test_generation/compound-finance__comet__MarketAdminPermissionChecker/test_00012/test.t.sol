...
contract MarketAdminPermissionCheckerCovTest_1_MarketAdminPermissionChecker_setMarketAdminPauseGuardian_put6p1_p1_part_part0_w_w is Test {
  MarketAdminPermissionChecker c0;
  function setUp() public {
  ...
  function _veriput_parameterized(address p_msg_sender, address newPauseGuardian) internal {
    p_msg_sender = address(uint160(bound(uint256(uint160(p_msg_sender)), 0, 4294967295)));
    vm.assume(uint256(uint160(p_msg_sender)) != 0);
    newPauseGuardian = address(uint160(bound(uint256(uint160(newPauseGuardian)), 0, 730750818665451459101842416358141509827966271486)));
    ...
    bool _put_ok = true;
    try c0.setMarketAdminPauseGuardian(newPauseGuardian) {} catch { _put_ok = false; }
    
    if (p_msg_sender == address(uint160(4294967295)) && newPauseGuardian == address(uint160(0))) {
  ...
  function test_put_MarketAdminPermissionChecker_setMarketAdminPauseGuardian_path6p1_part_part0_w_w(address p_msg_sender, address newPauseGuardian) public {
    _veriput_parameterized(p_msg_sender, newPauseGuardian);
    
    { MarketAdminPermissionCheckerCovTest_1_MarketAdminPermissionChecker_setMarketAdminPauseGuardian_concrete6p1__basis_part0_w_w__W _veriput_w = new MarketAdminPermissionCheckerCovTest_1_MarketAdminPermissionChecker_setMarketAdminPauseGuardian_concrete6p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract MarketAdminPermissionCheckerCovTest_1_MarketAdminPermissionChecker_setMarketAdminPauseGuardian_concrete6p1__basis_part0_w_w__W is Test {
  MarketAdminPermissionChecker c0;
  function setUp() public {
    c0 = new MarketAdminPermissionChecker(address(uint160(730750818665451459101842416358141509832261238783)), address(uint160(0)), address(uint160(0)));
  }
  ...
  function _w_test_cov_2() public {
    ...
    try c0.setMarketAdminPauseGuardian(address(uint160(0))) {
