...
contract MarketAdminPermissionCheckerCovTest_MarketAdminPermissionChecker_setMarketAdmin_put2p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address newMarketAdmin) internal {
    p_msg_sender = address(uint160(bound(uint256(uint160(p_msg_sender)), 1, 1461501637330902918203684832716283019655932542975)));
    p_msg_value = bound(p_msg_value, 1, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
    newMarketAdmin = address(uint160(bound(uint256(uint160(newMarketAdmin)), 0, 1461501637330902918203684832716283019655932542975)));
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("setMarketAdmin(address)", newMarketAdmin));
  ...
  function test_put_MarketAdminPermissionChecker_setMarketAdmin_path2p1(address p_msg_sender, uint256 p_msg_value, address newMarketAdmin) public {
    _veriput_parameterized(p_msg_sender, p_msg_value, newMarketAdmin);
  }
}
