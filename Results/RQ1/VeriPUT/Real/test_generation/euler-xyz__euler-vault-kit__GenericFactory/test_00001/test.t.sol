...
contract GenericFactoryCovTest_GenericFactory_createProxy_put2p1 is Test {
  ...
  // claim: sol:@C@GenericFactory@F@createProxy#273:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@GenericFactory@F@createProxy#273:path:2   depth=1
  ...
  //   level0 = True
  //   level0_perturb = True
  //   level0_points = {'28': 'desiredImplementation==0, state.implementation==0', '30': '(none)'}
  //   max_holes = 3
  //   max_region_pieces = 4
  //   max_tx = 1
  //   probe_ladder = True
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, desiredImplementation, upgradeable, trailingData
  ...
  // 20 snapshot local(s) HOISTED to storage: 5 fuzz parameter(s) + 20 snapshot local(s) exceed the 12-slot budget (solc stack reach); the reads and every assertion are unchanged
  uint256 _pre_reentrancyLock; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_implementation; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_proxyLookup_msg_sender__implementation; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_proxyLookup_desiredImplementation__implementation; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_proxyLookup_state_implementation__implementation; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_proxyLookup_state_upgradeAdmin__implementation; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_proxyLookup_msg_sender__upgradeable; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_proxyLookup_desiredImplementation__upgradeable; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_proxyLookup_state_implementation__upgradeable; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _pre_proxyLookup_state_upgradeAdmin__upgradeable; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_reentrancyLock; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_implementation; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_proxyLookup_msg_sender__implementation; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_proxyLookup_desiredImplementation__implementation; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_proxyLookup_state_implementation__implementation; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_proxyLookup_state_upgradeAdmin__implementation; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_proxyLookup_msg_sender__upgradeable; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_proxyLookup_desiredImplementation__upgradeable; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_proxyLookup_state_implementation__upgradeable; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_proxyLookup_state_upgradeAdmin__upgradeable; // VERIPUT_HOISTED_SNAPSHOT
