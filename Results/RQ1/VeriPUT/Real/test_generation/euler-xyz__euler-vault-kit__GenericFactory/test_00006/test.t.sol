...
contract GenericFactoryCovTest_GenericFactory_setImplementation_put2p1 is Test {
  ...
  // claim: sol:@C@GenericFactory@F@setImplementation#300:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@GenericFactory@F@setImplementation#300:path:2   depth=1
  ...
  //   level0 = True
  //   level0_perturb = True
  //   level0_points = {'14': '(none)', '30': '(none)', '31': '(none)'}
  //   max_holes = 3
  //   max_region_pieces = 4
  //   max_tx = 1
  //   probe_ladder = True
