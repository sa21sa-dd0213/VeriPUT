...
contract GenericFactoryCovTest_GenericFactory_isProxy_put2p1 is Test {
  GenericFactory c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address proxy) internal {
    ...
    _pre_proxyLookup_proxy__implementation = ((uint256(vm.load(address(c0), keccak256(abi.encode(proxy, uint256(3))))) >> 8) & 1461501637330902918203684832716283019655932542975);
    _pre_proxyLookup_msg_sender__upgradeable = (uint256(vm.load(address(c0), keccak256(abi.encode(p_msg_sender, uint256(3))))) & 255);
    _pre_proxyLookup_proxy__upgradeable = (uint256(vm.load(address(c0), keccak256(abi.encode(proxy, uint256(3))))) & 255);
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("isProxy(address)", proxy));
    
    _post_proxyLookup_proxy__implementation = ((uint256(vm.load(address(c0), keccak256(abi.encode(proxy, uint256(3))))) >> 8) & 1461501637330902918203684832716283019655932542975);
    _post_proxyLookup_msg_sender__upgradeable = (uint256(vm.load(address(c0), keccak256(abi.encode(p_msg_sender, uint256(3))))) & 255);
    _post_proxyLookup_proxy__upgradeable = (uint256(vm.load(address(c0), keccak256(abi.encode(proxy, uint256(3))))) & 255);
  ...
  function test_put_GenericFactory_isProxy_path2p1(address p_msg_sender, uint256 p_msg_value, address proxy) public {
