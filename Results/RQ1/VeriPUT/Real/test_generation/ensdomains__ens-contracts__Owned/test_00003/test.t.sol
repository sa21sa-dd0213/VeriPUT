...
contract OwnedCovTest_0_Owned_setOwner_put7p1_p1_part_part0_w_w is Test {
  Owned c0;
  ...
  function test_put_Owned_setOwner_path7p1_part_part0_w_w(address p_msg_sender, address newOwner) public {
    _veriput_parameterized(p_msg_sender, newOwner);
    
    { OwnedCovTest_0_Owned_setOwner_concrete7p1__basis_part0_w_w__W _veriput_w = new OwnedCovTest_0_Owned_setOwner_concrete7p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}

contract OwnedCovTest_1 is Test {
  Owned c0;
  function setUp() public {
...
contract OwnedCovTest_0_Owned_setOwner_concrete7p1__basis_part0_w_w__W is Test {
  Owned c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new Owned();
...
contract OwnedCovTest_1__W is Test {
  Owned c0;
  function setUp() public {
    vm.startPrank(address(uint160(4294967295)), address(uint160(4294967295)));
    c0 = new Owned();
