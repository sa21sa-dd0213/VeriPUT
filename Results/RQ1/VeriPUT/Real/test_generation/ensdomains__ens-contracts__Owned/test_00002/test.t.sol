...
contract OwnedCovTest_1_Owned_setOwner_put6p1 is Test {
  Owned c0;
  function setUp() public {
  ...
  function _veriput_parameterized(address p_msg_sender, address newOwner) internal {
    ...
    if (p_msg_sender == address(uint160(4294967294)) && newOwner == address(uint160(0))) {
  ...
  function test_put_Owned_setOwner_path6p1(address p_msg_sender, address newOwner) public {
    _veriput_parameterized(p_msg_sender, newOwner);
    
    { OwnedCovTest_1_Owned_setOwner_concrete6p1__basis_root__W _veriput_w = new OwnedCovTest_1_Owned_setOwner_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract OwnedCovTest_1_Owned_setOwner_concrete6p1__basis_root__W is Test {
  Owned c0;
  function setUp() public {
    vm.startPrank(address(uint160(4294967295)), address(uint160(4294967295)));
    c0 = new Owned();
