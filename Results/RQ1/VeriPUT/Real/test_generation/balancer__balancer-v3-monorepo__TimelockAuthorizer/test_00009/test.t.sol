...
contract TimelockAuthorizerCovTest_TimelockAuthorizer_isRoot_put3p1_p1_part_part0_w is Test {
  ...
  // claim: sol:@C@TimelockAuthorizer@F@isRoot#704:path:3

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@TimelockAuthorizer@F@isRoot#704:path:3   depth=1
  ...
  //   account in [0, 1461501637330902918203684832716283019655932542973]
  ...
  //   rung IMPLIED (not lost, not asserted twice): _root: post <= pre (entailed by a stronger rung that also HOLDS on _root, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): _root: post == (pre + msg.value) (entailed by a stronger rung that also HOLDS on _root, so asserting it detects nothing the stronger one misses)
...
contract TimelockAuthorizerCovTest_TimelockAuthorizer_isRoot_concrete3p1__basis_part0_w__W is Test {
  ...
  // claim: sol:@C@TimelockAuthorizer@F@isRoot#704:path:3
  // witness-fingerprint-sha256: 785472f583d79f91d24e5e65bdf5ef4f0c3550fd73ebdc3d858b570cc1763b0d
