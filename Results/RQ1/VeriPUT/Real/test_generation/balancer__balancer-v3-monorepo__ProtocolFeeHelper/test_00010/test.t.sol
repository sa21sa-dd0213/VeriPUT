...
import {ProtocolFeeHelper, IVault, IAuthorizer, IProtocolFeeController} from "../src/flat.sol";

contract ProtocolFeeHelperCovTest_ProtocolFeeHelper_pendingOwner_put3p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    uint256 _pre_pendingOwner_431 = (uint256(vm.load(address(c0), bytes32(uint256(1)))) & 1461501637330902918203684832716283019655932542975);
  ...
  function test_put_ProtocolFeeHelper_pendingOwner_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { ProtocolFeeHelperCovTest_ProtocolFeeHelper_pendingOwner_concrete3p1__basis_root__W _veriput_w = new ProtocolFeeHelperCovTest_ProtocolFeeHelper_pendingOwner_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}



contract ProtocolFeeHelperCovTest_ProtocolFeeHelper_pendingOwner_concrete3p1__basis_root__W is Test {
  ProtocolFeeHelper c0;
  function setUp() public {
    c0 = new ProtocolFeeHelper(IVault(address(uint160(1000))), address(uint160(1001)));
