...
contract BalancerFeeBurnerCovTest_BalancerFeeBurner_pendingOwner_put3p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    uint256 _pre_pendingOwner_274 = (uint256(vm.load(address(c0), bytes32(uint256(1)))) & 1461501637330902918203684832716283019655932542975);
  ...
  function test_put_BalancerFeeBurner_pendingOwner_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { BalancerFeeBurnerCovTest_BalancerFeeBurner_pendingOwner_concrete3p1__basis_root__W _veriput_w = new BalancerFeeBurnerCovTest_BalancerFeeBurner_pendingOwner_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}



contract BalancerFeeBurnerCovTest_BalancerFeeBurner_pendingOwner_concrete3p1__basis_root__W is Test {
  BalancerFeeBurner c0;
  function setUp() public {
    c0 = new BalancerFeeBurner(IVault(address(uint160(1000))), IProtocolFeeSweeper(address(uint160(1001))), address(uint160(1002)));
  ...
  function _w_test_cov_0() public {
    ...
    uint256 _veriput_fixed_state_owner_79_1 = (uint256(vm.load(address(c0), bytes32(uint256(0)))) & 1461501637330902918203684832716283019655932542975);

    uint256 _veriput_fixed_state_pendingOwner_274_2 = (uint256(vm.load(address(c0), bytes32(uint256(1)))) & 1461501637330902918203684832716283019655932542975);
