...
contract OwnedResolverCovTest_OwnedResolver_contenthash_put3p1 is Test {
  OwnedResolver c0;
  ...
  function test_put_OwnedResolver_contenthash_path3p1(address p_msg_sender, uint256 node) public {
    _veriput_parameterized(p_msg_sender, node);
    
    { OwnedResolverCovTest_OwnedResolver_contenthash_concrete3p1__basis_root__W _veriput_w = new OwnedResolverCovTest_OwnedResolver_contenthash_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract OwnedResolverCovTest_OwnedResolver_contenthash_concrete3p1__basis_root__W is Test {
  OwnedResolver c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new OwnedResolver();
  ...
  function _w_test_cov_0() public {
    ...
    c0.contenthash(bytes32(uint256(0)));
