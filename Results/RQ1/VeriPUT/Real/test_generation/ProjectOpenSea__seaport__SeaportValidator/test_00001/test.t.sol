...
contract SeaportValidatorCovTest_SeaportValidator_CONTRACT_OFFERER_INTERFACE_ID_put0 is Test {
  SeaportValidator c0;
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    c0.CONTRACT_OFFERER_INTERFACE_ID();
  ...
  function test_put_SeaportValidator_CONTRACT_OFFERER_INTERFACE_ID_path0(address p_msg_sender) public {
