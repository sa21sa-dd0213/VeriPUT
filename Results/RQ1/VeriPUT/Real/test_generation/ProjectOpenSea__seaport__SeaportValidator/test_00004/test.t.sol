...
contract SeaportValidatorCovTest_SeaportValidator_ERC1155_INTERFACE_ID_put1p1 is Test {
  SeaportValidator c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("ERC1155_INTERFACE_ID()"));
  ...
  function test_put_SeaportValidator_ERC1155_INTERFACE_ID_path1p1(address p_msg_sender, uint256 p_msg_value) public {
