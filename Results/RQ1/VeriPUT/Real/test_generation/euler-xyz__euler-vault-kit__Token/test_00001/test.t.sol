...
contract TokenCovTest_Token_allowance_put2p1 is Test {
  ...
  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@Token@F@allowance#2267:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, holder, spender
  ...
  // 42 snapshot local(s) HOISTED to storage: 4 fuzz parameter(s) + 42 snapshot local(s) exceed the 12-slot budget (solc stack reach); the reads and every assertion are unchanged
