...
contract RoninBridgeReceiverCovTest_RoninBridgeReceiver_sweepToken_put2p1 is Test {
  ...
  function test_put_RoninBridgeReceiver_sweepToken_path2p1(address p_msg_sender, uint256 p_msg_value, address recipient, address asset) public {
