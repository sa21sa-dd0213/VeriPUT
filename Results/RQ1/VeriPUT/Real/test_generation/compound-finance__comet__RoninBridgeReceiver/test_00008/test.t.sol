...
contract RoninBridgeReceiverCovTest_RoninBridgeReceiver_sweepToken_put6p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, address recipient, address asset, uint8 s_initialized_65) internal {
    ...
    s_initialized_65 = uint8(bound(uint256(s_initialized_65), 0, 1));
    
    
    {
      uint256 _w = uint256(vm.load(address(c0), bytes32(uint256(1))));
      _w = (_w & ~uint256(372682917519380244141939632342652170012262798458880)) | ((uint256(uint256(s_initialized_65)) & 255) << 160);
      vm.store(address(c0), bytes32(uint256(1)), bytes32(_w));
    }
    assertLe(((uint256(vm.load(address(c0), bytes32(uint256(1)))) >> 160) & 255), uint256(1), "the entry state is OUTSIDE the certified region: state.initialized$65 was assumed in [0, 1] when the path was certified, so a value outside it means the assumption was vacuous and the rungs below were proved about no execution this test can reach");
    {
      uint256 _w = uint256(vm.load(address(c0), bytes32(uint256(1))));
    ...
    _pre_l2Router = (uint256(vm.load(address(c0), bytes32(uint256(4)))) & 1461501637330902918203684832716283019655932542975);
    ...
    if (p_msg_sender == address(uint160(1)) && recipient == address(uint160(0)) && asset == address(uint160(0)) && s_initialized_65 == uint8(0)) {
    ...
    _post_l2Router = (uint256(vm.load(address(c0), bytes32(uint256(4)))) & 1461501637330902918203684832716283019655932542975);
    ...
    assertEq(_post_l2Router, _pre_l2Router, "l2Router: post == pre");
    ...
    assertGe(_post_l2Router, _pre_l2Router, "l2Router: post >= pre");
    assertLe(_post_l2Router, _pre_l2Router, "l2Router: post <= pre");
  ...
  function test_put_RoninBridgeReceiver_sweepToken_path6p1(address p_msg_sender, address recipient, address asset, uint8 s_initialized_65) public {
    _veriput_parameterized(p_msg_sender, recipient, asset, s_initialized_65);
    
    { RoninBridgeReceiverCovTest_RoninBridgeReceiver_sweepToken_concrete6p1__basis_root__W _veriput_w = new RoninBridgeReceiverCovTest_RoninBridgeReceiver_sweepToken_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract RoninBridgeReceiverCovTest_RoninBridgeReceiver_sweepToken_concrete6p1__basis_root__W is Test {
  RoninBridgeReceiver c0;
  function setUp() public {
    c0 = new RoninBridgeReceiver(address(uint160(0)));
  }
