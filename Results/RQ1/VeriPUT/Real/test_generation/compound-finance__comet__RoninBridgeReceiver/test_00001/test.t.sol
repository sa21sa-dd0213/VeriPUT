...
contract RoninBridgeReceiverCovTest_RoninBridgeReceiver_initialize_put2p1 is Test {
  ...
  // claim: sol:@C@RoninBridgeReceiver@F@initialize#139:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@RoninBridgeReceiver@F@initialize#139:path:2   depth=1
  ...
  //   level0 = True
  //   level0_perturb = True
  //   level0_points = {'14': 'state.initialized$65==0', '15': 'state.initialized$65==0'}
  //   max_holes = 3
  //   max_region_pieces = 4
  //   max_tx = 1
  //   probe_ladder = True
