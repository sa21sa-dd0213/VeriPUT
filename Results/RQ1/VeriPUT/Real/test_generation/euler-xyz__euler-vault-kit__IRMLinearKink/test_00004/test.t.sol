...
contract IRMLinearKinkCovTest_1_IRMLinearKink_computeInterestRateView_put6p1_p1_part_part0_r_w is Test {
  IRMLinearKink c0;
  function setUp() public {
  ...
  function _veriput_parameterized(address p_msg_sender, address vault, uint256 cash, uint256 borrows) internal {
    ...
    vault = address(uint160(bound(uint256(uint160(vault)), 0, 1461501637330902918203684832716283019655932542974)));
    cash = bound(cash, 0, 0);
    ...
    if (p_msg_sender == address(uint160(0)) && vault == address(uint160(0)) && cash == uint256(0) && borrows == uint256(0)) {
  ...
  function test_put_IRMLinearKink_computeInterestRateView_path6p1_part_part0_r_w(address p_msg_sender, address vault, uint256 cash, uint256 borrows) public {
    _veriput_parameterized(p_msg_sender, vault, cash, borrows);
    
    { IRMLinearKinkCovTest_1_IRMLinearKink_computeInterestRateView_concrete6p1__basis_part0_r_w__W _veriput_w = new IRMLinearKinkCovTest_1_IRMLinearKink_computeInterestRateView_concrete6p1__basis_part0_r_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract IRMLinearKinkCovTest_1_IRMLinearKink_computeInterestRateView_concrete6p1__basis_part0_r_w__W is Test {
  IRMLinearKink c0;
  function setUp() public {
    c0 = new IRMLinearKink(115792089237316195423570985008687907853269984665640564039457584007913129639935, 0, 0, 4294967294);
  }
  ...
  function _w_test_cov_1() public {
    ...
    uint256 _veriput_concrete_return = c0.computeInterestRateView(address(uint160(0)), uint256(0), uint256(0));
