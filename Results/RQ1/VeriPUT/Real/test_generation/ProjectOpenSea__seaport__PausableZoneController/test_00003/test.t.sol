...
contract PausableZoneControllerCovTest_0 is Test {
  ...
  // claim: sol:@C@PausableZoneController@F@assignOperator#600:path:7
  // witness-fingerprint-sha256: 60ca7653d8214c1f7c1eb82ef7bbe58dea7c1fb7d059483e0ae3764db8f7da99
  // claim: sol:@C@PausableZoneController@F@assignOperator#600:path:2
  // witness-fingerprint-sha256: 11086e40767f09e612f4e5687d9931d3aa17f272f5287fb640899059383208a6
}
...
contract PausableZoneControllerCovTest_1_PausableZoneController_assignOperator_put6p1 is Test {
  ...
  // claim: sol:@C@PausableZoneController@F@assignOperator#600:path:6
  // witness-fingerprint-sha256: 01dd3c1306b43cd5e8602b0951e3a8d978336ede99ed665baa1a017bb00d6141

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@PausableZoneController@F@assignOperator#600:path:6   depth=2
  ...
  //   operatorToAssign in [0, 1461501637330902918203684832716283019655932542975]
  //   pausableZoneAddress in [0, 1461501637330902918203684832716283019655932542975]
  //   state._owner in [730750818665451459101842416358141509832261238783, 730750818665451459101842416358141509832261238783]
  //   PIN block.basefee == 0
  ...
  // FUZZ COORDINATES: msg.sender, pausableZoneAddress, operatorToAssign
  ...
  //   path guard ESTABLISHED: `!(msg.sender != _owner)` -> `vm.assume(uint256(uint160(p_msg_sender)) != 730750818665451459101842416358141509832261238783);`
  ...
  function _veriput_parameterized(address p_msg_sender, address pausableZoneAddress, address operatorToAssign) internal {
    ...
    //   state._owner := 730750818665451459101842416358141509832261238783
    {
