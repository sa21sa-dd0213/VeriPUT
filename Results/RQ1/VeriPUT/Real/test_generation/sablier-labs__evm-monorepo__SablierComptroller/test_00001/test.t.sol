...
contract SablierComptrollerCovTest_SablierComptroller_calculateMinFeeWei_put6p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    uint256 _put_ret = c0.calculateMinFeeWei(ISablierComptroller.Protocol(0));
  ...
  function test_put_SablierComptroller_calculateMinFeeWei_path6p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { SablierComptrollerCovTest_SablierComptroller_calculateMinFeeWei_concrete6p1__basis_root__W _veriput_w = new SablierComptrollerCovTest_SablierComptroller_calculateMinFeeWei_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}



contract SablierComptrollerCovTest_SablierComptroller_calculateMinFeeWei_concrete6p1__basis_root__W is Test {
  SablierComptroller c0;
  function setUp() public {
    c0 = new SablierComptroller(address(uint160(1000)));
  }
  ...
  function _w_test_cov_0() public {
    ...
    uint256 _veriput_concrete_return = c0.calculateMinFeeWei(ISablierComptroller.Protocol(uint8(0)));
