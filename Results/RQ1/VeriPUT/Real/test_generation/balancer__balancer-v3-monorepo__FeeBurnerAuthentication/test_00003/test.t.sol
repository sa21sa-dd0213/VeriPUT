...
contract FeeBurnerAuthenticationCovTest_FeeBurnerAuthentication_owner_put3p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    assertEq(_post_owner, _pre_owner_32, "_owner: post == state._owner$32");
  ...
  function test_put_FeeBurnerAuthentication_owner_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { FeeBurnerAuthenticationCovTest_FeeBurnerAuthentication_owner_concrete3p1__basis_root__W _veriput_w = new FeeBurnerAuthenticationCovTest_FeeBurnerAuthentication_owner_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}



contract FeeBurnerAuthenticationCovTest_FeeBurnerAuthentication_owner_concrete3p1__basis_root__W is Test {
  FeeBurnerAuthentication c0;
  function setUp() public {
    c0 = new FeeBurnerAuthentication(IProtocolFeeSweeper(address(uint160(1000))), address(uint160(1001)));
