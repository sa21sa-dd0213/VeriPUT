...
contract PoolSwapFeeHelperCovTest_PoolSwapFeeHelper_isValidPoolSetId_put3p1 is Test {
  ...
  function test_put_PoolSwapFeeHelper_isValidPoolSetId_path3p1(address p_msg_sender, uint256 poolSetId) public {
    _veriput_parameterized(p_msg_sender, poolSetId);
    
    { PoolSwapFeeHelperCovTest_PoolSwapFeeHelper_isValidPoolSetId_concrete3p1__basis_root__W _veriput_w = new PoolSwapFeeHelperCovTest_PoolSwapFeeHelper_isValidPoolSetId_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}



contract PoolSwapFeeHelperCovTest_PoolSwapFeeHelper_isValidPoolSetId_concrete3p1__basis_root__W is Test {
  PoolSwapFeeHelper c0;
  function setUp() public {
    c0 = new PoolSwapFeeHelper(IVault(address(uint160(1000))), address(uint160(1001)));
  }
