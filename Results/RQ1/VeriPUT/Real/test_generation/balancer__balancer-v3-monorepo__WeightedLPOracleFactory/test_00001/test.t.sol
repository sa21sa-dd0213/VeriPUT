...
import {WeightedLPOracleFactory, AggregatorV3Interface, IBasePool, IVault} from "../src/flat.sol";

contract WeightedLPOracleFactoryCovTest_WeightedLPOracleFactory_getOracle_put2p1 is Test {
  ...
  function test_put_WeightedLPOracleFactory_getOracle_path2p1(address p_msg_sender, uint256 p_msg_value, bool shouldUseBlockTimeForOldestFeedUpdate, bool shouldRevertIfVaultUnlocked) public {
