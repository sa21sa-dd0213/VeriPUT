...
contract MainnetBulkerWithWstETHSupportCovTest_0 is Test {
  ...
  function setUp() public {
    ...
    address _esbmc_ctor_arg_mock_0_0 = address(uint160(1461501637330902918203684832716283019655932542975));
    ...
    c0 = new MainnetBulkerWithWstETHSupport(address(uint160(4294967295)), payable(address(uint160(0))), address(uint160(1461501637330902918203684832716283019655932542975)));
    vm.clearMockedCalls();
    ...
    address _esbmc_ctor_state_mock_0_0 = address(uint160(1461501637330902918203684832716283019655932542975));
...
contract MainnetBulkerWithWstETHSupportCovTest_1 is Test {
  MainnetBulkerWithWstETHSupport c0;
  function setUp() public {
    ...
    address _esbmc_ctor_arg_mock_1_0 = address(uint160(1461501637330902918203684832716283019655932542974));
    ...
    c0 = new MainnetBulkerWithWstETHSupport(address(uint160(4294967295)), payable(address(uint160(0))), address(uint160(1461501637330902918203684832716283019655932542974)));
    vm.clearMockedCalls();
    ...
    address _esbmc_ctor_state_mock_1_0 = address(uint160(1461501637330902918203684832716283019655932542974));
...
contract MainnetBulkerWithWstETHSupportCovTest_2_MainnetBulkerWithWstETHSupport_deposit_put2p1 is Test {
  MainnetBulkerWithWstETHSupport c0;
  function setUp() public {
    ...
    vm.etch(_esbmc_ctor_arg_mock_2_0_ret_0, hex"60006000f3");
    
    address _esbmc_ctor_arg_mock_2_0 = address(uint160(1461501637330902918203684832716283019655932542975));
    bytes memory _esbmc_ctor_arg_mock_2_0_code = _esbmc_ctor_arg_mock_2_0.code;
    vm.etch(_esbmc_ctor_arg_mock_2_0, hex"60006000f3");
    vm.mockCall(_esbmc_ctor_arg_mock_2_0, abi.encodeWithSignature("stETH()"), abi.encode(_esbmc_ctor_arg_mock_2_0_ret_0));
    c0 = new MainnetBulkerWithWstETHSupport(address(uint160(1461501637330902918203684832716283019655932542975)), payable(address(uint160(0))), address(uint160(1461501637330902918203684832716283019655932542975)));
    vm.clearMockedCalls();
    vm.etch(_esbmc_ctor_arg_mock_2_0, _esbmc_ctor_arg_mock_2_0_code);
    vm.etch(_esbmc_ctor_arg_mock_2_0_ret_0, _esbmc_ctor_arg_mock_2_0_ret_0_code);
    
    address _esbmc_ctor_state_mock_2_0 = address(uint160(1461501637330902918203684832716283019655932542975));
  ...
  function _veriput_parameterized(address p_msg_sender, address comet) internal {
    ...
    comet = address(uint160(bound(uint256(uint160(comet)), 0, 1461501637330902918203684832716283019655932542975)));

vm.mockCall(comet, abi.encodeWithSignature("baseToken()"), abi.encode(address(0)));
    ...
    bool _put_ok = true;
    try c0.deposit{value: 0}(comet) {} catch { _put_ok = false; }
    
    if (p_msg_sender == address(uint160(4294967295)) && comet == address(uint160(0))) {
  ...
  function test_put_MainnetBulkerWithWstETHSupport_deposit_path2p1(address p_msg_sender, address comet) public {
    _veriput_parameterized(p_msg_sender, comet);
    
    { MainnetBulkerWithWstETHSupportCovTest_2_MainnetBulkerWithWstETHSupport_deposit_concrete2p1__basis_root__W _veriput_w = new MainnetBulkerWithWstETHSupportCovTest_2_MainnetBulkerWithWstETHSupport_deposit_concrete2p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract MainnetBulkerWithWstETHSupportCovTest_1__W is Test {
  MainnetBulkerWithWstETHSupport c0;
  function setUp() public {
    address _esbmc_ctor_arg_mock_1_0_ret_0 = address(uint160(3000));
    bytes memory _esbmc_ctor_arg_mock_1_0_ret_0_code = _esbmc_ctor_arg_mock_1_0_ret_0.code;
...
contract MainnetBulkerWithWstETHSupportCovTest_2_MainnetBulkerWithWstETHSupport_deposit_concrete2p1__basis_root__W is Test {
  MainnetBulkerWithWstETHSupport c0;
  function setUp() public {
    address _esbmc_ctor_arg_mock_2_0_ret_0 = address(uint160(3000));
    bytes memory _esbmc_ctor_arg_mock_2_0_ret_0_code = _esbmc_ctor_arg_mock_2_0_ret_0.code;
  ...
  function _w_test_cov_2() public {
    ...
    try c0.deposit(address(uint160(0))) {
