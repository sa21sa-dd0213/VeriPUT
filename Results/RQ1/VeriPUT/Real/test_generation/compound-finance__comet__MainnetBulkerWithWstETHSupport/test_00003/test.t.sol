...
contract MainnetBulkerWithWstETHSupportCovTest_MainnetBulkerWithWstETHSupport_receive_concrete1p1_fb is Test {
  ...
  function setUp() public {
    ...
    c0 = new MainnetBulkerWithWstETHSupport(address(uint160(0)), payable(address(uint160(0))), address(uint160(0)));
    vm.clearMockedCalls();
    ...
    vm.mockCall(_esbmc_ctor_state_mock_0_0, abi.encodeWithSignature("getStETHByWstETH(uint256)"), abi.encode(uint256(0)));
    
    address _esbmc_ctor_state_mock_0_4 = address(uint160(0));
    vm.etch(_esbmc_ctor_state_mock_0_4, hex"60006000f3");
    vm.mockCall(_esbmc_ctor_state_mock_0_4, abi.encodeWithSignature("wrap(uint256)"), abi.encode(uint256(0)));
    
    address _esbmc_ctor_state_mock_0_8 = address(uint160(0));
    vm.etch(_esbmc_ctor_state_mock_0_8, hex"60006000f3");
    vm.mockCall(_esbmc_ctor_state_mock_0_8, abi.encodeWithSignature("approve(address,uint256)"), abi.encode(false));
    
    address _esbmc_ctor_state_mock_0_12 = address(uint160(0));
    vm.etch(_esbmc_ctor_state_mock_0_12, hex"60006000f3");
    vm.mockCall(_esbmc_ctor_state_mock_0_12, abi.encodeWithSignature("getWstETHByStETH(uint256)"), abi.encode(uint256(0)));
    
    address _esbmc_ctor_state_mock_0_16 = address(uint160(0));
    vm.etch(_esbmc_ctor_state_mock_0_16, hex"60006000f3");
    vm.mockCall(_esbmc_ctor_state_mock_0_16, abi.encodeWithSignature("unwrap(uint256)"), abi.encode(uint256(0)));
    ...
    address _esbmc_ctor_state_mock_0_24 = address(uint160(0));
    vm.etch(_esbmc_ctor_state_mock_0_24, hex"60006000f3");
    vm.mockCall(_esbmc_ctor_state_mock_0_24, abi.encodeWithSignature("deposit()"), bytes(""));
    
    address _esbmc_ctor_state_mock_0_28 = address(uint160(0));
    vm.etch(_esbmc_ctor_state_mock_0_28, hex"60006000f3");
    vm.mockCall(_esbmc_ctor_state_mock_0_28, abi.encodeWithSignature("withdraw(uint256)"), bytes(""));
    vm.etch(_esbmc_ctor_arg_mock_0_0_ret_0, hex"60006000f3");
  }
