...
contract MainnetBulkerWithWstETHSupportCovTest_1_MainnetBulkerWithWstETHSupport_sweepNativeToken_put6p1 is Test {
  MainnetBulkerWithWstETHSupport c0;
  function setUp() public {
  ...
  function test_put_MainnetBulkerWithWstETHSupport_sweepNativeToken_path6p1(address p_msg_sender, address recipient) public {
    _veriput_parameterized(p_msg_sender, recipient);
    
    { MainnetBulkerWithWstETHSupportCovTest_1_MainnetBulkerWithWstETHSupport_sweepNativeToken_concrete6p1__basis_root__W _veriput_w = new MainnetBulkerWithWstETHSupportCovTest_1_MainnetBulkerWithWstETHSupport_sweepNativeToken_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract MainnetBulkerWithWstETHSupportCovTest_1_MainnetBulkerWithWstETHSupport_sweepNativeToken_concrete6p1__basis_root__W is Test {
  MainnetBulkerWithWstETHSupport c0;
  function setUp() public {
    address _esbmc_ctor_arg_mock_1_0_ret_0 = address(uint160(3000));
    bytes memory _esbmc_ctor_arg_mock_1_0_ret_0_code = _esbmc_ctor_arg_mock_1_0_ret_0.code;
