...
contract DTokenCovTest_DToken_emitTransfer_put2p1 is Test {
  DToken c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address from, address to, uint256 value) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("emitTransfer(address,address,uint256)", from, to, value));
  ...
  function test_put_DToken_emitTransfer_path2p1(address p_msg_sender, uint256 p_msg_value, address from, address to, uint256 value) public {
