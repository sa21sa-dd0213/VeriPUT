...
contract DTokenCovTest_DToken_transfer_put2p1 is Test {
  DToken c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address arg0, uint256 arg1) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("transfer(address,uint256)", arg0, arg1));
  ...
  function test_put_DToken_transfer_path2p1(address p_msg_sender, uint256 p_msg_value, address arg0, uint256 arg1) public {
