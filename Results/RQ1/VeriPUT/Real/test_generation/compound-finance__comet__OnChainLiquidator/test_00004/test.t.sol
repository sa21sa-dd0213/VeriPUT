...
contract OnChainLiquidatorCovTest_OnChainLiquidator_uniswapV3FlashCallback_put1p1 is Test {
  ...
  // claim: sol:@C@OnChainLiquidator@F@uniswapV3FlashCallback#908:path:1

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@OnChainLiquidator@F@uniswapV3FlashCallback#908:path:1   depth=0
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, fee0, fee1
