...
contract MainnetBulkerCovTest_1_MainnetBulker_sweepToken_put6p1 is Test {
  MainnetBulker c0;
  function setUp() public {
  ...
  function test_put_MainnetBulker_sweepToken_path6p1(address p_msg_sender, address recipient, address asset) public {
    _veriput_parameterized(p_msg_sender, recipient, asset);
    
    { MainnetBulkerCovTest_1_MainnetBulker_sweepToken_concrete6p1__basis_root__W _veriput_w = new MainnetBulkerCovTest_1_MainnetBulker_sweepToken_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract MainnetBulkerCovTest_1_MainnetBulker_sweepToken_concrete6p1__basis_root__W is Test {
  MainnetBulker c0;
  function setUp() public {
    address _esbmc_ctor_arg_mock_1_0_ret_0 = address(uint160(3000));
    bytes memory _esbmc_ctor_arg_mock_1_0_ret_0_code = _esbmc_ctor_arg_mock_1_0_ret_0.code;
