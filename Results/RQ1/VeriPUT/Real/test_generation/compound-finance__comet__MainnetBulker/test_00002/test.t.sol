...
contract MainnetBulkerCovTest_MainnetBulker_sweepNativeToken_put2p1 is Test {
  MainnetBulker c0;
  function setUp() public {
    ...
    c0 = new MainnetBulker(address(uint160(1000)), payable(address(uint160(1001))), address(uint160(1002)));
    vm.clearMockedCalls();
  ...
  function test_put_MainnetBulker_sweepNativeToken_path2p1(address p_msg_sender, uint256 p_msg_value, address recipient) public {
