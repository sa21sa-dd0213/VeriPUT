...
contract RegistrarSecurityControllerCovTest_RegistrarSecurityController_setRegistrarResolver_put2p1 is Test {
  ...
  function setUp() public {
    ...
    vm.mockCall(_esbmc_ctor_state_mock_0_0, abi.encodeWithSignature("setResolver(address)"), bytes(""));
  }
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address resolver) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("setRegistrarResolver(address)", resolver));
  ...
  function test_put_RegistrarSecurityController_setRegistrarResolver_path2p1(address p_msg_sender, uint256 p_msg_value, address resolver) public {
