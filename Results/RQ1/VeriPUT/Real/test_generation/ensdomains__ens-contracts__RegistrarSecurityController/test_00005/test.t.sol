...
contract RegistrarSecurityControllerCovTest_RegistrarSecurityController_removeRegistrarController_put2p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address controller) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("removeRegistrarController(address)", controller));
  ...
  function test_put_RegistrarSecurityController_removeRegistrarController_path2p1(address p_msg_sender, uint256 p_msg_value, address controller) public {
