...
contract RegistrarSecurityControllerCovTest_RegistrarSecurityController_disableRegistrarController_put2p1 is Test {
  ...
  // claim: sol:@C@RegistrarSecurityController@F@disableRegistrarController#282:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@RegistrarSecurityController@F@disableRegistrarController#282:path:2   depth=1
