...
import {SHA1Digest} from "../src/flat.sol";

contract SHA1DigestCovTest_SHA1Digest_verify_put2p1 is Test {
  SHA1Digest c0;
  ...
  function test_put_SHA1Digest_verify_path2p1(address p_msg_sender, uint256 p_msg_value, bytes memory data, bytes memory hash) public {
