...
contract DefaultReverseRegistrarCovTest_DefaultReverseRegistrar_owner_put3p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender) internal {
    ...
    uint256 _pre_owner_88 = (uint256(vm.load(address(c0), bytes32(uint256(1)))) & 1461501637330902918203684832716283019655932542975);
    ...
    assertEq(_post_owner, _pre_owner_88, "_owner: post == state._owner$88");
  ...
  function test_put_DefaultReverseRegistrar_owner_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { DefaultReverseRegistrarCovTest_DefaultReverseRegistrar_owner_concrete3p1__basis_root__W _veriput_w = new DefaultReverseRegistrarCovTest_DefaultReverseRegistrar_owner_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract DefaultReverseRegistrarCovTest_DefaultReverseRegistrar_owner_concrete3p1__basis_root__W is Test {
  DefaultReverseRegistrar c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new DefaultReverseRegistrar();
  ...
  function _w_test_cov_0() public {
    ...
    assertEq((uint256(vm.load(address(c0), bytes32(uint256(1)))) & 1461501637330902918203684832716283019655932542975), uint256(0), "entry pin state._owner$88 did NOT land: vm.store wrote a word the contract does not read back at this slot, so the test is not inside the certified region and every rung below is about a different state");
    ...
    uint256 _veriput_fixed_state_owner_88_0 = (uint256(vm.load(address(c0), bytes32(uint256(1)))) & 1461501637330902918203684832716283019655932542975);
    assertEq(_veriput_fixed_state_owner_88_0, uint256(0), "fixed witness state");
  }
