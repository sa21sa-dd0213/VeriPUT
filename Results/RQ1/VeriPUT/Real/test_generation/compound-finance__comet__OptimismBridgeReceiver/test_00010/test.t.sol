...
contract OptimismBridgeReceiverCovTest_OptimismBridgeReceiver_sweepToken_put2p1 is Test {
  ...
  function test_put_OptimismBridgeReceiver_sweepToken_path2p1(address p_msg_sender, uint256 p_msg_value, address recipient, address asset) public {
