...
contract OptimismBridgeReceiverCovTest_OptimismBridgeReceiver_changeCrossDomainMessenger_put7p1_p1_part_part0_r_w is Test {
  ...
  // claim: sol:@C@OptimismBridgeReceiver@F@changeCrossDomainMessenger#604:path:7
  // witness-fingerprint-sha256: c1169cbc04dc71ac95aec62ad7d20298513c2fe7694a38cefd7c6fcfbe20f771
  // claim: sol:@C@OptimismBridgeReceiver@F@changeCrossDomainMessenger#604:path:6
  // witness-fingerprint-sha256: e19d3ea99c1e376ab4e3009d71d6aa874b473bc532e7241c905c6fe73f0f5ee4
  // claim: sol:@C@OptimismBridgeReceiver@F@changeCrossDomainMessenger#604:path:2
  // witness-fingerprint-sha256: 126ed7a207caef5837c112e585b998c799bf77ea8323039bea530572372d5d8a

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@OptimismBridgeReceiver@F@changeCrossDomainMessenger#604:path:7   depth=2
  ...
  //   newCrossDomainMessenger in [1461501637330902918203684832716283019655932542975, 1461501637330902918203684832716283019655932542975]
  //   PIN block.basefee == 0
  ...
  // FUZZ COORDINATES: msg.sender, newCrossDomainMessenger
  ...
  //   rung IMPLIED (not lost, not asserted twice): localTimelock: post >= pre (entailed by a stronger rung that also HOLDS on localTimelock, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): localTimelock: post <= pre (entailed by a stronger rung that also HOLDS on localTimelock, so asserting it detects nothing the stronger one misses)
  //   rung IMPLIED (not lost, not asserted twice): localTimelock: post == (pre + msg.value) (entailed by a stronger rung that also HOLDS on localTimelock, so asserting it detects nothing the stronger one misses)
  //   path guard ESTABLISHED: `msg.sender != localTimelock$48` -> `vm.assume(uint256(uint160(p_msg_sender)) == _pre_localTimelock_48);`
  ...
  function _veriput_parameterized(address p_msg_sender, address newCrossDomainMessenger) internal {
    ...
    //   state.localTimelock$48 := msg.sender
    {
