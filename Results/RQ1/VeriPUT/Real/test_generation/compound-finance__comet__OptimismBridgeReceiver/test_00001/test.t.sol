...
contract OptimismBridgeReceiverCovTest_OptimismBridgeReceiver_changeCrossDomainMessenger_put7p1_p1_part_part0_r_w is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, address newCrossDomainMessenger) internal {
    ...
    newCrossDomainMessenger = address(uint160(bound(uint256(uint160(newCrossDomainMessenger)), 1461501637330902918203684832716283019655932542975, 1461501637330902918203684832716283019655932542975)));
    ...
    if (p_msg_sender == address(uint160(0)) && newCrossDomainMessenger == address(uint160(1461501637330902918203684832716283019655932542975))) {
  ...
  function test_put_OptimismBridgeReceiver_changeCrossDomainMessenger_path7p1_part_part0_r_w(address p_msg_sender, address newCrossDomainMessenger) public {
    _veriput_parameterized(p_msg_sender, newCrossDomainMessenger);
    
    { OptimismBridgeReceiverCovTest_OptimismBridgeReceiver_changeCrossDomainMessenger_concrete7p1__basis_part0_r_w__W _veriput_w = new OptimismBridgeReceiverCovTest_OptimismBridgeReceiver_changeCrossDomainMessenger_concrete7p1__basis_part0_r_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract OptimismBridgeReceiverCovTest_OptimismBridgeReceiver_changeCrossDomainMessenger_concrete7p1__basis_part0_r_w__W is Test {
  OptimismBridgeReceiver c0;
  function setUp() public {
    c0 = new OptimismBridgeReceiver(address(uint160(0)));
  }
  ...
  function _w_test_cov_0() public {
    ...
    c0.changeCrossDomainMessenger(address(uint160(1461501637330902918203684832716283019655932542975)));
    ...
    assertEq(_veriput_fixed_state_crossDomainMessenger_0, uint256(1461501637330902918203684832716283019655932542975), "fixed witness state");
