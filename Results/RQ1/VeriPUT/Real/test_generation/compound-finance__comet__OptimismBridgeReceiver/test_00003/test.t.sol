...
contract OptimismBridgeReceiverCovTest_OptimismBridgeReceiver_changeCrossDomainMessenger_put7p1_p1_part_part0_w_w is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, address newCrossDomainMessenger) internal {
    ...
    newCrossDomainMessenger = address(uint160(bound(uint256(uint160(newCrossDomainMessenger)), 0, 730750818665451459101842416358141509827966271486)));
    ...
    if (p_msg_sender == address(uint160(0)) && newCrossDomainMessenger == address(uint160(0))) {
      ...
      assertEq(_veriputFixedLogs[0].topics[0], keccak256("NewCrossDomainMessenger(address,address)"));
  ...
  function test_put_OptimismBridgeReceiver_changeCrossDomainMessenger_path7p1_part_part0_w_w(address p_msg_sender, address newCrossDomainMessenger) public {
