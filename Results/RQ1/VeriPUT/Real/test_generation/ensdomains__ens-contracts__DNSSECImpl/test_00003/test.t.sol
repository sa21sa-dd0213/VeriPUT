...
contract DNSSECImplCovTest_DNSSECImpl_setOwner_put2p1 is Test {
  DNSSECImpl c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address newOwner) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("setOwner(address)", newOwner));
  ...
  function test_put_DNSSECImpl_setOwner_path2p1(address p_msg_sender, uint256 p_msg_value, address newOwner) public {
