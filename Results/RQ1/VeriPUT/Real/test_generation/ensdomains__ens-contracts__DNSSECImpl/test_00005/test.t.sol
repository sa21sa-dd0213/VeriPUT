...
contract DNSSECImplCovTest_1_DNSSECImpl_setOwner_put6p1_p1_part_part0_r_w is Test {
  DNSSECImpl c0;
  function setUp() public {
  ...
  function test_put_DNSSECImpl_setOwner_path6p1_part_part0_r_w(address p_msg_sender, address newOwner) public {
    _veriput_parameterized(p_msg_sender, newOwner);
    
    { DNSSECImplCovTest_1_DNSSECImpl_setOwner_concrete6p1__basis_part0_r_w__W _veriput_w = new DNSSECImplCovTest_1_DNSSECImpl_setOwner_concrete6p1__basis_part0_r_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_2(); }
}
}
...
contract DNSSECImplCovTest_1_DNSSECImpl_setOwner_concrete6p1__basis_part0_r_w__W is Test {
  DNSSECImpl c0;
  function setUp() public {
    vm.startPrank(address(uint160(2147483647)), address(uint160(2147483647)));
    c0 = new DNSSECImpl(hex"");
