...
contract SafeL2CovTest_SafeL2_getThreshold_put3p1 is Test {
  SafeL2 c0;
  ...
  function test_put_SafeL2_getThreshold_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { SafeL2CovTest_SafeL2_getThreshold_concrete3p1__basis_root__W _veriput_w = new SafeL2CovTest_SafeL2_getThreshold_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract SafeL2CovTest_SafeL2_getThreshold_concrete3p1__basis_root__W is Test {
  SafeL2 c0;
  function setUp() public {
    c0 = new SafeL2();
  }
