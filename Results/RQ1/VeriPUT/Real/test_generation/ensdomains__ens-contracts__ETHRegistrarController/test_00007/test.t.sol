...
contract ETHRegistrarControllerCovTest_ETHRegistrarController_valid_put2p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, string memory label) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("valid(string)", label));
  ...
  function test_put_ETHRegistrarController_valid_path2p1(address p_msg_sender, uint256 p_msg_value, string memory label) public {
