...
contract ETHRegistrarControllerCovTest_ETHRegistrarController_recoverFunds_put2p1 is Test {
  ...
  // claim: sol:@C@ETHRegistrarController@F@recoverFunds#234:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@ETHRegistrarController@F@recoverFunds#234:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, _token, _to, _amount
