...
contract ETHRegistrarControllerCovTest_ETHRegistrarController_recoverFunds_put2p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address _token, address _to, uint256 _amount) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("recoverFunds(address,address,uint256)", _token, _to, _amount));
  ...
  function test_put_ETHRegistrarController_recoverFunds_path2p1(address p_msg_sender, uint256 p_msg_value, address _token, address _to, uint256 _amount) public {
    _veriput_parameterized(p_msg_sender, p_msg_value, _token, _to, _amount);
  }
}
