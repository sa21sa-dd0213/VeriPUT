...
contract ETHRegistrarControllerCovTest_ETHRegistrarController_commit_put2p1 is Test {
  ...
  // claim: sol:@C@ETHRegistrarController@F@commit#577:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@ETHRegistrarController@F@commit#577:path:2   depth=1
  ...
  // FUZZ COORDINATES: msg.sender, msg.value, commitment
