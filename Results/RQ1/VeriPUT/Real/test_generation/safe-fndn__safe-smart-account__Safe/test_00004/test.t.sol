...
contract SafeCovTest_Safe_isOwner_put6p1 is Test {
  Safe c0;
  ...
  function test_put_Safe_isOwner_path6p1(address p_msg_sender, address owner) public {
    _veriput_parameterized(p_msg_sender, owner);
    
    { SafeCovTest_Safe_isOwner_concrete6p1__basis_root__W _veriput_w = new SafeCovTest_Safe_isOwner_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract SafeCovTest_Safe_isOwner_concrete6p1__basis_root__W is Test {
  Safe c0;
  function setUp() public {
    c0 = new Safe();
  }
