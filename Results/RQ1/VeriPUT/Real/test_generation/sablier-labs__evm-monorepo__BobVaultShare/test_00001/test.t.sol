...
contract BobVaultShareCovTest_BobVaultShare_allowance_put2p1 is Test {
  BobVaultShare c0;
  ...
  function test_put_BobVaultShare_allowance_path2p1(address p_msg_sender, uint256 p_msg_value, address owner, address spender) public {
