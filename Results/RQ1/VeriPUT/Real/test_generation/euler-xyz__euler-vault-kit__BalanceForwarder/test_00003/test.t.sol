...
contract BalanceForwarderCovTest_BalanceForwarder_disableBalanceForwarder_put2p1 is Test {
  ...
  // claim: sol:@C@BalanceForwarder@F@disableBalanceForwarder#1793:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@BalanceForwarder@F@disableBalanceForwarder#1793:path:2   depth=1
  ...
  //   level0 = True
  //   level0_perturb = True
  //   level0_points = {'121': '(none)', '125': '(none)'}
  //   max_holes = 3
  //   max_region_pieces = 4
  //   max_tx = 1
  //   probe_ladder = True
