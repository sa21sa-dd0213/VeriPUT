...
contract BalanceForwarderCovTest_BalanceForwarder_enableBalanceForwarder_put2p1 is Test {
  ...
  // claim: sol:@C@BalanceForwarder@F@enableBalanceForwarder#1734:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@BalanceForwarder@F@enableBalanceForwarder#1734:path:2   depth=1
  ...
  //   level0 = True
  //   level0_perturb = True
  //   level0_points = {'122': '(none)', '126': '(none)'}
  //   max_holes = 3
  //   max_region_pieces = 4
  //   max_tx = 1
  //   probe_ladder = True
