...
contract BalanceForwarderCovTest_BalanceForwarder_balanceForwarderEnabled_put2p1 is Test {
  ...
  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@BalanceForwarder@F@balanceForwarderEnabled#1670:path:2   depth=1
  ...
  // 42 snapshot local(s) HOISTED to storage: 3 fuzz parameter(s) + 42 snapshot local(s) exceed the 12-slot budget (solc stack reach); the reads and every assertion are unchanged
