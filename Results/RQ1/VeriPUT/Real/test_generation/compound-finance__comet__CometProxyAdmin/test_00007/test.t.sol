...
contract CometProxyAdminCovTest_CometProxyAdmin_owner_put3p1 is Test {
  CometProxyAdmin c0;
  ...
  function test_put_CometProxyAdmin_owner_path3p1(address p_msg_sender) public {
    _veriput_parameterized(p_msg_sender);
    
    { CometProxyAdminCovTest_CometProxyAdmin_owner_concrete3p1__basis_root__W _veriput_w = new CometProxyAdminCovTest_CometProxyAdmin_owner_concrete3p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract CometProxyAdminCovTest_CometProxyAdmin_owner_concrete3p1__basis_root__W is Test {
  CometProxyAdmin c0;
  function setUp() public {
    c0 = new CometProxyAdmin(address(uint160(1000)));
  }
