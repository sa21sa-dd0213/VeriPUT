...
contract CometProxyAdminCovTest_CometProxyAdmin_deployUpgradeToAndCall_put2p1 is Test {
  CometProxyAdmin c0;
  ...
  function test_put_CometProxyAdmin_deployUpgradeToAndCall_path2p1(address p_msg_sender, uint256 p_msg_value, address configuratorProxy, address cometProxy, bytes memory data) public {
