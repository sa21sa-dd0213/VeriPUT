...
contract ESBMCMock_ENS_BaseRegistrarImplementationCovTest_BaseRegistrarImplementation_balanceOf_put7p1 is ENS {
...
contract BaseRegistrarImplementationCovTest_BaseRegistrarImplementation_balanceOf_put7p1 is Test {
  ESBMCMock_ENS_BaseRegistrarImplementationCovTest_BaseRegistrarImplementation_balanceOf_put7p1 mk_ENS__ens;
  BaseRegistrarImplementation c0;
  function setUp() public {
    try new ESBMCMock_ENS_BaseRegistrarImplementationCovTest_BaseRegistrarImplementation_balanceOf_put7p1() returns (ESBMCMock_ENS_BaseRegistrarImplementationCovTest_BaseRegistrarImplementation_balanceOf_put7p1 _esbmc_setup_mk_ENS__ens) {
  ...
  function _veriput_parameterized(address p_msg_sender, address owner) internal {
    ...
    uint256 _pre_balances_owner = uint256(vm.load(address(c0), keccak256(abi.encode(owner, uint256(3)))));
    ...
    uint256 _post_balances_owner = uint256(vm.load(address(c0), keccak256(abi.encode(owner, uint256(3)))));
  ...
  function test_put_BaseRegistrarImplementation_balanceOf_path7p1(address p_msg_sender, address owner) public {
