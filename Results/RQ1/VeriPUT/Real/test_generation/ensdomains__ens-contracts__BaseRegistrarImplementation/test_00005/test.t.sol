...
contract ESBMCMock_ENS_BaseRegistrarImplementationCovTest_BaseRegistrarImplementation_nameExpires_put3p1 is ENS {
...
contract BaseRegistrarImplementationCovTest_BaseRegistrarImplementation_nameExpires_put3p1 is Test {
  ESBMCMock_ENS_BaseRegistrarImplementationCovTest_BaseRegistrarImplementation_nameExpires_put3p1 mk_ENS__ens;
  BaseRegistrarImplementation c0;
  function setUp() public {
    try new ESBMCMock_ENS_BaseRegistrarImplementationCovTest_BaseRegistrarImplementation_nameExpires_put3p1() returns (ESBMCMock_ENS_BaseRegistrarImplementationCovTest_BaseRegistrarImplementation_nameExpires_put3p1 _esbmc_setup_mk_ENS__ens) {
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 id) internal {
    ...
    uint256 _ret_pre_expiries_id = uint256(vm.load(address(c0), keccak256(abi.encode(id, uint256(7)))));
    ...
    uint256 _put_ret = c0.nameExpires(id);
    ...
    assertEq(uint256(_put_ret), _ret_pre_expiries_id, "return: return == state.expiries[id]");
  ...
  function test_put_BaseRegistrarImplementation_nameExpires_path3p1(address p_msg_sender, uint256 id) public {
