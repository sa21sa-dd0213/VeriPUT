...
contract BalancerPoolTokenCovTest_BalancerPoolToken_balanceOf_put2p1 is Test {
  ...
  function test_put_BalancerPoolToken_balanceOf_path2p1(address p_msg_sender, uint256 p_msg_value, address account) public {
