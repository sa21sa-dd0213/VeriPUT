...
contract OwnableCovTest_Ownable_isOwner_put3p1_p1_part_part0_r is Test {
  ...
  function test_put_Ownable_isOwner_path3p1_part_part0_r(address p_msg_sender, address addr) public {
    ...
    { OwnableCovTest_Ownable_isOwner_concrete3p1__basis_part0_r__W _veriput_w = new OwnableCovTest_Ownable_isOwner_concrete3p1__basis_part0_r__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract OwnableCovTest_Ownable_isOwner_concrete3p1__basis_part0_r__W is Test {
  Ownable c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new Ownable();
