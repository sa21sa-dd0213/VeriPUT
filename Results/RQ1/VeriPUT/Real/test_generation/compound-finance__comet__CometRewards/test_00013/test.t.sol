...
contract CometRewardsCovTest_0_CometRewards_transferGovernor_put6p1_p1_part_part0_w_w is Test {
  CometRewards c0;
  ...
  function _veriput_parameterized(address p_msg_sender, address newGovernor) internal {
    p_msg_sender = address(uint160(bound(uint256(uint160(p_msg_sender)), 3221225472, 1461501637330902918203684832716283019655932542975)));
    ...
    if (p_msg_sender == address(uint160(4294967294)) && newGovernor == address(uint160(0))) {
  ...
  function test_put_CometRewards_transferGovernor_path6p1_part_part0_w_w(address p_msg_sender, address newGovernor) public {
    _veriput_parameterized(p_msg_sender, newGovernor);
    
    { CometRewardsCovTest_0_CometRewards_transferGovernor_concrete6p1__basis_part0_w_w__W _veriput_w = new CometRewardsCovTest_0_CometRewards_transferGovernor_concrete6p1__basis_part0_w_w__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract CometRewardsCovTest_0_CometRewards_transferGovernor_concrete6p1__basis_part0_w_w__W is Test {
  CometRewards c0;
  function setUp() public {
    c0 = new CometRewards(address(uint160(4294967295)));
  }
  ...
  function _w_test_cov_1() public {
    ...
    assertEq((uint256(vm.load(address(c0), bytes32(uint256(0)))) & 1461501637330902918203684832716283019655932542975), uint256(4294967295), "entry pin state.governor did NOT land: vm.store wrote a word the contract does not read back at this slot, so the test is not inside the certified region and every rung below is about a different state");
