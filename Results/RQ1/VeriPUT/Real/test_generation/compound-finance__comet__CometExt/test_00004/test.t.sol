...
contract CometExtCovTest_CometExt_collateralBalanceOf_put2p1 is Test {
  CometExt c0;
  ...
  uint256 _pre_userCollateral_asset__msg_sender___reserved; 
  uint256 _pre_userCollateral_asset__account___reserved; 
  ...
  uint256 _post_userCollateral_asset__msg_sender___reserved; 
  uint256 _post_userCollateral_asset__account___reserved; 
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address account, address asset) internal {
    ...
    _pre_userCollateral_asset__msg_sender___reserved = ((uint256(vm.load(address(c0), keccak256(abi.encode(p_msg_sender, keccak256(abi.encode(asset, uint256(6))))))) >> 128) & 340282366920938463463374607431768211455);
    _pre_userCollateral_asset__account___reserved = ((uint256(vm.load(address(c0), keccak256(abi.encode(account, keccak256(abi.encode(asset, uint256(6))))))) >> 128) & 340282366920938463463374607431768211455);
    ...
    _post_userCollateral_asset__msg_sender___reserved = ((uint256(vm.load(address(c0), keccak256(abi.encode(p_msg_sender, keccak256(abi.encode(asset, uint256(6))))))) >> 128) & 340282366920938463463374607431768211455);
    _post_userCollateral_asset__account___reserved = ((uint256(vm.load(address(c0), keccak256(abi.encode(account, keccak256(abi.encode(asset, uint256(6))))))) >> 128) & 340282366920938463463374607431768211455);
    ...
    assertEq(_post_userCollateral_asset__msg_sender___reserved, _pre_userCollateral_asset__msg_sender___reserved, "userCollateral[asset][msg.sender]._reserved: post == pre");
    assertEq(_post_userCollateral_asset__account___reserved, _pre_userCollateral_asset__account___reserved, "userCollateral[asset][account]._reserved: post == pre");
  ...
  function test_put_CometExt_collateralBalanceOf_path2p1(address p_msg_sender, uint256 p_msg_value, address account, address asset) public {
