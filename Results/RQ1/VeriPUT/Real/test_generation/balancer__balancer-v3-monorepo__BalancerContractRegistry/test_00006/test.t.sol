...
contract BalancerContractRegistryCovTest_BalancerContractRegistry_getBalancerContractInfo_put2p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address contractAddress) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("getBalancerContractInfo(address)", contractAddress));
  ...
  function test_put_BalancerContractRegistry_getBalancerContractInfo_path2p1(address p_msg_sender, uint256 p_msg_value, address contractAddress) public {
