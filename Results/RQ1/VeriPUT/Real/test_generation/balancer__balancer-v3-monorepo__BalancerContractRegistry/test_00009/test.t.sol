...
contract BalancerContractRegistryCovTest_BalancerContractRegistry_isActiveBalancerContract_put6p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, address contractAddress) internal {
    ...
    bool _put_ret = c0.isActiveBalancerContract(ContractType(0), contractAddress);
    
    if (p_msg_sender == address(uint160(0)) && contractAddress == address(uint160(0))) {
  ...
  function test_put_BalancerContractRegistry_isActiveBalancerContract_path6p1(address p_msg_sender, address contractAddress) public {
    _veriput_parameterized(p_msg_sender, contractAddress);
    
    { BalancerContractRegistryCovTest_BalancerContractRegistry_isActiveBalancerContract_concrete6p1__basis_root__W _veriput_w = new BalancerContractRegistryCovTest_BalancerContractRegistry_isActiveBalancerContract_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}



contract BalancerContractRegistryCovTest_BalancerContractRegistry_isActiveBalancerContract_concrete6p1__basis_root__W is Test {
  BalancerContractRegistry c0;
  function setUp() public {
    c0 = new BalancerContractRegistry(IVault(address(uint160(1000))));
  }
  ...
  function _w_test_cov_0() public {
    ...
    bool _veriput_concrete_return = c0.isActiveBalancerContract(ContractType(uint8(0)), address(uint160(0)));
