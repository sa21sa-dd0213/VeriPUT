...
contract ScrollBridgeReceiverCovTest_ScrollBridgeReceiver_sweepToken_put6p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, address recipient, address asset, uint8 s_initialized_50) internal {
    ...
    _pre_l2Messenger = (uint256(vm.load(address(c0), bytes32(uint256(4)))) & 1461501637330902918203684832716283019655932542975);
    ...
    _post_l2Messenger = (uint256(vm.load(address(c0), bytes32(uint256(4)))) & 1461501637330902918203684832716283019655932542975);
    ...
    assertEq(_post_l2Messenger, _pre_l2Messenger, "l2Messenger: post == pre");
    ...
    assertGe(_post_l2Messenger, _pre_l2Messenger, "l2Messenger: post >= pre");
    assertLe(_post_l2Messenger, _pre_l2Messenger, "l2Messenger: post <= pre");
  ...
  function test_put_ScrollBridgeReceiver_sweepToken_path6p1(address p_msg_sender, address recipient, address asset, uint8 s_initialized_50) public {
    _veriput_parameterized(p_msg_sender, recipient, asset, s_initialized_50);
    
    { ScrollBridgeReceiverCovTest_ScrollBridgeReceiver_sweepToken_concrete6p1__basis_root__W _veriput_w = new ScrollBridgeReceiverCovTest_ScrollBridgeReceiver_sweepToken_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract ScrollBridgeReceiverCovTest_ScrollBridgeReceiver_sweepToken_concrete6p1__basis_root__W is Test {
  ScrollBridgeReceiver c0;
  function setUp() public {
    c0 = new ScrollBridgeReceiver(address(uint160(0)));
  }
  ...
  function _w_test_cov_1() public {
    ...
    assertEq(_veriput_fixed_state_l2Messenger_2, uint256(0), "fixed witness state");
