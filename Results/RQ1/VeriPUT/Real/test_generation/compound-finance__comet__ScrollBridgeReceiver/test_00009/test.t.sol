...
contract ScrollBridgeReceiverCovTest_ScrollBridgeReceiver_sweepNativeToken_put6p1 is Test {
  ...
  function test_put_ScrollBridgeReceiver_sweepNativeToken_path6p1(address p_msg_sender, address recipient) public {
    _veriput_parameterized(p_msg_sender, recipient);
    
    { ScrollBridgeReceiverCovTest_ScrollBridgeReceiver_sweepNativeToken_concrete6p1__basis_root__W _veriput_w = new ScrollBridgeReceiverCovTest_ScrollBridgeReceiver_sweepNativeToken_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract ScrollBridgeReceiverCovTest_ScrollBridgeReceiver_sweepNativeToken_concrete6p1__basis_root__W is Test {
  ScrollBridgeReceiver c0;
  function setUp() public {
    c0 = new ScrollBridgeReceiver(address(uint160(0)));
  }
