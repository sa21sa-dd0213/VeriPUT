...
contract ESynthCovTest_ESynth_balanceOf_put1p1 is Test {
  ESynth c0;
  ...
  function test_put_ESynth_balanceOf_path1p1(address p_msg_sender, uint256 p_msg_value, address account) public {
