...
contract CometProxyAdminOldCovTest_0_CometProxyAdminOld_transferOwnership_put15p1_p1_part_part0_w_w is Test {
  CometProxyAdminOld c0;
  function setUp() public {
    c0 = new CometProxyAdminOld(address(uint160(4294967295)));
  }
  ...
  function test_put_CometProxyAdminOld_transferOwnership_path15p1_part_part0_w_w(address newOwner) public {
    _veriput_parameterized(newOwner);
  }
}

contract CometProxyAdminOldCovTest_1 is Test {
  CometProxyAdminOld c0;
  function setUp() public {
    c0 = new CometProxyAdminOld(address(uint160(730750818665451459101842416358141509832261238783)));
  }
...
contract CometProxyAdminOldCovTest_2 is Test {
  CometProxyAdminOld c0;
  function setUp() public {
