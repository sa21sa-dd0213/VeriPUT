...
contract MarketUpdateProposerCovTest_MarketUpdateProposer_getProposal_put2p1 is Test {
  ...
  // claim: sol:@C@MarketUpdateProposer@F@getProposal#778:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@MarketUpdateProposer@F@getProposal#778:path:2   depth=1
  ...
  uint256 _pre_proposals_proposalId__canceled; // VERIPUT_HOISTED_SNAPSHOT
  ...
  uint256 _pre_proposals_proposalId__proposer; // VERIPUT_HOISTED_SNAPSHOT
  uint256 _post_proposals_proposalId__canceled; // VERIPUT_HOISTED_SNAPSHOT
  ...
  uint256 _post_proposals_proposalId__proposer; // VERIPUT_HOISTED_SNAPSHOT
