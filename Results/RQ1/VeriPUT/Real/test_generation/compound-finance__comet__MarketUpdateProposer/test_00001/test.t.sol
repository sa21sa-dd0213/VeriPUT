...
contract MarketUpdateProposerCovTest_MarketUpdateProposer_getProposal_put2p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, uint256 proposalId) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("getProposal(uint256)", proposalId));
  ...
  function test_put_MarketUpdateProposer_getProposal_path2p1(address p_msg_sender, uint256 p_msg_value, uint256 proposalId) public {
