...
contract MarketUpdateProposerCovTest_MarketUpdateProposer_state_put2p1 is Test {
  ...
  function setUp() public {
    ...
    // ESBMC runtime fixture: constructor argument `timelock_` is stored in `timelock`.
  ...
  // claim: sol:@C@MarketUpdateProposer@F@state#723:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@MarketUpdateProposer@F@state#723:path:2   depth=1
  ...
  // ORACLE: rollback exit plus 14 restored post-state frame assertion(s).
