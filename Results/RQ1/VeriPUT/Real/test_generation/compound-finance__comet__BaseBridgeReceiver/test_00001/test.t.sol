...
contract BaseBridgeReceiverCovTest_BaseBridgeReceiver_initialize_put2p1 is Test {
...
vm.mockCall(_localTimelock, abi.encodeWithSignature("admin()"), abi.encode(address(0)));
  ...
  function test_put_BaseBridgeReceiver_initialize_path2p1(address p_msg_sender, uint256 p_msg_value, address _govTimelock, address _localTimelock) public {
