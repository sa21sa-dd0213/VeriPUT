...
contract BaseBridgeReceiverCovTest_BaseBridgeReceiver_state_put2p1 is Test {
  ...
  function test_put_BaseBridgeReceiver_state_path2p1(address p_msg_sender, uint256 p_msg_value, uint256 proposalId) public {
