...
contract WrappedBalancerPoolTokenFactoryCovTest_WrappedBalancerPoolTokenFactory_createWrappedToken_put2p1 is Test {
...
vm.mockCall(balancerPoolToken, abi.encodeWithSignature("symbol()"), abi.encode(""));
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("createWrappedToken(address)", balancerPoolToken));
  ...
  function test_put_WrappedBalancerPoolTokenFactory_createWrappedToken_path2p1(address p_msg_sender, uint256 p_msg_value, address balancerPoolToken) public {
