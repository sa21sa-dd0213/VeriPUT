...
contract WrappedBalancerPoolTokenFactoryCovTest_WrappedBalancerPoolTokenFactory_getWrappedToken_put2p1 is Test {
  ...
  // claim: sol:@C@WrappedBalancerPoolTokenFactory@F@getWrappedToken#179:path:2

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@WrappedBalancerPoolTokenFactory@F@getWrappedToken#179:path:2   depth=1
