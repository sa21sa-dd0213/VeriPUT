...
contract L2ReverseRegistrarCovTest_L2ReverseRegistrar_setNameForAddr_put2p1 is Test {
  ...
  function test_put_L2ReverseRegistrar_setNameForAddr_path2p1(address p_msg_sender, uint256 p_msg_value, address addr, string memory name) public {
