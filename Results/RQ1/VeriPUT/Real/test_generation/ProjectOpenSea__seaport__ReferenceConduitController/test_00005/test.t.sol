...
contract ReferenceConduitControllerCovTest_ReferenceConduitController_getChannel_put2p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address conduit, uint256 channelIndex) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("getChannel(address,uint256)", conduit, channelIndex));
  ...
  function test_put_ReferenceConduitController_getChannel_path2p1(address p_msg_sender, uint256 p_msg_value, address conduit, uint256 channelIndex) public {
    _veriput_parameterized(p_msg_sender, p_msg_value, conduit, channelIndex);
  }
}
