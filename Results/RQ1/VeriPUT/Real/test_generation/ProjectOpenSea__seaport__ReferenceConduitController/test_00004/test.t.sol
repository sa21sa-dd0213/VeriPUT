...
contract ReferenceConduitControllerCovTest_ReferenceConduitController_getChannel_put14p1 is Test {
  ...
  function test_put_ReferenceConduitController_getChannel_path14p1(address p_msg_sender, address conduit, uint256 channelIndex) public {
    _veriput_parameterized(p_msg_sender, conduit, channelIndex);
    
    { ReferenceConduitControllerCovTest_ReferenceConduitController_getChannel_concrete14p1__basis_root__W _veriput_w = new ReferenceConduitControllerCovTest_ReferenceConduitController_getChannel_concrete14p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract ReferenceConduitControllerCovTest_ReferenceConduitController_getChannel_concrete14p1__basis_root__W is Test {
  ReferenceConduitController c0;
  function setUp() public {
    vm.startPrank(address(uint160(1)), address(uint160(1)));
    c0 = new ReferenceConduitController();
