...
contract ReferenceConduitControllerCovTest_ReferenceConduitController_cancelOwnershipTransfer_put2p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address conduit) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("cancelOwnershipTransfer(address)", conduit));
  ...
  function test_put_ReferenceConduitController_cancelOwnershipTransfer_path2p1(address p_msg_sender, uint256 p_msg_value, address conduit) public {
