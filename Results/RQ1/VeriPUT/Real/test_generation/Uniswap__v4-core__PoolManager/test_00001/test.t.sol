...
contract PoolManagerCovTest_PoolManager_supportsInterface_put2p1 is Test {
  PoolManager c0;
  function setUp() public {
    c0 = new PoolManager(address(uint160(1000)));
  }
  ...
  function test_put_PoolManager_supportsInterface_path2p1(address p_msg_sender, uint256 p_msg_value, uint32 interfaceId) public {
