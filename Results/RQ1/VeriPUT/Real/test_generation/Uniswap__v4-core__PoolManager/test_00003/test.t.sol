...
contract PoolManagerCovTest_PoolManager_transferOwnership_put2p1 is Test {
  PoolManager c0;
  ...
  function test_put_PoolManager_transferOwnership_path2p1(address p_msg_sender, uint256 p_msg_value, address newOwner) public {
