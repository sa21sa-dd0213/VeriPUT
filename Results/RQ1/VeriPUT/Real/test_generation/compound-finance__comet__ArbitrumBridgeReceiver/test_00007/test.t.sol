...
contract ArbitrumBridgeReceiverCovTest_ArbitrumBridgeReceiver_sweepToken_put6p1 is Test {
  ...
  function test_put_ArbitrumBridgeReceiver_sweepToken_path6p1(address p_msg_sender, address recipient, address asset, uint8 s_initialized_50) public {
    _veriput_parameterized(p_msg_sender, recipient, asset, s_initialized_50);
    
    { ArbitrumBridgeReceiverCovTest_ArbitrumBridgeReceiver_sweepToken_concrete6p1__basis_root__W _veriput_w = new ArbitrumBridgeReceiverCovTest_ArbitrumBridgeReceiver_sweepToken_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract ArbitrumBridgeReceiverCovTest_ArbitrumBridgeReceiver_sweepToken_concrete6p1__basis_root__W is Test {
  ArbitrumBridgeReceiver c0;
  function setUp() public {
    c0 = new ArbitrumBridgeReceiver();
  }
