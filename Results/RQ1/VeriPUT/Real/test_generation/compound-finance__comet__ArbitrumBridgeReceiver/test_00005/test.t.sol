...
import {ArbitrumBridgeReceiver} from "../src/flat.sol";

contract ArbitrumBridgeReceiverCovTest_ArbitrumBridgeReceiver_sweepNativeToken_put6p1 is Test {
  ArbitrumBridgeReceiver c0;
  function setUp() public {
    c0 = new ArbitrumBridgeReceiver();
  }
  ...
  function test_put_ArbitrumBridgeReceiver_sweepNativeToken_path6p1(address p_msg_sender, address recipient) public {
    _veriput_parameterized(p_msg_sender, recipient);
    
    { ArbitrumBridgeReceiverCovTest_ArbitrumBridgeReceiver_sweepNativeToken_concrete6p1__basis_root__W _veriput_w = new ArbitrumBridgeReceiverCovTest_ArbitrumBridgeReceiver_sweepNativeToken_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_1(); }
}
}
...
contract ArbitrumBridgeReceiverCovTest_ArbitrumBridgeReceiver_sweepNativeToken_concrete6p1__basis_root__W is Test {
  ArbitrumBridgeReceiver c0;
  function setUp() public {
    c0 = new ArbitrumBridgeReceiver();
  }
