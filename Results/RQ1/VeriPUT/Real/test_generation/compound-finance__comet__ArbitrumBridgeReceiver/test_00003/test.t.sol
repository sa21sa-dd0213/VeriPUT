...
contract ArbitrumBridgeReceiverCovTest_ArbitrumBridgeReceiver_state_put6p1 is Test {
  ...
  function test_put_ArbitrumBridgeReceiver_state_path6p1(address p_msg_sender, uint256 proposalId) public {
    _veriput_parameterized(p_msg_sender, proposalId);
    
    { ArbitrumBridgeReceiverCovTest_ArbitrumBridgeReceiver_state_concrete6p1__basis_root__W _veriput_w = new ArbitrumBridgeReceiverCovTest_ArbitrumBridgeReceiver_state_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract ArbitrumBridgeReceiverCovTest_ArbitrumBridgeReceiver_state_concrete6p1__basis_root__W is Test {
  ArbitrumBridgeReceiver c0;
  function setUp() public {
    c0 = new ArbitrumBridgeReceiver();
  }
