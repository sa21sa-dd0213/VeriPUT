...
contract ArbitrumBridgeReceiverCovTest_ArbitrumBridgeReceiver_sweepNativeToken_put2p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, address recipient) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("sweepNativeToken(address)", recipient));
  ...
  function test_put_ArbitrumBridgeReceiver_sweepNativeToken_path2p1(address p_msg_sender, uint256 p_msg_value, address recipient) public {
