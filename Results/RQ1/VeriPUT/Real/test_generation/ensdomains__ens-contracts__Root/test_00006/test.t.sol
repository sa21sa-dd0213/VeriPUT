...
contract RootCovTest_Root_setSubnodeOwner_put2p1 is Test {
  Root c0;
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 p_msg_value, uint256 label, address owner) internal {
    ...
    (bool _esbmc_value_gate_ok, ) = address(c0).call{value: p_msg_value}(abi.encodeWithSignature("setSubnodeOwner(bytes32,address)", bytes32(label), owner));
  ...
  function test_put_Root_setSubnodeOwner_path2p1(address p_msg_sender, uint256 p_msg_value, uint256 label, address owner) public {
