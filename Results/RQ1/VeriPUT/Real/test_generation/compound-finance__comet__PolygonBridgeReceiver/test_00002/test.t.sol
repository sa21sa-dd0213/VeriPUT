...
contract PolygonBridgeReceiverCovTest_PolygonBridgeReceiver_changeFxChild_put7p1_p1_part_part0_w_r is Test {
  ...
  // claim: sol:@C@PolygonBridgeReceiver@F@changeFxChild#511:path:7
  // witness-fingerprint-sha256: 96f3b587a027e638084902999a27943ca66947ec854cf8683673532889cd93d3
  // claim: sol:@C@PolygonBridgeReceiver@F@changeFxChild#511:path:6
  // witness-fingerprint-sha256: e0bd24941a4c652e56242828c7eade6005eff5f46395978e2ecaa5f61cc9ce8d
  // claim: sol:@C@PolygonBridgeReceiver@F@changeFxChild#511:path:2
  // witness-fingerprint-sha256: 65375395492f6890de57186332482e68dab5ee00d30fae8cc2d6bd663583e7f6

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@PolygonBridgeReceiver@F@changeFxChild#511:path:7   depth=2
  ...
  //   newFxChild in [730750818665451459101842416358141509827966271487, 1461501637330902918203684832716283019655932542974]
  //   PIN block.basefee == 0
  ...
  // FUZZ COORDINATES: msg.sender, newFxChild
  ...
  //   path guard ESTABLISHED: `msg.sender != localTimelock$59` -> `vm.assume(uint256(uint160(p_msg_sender)) == _pre_localTimelock_59);`
  ...
  function _veriput_parameterized(address p_msg_sender, address newFxChild) internal {
    ...
    //   state.localTimelock$59 := msg.sender
    {
