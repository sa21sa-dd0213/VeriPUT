...
contract PolygonBridgeReceiverCovTest_PolygonBridgeReceiver_initialize_put2p1 is Test {
  PolygonBridgeReceiver c0;
  function setUp() public {
    c0 = new PolygonBridgeReceiver(address(uint160(1000)));
  }
  ...
  function test_put_PolygonBridgeReceiver_initialize_path2p1(address p_msg_sender, uint256 p_msg_value, address _govTimelock, address _localTimelock) public {
