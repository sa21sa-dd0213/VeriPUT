...
contract PolygonBridgeReceiverCovTest_PolygonBridgeReceiver_state_put6p1 is Test {
  ...
  function _veriput_parameterized(address p_msg_sender, uint256 proposalId) internal {
    ...
    _pre_proposalCount_63 = uint256(vm.load(address(c0), bytes32(uint256(2))));
  ...
  function test_put_PolygonBridgeReceiver_state_path6p1(address p_msg_sender, uint256 proposalId) public {
    _veriput_parameterized(p_msg_sender, proposalId);
    
    { PolygonBridgeReceiverCovTest_PolygonBridgeReceiver_state_concrete6p1__basis_root__W _veriput_w = new PolygonBridgeReceiverCovTest_PolygonBridgeReceiver_state_concrete6p1__basis_root__W(); _veriput_w.setUp(); _veriput_w._w_test_cov_0(); }
}
}
...
contract PolygonBridgeReceiverCovTest_PolygonBridgeReceiver_state_concrete6p1__basis_root__W is Test {
  PolygonBridgeReceiver c0;
  function setUp() public {
    c0 = new PolygonBridgeReceiver(address(uint160(0)));
  }
  ...
  function _w_test_cov_0() public {
    ...
    assertEq(_veriput_fixed_state_fxChild_0, uint256(0), "fixed witness state");
