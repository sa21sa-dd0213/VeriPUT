...
contract PolygonBridgeReceiverCovTest_PolygonBridgeReceiver_state_put6p1 is Test {
  ...
  // claim: sol:@C@PolygonBridgeReceiver@F@state#459:path:6
  // witness-fingerprint-sha256: 18840e8bf7850083b854096177cbe16e97b71abd48706ee07100b80dc01b2a43
  // claim: sol:@C@PolygonBridgeReceiver@F@state#459:path:2
  // witness-fingerprint-sha256: 7a9946407e7d4da1df57568d2dcd463fe1dbee48a4a6814e513919712d383344

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@PolygonBridgeReceiver@F@state#459:path:6   depth=2
  ...
  uint256 _pre_proposalCount_63; // VERIPUT_HOISTED_SNAPSHOT
