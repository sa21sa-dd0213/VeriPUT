...
contract CCSolBMCDerived is Test {
    ...
    function setUp() public {
        ...
        target = new ProtocolFeeHelper(IVault(address(0xDEAD0000000000000000000000000000BEEF)), address(this));
    }
    ...
    function test_ce_22_setProtocolSwapFeePercentage() public {
        

        target.setProtocolSwapFeePercentage(address(uint160(0)), 0);
    }
