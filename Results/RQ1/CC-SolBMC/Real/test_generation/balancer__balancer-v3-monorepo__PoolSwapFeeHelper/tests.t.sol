...
contract CCSolBMCDerived is Test {
    ...
    function setUp() public {
        ...
        target = new PoolSwapFeeHelper(IVault(address(0xDEAD0000000000000000000000000000BEEF)), address(this));
    }
    ...
    function test_ce_4_createPoolSet() public {
    ...
    function test_ce_22_setStaticSwapFeePercentage() public {


        target.setStaticSwapFeePercentage(address(uint160(0)), 0);
    }
    function test_ce_23_destroyPoolSet() public {
