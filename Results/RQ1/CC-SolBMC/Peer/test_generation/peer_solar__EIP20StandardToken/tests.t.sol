...
contract CCSolBMCDerived is Test {
    ...
    function test_ce_4_transferFrom() public {
        ...
        target.transferFrom(address(uint160(21238)), address(uint160(0)), 0);
    }
    function test_ce_5_transferFrom() public {


        target.transferFrom(address(uint160(21238)), address(uint160(0)), 39);
    }
    function test_ce_6_transferFrom() public {


        target.transferFrom(address(uint160(0)), address(uint160(0)), 3);
    }
    function test_ce_7_transferFrom() public {


        target.transferFrom(address(uint160(0)), address(uint160(0)), 1);
    }
}
