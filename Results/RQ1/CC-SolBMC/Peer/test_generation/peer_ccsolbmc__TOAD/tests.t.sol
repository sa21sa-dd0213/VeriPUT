...
contract CCSolBMCDerived is Test {
    ...
    function test_ce_12_reflectionFromToken() public {
    ...
    function test_ce_14_excludeAccount() public {


        target.excludeAccount(address(uint160(38)));
    }
    function test_ce_15_excludeAccount() public {


        target.excludeAccount(address(uint160(7719)));
    }
    function test_ce_16_includeAccount() public {
