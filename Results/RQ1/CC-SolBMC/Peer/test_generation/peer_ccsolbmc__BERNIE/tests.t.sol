...
contract CCSolBMCDerived is Test {
    ...
    function test_ce_12_transfer() public {
        ...
        target.transfer(address(uint160(2438)), 1);
    }
    ...
    function test_ce_15_reflect() public {
    ...
    function test_ce_17_reflectionFromToken() public {
    ...
    function test_ce_19_excludeAccount() public {
        

        target.excludeAccount(address(uint160(7719)));
    }
    function test_ce_20_includeAccount() public {
        

        target.includeAccount(address(uint160(38)));
    }
    function test_ce_21_uniswapPair() public {
