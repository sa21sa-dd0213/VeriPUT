...
contract CCSolBMCDerived is Test {
    ...
    function test_ce_14_reflectionFromToken() public {
        ...
        target.reflectionFromToken(1, false);
    }
    ...
    function test_ce_16_excludeAccount() public {
        ...
        target.excludeAccount(address(uint160(0)));
    }
    function test_ce_17_includeAccount() public {


        target.includeAccount(address(uint160(0)));
    }
    function test_ce_18__burn() public {


        target._burn(address(uint160(0)), 0);
    }
    function test_ce_19_setCharityAddress() public {


        target.setCharityAddress(address(uint160(1)));
    }
    function test_ce_20_setCharityAddress() public {


        target.setCharityAddress(address(uint160(0)));
    }
}
