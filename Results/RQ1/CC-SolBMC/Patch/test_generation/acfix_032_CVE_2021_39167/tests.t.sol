...
contract CCSolBMCDerived is Test {
    ...
    function test_ce_0_grantRole() public {
        

        target.grantRole(bytes32(uint256(0)), address(uint160(0)));
    }
    function test_ce_1_revokeRole() public {
        

        target.revokeRole(bytes32(uint256(7719)), address(uint160(38)));
    }
    ...
    function test_ce_3_cancel() public {
    ...
    function test_ce_5_updateDelay() public {
