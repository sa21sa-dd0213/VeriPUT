...
contract Owned_Echidna_Test is Test {
    ...
    function test_auto_setOwner_0() public {
        ...
        vm.warp(block.timestamp + 285753);
        vm.roll(block.number + 3661);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.setOwner(0x00000000000000000000000000000000FFFFfFFF);

        vm.warp(block.timestamp + 396276);
        ...
        vm.warp(block.timestamp + 244469);
        ...
        vm.warp(block.timestamp + 306637);
        vm.roll(block.number + 23722);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.setOwner(0x0000000000000000000000000000000000030000);
        ...
        vm.warp(block.timestamp + 470675);
        ...
        vm.warp(block.timestamp + 493233);
        ...
        vm.warp(block.timestamp + 90290);
        vm.roll(block.number + 30352);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.setOwner(0x00000000000000000000000000000000FFFFfFFF);
        ...
        vm.warp(block.timestamp + 443677);
    ...
    function test_auto_setOwner_2() public {
        ...
        vm.warp(block.timestamp + 95969);
        vm.roll(block.number + 39636);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.setOwner(0x0000000000000000000000000000000000000000);
        ...
        vm.warp(block.timestamp + 443174);
        vm.roll(block.number + 47075);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.setOwner(0x00000000000000000000000000000001fffffffE);
        ...
        vm.warp(block.timestamp + 584157);
        vm.roll(block.number + 1984);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.setOwner(0x0000000000000000000000000000000000030000);
        ...
        vm.warp(block.timestamp + 412086);
        vm.roll(block.number + 9920);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.setOwner(0x00000000000000000000000000000002fFffFffD);
        ...
        vm.warp(block.timestamp + 233776);
        vm.roll(block.number + 59552);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.setOwner(0x00000000000000000000000000000002fFffFffD);

        vm.warp(block.timestamp + 5303);
        vm.roll(block.number + 34272);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.setOwner(0x00000000000000000000000000000002fFffFffD);

        vm.warp(block.timestamp + 373422);
        ...
        vm.warp(block.timestamp + 480172);
        vm.roll(block.number + 5023);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.setOwner(0x0000000000000000000000000000000000010000);
        ...
        vm.warp(block.timestamp + 545255);
        vm.roll(block.number + 59982);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.setOwner(0x00000000000000000000000000000001fffffffE);
