...
contract Csi3_Echidna_Test is Test {
    ...
    function test_auto_check_0() public { 
        ...
        vm.warp(block.timestamp + 402943);
        ...
        vm.warp(block.timestamp + 473958);
        ...
        vm.warp(block.timestamp + 326012);
        ...
        vm.warp(block.timestamp + 468806);
        ...
        vm.warp(block.timestamp + 516595);
        ...
        vm.warp(block.timestamp + 420945);
    ...
    function test_auto_check_1() public { 
        ...
        vm.warp(block.timestamp + 239493);
        vm.roll(block.number + 1362);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.check();
