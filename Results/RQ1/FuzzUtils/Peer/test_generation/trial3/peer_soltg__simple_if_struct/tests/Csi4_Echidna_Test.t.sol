...
contract Csi4_Echidna_Test is Test {
    ...
    function test_auto_check_0() public {
        ...
        vm.warp(block.timestamp + 505877);
        ...
        vm.roll(block.number + 42800);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.check();

        vm.warp(block.timestamp + 263703);
        ...
        vm.warp(block.timestamp + 114532);
        ...
        vm.warp(block.timestamp + 219410);
        ...
        vm.warp(block.timestamp + 367749);
        vm.roll(block.number + 2497);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.check();
    ...
    function test_auto_check_1() public {
        ...
        vm.warp(block.timestamp + 335528);
        vm.roll(block.number + 45819);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.check();
        ...
        vm.warp(block.timestamp + 230506);
        ...
        vm.warp(block.timestamp + 543830);
        vm.roll(block.number + 5020);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.check();
