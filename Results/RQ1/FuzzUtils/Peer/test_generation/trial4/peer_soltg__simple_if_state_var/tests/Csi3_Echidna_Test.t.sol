...
contract Csi3_Echidna_Test is Test {
    ...
    function test_auto_check_0() public {
        ...
        vm.warp(block.timestamp + 220564);
        ...
        vm.warp(block.timestamp + 144527);
        vm.roll(block.number + 8447);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.check();
        ...
        vm.warp(block.timestamp + 483629);
        ...
        vm.warp(block.timestamp + 532336);
        vm.roll(block.number + 30042);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.check();
    ...
    function test_auto_check_1() public {
        ...
        vm.warp(block.timestamp + 502693);
        vm.roll(block.number + 5952);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.check();
        ...
        vm.warp(block.timestamp + 402656);
        vm.roll(block.number + 9966);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.check();
        ...
        vm.warp(block.timestamp + 403144);
        ...
        vm.warp(block.timestamp + 307119);
        ...
        vm.warp(block.timestamp + 432580);
        vm.roll(block.number + 23403);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.check();
