...
contract Cb4_Echidna_Test is Test {
    ...
    function test_auto_g_0() public { 
        ...
        vm.warp(block.timestamp + 434279);
        ...
        vm.warp(block.timestamp + 182295);
        ...
        vm.warp(block.timestamp + 309731);
        ...
        vm.warp(block.timestamp + 157677);
        ...
        vm.warp(block.timestamp + 390986);
        vm.roll(block.number + 23885);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.g();
        ...
        vm.warp(block.timestamp + 536977);
        ...
        vm.warp(block.timestamp + 168608);
        ...
        vm.warp(block.timestamp + 360633);
        ...
        vm.warp(block.timestamp + 384460);
        ...
        vm.warp(block.timestamp + 531432);
        ...
        vm.warp(block.timestamp + 269806);
        vm.roll(block.number + 23517);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.g();
        
        vm.warp(block.timestamp + 265280);
        ...
        vm.warp(block.timestamp + 374593);
    ...
    function test_auto_g_1() public { 
        ...
        vm.warp(block.timestamp + 447267);
        ...
        vm.warp(block.timestamp + 558786);
        vm.roll(block.number + 27404);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.g();
        ...
        vm.warp(block.timestamp + 343398);
        ...
        vm.warp(block.timestamp + 579655);
        vm.roll(block.number + 34720);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.g();
        ...
        vm.warp(block.timestamp + 546791);
        vm.roll(block.number + 23275);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.g();
        
        vm.warp(block.timestamp + 307502);
        ...
        vm.warp(block.timestamp + 419191);
        vm.roll(block.number + 6721);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.g();
        ...
        vm.warp(block.timestamp + 125207);
        vm.roll(block.number + 60267);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.g();
        ...
        vm.warp(block.timestamp + 421182);
