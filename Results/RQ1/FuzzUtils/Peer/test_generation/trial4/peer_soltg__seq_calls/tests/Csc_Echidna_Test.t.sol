...
contract Csc_Echidna_Test is Test {
    ...
    function test_auto_call_1_0() public { 
        ...
        vm.warp(block.timestamp + 139187);
        ...
        vm.roll(block.number + 55730);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.call_2();
        
        vm.warp(block.timestamp + 40079);
        ...
        vm.warp(block.timestamp + 421276);
        vm.roll(block.number + 34720);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.call_1();
        ...
        vm.warp(block.timestamp + 363326);
        ...
        vm.warp(block.timestamp + 345463);
        ...
        vm.warp(block.timestamp + 203741);
    ...
    function test_auto_call_2_1() public { 
        ...
        vm.warp(block.timestamp + 571185);
        ...
        vm.warp(block.timestamp + 552662);
        vm.roll(block.number + 4896);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.call_2();
        ...
        vm.warp(block.timestamp + 529209);
