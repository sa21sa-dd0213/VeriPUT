...
contract Ci1_Echidna_Test is Test {
    ...
    function test_auto_f_0() public { 
        ...
        vm.warp(block.timestamp + 450207);
        vm.roll(block.number + 24923);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.f();
        ...
        vm.warp(block.timestamp + 206084);
        vm.roll(block.number + 800);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.f();
        ...
        vm.warp(block.timestamp + 157800);
        vm.roll(block.number + 59983);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.f();
    ...
    function test_auto_f_1() public { 
        ...
        vm.warp(block.timestamp + 235235);
        vm.roll(block.number + 45819);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.f();
        ...
        vm.warp(block.timestamp + 163105);
