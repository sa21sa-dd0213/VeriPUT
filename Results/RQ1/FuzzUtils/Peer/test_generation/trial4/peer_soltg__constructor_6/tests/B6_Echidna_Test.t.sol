...
contract B6_Echidna_Test is Test {
    ...
    function test_auto_f6_0() public {
        ...
        vm.warp(block.timestamp + 558850);
        ...
        vm.warp(block.timestamp + 250628);
        ...
        vm.warp(block.timestamp + 288628);
    ...
    function test_auto_f6_1() public {
        ...
        vm.warp(block.timestamp + 393310);
        ...
        vm.warp(block.timestamp + 139601);
        ...
        vm.warp(block.timestamp + 342787);
        vm.roll(block.number + 4981);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.g6();
        ...
        vm.warp(block.timestamp + 155900);
        vm.roll(block.number + 5952);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.f6();
        ...
        vm.warp(block.timestamp + 463153);
    ...
    function test_auto_f6_2() public {
        ...
        vm.warp(block.timestamp + 483560);
        ...
        vm.warp(block.timestamp + 332217);
        vm.roll(block.number + 60364);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.f6();
        ...
        vm.warp(block.timestamp + 342075);
        vm.roll(block.number + 30042);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.f6();

        vm.warp(block.timestamp + 48391);
        vm.roll(block.number + 53451);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.g6();
        ...
        vm.warp(block.timestamp + 363101);
        vm.roll(block.number + 5014);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.g6();
        ...
        vm.warp(block.timestamp + 432466);
        ...
        vm.warp(block.timestamp + 580642);
        vm.roll(block.number + 5018);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.g6();
    ...
    function test_auto_g6_3() public {
        ...
        vm.warp(block.timestamp + 143377);
        ...
        vm.warp(block.timestamp + 258100);
        vm.roll(block.number + 181);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.f6();

        vm.warp(block.timestamp + 445824);
        vm.roll(block.number + 42101);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.g6();
        ...
        vm.warp(block.timestamp + 148988);
        vm.roll(block.number + 5022);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.g6();
        ...
        vm.warp(block.timestamp + 183859);
        vm.roll(block.number + 56309);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.f6();
