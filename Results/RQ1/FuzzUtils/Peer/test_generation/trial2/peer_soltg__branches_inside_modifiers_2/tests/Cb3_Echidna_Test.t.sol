...
contract Cb3_Echidna_Test is Test {
    ...
    function test_auto_g_0() public {
        ...
        vm.warp(block.timestamp + 518888);
        ...
        vm.warp(block.timestamp + 141260);
        ...
        vm.warp(block.timestamp + 225286);
        ...
        vm.warp(block.timestamp + 475768);
        ...
        vm.warp(block.timestamp + 567857);
        ...
        vm.warp(block.timestamp + 178497);
    ...
    function test_auto_g_1() public {
        ...
        vm.warp(block.timestamp + 167496);
        vm.roll(block.number + 18429);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.g();
        ...
        vm.warp(block.timestamp + 358836);
        ...
        vm.warp(block.timestamp + 132321);
        ...
        vm.warp(block.timestamp + 572961);
        vm.roll(block.number + 53349);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.g();
