...
contract Storage_Echidna_Test is Test {
    ...
    function test_auto_balanceCheck_0() public {
        ...
        vm.warp(block.timestamp + 375192);
        ...
        vm.prank(0x0000000000000000000000000000000000020000);
        target.deposit{value: 19832409218875034073}();
        ...
        vm.warp(block.timestamp + 510363);
        vm.roll(block.number + 53451);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.deposit{value: 998}();

        vm.warp(block.timestamp + 45142);
        vm.roll(block.number + 22225);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.balanceCheck();
        ...
        vm.warp(block.timestamp + 287163);
        ...
        vm.warp(block.timestamp + 440325);
        ...
        vm.warp(block.timestamp + 390581);
        vm.roll(block.number + 49415);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.deposit{value: 9993298871979639776}();

        vm.warp(block.timestamp + 195123);
        vm.roll(block.number + 48147);
        vm.prank(0x0000000000000000000000000000000000020000);
        ...
        vm.roll(block.number + 2512);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.deposit{value: 77634193569344200563}();
        ...
        vm.prank(0x0000000000000000000000000000000000020000);
        target.deposit{value: 67125467668355473133}();
        ...
        vm.warp(block.timestamp + 514458);
        vm.roll(block.number + 45819);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.balanceCheck();

        vm.warp(block.timestamp + 203559);
        vm.roll(block.number + 24987);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.balanceCheck();
        ...
        vm.warp(block.timestamp + 245339);
        ...
        vm.prank(0x0000000000000000000000000000000000020000);
        target.deposit{value: 49609027437400859081}();
        ...
        vm.prank(0x0000000000000000000000000000000000030000);
        target.deposit{value: 54212493688054076703}();
        ...
        vm.warp(block.timestamp + 367693);
    ...
    function test_auto_balanceCheck_1() public {
        ...
        vm.warp(block.timestamp + 285291);
        vm.roll(block.number + 2512);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.deposit{value: 670780677356136008}();
        ...
        vm.warp(block.timestamp + 238813);
        vm.roll(block.number + 1000);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.deposit{value: 81411664210967045764}();
        ...
        vm.warp(block.timestamp + 604449);
        ...
        vm.warp(block.timestamp + 570951);
        vm.roll(block.number + 4021);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.deposit{value: 1341561354712272017}();
        ...
        vm.warp(block.timestamp + 297612);
        vm.roll(block.number + 30304);
        vm.prank(0x0000000000000000000000000000000000010000);
        ...
        vm.warp(block.timestamp + 281750);
        vm.roll(block.number + 22909);
        vm.prank(0x0000000000000000000000000000000000020000);
        ...
        vm.prank(0x0000000000000000000000000000000000010000);
        target.deposit{value: 41176948735793089905}();
    ...
    function test_auto_deposit_2() public {
        ...
        vm.warp(block.timestamp + 233306);
        vm.roll(block.number + 32767);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.balanceCheck();
        ...
        vm.warp(block.timestamp + 410853);
        vm.roll(block.number + 35200);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.deposit{value: 62909807314587347043}();
        ...
        vm.warp(block.timestamp + 142702);
        vm.roll(block.number + 59983);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.deposit{value: 1524785993}();

        vm.warp(block.timestamp + 330940);
        vm.roll(block.number + 8447);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.balanceCheck();

        vm.warp(block.timestamp + 419412);
        ...
        vm.warp(block.timestamp + 104629);
        ...
        vm.warp(block.timestamp + 235136);
        vm.roll(block.number + 12493);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.deposit{value: 64625260405496516811}();

        vm.warp(block.timestamp + 249138);
        vm.roll(block.number + 1002);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.balanceCheck();

        vm.warp(block.timestamp + 595808);
        vm.roll(block.number + 2526);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.balanceCheck();
