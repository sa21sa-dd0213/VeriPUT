...
contract Csi5_Echidna_Test is Test {
    ...
    function test_auto_check_0() public { 
        ...
        vm.warp(block.timestamp + 357081);
        ...
        vm.warp(block.timestamp + 398229);
        ...
        vm.warp(block.timestamp + 588401);
        vm.roll(block.number + 15368);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.check();
        ...
        vm.warp(block.timestamp + 246980);
        ...
        vm.warp(block.timestamp + 377724);
        ...
        vm.warp(block.timestamp + 186899);
        vm.roll(block.number + 5020);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.check();
    ...
    function test_auto_check_1() public { 
        ...
        vm.warp(block.timestamp + 567925);
        ...
        vm.warp(block.timestamp + 584782);
        vm.roll(block.number + 16089);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.check();
        ...
        vm.warp(block.timestamp + 459364);
        ...
        vm.warp(block.timestamp + 187863);
        ...
        vm.warp(block.timestamp + 489103);
        vm.roll(block.number + 24987);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.check();
        ...
        vm.warp(block.timestamp + 336232);
        vm.roll(block.number + 45819);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.check();
