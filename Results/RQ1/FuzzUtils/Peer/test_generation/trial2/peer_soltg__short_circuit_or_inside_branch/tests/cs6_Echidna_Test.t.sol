...
contract cs6_Echidna_Test is Test {
    ...
    function test_auto_g_0() public {
        ...
        vm.warp(block.timestamp + 142556);
        ...
        vm.warp(block.timestamp + 384223);
        ...
        vm.warp(block.timestamp + 140905);
        vm.roll(block.number + 7323);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.g(false);

        vm.warp(block.timestamp + 97431);
        vm.roll(block.number + 32767);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.g(true);
    }
    ...
    function test_auto_g_1() public {
        ...
        vm.warp(block.timestamp + 420905);
        ...
        vm.warp(block.timestamp + 588796);
        vm.roll(block.number + 4924);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.g(false);
        ...
        vm.warp(block.timestamp + 419159);
        ...
        vm.warp(block.timestamp + 319303);
        ...
        vm.warp(block.timestamp + 14038);
        vm.roll(block.number + 30784);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.g(true);

        vm.warp(block.timestamp + 344580);
