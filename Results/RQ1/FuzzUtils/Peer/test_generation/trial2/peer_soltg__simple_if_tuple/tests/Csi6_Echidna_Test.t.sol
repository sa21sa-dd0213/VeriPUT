...
contract Csi6_Echidna_Test is Test {
    ...
    function test_auto_check_0() public {
        ...
        vm.warp(block.timestamp + 119896);
        ...
        vm.warp(block.timestamp + 541647);
        ...
        vm.warp(block.timestamp + 178871);
        ...
        vm.roll(block.number + 23677);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.check();

        vm.warp(block.timestamp + 386322);
        vm.roll(block.number + 49415);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.check();
        ...
        vm.warp(block.timestamp + 598235);
        ...
        vm.warp(block.timestamp + 243794);
        ...
        vm.warp(block.timestamp + 587578);
        vm.roll(block.number + 15367);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.check();
        ...
        vm.warp(block.timestamp + 384071);
        ...
        vm.warp(block.timestamp + 489059);
        vm.roll(block.number + 20243);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.check();

        vm.warp(block.timestamp + 575957);
    ...
    function test_auto_check_1() public {
        ...
        vm.warp(block.timestamp + 393753);
        ...
        vm.warp(block.timestamp + 199973);
        vm.roll(block.number + 23722);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.check();
        ...
        vm.warp(block.timestamp + 491547);
        vm.roll(block.number + 12155);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.check();
        ...
        vm.warp(block.timestamp + 347737);
        ...
        vm.warp(block.timestamp + 373466);
        vm.roll(block.number + 47075);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.check();
        ...
        vm.warp(block.timestamp + 224518);
