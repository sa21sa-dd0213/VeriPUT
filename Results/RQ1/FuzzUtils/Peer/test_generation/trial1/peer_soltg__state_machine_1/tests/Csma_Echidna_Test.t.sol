...
contract Csma_Echidna_Test is Test {
    ...
    function test_auto_h_0() public {
        ...
        vm.warp(block.timestamp + 188549);
        vm.roll(block.number + 11349);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.f();
        ...
        vm.warp(block.timestamp + 547771);
        ...
        vm.warp(block.timestamp + 554332);
        ...
        vm.warp(block.timestamp + 293458);
    ...
    function test_auto_h_1() public {
        ...
        vm.warp(block.timestamp + 340218);
        ...
        vm.warp(block.timestamp + 125327);
        vm.roll(block.number + 5019);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.i();
        ...
        vm.warp(block.timestamp + 253984);
        ...
        vm.warp(block.timestamp + 411784);
        vm.roll(block.number + 5);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.h();
