...
contract Cfc1_Echidna_Test is Test {
    ...
    function test_auto_f_0() public {
        ...
        vm.warp(block.timestamp + 159158);
        ...
        vm.warp(block.timestamp + 420592);
        ...
        vm.warp(block.timestamp + 211040);
        vm.roll(block.number + 53451);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.f();

        vm.warp(block.timestamp + 239824);
        vm.roll(block.number + 33357);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.f();
        ...
        vm.warp(block.timestamp + 395522);
        ...
        vm.warp(block.timestamp + 152135);
        ...
        vm.warp(block.timestamp + 382854);
        ...
        vm.warp(block.timestamp + 458990);
        ...
        vm.warp(block.timestamp + 278485);
        vm.roll(block.number + 11942);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.f();
        ...
        vm.warp(block.timestamp + 466505);
        ...
        vm.warp(block.timestamp + 172395);
        vm.roll(block.number + 4223);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.f();
    ...
    function test_auto_f_1() public {
        ...
        vm.warp(block.timestamp + 574092);
        ...
        vm.warp(block.timestamp + 334655);
        vm.roll(block.number + 46422);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.f();
        ...
        vm.warp(block.timestamp + 131749);
        ...
        vm.warp(block.timestamp + 317982);
        vm.roll(block.number + 9920);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.f();
        ...
        vm.warp(block.timestamp + 528771);
        vm.roll(block.number + 4);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.f();

        vm.warp(block.timestamp + 206877);
