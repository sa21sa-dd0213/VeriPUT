...
contract cs6_Echidna_Test is Test {
    ...
    function test_auto_g_0() public { 
        ...
        vm.warp(block.timestamp + 379502);
        ...
        vm.warp(block.timestamp + 249782);
        ...
        vm.warp(block.timestamp + 316690);
        ...
        vm.warp(block.timestamp + 434522);
        ...
        vm.warp(block.timestamp + 601491);
        vm.roll(block.number + 30011);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.g(false);
        
        vm.warp(block.timestamp + 478623);
        vm.roll(block.number + 7134);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.g(true);
        ...
        vm.warp(block.timestamp + 426517);
        ...
        vm.warp(block.timestamp + 307106);
        vm.roll(block.number + 99);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.g(true);
    ...
    function test_auto_g_1() public { 
        ...
        vm.warp(block.timestamp + 485836);
        ...
        vm.warp(block.timestamp + 241648);
        ...
        vm.warp(block.timestamp + 162778);
        ...
        vm.warp(block.timestamp + 428642);
        vm.roll(block.number + 4922);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.g(false);
