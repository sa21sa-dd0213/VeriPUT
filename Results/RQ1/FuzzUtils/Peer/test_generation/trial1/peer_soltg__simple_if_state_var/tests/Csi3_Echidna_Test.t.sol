...
contract Csi3_Echidna_Test is Test {
    ...
    function test_auto_check_0() public { 
        ...
        vm.warp(block.timestamp + 430375);
        ...
        vm.warp(block.timestamp + 232257);
        ...
        vm.warp(block.timestamp + 238100);
        vm.roll(block.number + 15369);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.check();
        ...
        vm.warp(block.timestamp + 292513);
    ...
    function test_auto_check_1() public { 
        ...
        vm.warp(block.timestamp + 484932);
        vm.roll(block.number + 127);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.check();
        ...
        vm.warp(block.timestamp + 543781);
        vm.roll(block.number + 20243);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.check();
        
        vm.warp(block.timestamp + 82670);
        vm.roll(block.number + 13166);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.check();
        ...
        vm.warp(block.timestamp + 451816);
        vm.roll(block.number + 59552);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.check();
