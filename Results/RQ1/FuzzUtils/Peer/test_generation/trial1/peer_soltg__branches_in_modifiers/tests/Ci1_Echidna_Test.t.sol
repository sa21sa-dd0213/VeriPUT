...
contract Ci1_Echidna_Test is Test {
    ...
    function test_auto_f_0() public { 
        ...
        vm.warp(block.timestamp + 293476);
        vm.roll(block.number + 37847);
        ...
        vm.warp(block.timestamp + 337586);
