...
contract cs1_Echidna_Test is Test {
    ...
    function test_auto_g_0() public {
        ...
        vm.warp(block.timestamp + 440786);
        ...
        vm.warp(block.timestamp + 500034);
        ...
        vm.warp(block.timestamp + 412994);
        vm.roll(block.number + 33357);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.g();

        vm.warp(block.timestamp + 327020);
        ...
        vm.warp(block.timestamp + 351298);
        ...
        vm.warp(block.timestamp + 461060);
        vm.roll(block.number + 59552);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.g();
        ...
        vm.warp(block.timestamp + 565364);
        vm.roll(block.number + 5054);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.g();
    ...
    function test_auto_g_1() public {
        ...
        vm.warp(block.timestamp + 588684);
        vm.roll(block.number + 23403);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.g();
        ...
        vm.warp(block.timestamp + 383268);
        ...
        vm.warp(block.timestamp + 421328);
        vm.roll(block.number + 34720);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.g();
        ...
        vm.warp(block.timestamp + 572332);
        vm.roll(block.number + 15368);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.g();
