...
contract Ci1_Echidna_Test is Test {
    ...
    function test_auto_f_0() public {
        ...
        vm.warp(block.timestamp + 196773);
        ...
        vm.warp(block.timestamp + 429245);
        ...
        vm.warp(block.timestamp + 540004);
        ...
        vm.warp(block.timestamp + 338906);
        vm.roll(block.number + 53562);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.f();

        vm.warp(block.timestamp + 322372);
        vm.roll(block.number + 18399);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.f();
        ...
        vm.warp(block.timestamp + 261911);
        ...
        vm.warp(block.timestamp + 350222);
        ...
        vm.warp(block.timestamp + 210545);
        vm.roll(block.number + 36859);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.f();
        ...
        vm.warp(block.timestamp + 68042);
        vm.roll(block.number + 20243);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.f();

        vm.warp(block.timestamp + 32767);
        vm.roll(block.number + 3355);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.f();
    ...
    function test_auto_f_1() public {
        ...
        vm.warp(block.timestamp + 501435);
        ...
        vm.warp(block.timestamp + 439319);
        vm.roll(block.number + 5021);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.f();
        ...
        vm.warp(block.timestamp + 465111);
        vm.roll(block.number + 53451);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.f();
        ...
        vm.warp(block.timestamp + 159394);
        vm.roll(block.number + 30011);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.f();
        ...
        vm.warp(block.timestamp + 487562);
        vm.roll(block.number + 5022);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.f();
