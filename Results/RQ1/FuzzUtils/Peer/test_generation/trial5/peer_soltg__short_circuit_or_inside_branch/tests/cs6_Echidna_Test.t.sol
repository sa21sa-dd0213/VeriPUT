...
contract cs6_Echidna_Test is Test {
    ...
    function test_auto_g_0() public { 
        ...
        vm.warp(block.timestamp + 165129);
        ...
        vm.warp(block.timestamp + 118559);
    ...
    function test_auto_g_1() public { 
        ...
        vm.warp(block.timestamp + 127634);
        vm.roll(block.number + 4919);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.g(false);
        ...
        vm.warp(block.timestamp + 540889);
        ...
        vm.warp(block.timestamp + 244591);
        vm.roll(block.number + 2);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.g(false);
        ...
        vm.warp(block.timestamp + 547893);
        vm.roll(block.number + 6721);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.g(true);
        ...
        vm.warp(block.timestamp + 270767);
        ...
        vm.warp(block.timestamp + 245494);
        vm.roll(block.number + 5054);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.g(false);
    }
