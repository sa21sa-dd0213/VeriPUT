...
contract Csi2_Echidna_Test is Test {
    ...
    function test_auto_check_0() public { 
        ...
        vm.warp(block.timestamp + 531531);
        ...
        vm.warp(block.timestamp + 119086);
        ...
        vm.warp(block.timestamp + 328211);
        vm.roll(block.number + 2);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.check();
        ...
        vm.warp(block.timestamp + 497269);
    ...
    function test_auto_check_1() public { 
        ...
        vm.warp(block.timestamp + 456808);
        vm.roll(block.number + 1123);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.check();
