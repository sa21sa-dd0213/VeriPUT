...
contract ReentrancyDAO_Echidna_Test is Test {
    ...
    function test_auto_withdrawAll_0() public {
        ...
        vm.warp(block.timestamp + 322794);
        vm.roll(block.number + 1);
        vm.prank(0x0000000000000000000000000000000000030000);
        ...
        vm.warp(block.timestamp + 128475);
        vm.roll(block.number + 59981);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.withdrawAll();
        ...
        vm.warp(block.timestamp + 317984);
        ...
        vm.warp(block.timestamp + 417847);
        ...
        vm.prank(0x0000000000000000000000000000000000010000);
        target.deposit{value: 96043384928922732700}();
        ...
        vm.roll(block.number + 1);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.deposit{value: 19291581400437595538}();
        ...
        vm.warp(block.timestamp + 161880);
    ...
    function test_auto_withdrawAll_1() public {
        ...
        vm.warp(block.timestamp + 336186);
        vm.roll(block.number + 23722);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.deposit{value: 43439706806341636604}();
        ...
        vm.roll(block.number + 15369);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.deposit{value: 73055114182511076064}();
        ...
        vm.warp(block.timestamp + 593103);
        vm.roll(block.number + 15367);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.withdrawAll();

        vm.warp(block.timestamp + 40218);
        vm.roll(block.number + 54155);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.deposit{value: 49709386032015071375}();
        ...
        vm.roll(block.number + 4223);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.deposit{value: 42456594838973325929}();
        ...
        vm.warp(block.timestamp + 380620);
        ...
        vm.warp(block.timestamp + 364362);
