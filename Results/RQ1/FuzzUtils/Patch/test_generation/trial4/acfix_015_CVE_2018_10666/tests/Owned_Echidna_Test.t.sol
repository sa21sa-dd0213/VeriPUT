...
contract Owned_Echidna_Test is Test {
    ...
    function test_auto_setOwner_0() public { 
        ...
        vm.warp(block.timestamp + 565268);
        ...
        vm.warp(block.timestamp + 135412);
        ...
        vm.warp(block.timestamp + 460542);
        vm.roll(block.number + 40599);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.setOwner(0x00000000000000000000000000000000FFFFfFFF);
        ...
        vm.warp(block.timestamp + 273089);
    ...
    function test_auto_setOwner_1() public { 
        ...
        vm.warp(block.timestamp + 477212);
        ...
        vm.warp(block.timestamp + 250810);
        vm.roll(block.number + 29939);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.setOwner(0x00000000000000000000000000000002fFffFffD);
        
        vm.warp(block.timestamp + 72603);
        vm.roll(block.number + 40597);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.setOwner(0x00000000000000000000000000000000FFFFfFFF);
    ...
    function test_auto_setOwner_2() public { 
        ...
        vm.warp(block.timestamp + 122113);
        ...
        vm.warp(block.timestamp + 463337);
        ...
        vm.warp(block.timestamp + 142521);
        ...
        vm.warp(block.timestamp + 523717);
        ...
        vm.warp(block.timestamp + 377813);
        vm.roll(block.number + 41151);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.setOwner(0x00000000000000000000000000000000FFFFfFFF);
        ...
        vm.warp(block.timestamp + 229952);
        ...
        vm.warp(block.timestamp + 272256);
        vm.roll(block.number + 5023);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.setOwner(0x00000000000000000000000000000000FFFFfFFF);
        ...
        vm.warp(block.timestamp + 304800);
        vm.roll(block.number + 30042);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.setOwner(0x00000000000000000000000000000000FFFFfFFF);
    ...
    function test_auto_setOwner_3() public { 
        ...
        vm.warp(block.timestamp + 166515);
        vm.roll(block.number + 2512);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.setOwner(0x0000000000000000000000000000000000020000);
        ...
        vm.warp(block.timestamp + 317048);
        ...
        vm.warp(block.timestamp + 279364);
        vm.roll(block.number + 50499);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.setOwner(0x00000000000000000000000000000000FFFFfFFF);
        ...
        vm.warp(block.timestamp + 421687);
        vm.roll(block.number + 5017);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.setOwner(0x00000000000000000000000000000000FFFFfFFF);
        ...
        vm.warp(block.timestamp + 421174);
        vm.roll(block.number + 55538);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.setOwner(0x00000000000000000000000000000000FFFFfFFF);
