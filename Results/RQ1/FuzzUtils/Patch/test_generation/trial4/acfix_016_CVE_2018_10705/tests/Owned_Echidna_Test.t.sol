...
contract Owned_Echidna_Test is Test {
    ...
    function test_auto_setOwner_0() public {
        ...
        vm.warp(block.timestamp + 515450);
        ...
        vm.warp(block.timestamp + 517685);
        ...
        vm.warp(block.timestamp + 109129);
        ...
        vm.warp(block.timestamp + 222427);
        ...
        vm.warp(block.timestamp + 202834);
    ...
    function test_auto_setOwner_1() public {
        ...
        vm.warp(block.timestamp + 559545);
        vm.roll(block.number + 30011);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.setOwner(0x0000000000000000000000000000000000010000);
        ...
        vm.warp(block.timestamp + 339979);
        ...
        vm.warp(block.timestamp + 117261);
    ...
    function test_auto_setOwner_2() public {
        ...
        vm.warp(block.timestamp + 555055);
        vm.roll(block.number + 4223);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.setOwner(0x00000000000000000000000000000000FFFFfFFF);
        ...
        vm.warp(block.timestamp + 501462);
        vm.roll(block.number + 59981);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.setOwner(0x00000000000000000000000000000002fFffFffD);
        ...
        vm.warp(block.timestamp + 175625);
        vm.roll(block.number + 12338);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.setOwner(0x00000000000000000000000000000000FFFFfFFF);
        ...
        vm.warp(block.timestamp + 349509);
        vm.roll(block.number + 53562);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.setOwner(0x00000000000000000000000000000001fffffffE);
        ...
        vm.warp(block.timestamp + 265008);
        vm.roll(block.number + 35680);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.setOwner(0x00000000000000000000000000000000FFFFfFFF);
        ...
        vm.warp(block.timestamp + 543116);
        vm.roll(block.number + 53678);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.setOwner(0x00000000000000000000000000000001fffffffE);
    ...
    function test_auto_setOwner_3() public {
        ...
        vm.warp(block.timestamp + 561066);
        vm.roll(block.number + 29483);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.setOwner(0x0000000000000000000000000000000000020000);
        ...
        vm.warp(block.timestamp + 163044);
        vm.roll(block.number + 22699);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.setOwner(0x00000000000000000000000000000001fffffffE);
        ...
        vm.warp(block.timestamp + 507248);
        vm.roll(block.number + 53166);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.setOwner(0x00000000000000000000000000000001fffffffE);
        ...
        vm.warp(block.timestamp + 387195);
        vm.roll(block.number + 42229);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.setOwner(0x00000000000000000000000000000002fFffFffD);
    }
