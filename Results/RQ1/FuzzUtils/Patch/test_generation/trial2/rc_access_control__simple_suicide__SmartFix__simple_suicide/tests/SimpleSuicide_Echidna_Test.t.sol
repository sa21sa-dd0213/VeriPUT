...
contract SimpleSuicide_Echidna_Test is Test {
    ...
    function test_auto_sudicideAnyone_0() public {
        ...
        vm.roll(block.number + 19369);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.sudicideAnyone();

        vm.warp(block.timestamp + 314862);
        ...
        vm.warp(block.timestamp + 272476);
        ...
        vm.warp(block.timestamp + 421066);
        vm.roll(block.number + 12053);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.sudicideAnyone();
        ...
        vm.warp(block.timestamp + 539115);
        ...
        vm.warp(block.timestamp + 406460);
        vm.roll(block.number + 49415);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.sudicideAnyone();
    ...
    function test_auto_sudicideAnyone_1() public {
        ...
        vm.warp(block.timestamp + 263491);
        vm.roll(block.number + 42101);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.sudicideAnyone();
        ...
        vm.warp(block.timestamp + 497756);
        ...
        vm.warp(block.timestamp + 237463);
        vm.roll(block.number + 53562);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.sudicideAnyone();
        ...
        vm.warp(block.timestamp + 415180);
    ...
    function test_auto_sudicideAnyone_2() public {
        ...
        vm.warp(block.timestamp + 288147);
        vm.roll(block.number + 4462);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.sudicideAnyone();
        ...
        vm.warp(block.timestamp + 447084);
        vm.roll(block.number + 22909);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.sudicideAnyone();
        ...
        vm.warp(block.timestamp + 216130);
        ...
        vm.warp(block.timestamp + 257245);
        vm.roll(block.number + 255);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.sudicideAnyone();
        ...
        vm.warp(block.timestamp + 154798);
        vm.roll(block.number + 31232);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.sudicideAnyone();
        ...
        vm.warp(block.timestamp + 385736);
        vm.roll(block.number + 11942);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.sudicideAnyone();
