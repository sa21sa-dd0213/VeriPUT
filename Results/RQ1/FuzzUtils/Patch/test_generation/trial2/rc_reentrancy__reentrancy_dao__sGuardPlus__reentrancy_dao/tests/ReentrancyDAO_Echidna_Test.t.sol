...
contract ReentrancyDAO_Echidna_Test is Test {
    ...
    function test_auto_withdrawAll_0() public { 
        ...
        vm.warp(block.timestamp + 269970);
        ...
        vm.prank(0x0000000000000000000000000000000000030000);
        target.deposit{value: 3535110105660404020}();
        
        vm.warp(block.timestamp + 303345);
        vm.roll(block.number + 5023);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.deposit{value: 41988273384745214022}();
        ...
        vm.warp(block.timestamp + 371911);
        ...
        vm.roll(block.number + 32147);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.deposit{value: 45062511014515861956}();
        ...
        vm.warp(block.timestamp + 584430);
        ...
        vm.warp(block.timestamp + 298430);
        ...
        vm.warp(block.timestamp + 424182);
        ...
        vm.warp(block.timestamp + 575951);
        ...
        vm.warp(block.timestamp + 326864);
        ...
        vm.warp(block.timestamp + 242650);
        vm.roll(block.number + 42595);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.withdrawAll();
        
        vm.warp(block.timestamp + 554576);
        vm.roll(block.number + 6376);
        vm.prank(0x0000000000000000000000000000000000010000);
    ...
    function test_auto_withdrawAll_1() public { 
        ...
        vm.warp(block.timestamp + 561157);
        vm.roll(block.number + 32147);
        vm.prank(0x0000000000000000000000000000000000020000);
        ...
        vm.warp(block.timestamp + 233644);
        vm.roll(block.number + 53166);
        vm.prank(0x0000000000000000000000000000000000010000);
        ...
        vm.warp(block.timestamp + 231764);
        vm.roll(block.number + 36859);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.withdrawAll();
        ...
        vm.warp(block.timestamp + 517198);
        vm.roll(block.number + 51846);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.withdrawAll();
    }
