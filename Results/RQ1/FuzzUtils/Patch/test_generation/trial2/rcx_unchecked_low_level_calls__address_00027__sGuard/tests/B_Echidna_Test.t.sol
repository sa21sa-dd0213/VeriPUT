...
contract B_Echidna_Test is Test {
    ...
    function test_auto__0() public {
        ...
        vm.warp(block.timestamp + 261248);
        vm.roll(block.number + 5054);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.go{value: 2487421117953226060}();
        ...
        vm.prank(0x0000000000000000000000000000000000030000);
        target.go{value: 48156020909999008794}();
        ...
        vm.prank(0x0000000000000000000000000000000000010000);
        target.go{value: 2266293555728283295}();
        ...
        vm.warp(block.timestamp + 367702);
        vm.roll(block.number + 27404);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.go{value: 16777215}();

        vm.prank(0x0000000000000000000000000000000000010000);
        (success, ) = payable(address(target)).call{value: 82465050202746731995}("");
        require(success, "Low level call failed.");
        ...
        vm.prank(0x0000000000000000000000000000000000030000);
        (success, ) = payable(address(target)).call{value: 23755395719008117117}("");
        require(success, "Low level call failed.");
        ...
        vm.prank(0x0000000000000000000000000000000000010000);
        (success, ) = payable(address(target)).call{value: 26486881153082380713}("");
        require(success, "Low level call failed.");
        ...
        vm.prank(0x0000000000000000000000000000000000010000);
        target.go{value: 92867232038392054543}();
        ...
        vm.prank(0x0000000000000000000000000000000000010000);
        (success, ) = payable(address(target)).call{value: 31194316467509444795}("");
        require(success, "Low level call failed.");
    }
    ...
    function test_auto__1() public {
        ...
        vm.warp(block.timestamp + 461074);
        ...
        vm.prank(0x0000000000000000000000000000000000020000);
        (success, ) = payable(address(target)).call{value: 16684617502752055614}("");
        require(success, "Low level call failed.");
        ...
        vm.prank(0x0000000000000000000000000000000000020000);
        target.go{value: 28399367062592962135}();
        ...
        vm.warp(block.timestamp + 557496);
        ...
        vm.roll(block.number + 26527);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.go{value: 42722651420139728978}();
        ...
        vm.prank(0x0000000000000000000000000000000000010000);
        target.go{value: 68557471066757271225}();
        ...
        vm.roll(block.number + 11826);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.go{value: 61571341003385312690}();
        ...
        vm.prank(0x0000000000000000000000000000000000030000);
        (success, ) = payable(address(target)).call{value: 59956068651754332707}("");
        require(success, "Low level call failed.");
    ...
    function test_auto_go_2() public {
        ...
        vm.warp(block.timestamp + 559735);
        vm.roll(block.number + 55538);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.go{value: 1524785991}();

        vm.prank(0x0000000000000000000000000000000000020000);
        (success, ) = payable(address(target)).call{value: 86137802234584528090}("");
        require(success, "Low level call failed.");
        ...
        vm.roll(block.number + 35248);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.go{value: 60057427791388426733}();
        ...
        vm.roll(block.number + 31232);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.go{value: 38083093470094964229}();
        ...
        vm.warp(block.timestamp + 168387);
        vm.roll(block.number + 34369);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.go{value: 4369999}();

        vm.prank(0x0000000000000000000000000000000000020000);
        (success, ) = payable(address(target)).call{value: 96367545403261544568}("");
        require(success, "Low level call failed.");
