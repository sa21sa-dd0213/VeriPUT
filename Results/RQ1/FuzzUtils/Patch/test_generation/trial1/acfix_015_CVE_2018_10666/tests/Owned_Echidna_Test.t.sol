...
contract Owned_Echidna_Test is Test {
    ...
    function test_auto_setOwner_0() public { 
        ...
        vm.warp(block.timestamp + 340664);
        ...
        vm.warp(block.timestamp + 85717);
        vm.roll(block.number + 30975);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.setOwner(0x00000000000000000000000000000000000000ff);
        ...
        vm.warp(block.timestamp + 371201);
        vm.roll(block.number + 20984);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.setOwner(0x00a329c0648769A73afAc7F9381E08FB43dBEA72);
        
        vm.warp(block.timestamp + 363885);
        ...
        vm.warp(block.timestamp + 418951);
        ...
        vm.warp(block.timestamp + 497409);
        vm.roll(block.number + 32);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.setOwner(0x00000000000000000000000000000000FFFFfFFF);
        ...
        vm.warp(block.timestamp + 68926);
        vm.roll(block.number + 43161);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.setOwner(0x00000000000000000000000000000001fffffffE);
    ...
    function test_auto_setOwner_1() public { 
        ...
        vm.warp(block.timestamp + 198373);
        vm.roll(block.number + 31232);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.setOwner(0x00000000000000000000000000000001fffffffE);
        
        vm.warp(block.timestamp + 262844);
        ...
        vm.warp(block.timestamp + 494823);
        ...
        vm.warp(block.timestamp + 308497);
        vm.roll(block.number + 16089);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.setOwner(0x00a329c0648769A73afAc7F9381E08FB43dBEA72);
        ...
        vm.warp(block.timestamp + 249382);
    ...
    function test_auto_setOwner_2() public { 
        ...
        vm.warp(block.timestamp + 121185);
        ...
        vm.warp(block.timestamp + 170089);
        vm.roll(block.number + 34272);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.setOwner(0x00000000000000000000000000000000FFFFfFFF);
        ...
        vm.warp(block.timestamp + 240793);
        vm.roll(block.number + 59983);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.setOwner(0x0000000000000000000000000000000000000000);
        ...
        vm.warp(block.timestamp + 589543);
        vm.roll(block.number + 2497);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.setOwner(0x00000000000000000000000000000001fffffffE);
        ...
        vm.warp(block.timestamp + 586678);
        vm.roll(block.number + 32);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.setOwner(0x00000000000000000000000000000000000000ff);
        ...
        vm.warp(block.timestamp + 159179);
        vm.roll(block.number + 38138);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.setOwner(0x00000000000000000000000000000000FFFFfFFF);
    ...
    function test_auto_setOwner_3() public { 
        ...
        vm.warp(block.timestamp + 244507);
        ...
        vm.warp(block.timestamp + 349836);
        vm.roll(block.number + 1984);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.setOwner(0x00000000000000000000000000000002fFffFffD);
        
        vm.warp(block.timestamp + 395604);
        ...
        vm.warp(block.timestamp + 486576);
        vm.roll(block.number + 1123);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.setOwner(0x0000000000000000000000000000000000020000);
