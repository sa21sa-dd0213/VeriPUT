...
contract Reentrance_Echidna_Test is Test {
    ...
    function test_auto_addToBalance_0() public { 
        ...
        vm.prank(0x0000000000000000000000000000000000010000);
        target.addToBalance{value: 67350933886320147589}();
        ...
        vm.warp(block.timestamp + 203636);
        vm.roll(block.number + 57086);
        vm.prank(0x0000000000000000000000000000000000010000);
        ...
        vm.warp(block.timestamp + 466274);
        ...
        vm.warp(block.timestamp + 274418);
        vm.roll(block.number + 9920);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.withdrawBalance();
        ...
        vm.warp(block.timestamp + 547756);
        ...
        vm.prank(0x0000000000000000000000000000000000010000);
        target.addToBalance{value: 60160680777784876179}();
    ...
    function test_auto_withdrawBalance_1() public { 
        ...
        vm.roll(block.number + 45433);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.withdrawBalance();
        
        vm.warp(block.timestamp + 527623);
        ...
        vm.roll(block.number + 15367);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.addToBalance{value: 48849031206913199197}();
        ...
        vm.prank(0x0000000000000000000000000000000000020000);
        target.addToBalance{value: 75046730324286476727}();
        ...
        vm.warp(block.timestamp + 405652);
        vm.roll(block.number + 32);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.withdrawBalance();
    ...
    function test_auto_addToBalance_2() public { 
        ...
        vm.warp(block.timestamp + 270681);
        vm.roll(block.number + 34720);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.addToBalance{value: 71486995237020922406}();
        
        vm.warp(block.timestamp + 148089);
        vm.roll(block.number + 23722);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.addToBalance{value: 85572211742064992979}();
        ...
        vm.roll(block.number + 59552);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.addToBalance{value: 33904880886030391164}();
        ...
        vm.prank(0x0000000000000000000000000000000000030000);
        target.addToBalance{value: 55192286058591897378}();
        ...
        vm.roll(block.number + 1362);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.addToBalance{value: 50793594827692089274}();
        ...
        vm.roll(block.number + 53678);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.addToBalance{value: 26637793525647824362}();
    }
