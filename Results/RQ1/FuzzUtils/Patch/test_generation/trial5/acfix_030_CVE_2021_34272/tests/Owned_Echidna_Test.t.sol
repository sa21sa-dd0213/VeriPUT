...
contract Owned_Echidna_Test is Test {
    ...
    function test_auto_transferOwnership_0() public {
        ...
        vm.warp(block.timestamp + 109265);
        ...
        vm.warp(block.timestamp + 590719);
        ...
        vm.warp(block.timestamp + 389981);
        ...
        vm.warp(block.timestamp + 257899);
        vm.roll(block.number + 23275);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.transferOwnership(0x00000000000000000000000000000000FFFFfFFF);
    ...
    function test_auto_transferOwnership_1() public {
        ...
        vm.warp(block.timestamp + 24499);
        vm.roll(block.number + 5021);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.transferOwnership(0x0000000000000000000000000000000000010000);

        vm.warp(block.timestamp + 182332);
        vm.roll(block.number + 53349);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.transferOwnership(0x00a329c0648769A73afAc7F9381E08FB43dBEA72);
        ...
        vm.warp(block.timestamp + 294762);
        ...
        vm.warp(block.timestamp + 163796);
        ...
        vm.warp(block.timestamp + 134833);
        vm.roll(block.number + 20243);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.transferOwnership(0x0000000000000000000000000000000000010000);
    ...
    function test_auto_transferOwnership_2() public {
        ...
        vm.warp(block.timestamp + 168534);
        vm.roll(block.number + 12338);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.transferOwnership(0x0000000000000000000000000000000000010000);
        ...
        vm.warp(block.timestamp + 363517);
        vm.roll(block.number + 23722);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.transferOwnership(0x0000000000000000000000000000000000010000);
    ...
    function test_auto_transferOwnership_3() public {
        ...
        vm.warp(block.timestamp + 199139);
        vm.roll(block.number + 7720);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.transferOwnership(0x0000000000000000000000000000000000020000);

        vm.warp(block.timestamp + 131111);
        vm.roll(block.number + 5018);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.transferOwnership(0x00000000000000000000000000000002fFffFffD);
        ...
        vm.warp(block.timestamp + 315156);
        vm.roll(block.number + 20243);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.transferOwnership(0x0000000000000000000000000000000000030000);
        ...
        vm.warp(block.timestamp + 212472);
        ...
        vm.warp(block.timestamp + 502876);
        vm.roll(block.number + 4223);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.transferOwnership(0x0000000000000000000000000000000000000000);
