...
contract B_Echidna_Test is Test {
    ...
    function test_auto__0() public {
        ...
        vm.prank(0x0000000000000000000000000000000000030000);
        (success, ) = payable(address(target)).call{value: 31440811102797558461}("");
        require(success, "Low level call failed.");
        ...
        vm.warp(block.timestamp + 536909);
        ...
        vm.prank(0x0000000000000000000000000000000000010000);
        target.go{value: 94103813424612901153}();
        ...
        vm.prank(0x0000000000000000000000000000000000010000);
        (success, ) = payable(address(target)).call{value: 81544832884399391032}("");
        require(success, "Low level call failed.");
        ...
        vm.prank(0x0000000000000000000000000000000000030000);
        (success, ) = payable(address(target)).call{value: 95463949116013382988}("");
        require(success, "Low level call failed.");
        ...
        vm.prank(0x0000000000000000000000000000000000010000);
        target.go{value: 33219200529448023216}();
        ...
        vm.prank(0x0000000000000000000000000000000000020000);
        (success, ) = payable(address(target)).call{value: 87051427195707300766}("");
        require(success, "Low level call failed.");
        ...
        vm.warp(block.timestamp + 215691);
        vm.roll(block.number + 22909);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.go{value: 8388607}();
        ...
        vm.prank(0x0000000000000000000000000000000000010000);
        (success, ) = payable(address(target)).call{value: 26995766141462817762}("");
        require(success, "Low level call failed.");
    ...
    function test_auto_go_1() public {
        ...
        vm.prank(0x0000000000000000000000000000000000010000);
        (success, ) = payable(address(target)).call{value: 54738957226076128720}("");
        require(success, "Low level call failed.");
        ...
        vm.roll(block.number + 3661);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.go{value: 44022243688766652181}();
        ...
        vm.prank(0x0000000000000000000000000000000000020000);
        (success, ) = payable(address(target)).call{value: 52339321584636629204}("");
        require(success, "Low level call failed.");
        ...
        vm.prank(0x0000000000000000000000000000000000030000);
        target.go{value: 84350779684472252987}();
        
        vm.prank(0x0000000000000000000000000000000000030000);
        (success, ) = payable(address(target)).call{value: 37899003175594097783}("");
        require(success, "Low level call failed.");
        ...
        vm.warp(block.timestamp + 598221);
        ...
        vm.roll(block.number + 34720);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.go{value: 11539952314008233396}();
        ...
        vm.prank(0x0000000000000000000000000000000000030000);
        (success, ) = payable(address(target)).call{value: 6949707313862871947}("");
        require(success, "Low level call failed.");
        ...
        vm.warp(block.timestamp + 131327);
        ...
        vm.warp(block.timestamp + 258956);
        vm.roll(block.number + 34720);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.go{value: 27476335788990931285}();
