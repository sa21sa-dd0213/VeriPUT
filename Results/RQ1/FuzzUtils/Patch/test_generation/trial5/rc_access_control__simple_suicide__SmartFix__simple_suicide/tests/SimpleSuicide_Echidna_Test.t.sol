...
contract SimpleSuicide_Echidna_Test is Test {
    ...
    function test_auto_sudicideAnyone_0() public {
        ...
        vm.warp(block.timestamp + 577466);
        ...
        vm.warp(block.timestamp + 338078);
        ...
        vm.warp(block.timestamp + 492878);
        vm.roll(block.number + 31232);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.sudicideAnyone();

        vm.warp(block.timestamp + 298543);
        ...
        vm.warp(block.timestamp + 417425);
        ...
        vm.roll(block.number + 9113);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.sudicideAnyone();

        vm.warp(block.timestamp + 50197);
        vm.roll(block.number + 30042);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.sudicideAnyone();
    ...
    function test_auto_sudicideAnyone_1() public {
        ...
        vm.warp(block.timestamp + 373729);
        vm.roll(block.number + 23722);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.sudicideAnyone();
        ...
        vm.warp(block.timestamp + 460860);
        vm.roll(block.number + 4223);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.sudicideAnyone();
        ...
        vm.warp(block.timestamp + 411652);
        vm.roll(block.number + 23275);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.sudicideAnyone();
    ...
    function test_auto_sudicideAnyone_2() public {
        ...
        vm.warp(block.timestamp + 445203);
        vm.roll(block.number + 4462);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.sudicideAnyone();
        ...
        vm.warp(block.timestamp + 257321);
        vm.roll(block.number + 12155);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.sudicideAnyone();

        vm.warp(block.timestamp + 110988);
        vm.roll(block.number + 22909);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.sudicideAnyone();

        vm.warp(block.timestamp + 279319);
        vm.roll(block.number + 9966);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.sudicideAnyone();
        ...
        vm.warp(block.timestamp + 298661);
        vm.roll(block.number + 24987);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.sudicideAnyone();
