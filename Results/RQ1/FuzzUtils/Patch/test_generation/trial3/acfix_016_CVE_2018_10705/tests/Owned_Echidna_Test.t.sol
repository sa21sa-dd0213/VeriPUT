...
contract Owned_Echidna_Test is Test {
    ...
    function test_auto_setOwner_0() public {
        ...
        vm.warp(block.timestamp + 323197);
        ...
        vm.warp(block.timestamp + 511124);
        vm.roll(block.number + 2497);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.setOwner(0x00000000000000000000000000000002fFffFffD);
        ...
        vm.warp(block.timestamp + 549597);
        vm.roll(block.number + 255);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.setOwner(0x0000000000000000000000000000000000030000);
        ...
        vm.warp(block.timestamp + 373079);
        vm.roll(block.number + 59983);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.setOwner(0x00000000000000000000000000000002fFffFffD);
        ...
        vm.warp(block.timestamp + 572770);
        ...
        vm.warp(block.timestamp + 532298);
        ...
        vm.warp(block.timestamp + 458518);
        ...
        vm.warp(block.timestamp + 364043);
    ...
    function test_auto_setOwner_1() public {
        ...
        vm.warp(block.timestamp + 197960);
        ...
        vm.warp(block.timestamp + 312045);
        vm.roll(block.number + 255);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.setOwner(0x00000000000000000000000000000001fffffffE);
        ...
        vm.warp(block.timestamp + 166943);
        vm.roll(block.number + 53011);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.setOwner(0x00000000000000000000000000000002fFffFffD);
        ...
        vm.warp(block.timestamp + 120149);
        vm.roll(block.number + 1984);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.setOwner(0x0000000000000000000000000000000000020000);
        ...
        vm.warp(block.timestamp + 344992);
        vm.roll(block.number + 8968);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.setOwner(0x00000000000000000000000000000002fFffFffD);
    ...
    function test_auto_setOwner_2() public {
        ...
        vm.warp(block.timestamp + 414579);
        vm.roll(block.number + 16808);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.setOwner(0x00000000000000000000000000000001fffffffE);

        vm.warp(block.timestamp + 358061);
        vm.roll(block.number + 3152);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.setOwner(0x0000000000000000000000000000000000020000);
    ...
    function test_auto_setOwner_3() public {
        ...
        vm.warp(block.timestamp + 353194);
        vm.roll(block.number + 59983);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.setOwner(0x00000000000000000000000000000001fffffffE);
        ...
        vm.warp(block.timestamp + 228829);
        vm.roll(block.number + 1088);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.setOwner(0x0000000000000000000000000000000000020000);
        ...
        vm.warp(block.timestamp + 145901);
        vm.roll(block.number + 49415);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.setOwner(0x00000000000000000000000000000002fFffFffD);
        ...
        vm.warp(block.timestamp + 222025);
        vm.roll(block.number + 57086);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.setOwner(0x0000000000000000000000000000000000010000);
