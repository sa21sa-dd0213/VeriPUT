...
contract SimpleSuicide_Echidna_Test is Test {
    ...
    function test_auto_sudicideAnyone_0() public { 
        ...
        vm.roll(block.number + 42398);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.sudicideAnyone();
        
        vm.warp(block.timestamp + 526239);
        ...
        vm.warp(block.timestamp + 112719);
        ...
        vm.warp(block.timestamp + 124070);
        vm.roll(block.number + 12155);
        vm.prank(0x0000000000000000000000000000000000010000);
        target.sudicideAnyone();
    ...
    function test_auto_sudicideAnyone_1() public { 
        ...
        vm.warp(block.timestamp + 333287);
        ...
        vm.warp(block.timestamp + 483684);
        vm.roll(block.number + 53678);
        vm.prank(0x0000000000000000000000000000000000020000);
        target.sudicideAnyone();
        ...
        vm.warp(block.timestamp + 458234);
        vm.roll(block.number + 800);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.sudicideAnyone();
        ...
        vm.warp(block.timestamp + 198285);
        vm.roll(block.number + 23275);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.sudicideAnyone();
        ...
        vm.warp(block.timestamp + 344292);
        vm.roll(block.number + 23403);
        vm.prank(0x0000000000000000000000000000000000030000);
        target.sudicideAnyone();
